...
extends MessageToByteEncoder<ByteBuf> {
    ...
    protected ByteBuf allocateBuffer(ChannelHandlerContext ctx, ByteBuf msg, boolean preferDirect) {
        ...
        while (remaining > 0) {
            ...
            remaining -= curSize;
            bufferSize += com.github.luben.zstd.Zstd.compressBound((long)curSize);
        }
    ...
    private void flushBufferedData(ByteBuf out) {
        ...
        try {
            ...
            compressedLength = com.github.luben.zstd.Zstd.compress((ByteBuffer)outNioBuffer, (ByteBuffer)this.buffer.internalNioBuffer(this.buffer.readerIndex(), flushableBytes), (int)this.compressionLevel);
        }
        catch (Exception e) {
