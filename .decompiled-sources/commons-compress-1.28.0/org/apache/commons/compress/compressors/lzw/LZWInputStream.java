...
implements InputStreamStatistics {
    ...
    protected void initializeTables(int maxCodeSize, int memoryLimiKiB) throws MemoryLimitException {
        int maxTableSize;
        ...
        if (memoryLimiKiB > -1 && (memoryUsageKiB = (memoryUsageBytes = (long)(maxTableSize = 1 << maxCodeSize) * 6L) >> 10) > (long)memoryLimiKiB) {
