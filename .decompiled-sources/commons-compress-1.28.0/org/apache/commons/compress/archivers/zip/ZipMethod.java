...
public enum ZipMethod {
    ...
    static boolean isZstd(int method) {
    ...
    static {
        codeToEnum = Collections.unmodifiableMap(Stream.of(ZipMethod.values()).collect(Collectors.toMap(ZipMethod::getCode, Function.identity())));
    }
}
