...
Serializable {
    ...
    public byte[] getLocalFileDataData() {
        ...
        int uidBytesLen = ArrayUtils.getLength(uidBytes);
        gidBytes = X7875_NewUnix.trimLeadingZeroesForceMinLength(gidBytes);
        int gidBytesLen = ArrayUtils.getLength(gidBytes);
    ...
    public ZipShort getLocalFileDataLength() {
        ...
        int gidSize = ArrayUtils.getLength(b);
    ...
    public void parseFromLocalFileData(byte[] data, int offset, int length) throws ZipException {
        ...
        if ((uidSize = Byte.toUnsignedInt(data[offset++])) + 3 > length) {
        ...
        if (uidSize + 3 + (gidSize = Byte.toUnsignedInt(data[offset++])) > length) {
