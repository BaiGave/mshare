...
{
    public static final MapCodec<AllModsLoadedResourceCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(((MapCodec)Codec.STRING.listOf().fieldOf("values")).forGetter(AllModsLoadedResourceCondition::modIds)).apply((Applicative<AllModsLoadedResourceCondition, ?>)instance, AllModsLoadedResourceCondition::new));
