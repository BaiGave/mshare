...
Cloneable {
        ...
        public ObjectIterator<Double2IntMap.Entry> iterator() {
            return new ObjectIterator<Double2IntMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Double2IntArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                public void forEachRemaining(DoubleConsumer action) {
                    double[] key = Double2IntArrayMap.this.key;
                    int max = Double2IntArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public IntIterator iterator() {
            return new IntIterator(){
                ...
                public void forEachRemaining(IntConsumer action) {
                    int[] value = Double2IntArrayMap.this.value;
                    int max = Double2IntArrayMap.this.size;
                    while (this.pos < max) {
    ...
    DoubleIntPair {
        ...
        public double getDoubleKey() {
            return Double2IntArrayMap.this.key[this.index];
        }
        ...
        public int getIntValue() {
            return Double2IntArrayMap.this.value[this.index];
        }
        ...
        public int setValue(int v) {
            int oldValue = Double2IntArrayMap.this.value[this.index];
            Double2IntArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2IntArrayMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double2IntArrayMap.this.value[this.index] == (Integer)e.getValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.double2int(Double2IntArrayMap.this.key[this.index]) ^ Double2IntArrayMap.this.value[this.index];
        }

        public String toString() {
            return Double2IntArrayMap.this.key[this.index] + "=>" + Double2IntArrayMap.this.value[this.index];
        }
    }
}
