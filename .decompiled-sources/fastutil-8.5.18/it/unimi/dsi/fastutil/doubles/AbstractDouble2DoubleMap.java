...
Serializable {
    ...
    extends AbstractObjectSet<Double2DoubleMap.Entry> {
        ...
        public boolean contains(Object o) {
            ...
            if (o instanceof Double2DoubleMap.Entry) {
                ...
                return this.map.containsKey(k) && Double.doubleToRawLongBits(this.map.get(k)) == Double.doubleToRawLongBits(e.getDoubleValue());
            }
            ...
            return this.map.containsKey(k) && Double.doubleToRawLongBits(this.map.get(k)) == Double.doubleToRawLongBits((Double)value);
        }
    ...
    implements Double2DoubleMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Double2DoubleMap.Entry) {
                Double2DoubleMap.Entry e = (Double2DoubleMap.Entry)o;
                return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(e.getDoubleKey()) && Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits(e.getDoubleValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Double)) {
            ...
            return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits((Double)key) && Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits((Double)value);
        }
