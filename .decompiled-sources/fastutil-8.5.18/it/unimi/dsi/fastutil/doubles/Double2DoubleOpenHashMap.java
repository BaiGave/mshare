...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Double2DoubleOpenHashMap.this.value;
                    if (Double2DoubleOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2DoubleOpenHashMap.this.n]);
                    }
    ...
    implements Double2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double.doubleToRawLongBits(k) == 0L) {
                return Double2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Double2DoubleOpenHashMap.this.value[Double2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            double[] key = Double2DoubleOpenHashMap.this.key;
            ...
            if (Double.doubleToRawLongBits(k) == Double.doubleToRawLongBits(curr)) {
                return Double.doubleToRawLongBits(Double2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2DoubleOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(curr));
            return Double.doubleToRawLongBits(Double2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Double.doubleToRawLongBits(k) == 0L) {
                if (Double2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Double2DoubleOpenHashMap.this.value[Double2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Double.doubleToRawLongBits(curr) == Double.doubleToRawLongBits(k)) {
                if (Double.doubleToRawLongBits(Double2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2DoubleOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k) || Double.doubleToRawLongBits(Double2DoubleOpenHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Double2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2DoubleOpenHashMap.this.key;
            if (Double2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Double2DoubleOpenHashMap.this.n]);
            }
            int pos = Double2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2DoubleOpenHashMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double.doubleToRawLongBits(Double2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
