...
Serializable {
    ...
    implements Double2ObjectMap.Entry<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Double2ObjectMap.Entry) {
                Double2ObjectMap.Entry e = (Double2ObjectMap.Entry)o;
                return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(e.getDoubleKey()) && Objects.equals(this.value, e.getValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Double)) {
            ...
            Object value = e.getValue();
            return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits((Double)key) && Objects.equals(this.value, value);
        }
