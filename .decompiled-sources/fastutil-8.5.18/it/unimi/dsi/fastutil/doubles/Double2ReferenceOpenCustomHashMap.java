...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Double2ReferenceOpenCustomHashMap.this.value;
                    if (Double2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2ReferenceOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ReferenceOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2ReferenceOpenCustomHashMap.this.key;
            if (Double2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2ReferenceOpenCustomHashMap.this.n]);
            }
            int pos = Double2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
