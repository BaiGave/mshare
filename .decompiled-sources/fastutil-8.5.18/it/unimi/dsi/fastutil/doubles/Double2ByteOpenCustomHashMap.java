...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Double2ByteOpenCustomHashMap.this.value;
                    if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2ByteOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ByteOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2ByteOpenCustomHashMap.this.key;
            if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2ByteOpenCustomHashMap.this.n]);
            }
            int pos = Double2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
