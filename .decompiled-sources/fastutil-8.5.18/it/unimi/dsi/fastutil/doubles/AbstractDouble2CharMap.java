...
Serializable {
    ...
    implements Double2CharMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Double2CharMap.Entry) {
                Double2CharMap.Entry e = (Double2CharMap.Entry)o;
                return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(e.getDoubleKey()) && this.value == e.getCharValue();
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Double)) {
            ...
            return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits((Double)key) && this.value == ((Character)value).charValue();
        }
