...
Serializable {
    ...
    public long indexOf(double k) {
        for (long i = 0L; i < this.size; ++i) {
            if (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(BigArrays.get(this.a, i))) continue;
            return i;
        }
        return -1L;
    }
    ...
    public DoubleBigListIterator listIterator(final long index) {
        ...
        return new DoubleBigListIterator(){
            long pos;
            long last;
            final /* synthetic */ DoubleBigArrayBigList this$0;
            {
                this.this$0 = this$0;
                this.pos = index;
                this.last = -1L;
            ...
            public double nextDouble() {
                ...
                this.last = this.pos++;
                return BigArrays.get(this.this$0.a, this.last);
            }
            ...
            public double previousDouble() {
                ...
                this.last = --this.pos;
                return BigArrays.get(this.this$0.a, this.pos);
            }
            ...
            public void forEachRemaining(DoubleConsumer action) {
                while (this.pos < this.this$0.size) {
                    ++this.pos;
                    this.last = this.last;
                    action.accept(BigArrays.get(this.this$0.a, this.last));
                }
            }
            ...
            public long back(long n) {
                ...
                long remaining = this.this$0.size - this.pos;
                if (n < remaining) {
                    this.pos -= n;
                } else {
                    n = remaining;
