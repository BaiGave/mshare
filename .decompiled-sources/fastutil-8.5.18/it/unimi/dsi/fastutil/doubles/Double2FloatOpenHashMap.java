...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Double2FloatOpenHashMap.this.value;
                    if (Double2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2FloatOpenHashMap.this.n]);
                    }
    ...
    implements Double2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double.doubleToRawLongBits(k) == 0L) {
                return Double2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Double2FloatOpenHashMap.this.value[Double2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            double[] key = Double2FloatOpenHashMap.this.key;
            ...
            if (Double.doubleToRawLongBits(k) == Double.doubleToRawLongBits(curr)) {
                return Float.floatToRawIntBits(Double2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2FloatOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(curr));
            return Float.floatToRawIntBits(Double2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Double.doubleToRawLongBits(k) == 0L) {
                if (Double2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Double2FloatOpenHashMap.this.value[Double2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Double.doubleToRawLongBits(curr) == Double.doubleToRawLongBits(k)) {
                if (Float.floatToRawIntBits(Double2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2FloatOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k) || Float.floatToRawIntBits(Double2FloatOpenHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Double2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2FloatOpenHashMap.this.key;
            if (Double2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Double2FloatOpenHashMap.this.n]);
            }
            int pos = Double2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2FloatOpenHashMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Float.floatToRawIntBits(Double2FloatOpenHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
