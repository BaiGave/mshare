...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Double2CharOpenCustomHashMap.this.value;
                    if (Double2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2CharOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2CharOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2CharOpenCustomHashMap.this.key;
            if (Double2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2CharOpenCustomHashMap.this.n]);
            }
            int pos = Double2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
