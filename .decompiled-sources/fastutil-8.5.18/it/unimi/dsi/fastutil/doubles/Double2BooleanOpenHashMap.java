...
Hash {
    ...
    @Override
    public void forEach(DoubleBooleanBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Double2BooleanOpenHashMap.this.value;
                    if (Double2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2BooleanOpenHashMap.this.n]);
                    }
    ...
    implements Double2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2BooleanOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(curr));
            return Double2BooleanOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2BooleanOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k) || Double2BooleanOpenHashMap.this.value[pos] != v);
            Double2BooleanOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2BooleanOpenHashMap.this.key;
            if (Double2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Double2BooleanOpenHashMap.this.n]);
            }
            int pos = Double2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleBooleanPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2BooleanOpenHashMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double2BooleanOpenHashMap.this.value[this.index] == (Boolean)e.getValue();
        }
