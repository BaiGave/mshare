...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Double2ObjectOpenCustomHashMap.this.value;
                    if (Double2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2ObjectOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ObjectOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2ObjectOpenCustomHashMap.this.key;
            if (Double2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Double2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
