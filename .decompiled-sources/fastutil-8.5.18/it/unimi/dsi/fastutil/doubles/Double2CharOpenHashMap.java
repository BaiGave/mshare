...
Hash {
    ...
    @Override
    public void forEach(DoubleCharBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Double2CharOpenHashMap.this.value;
                    if (Double2CharOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2CharOpenHashMap.this.n]);
                    }
    ...
    implements Double2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2CharOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(curr));
            return Double2CharOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2CharOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k) || Double2CharOpenHashMap.this.value[pos] != v);
            Double2CharOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2CharOpenHashMap.this.key;
            if (Double2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Double2CharOpenHashMap.this.n]);
            }
            int pos = Double2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleCharPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2CharOpenHashMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }
