...
Serializable {
    ...
    extends AbstractObjectSet<Double2FloatMap.Entry> {
        ...
        public boolean contains(Object o) {
            ...
            if (o instanceof Double2FloatMap.Entry) {
                ...
                return this.map.containsKey(k) && Float.floatToRawIntBits(this.map.get(k)) == Float.floatToRawIntBits(e.getFloatValue());
            }
            ...
            return this.map.containsKey(k) && Float.floatToRawIntBits(this.map.get(k)) == Float.floatToRawIntBits(((Float)value).floatValue());
        }
    ...
    implements Double2FloatMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Double2FloatMap.Entry) {
                Double2FloatMap.Entry e = (Double2FloatMap.Entry)o;
                return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(e.getDoubleKey()) && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(e.getFloatValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Double)) {
            ...
            return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits((Double)key) && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(((Float)value).floatValue());
        }
