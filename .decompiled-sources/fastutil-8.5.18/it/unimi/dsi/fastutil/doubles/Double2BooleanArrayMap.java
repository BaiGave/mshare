...
Cloneable {
        ...
        public ObjectIterator<Double2BooleanMap.Entry> iterator() {
            return new ObjectIterator<Double2BooleanMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Double2BooleanArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                public void forEachRemaining(DoubleConsumer action) {
                    double[] key = Double2BooleanArrayMap.this.key;
                    int max = Double2BooleanArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public BooleanIterator iterator() {
            return new BooleanIterator(){
                ...
                public void forEachRemaining(BooleanConsumer action) {
                    boolean[] value = Double2BooleanArrayMap.this.value;
                    int max = Double2BooleanArrayMap.this.size;
                    while (this.pos < max) {
    ...
    DoubleBooleanPair {
        ...
        public double getDoubleKey() {
            return Double2BooleanArrayMap.this.key[this.index];
        }
        ...
        public boolean getBooleanValue() {
            return Double2BooleanArrayMap.this.value[this.index];
        }
        ...
        public boolean setValue(boolean v) {
            boolean oldValue = Double2BooleanArrayMap.this.value[this.index];
            Double2BooleanArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2BooleanArrayMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double2BooleanArrayMap.this.value[this.index] == (Boolean)e.getValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.double2int(Double2BooleanArrayMap.this.key[this.index]) ^ (Double2BooleanArrayMap.this.value[this.index] ? 1231 : 1237);
        }

        public String toString() {
            return Double2BooleanArrayMap.this.key[this.index] + "=>" + Double2BooleanArrayMap.this.value[this.index];
        }
    }
}
