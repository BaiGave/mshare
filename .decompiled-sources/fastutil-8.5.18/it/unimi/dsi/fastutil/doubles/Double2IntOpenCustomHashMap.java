...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Double2IntOpenCustomHashMap.this.value;
                    if (Double2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2IntOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2IntOpenCustomHashMap.this.key;
            if (Double2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2IntOpenCustomHashMap.this.n]);
            }
            int pos = Double2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
