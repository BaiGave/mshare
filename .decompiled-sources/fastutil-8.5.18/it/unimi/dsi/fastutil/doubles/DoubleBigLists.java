...
public final class DoubleBigLists {
    ...
    Cloneable {
        ...
        public boolean contains(double k) {
            return Double.doubleToRawLongBits(k) == Double.doubleToRawLongBits(this.element);
        }

        @Override
        public long indexOf(double k) {
            return Double.doubleToRawLongBits(k) == Double.doubleToRawLongBits(this.element) ? 0L : -1L;
        }
