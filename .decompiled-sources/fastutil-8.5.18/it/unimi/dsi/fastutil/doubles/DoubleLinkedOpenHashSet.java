...
Hash {
    ...
    public boolean addAndMoveToFirst(double k) {
        ...
        if (Double.doubleToRawLongBits(k) == 0L) {
            ...
            while (Double.doubleToRawLongBits(key[pos]) != 0L) {
                if (Double.doubleToRawLongBits(k) == Double.doubleToRawLongBits(key[pos])) {
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        while (i-- != 0) {
            ...
            if (Double.doubleToRawLongBits(k) == 0L) {
                ...
                pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
                if (Double.doubleToRawLongBits(key[pos]) != 0L) {
                    while (Double.doubleToRawLongBits(key[pos = pos + 1 & this.mask]) != 0L) {
                    }
                }
            }
            key[pos] = k;
    ...
    implements DoubleListIterator {
        ...
        SetIterator(double from) {
            ...
            if (Double.doubleToRawLongBits(DoubleLinkedOpenHashSet.this.key[DoubleLinkedOpenHashSet.this.last]) == Double.doubleToRawLongBits(from)) {
            ...
            while (Double.doubleToRawLongBits(key[pos]) != 0L) {
                if (Double.doubleToRawLongBits(key[pos]) == Double.doubleToRawLongBits(from)) {
