...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Double2ReferenceOpenHashMap.this.value;
                    if (Double2ReferenceOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2ReferenceOpenHashMap.this.n]);
                    }
    ...
    implements Double2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ReferenceOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(curr));
            return Double2ReferenceOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ReferenceOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k) || Double2ReferenceOpenHashMap.this.value[pos] != v);
            Double2ReferenceOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2ReferenceOpenHashMap.this.key;
            if (Double2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Double2ReferenceOpenHashMap.this.n]);
            }
            int pos = Double2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleReferencePair<V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2ReferenceOpenHashMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
        }
