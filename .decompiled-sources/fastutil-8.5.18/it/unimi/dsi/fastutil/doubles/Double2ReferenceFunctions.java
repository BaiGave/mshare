...
public final class Double2ReferenceFunctions {
    ...
    Cloneable {
        ...
        public boolean containsKey(double k) {
            return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(k);
        }

        @Override
        public V get(double k) {
            return (V)(Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(k) ? this.value : this.defRetValue);
        }

        @Override
        public V getOrDefault(double k, V defaultValue) {
            return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(k) ? this.value : defaultValue;
        }
