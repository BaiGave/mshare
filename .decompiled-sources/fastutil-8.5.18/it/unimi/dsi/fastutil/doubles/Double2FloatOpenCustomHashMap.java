...
import it.unimi.dsi.fastutil.doubles.DoubleFloatBiConsumer;
...
Hash {
    ...
    @Override
    public void forEach(DoubleFloatBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Double2FloatOpenCustomHashMap.this.value;
                    if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2FloatOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                return Double2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            double[] key = Double2FloatOpenCustomHashMap.this.key;
            ...
            if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float.floatToRawIntBits(Double2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2FloatOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                if (Double2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Double2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToRawIntBits(Double2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2FloatOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Double2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToRawIntBits(Double2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Double2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2FloatOpenCustomHashMap.this.key;
            if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Double2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double2FloatOpenCustomHashMap.this.strategy.equals(Double2FloatOpenCustomHashMap.this.key[this.index], (Double)e.getKey()) && Float.floatToRawIntBits(Double2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
