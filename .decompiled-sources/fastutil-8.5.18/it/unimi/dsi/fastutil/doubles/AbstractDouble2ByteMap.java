...
Serializable {
    ...
    implements Double2ByteMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Double2ByteMap.Entry) {
                Double2ByteMap.Entry e = (Double2ByteMap.Entry)o;
                return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(e.getDoubleKey()) && this.value == e.getByteValue();
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Double)) {
            ...
            return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits((Double)key) && this.value == (Byte)value;
        }
