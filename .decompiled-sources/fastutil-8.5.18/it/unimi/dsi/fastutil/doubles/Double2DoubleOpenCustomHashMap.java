...
import it.unimi.dsi.fastutil.doubles.DoubleDoubleBiConsumer;
...
Hash {
    ...
    @Override
    public void forEach(DoubleDoubleBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Double2DoubleOpenCustomHashMap.this.value;
                    if (Double2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2DoubleOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                return Double2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Double2DoubleOpenCustomHashMap.this.value[Double2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            double[] key = Double2DoubleOpenCustomHashMap.this.key;
            ...
            if (Double2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Double.doubleToRawLongBits(Double2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2DoubleOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Double2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                if (Double2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Double2DoubleOpenCustomHashMap.this.value[Double2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Double2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double.doubleToRawLongBits(Double2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2DoubleOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Double2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double.doubleToRawLongBits(Double2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Double2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2DoubleOpenCustomHashMap.this.key;
            if (Double2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Double2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double2DoubleOpenCustomHashMap.this.strategy.equals(Double2DoubleOpenCustomHashMap.this.key[this.index], (Double)e.getKey()) && Double.doubleToRawLongBits(Double2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
