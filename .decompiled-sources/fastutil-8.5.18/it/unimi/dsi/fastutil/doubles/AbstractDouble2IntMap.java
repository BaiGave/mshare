...
Serializable {
    ...
    implements Double2IntMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Double2IntMap.Entry) {
                Double2IntMap.Entry e = (Double2IntMap.Entry)o;
                return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(e.getDoubleKey()) && this.value == e.getIntValue();
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Double)) {
            ...
            return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits((Double)key) && this.value == (Integer)value;
        }
