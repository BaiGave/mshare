...
import it.unimi.dsi.fastutil.doubles.DoubleIntBiConsumer;
...
Hash {
    ...
    @Override
    public void forEach(DoubleIntBiConsumer consumer) {
        if (this.containsNullKey) {
    ...
    implements Double2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2IntOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(curr));
            return Double2IntOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2IntOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k) || Double2IntOpenHashMap.this.value[pos] != v);
            Double2IntOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    DoubleIntPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2IntOpenHashMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double2IntOpenHashMap.this.value[this.index] == (Integer)e.getValue();
        }
