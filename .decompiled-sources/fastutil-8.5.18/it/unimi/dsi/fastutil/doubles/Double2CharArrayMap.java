...
Cloneable {
        ...
        public ObjectIterator<Double2CharMap.Entry> iterator() {
            return new ObjectIterator<Double2CharMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Double2CharArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                public void forEachRemaining(DoubleConsumer action) {
                    double[] key = Double2CharArrayMap.this.key;
                    int max = Double2CharArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public CharIterator iterator() {
            return new CharIterator(){
                ...
                public void forEachRemaining(CharConsumer action) {
                    char[] value = Double2CharArrayMap.this.value;
                    int max = Double2CharArrayMap.this.size;
                    while (this.pos < max) {
    ...
    DoubleCharPair {
        ...
        public double getDoubleKey() {
            return Double2CharArrayMap.this.key[this.index];
        }
        ...
        public char getCharValue() {
            return Double2CharArrayMap.this.value[this.index];
        }
        ...
        public char setValue(char v) {
            char oldValue = Double2CharArrayMap.this.value[this.index];
            Double2CharArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public Character getValue() {
            return Character.valueOf(Double2CharArrayMap.this.value[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2CharArrayMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double2CharArrayMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.double2int(Double2CharArrayMap.this.key[this.index]) ^ Double2CharArrayMap.this.value[this.index];
        }

        public String toString() {
            return Double2CharArrayMap.this.key[this.index] + "=>" + Double2CharArrayMap.this.value[this.index];
        }
    }
}
