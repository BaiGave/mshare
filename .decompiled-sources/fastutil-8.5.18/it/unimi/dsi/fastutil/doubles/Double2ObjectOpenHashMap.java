...
Hash {
    ...
    @Override
    public void forEach(DoubleObjectBiConsumer<? super V> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Double2ObjectOpenHashMap.this.value;
                    if (Double2ObjectOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2ObjectOpenHashMap.this.n]);
                    }
    ...
    implements Double2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ObjectOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(curr));
            return Objects.equals(Double2ObjectOpenHashMap.this.value[pos], v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ObjectOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k) || !Objects.equals(Double2ObjectOpenHashMap.this.value[pos], v));
            Double2ObjectOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2ObjectOpenHashMap.this.key;
            if (Double2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Double2ObjectOpenHashMap.this.n]);
            }
            int pos = Double2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleObjectPair<V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2ObjectOpenHashMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Objects.equals(Double2ObjectOpenHashMap.this.value[this.index], e.getValue());
        }
