...
Cloneable {
    ...
    implements Double2DoubleMap.FastEntrySet {
        ...
        public ObjectIterator<Double2DoubleMap.Entry> iterator() {
            return new ObjectIterator<Double2DoubleMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Double2DoubleArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public boolean contains(Object o) {
            ...
            return Double2DoubleArrayMap.this.containsKey(k) && Double.doubleToRawLongBits(Double2DoubleArrayMap.this.get(k)) == Double.doubleToRawLongBits((Double)e.getValue());
        }
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || Double.doubleToRawLongBits(v) != Double.doubleToRawLongBits(Double2DoubleArrayMap.this.value[oldPos])) {
                return false;
            }
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                public void forEachRemaining(DoubleConsumer action) {
                    double[] key = Double2DoubleArrayMap.this.key;
                    int max = Double2DoubleArrayMap.this.size;
                    while (this.pos < max) {
    ...
    extends AbstractDoubleCollection {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                @Override
                public void forEachRemaining(DoubleConsumer action) {
                    double[] value = Double2DoubleArrayMap.this.value;
                    int max = Double2DoubleArrayMap.this.size;
                    while (this.pos < max) {
    ...
    DoubleDoublePair {
        ...
        public double getDoubleKey() {
            return Double2DoubleArrayMap.this.key[this.index];
        }
        ...
        public double getDoubleValue() {
            return Double2DoubleArrayMap.this.value[this.index];
        }
        ...
        public double setValue(double v) {
            double oldValue = Double2DoubleArrayMap.this.value[this.index];
            Double2DoubleArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2DoubleArrayMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double.doubleToRawLongBits(Double2DoubleArrayMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }

        @Override
        public int hashCode() {
            return HashCommon.double2int(Double2DoubleArrayMap.this.key[this.index]) ^ HashCommon.double2int(Double2DoubleArrayMap.this.value[this.index]);
        }

        public String toString() {
            return Double2DoubleArrayMap.this.key[this.index] + "=>" + Double2DoubleArrayMap.this.value[this.index];
        }
    }
}
