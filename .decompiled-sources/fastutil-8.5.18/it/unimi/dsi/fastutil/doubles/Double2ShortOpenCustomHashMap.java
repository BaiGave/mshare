...
Hash {
    ...
    @Override
    public void forEach(DoubleShortBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Double2ShortOpenCustomHashMap.this.value;
                    if (Double2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2ShortOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ShortOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2ShortOpenCustomHashMap.this.key;
            if (Double2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Double2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
