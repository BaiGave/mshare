...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Double2BooleanOpenCustomHashMap.this.value;
                    if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2BooleanOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2BooleanOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2BooleanOpenCustomHashMap.this.key;
            if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Double2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
