...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Double2LongOpenCustomHashMap.this.value;
                    if (Double2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2LongOpenCustomHashMap.this.n]);
                    }
    ...
    implements Double2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2LongOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2LongOpenCustomHashMap.this.key;
            if (Double2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Double2LongOpenCustomHashMap.this.n]);
            }
            int pos = Double2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
