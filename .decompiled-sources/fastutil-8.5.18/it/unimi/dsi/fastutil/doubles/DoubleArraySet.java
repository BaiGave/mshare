...
Cloneable {
    ...
    public static DoubleArraySet of(double ... a) {
        if (a.length == 2) {
            if (Double.doubleToRawLongBits(a[0]) == Double.doubleToRawLongBits(a[1])) {
    ...
    private int findKey(double o) {
        ...
        int i = this.size;
        while (i-- != 0) {
            if (Double.doubleToRawLongBits(a[i]) != Double.doubleToRawLongBits(o)) continue;
            return i;
        }
        return -1;
    }
    ...
    public DoubleIterator iterator() {
        return new DoubleIterator(){
            ...
            public double nextDouble() {
                ...
                this.curr = this.next++;
                return DoubleArraySet.this.a[this.curr];
            }
