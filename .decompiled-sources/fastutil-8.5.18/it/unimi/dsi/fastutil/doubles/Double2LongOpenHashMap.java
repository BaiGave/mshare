...
import it.unimi.dsi.fastutil.doubles.DoubleLongBiConsumer;
...
Hash {
    ...
    @Override
    public void forEach(DoubleLongBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Double2LongOpenHashMap.this.value;
                    if (Double2LongOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2LongOpenHashMap.this.n]);
                    }
    ...
    implements Double2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2LongOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(curr));
            return Double2LongOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2LongOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k) || Double2LongOpenHashMap.this.value[pos] != v);
            Double2LongOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2LongOpenHashMap.this.key;
            if (Double2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Double2LongOpenHashMap.this.n]);
            }
            int pos = Double2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleLongPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2LongOpenHashMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double2LongOpenHashMap.this.value[this.index] == (Long)e.getValue();
        }
