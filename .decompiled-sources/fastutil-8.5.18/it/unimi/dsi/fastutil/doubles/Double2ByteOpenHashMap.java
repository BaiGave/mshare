...
import it.unimi.dsi.fastutil.doubles.DoubleByteBiConsumer;
...
Hash {
    ...
    @Override
    public void forEach(DoubleByteBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Double2ByteOpenHashMap.this.value;
                    if (Double2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Double2ByteOpenHashMap.this.n]);
                    }
    ...
    implements Double2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ByteOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(k) != Double.doubleToRawLongBits(curr));
            return Double2ByteOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Double.doubleToRawLongBits(curr = key[pos = pos + 1 & Double2ByteOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k) || Double2ByteOpenHashMap.this.value[pos] != v);
            Double2ByteOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            double[] key = Double2ByteOpenHashMap.this.key;
            if (Double2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Double2ByteOpenHashMap.this.n]);
            }
            int pos = Double2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                double k = key[pos];
    ...
    DoubleBytePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2ByteOpenHashMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Double2ByteOpenHashMap.this.value[this.index] == (Byte)e.getValue();
        }
