...
public final class Double2DoubleMaps {
    ...
    Cloneable {
        ...
        public boolean containsValue(double v) {
            return Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits(v);
        }

        @Override
        @Deprecated
        public boolean containsValue(Object ov) {
            return Double.doubleToRawLongBits((Double)ov) == Double.doubleToRawLongBits(this.value);
        }
    ...
    Serializable {
         ...
         */
        @Override
        public void forEach(DoubleDoubleBiConsumer action) {
            Object object = this.sync;
            synchronized (object) {
