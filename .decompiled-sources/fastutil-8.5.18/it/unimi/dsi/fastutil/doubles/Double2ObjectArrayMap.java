...
Cloneable {
        ...
        public ObjectIterator<Double2ObjectMap.Entry<V>> iterator() {
            return new ObjectIterator<Double2ObjectMap.Entry<V>>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Double2ObjectArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                public void forEachRemaining(DoubleConsumer action) {
                    double[] key = Double2ObjectArrayMap.this.key;
                    int max = Double2ObjectArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>(){
                ...
                public void forEachRemaining(Consumer<? super V> action) {
                    Object[] value = Double2ObjectArrayMap.this.value;
                    int max = Double2ObjectArrayMap.this.size;
                    while (this.pos < max) {
    ...
    DoubleObjectPair<V> {
        ...
        public double getDoubleKey() {
            return Double2ObjectArrayMap.this.key[this.index];
        }
        ...
        @Override
        public V getValue() {
            return Double2ObjectArrayMap.this.value[this.index];
        }
        ...
        public V setValue(V v) {
            Object oldValue = Double2ObjectArrayMap.this.value[this.index];
            Double2ObjectArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToRawLongBits(Double2ObjectArrayMap.this.key[this.index]) == Double.doubleToRawLongBits((Double)e.getKey()) && Objects.equals(Double2ObjectArrayMap.this.value[this.index], e.getValue());
        }

        @Override
        public int hashCode() {
            return HashCommon.double2int(Double2ObjectArrayMap.this.key[this.index]) ^ (Double2ObjectArrayMap.this.value[this.index] == null ? 0 : Double2ObjectArrayMap.this.value[this.index].hashCode());
        }

        public String toString() {
            return Double2ObjectArrayMap.this.key[this.index] + "=>" + Double2ObjectArrayMap.this.value[this.index];
        }
    }
}
