...
Size64 {
    ...
    public boolean add(double k) {
        if (Double.doubleToRawLongBits(k) == 0L) {
            ...
            if (Double.doubleToRawLongBits(curr) != 0L) {
                ...
                while (Double.doubleToRawLongBits(curr = key[base = base + ((displ = displ + 1 & this.segmentMask) == 0 ? 1 : 0) & this.baseMask][displ]) != 0L) {
    ...
    protected final void shiftKeys(long pos) {
        ...
        while (true) {
            ...
            while (true) {
                if (Double.doubleToRawLongBits(BigArrays.get(key, pos)) == 0L) {
    ...
    public boolean remove(double k) {
        ...
        do {
            if (Double.doubleToRawLongBits(curr = key[base = base + ((displ = displ + 1 & this.segmentMask) == 0 ? 1 : 0) & this.baseMask][displ]) != 0L) continue;
            return false;
        } while (Double.doubleToRawLongBits(curr) != Double.doubleToRawLongBits(k));
        return this.removeEntry(base, displ);
    }
    ...
    public void forEach(DoubleConsumer action) {
        ...
        while (pos < max) {
            double gotten;
            if (Double.doubleToRawLongBits(gotten = BigArrays.get(key, pos++)) == 0L) continue;
    ...
    protected void rehash(long newN) {
        ...
        while (i-- != 0L) {
            int d;
            while (Double.doubleToRawLongBits(key[base][displ]) == 0L) {
                base += (displ = displ + 1 & this.segmentMask) == 0 ? 1 : 0;
            }
            double k = key[base][displ];
            long h = HashCommon.mix(Double.doubleToRawLongBits(k));
            int b = (int)((h & mask) >>> 27);
            if (Double.doubleToRawLongBits(newKey[b][d = (int)(h & (long)newSegmentMask)]) != 0L) {
                while (Double.doubleToRawLongBits(newKey[b = b + ((d = d + 1 & newSegmentMask) == 0 ? 1 : 0) & newBaseMask][d]) != 0L) {
                }
            }
            newKey[b][d] = k;
            base += (displ = displ + 1 & this.segmentMask) == 0 ? 1 : 0;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        while (i-- != 0L) {
            ...
            long h = HashCommon.mix(Double.doubleToRawLongBits(k));
            int base = (int)((h & this.mask) >>> 27);
            if (Double.doubleToRawLongBits(key[base][displ = (int)(h & (long)this.segmentMask)]) != 0L) {
                while (Double.doubleToRawLongBits(key[base = base + ((displ = displ + 1 & this.segmentMask) == 0 ? 1 : 0) & this.baseMask][displ]) != 0L) {
                }
            }
            key[base][displ] = k;
        }
    ...
    implements DoubleIterator {
        ...
        public double nextDouble() {
            ...
            } while (Double.doubleToRawLongBits(k = key[this.base][this.displ]) == 0L);
        ...
        private final void shiftKeys(long pos) {
            ...
            while (true) {
                ...
                while (true) {
                    if (Double.doubleToRawLongBits(curr = BigArrays.get(key, pos)) == 0L) {
                        BigArrays.set(key, last, 0.0);
                        return;
                    }
    ...
    implements DoubleSpliterator {
        ...
        public boolean tryAdvance(DoubleConsumer action) {
            ...
            while (this.pos < this.max) {
                ...
                if (Double.doubleToRawLongBits(gotten) != 0L) {
                    ++this.c;
                    ++this.pos;
                    action.accept(gotten);
                    return true;
        ...
        public long skip(long n) {
            ...
            while (this.pos < this.max && n > 0L) {
                if (Double.doubleToRawLongBits(BigArrays.get(key, this.pos++)) == 0L) continue;
                ++skipped;
                --n;
            }
            return skipped;
