...
Serializable {
    ...
    implements Double2ReferenceMap.Entry<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Double2ReferenceMap.Entry) {
                Double2ReferenceMap.Entry e = (Double2ReferenceMap.Entry)o;
                return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits(e.getDoubleKey()) && this.value == e.getValue();
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Double)) {
            ...
            Object value = e.getValue();
            return Double.doubleToRawLongBits(this.key) == Double.doubleToRawLongBits((Double)key) && this.value == value;
        }
