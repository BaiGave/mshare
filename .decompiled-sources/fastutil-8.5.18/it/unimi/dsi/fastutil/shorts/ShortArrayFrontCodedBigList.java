...
RandomAccess {
    ...
    public ObjectBigListIterator<short[]> listIterator(final long start) {
        ...
        return new ObjectBigListIterator<short[]>(){
            ...
            long pos = 0L;
            boolean inSync;
            final /* synthetic */ ShortArrayFrontCodedBigList this$0;
            {
                this.this$0 = this$0;
                if (start != 0L) {
                    if (start == this.this$0.n) {
                        this.i = start;
                    } else {
                        this.pos = BigArrays.get(this.this$0.p, start / (long)this.this$0.ratio);
                        int j = (int)(start % (long)this.this$0.ratio);
                        this.i = start - (long)j;
                        while (j-- != 0) {
                            this.next();
                        }
            ...
            public short[] next() {
                ...
                if (this.i % (long)this.this$0.ratio == 0L) {
                    this.pos = BigArrays.get(this.this$0.p, this.i / (long)this.this$0.ratio);
                    length = ShortArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    this.s = ShortArrays.ensureCapacity(this.s, length, 0);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)ShortArrayFrontCodedList.count(length), this.s, 0, length);
                    this.pos += (long)(length + ShortArrayFrontCodedList.count(length));
                    this.inSync = true;
                } else if (this.inSync) {
                    length = ShortArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    int common = ShortArrayFrontCodedList.readInt(this.this$0.array, this.pos + (long)ShortArrayFrontCodedList.count(length));
                    this.s = ShortArrays.ensureCapacity(this.s, length + common, common);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)ShortArrayFrontCodedList.count(length) + (long)ShortArrayFrontCodedList.count(common), this.s, common, length);
                    this.pos += (long)(ShortArrayFrontCodedList.count(length) + ShortArrayFrontCodedList.count(common) + length);
                    length += common;
                } else {
                    length = this.this$0.length(this.i);
                    this.s = ShortArrays.ensureCapacity(this.s, length, 0);
                    this.this$0.extract(this.i, this.s, 0, length);
                }
                ++this.i;
