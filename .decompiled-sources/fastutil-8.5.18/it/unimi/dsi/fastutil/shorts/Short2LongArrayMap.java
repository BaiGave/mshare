...
Cloneable {
        ...
        public ObjectIterator<Short2LongMap.Entry> iterator() {
            return new ObjectIterator<Short2LongMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Short2LongArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public ShortIterator iterator() {
            return new ShortIterator(){
                ...
                public void forEachRemaining(ShortConsumer action) {
                    short[] key = Short2LongArrayMap.this.key;
                    int max = Short2LongArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public LongIterator iterator() {
            return new LongIterator(){
                ...
                public void forEachRemaining(LongConsumer action) {
                    long[] value = Short2LongArrayMap.this.value;
                    int max = Short2LongArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ShortLongPair {
        ...
        public short getShortKey() {
            return Short2LongArrayMap.this.key[this.index];
        }
        ...
        public long getLongValue() {
            return Short2LongArrayMap.this.value[this.index];
        }
        ...
        public long setValue(long v) {
            long oldValue = Short2LongArrayMap.this.value[this.index];
            Short2LongArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2LongArrayMap.this.key[this.index] == (Short)e.getKey() && Short2LongArrayMap.this.value[this.index] == (Long)e.getValue();
        }

        @Override
        public int hashCode() {
            return Short2LongArrayMap.this.key[this.index] ^ HashCommon.long2int(Short2LongArrayMap.this.value[this.index]);
        }

        public String toString() {
            return Short2LongArrayMap.this.key[this.index] + "=>" + Short2LongArrayMap.this.value[this.index];
        }
    }
}
