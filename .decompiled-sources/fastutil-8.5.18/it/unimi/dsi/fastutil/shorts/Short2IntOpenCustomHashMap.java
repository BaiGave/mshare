...
Hash {
    ...
    @Override
    public int mergeInt(short k, int v, IntBinaryOperator remappingFunction) {
        int newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ShortIntBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Short2IntOpenCustomHashMap.this.value;
                    if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2IntOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2IntOpenCustomHashMap.this.key;
            if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Short2IntOpenCustomHashMap.this.n]);
            }
            int pos = Short2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
