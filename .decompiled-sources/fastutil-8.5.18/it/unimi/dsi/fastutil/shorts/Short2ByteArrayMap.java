...
Cloneable {
        ...
        public ObjectIterator<Short2ByteMap.Entry> iterator() {
            return new ObjectIterator<Short2ByteMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Short2ByteArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public ShortIterator iterator() {
            return new ShortIterator(){
                ...
                public void forEachRemaining(ShortConsumer action) {
                    short[] key = Short2ByteArrayMap.this.key;
                    int max = Short2ByteArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ByteIterator iterator() {
            return new ByteIterator(){
                ...
                public void forEachRemaining(ByteConsumer action) {
                    byte[] value = Short2ByteArrayMap.this.value;
                    int max = Short2ByteArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ShortBytePair {
        ...
        public short getShortKey() {
            return Short2ByteArrayMap.this.key[this.index];
        }
        ...
        public byte getByteValue() {
            return Short2ByteArrayMap.this.value[this.index];
        }
        ...
        public byte setValue(byte v) {
            byte oldValue = Short2ByteArrayMap.this.value[this.index];
            Short2ByteArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2ByteArrayMap.this.key[this.index] == (Short)e.getKey() && Short2ByteArrayMap.this.value[this.index] == (Byte)e.getValue();
        }

        @Override
        public int hashCode() {
            return Short2ByteArrayMap.this.key[this.index] ^ Short2ByteArrayMap.this.value[this.index];
        }
