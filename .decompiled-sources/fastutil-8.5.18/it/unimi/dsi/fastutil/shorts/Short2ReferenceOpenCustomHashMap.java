...
Hash {
    ...
    @Override
    public void forEach(ShortObjectBiConsumer<? super V> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Short2ReferenceOpenCustomHashMap.this.value;
                    if (Short2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2ReferenceOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2ReferenceOpenCustomHashMap.this.key;
            if (Short2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Short2ReferenceOpenCustomHashMap.this.n]);
            }
            int pos = Short2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
