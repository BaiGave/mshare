...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Short2ObjectOpenCustomHashMap.this.value;
                    if (Short2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2ObjectOpenCustomHashMap.this.n]);
                    }
    ...
    implements Short2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
            if (Short2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new MapEntry(Short2ObjectOpenCustomHashMap.this.n));
            }
            short[] key = Short2ObjectOpenCustomHashMap.this.key;
            int pos = Short2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2ObjectOpenCustomHashMap.this.key;
            if (Short2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Short2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Short2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
