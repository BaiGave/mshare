...
Serializable {
    ...
    implements Short2FloatMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Short2FloatMap.Entry) {
                Short2FloatMap.Entry e = (Short2FloatMap.Entry)o;
                return this.key == e.getShortKey() && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(e.getFloatValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Short)) {
            ...
            return this.key == (Short)key && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(((Float)value).floatValue());
        }
