...
Serializable {
    ...
    public ShortListIterator listIterator(final int index) {
        ...
        return new ShortListIterator(){
            int pos;
            final /* synthetic */ ShortImmutableList this$0;
            {
                this.this$0 = this$0;
                this.pos = index;
            }
            ...
            public int skip(int n) {
                ...
                int remaining = this.this$0.a.length - this.pos;
                if (n < remaining) {
                    this.pos += n;
                } else {
                    n = remaining;
                    this.pos = this.this$0.a.length;
                }
                return n;
            }
        };
    ...
    implements ShortSpliterator {
        ...
        @Override
        public void forEachRemaining(ShortConsumer action) {
            short[] a = ShortImmutableList.this.a;
    ...
    Serializable {
        ...
        public ShortListIterator listIterator(final int index) {
            ...
            return new ShortListIterator(){
                int pos;
                final /* synthetic */ ImmutableSubList this$0;
                {
                    this.this$0 = this$0;
                    this.pos = index + this.this$0.from;
                }
                ...
                @Override
                public int previousIndex() {
                    return this.pos - this.this$0.from - 1;
                }
                ...
                public int back(int n) {
                    ...
                    int remaining = this.pos - this.this$0.from;
                    if (n < remaining) {
                        this.pos -= n;
                    } else {
                        n = remaining;
                        this.pos = this.this$0.from;
                    }
                    return n;
                }
                ...
                public int skip(int n) {
                    ...
                    int remaining = this.this$0.to - this.pos;
                    if (n < remaining) {
                        this.pos += n;
                    } else {
                        n = remaining;
        ...
        extends ShortSpliterators.EarlyBindingSizeIndexBasedSpliterator {
            ...
            @Override
            public void forEachRemaining(ShortConsumer action) {
                short[] a = ImmutableSubList.this.a;
                int max = this.maxPos;
                while (this.pos < max) {
                    action.accept(a[this.pos++]);
                }
