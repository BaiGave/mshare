...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Short2FloatOpenHashMap.this.value;
                    if (Short2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2FloatOpenHashMap.this.n]);
                    }
    ...
    implements Short2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Short2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            short[] key = Short2FloatOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Float.floatToRawIntBits(Short2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == 0) {
                if (Short2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (curr == k) {
                if (Float.floatToRawIntBits(Short2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2FloatOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Float.floatToRawIntBits(Short2FloatOpenHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Short2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2FloatOpenHashMap.this.key;
            if (Short2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Short2FloatOpenHashMap.this.n]);
            }
            int pos = Short2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
    ...
    ShortFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2FloatOpenHashMap.this.key[this.index] == (Short)e.getKey() && Float.floatToRawIntBits(Short2FloatOpenHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
