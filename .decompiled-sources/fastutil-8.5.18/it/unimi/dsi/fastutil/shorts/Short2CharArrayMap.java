...
Cloneable {
        ...
        public ObjectIterator<Short2CharMap.Entry> iterator() {
            return new ObjectIterator<Short2CharMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Short2CharArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public ShortIterator iterator() {
            return new ShortIterator(){
                ...
                public void forEachRemaining(ShortConsumer action) {
                    short[] key = Short2CharArrayMap.this.key;
                    int max = Short2CharArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public CharIterator iterator() {
            return new CharIterator(){
                ...
                public void forEachRemaining(CharConsumer action) {
                    char[] value = Short2CharArrayMap.this.value;
                    int max = Short2CharArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ShortCharPair {
        ...
        public short getShortKey() {
            return Short2CharArrayMap.this.key[this.index];
        }
        ...
        public char getCharValue() {
            return Short2CharArrayMap.this.value[this.index];
        }
        ...
        public char setValue(char v) {
            char oldValue = Short2CharArrayMap.this.value[this.index];
            Short2CharArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public Character getValue() {
            return Character.valueOf(Short2CharArrayMap.this.value[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2CharArrayMap.this.key[this.index] == (Short)e.getKey() && Short2CharArrayMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }

        @Override
        public int hashCode() {
            return Short2CharArrayMap.this.key[this.index] ^ Short2CharArrayMap.this.value[this.index];
        }
