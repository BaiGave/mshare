...
Hash {
    ...
    @Override
    public void forEach(ShortBooleanBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Short2BooleanOpenCustomHashMap.this.value;
                    if (Short2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2BooleanOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2BooleanOpenCustomHashMap.this.key;
            if (Short2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Short2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Short2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
