...
Hash {
    ...
    @Override
    public short mergeShort(short k, short v, ShortBinaryOperator remappingFunction) {
        short newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ShortShortBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Short2ShortOpenCustomHashMap.this.value;
                    if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2ShortOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2ShortOpenCustomHashMap.this.key;
            if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Short2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Short2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
