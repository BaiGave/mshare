...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Short2DoubleOpenHashMap.this.value;
                    if (Short2DoubleOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2DoubleOpenHashMap.this.n]);
                    }
    ...
    implements Short2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Short2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            short[] key = Short2DoubleOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Double.doubleToRawLongBits(Short2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (k == 0) {
                if (Short2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (curr == k) {
                if (Double.doubleToRawLongBits(Short2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Double.doubleToRawLongBits(Short2DoubleOpenHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Short2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2DoubleOpenHashMap.this.key;
            if (Short2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Short2DoubleOpenHashMap.this.n]);
            }
            int pos = Short2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
    ...
    ShortDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2DoubleOpenHashMap.this.key[this.index] == (Short)e.getKey() && Double.doubleToRawLongBits(Short2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
