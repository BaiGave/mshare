...
import it.unimi.dsi.fastutil.shorts.ShortLongBiConsumer;
...
Hash {
    ...
    @Override
    public long mergeLong(short k, long v, LongBinaryOperator remappingFunction) {
        long newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ShortLongBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Short2LongOpenCustomHashMap.this.value;
                    if (Short2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2LongOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2LongOpenCustomHashMap.this.key;
            if (Short2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Short2LongOpenCustomHashMap.this.n]);
            }
            int pos = Short2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
