...
import it.unimi.dsi.fastutil.shorts.ShortFloatBiConsumer;
...
Hash {
    ...
    public boolean containsValue(float v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (key[i] == 0 || Float.floatToRawIntBits(value[i]) != Float.floatToRawIntBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    @Override
    public float mergeFloat(short k, float v, FloatBinaryOperator remappingFunction) {
        float newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ShortFloatBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Short2FloatOpenCustomHashMap.this.value;
                    if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2FloatOpenCustomHashMap.this.n]);
                    }
    ...
    implements Short2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2FloatOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
                return Short2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            short[] key = Short2FloatOpenCustomHashMap.this.key;
            ...
            if (Short2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float.floatToRawIntBits(Short2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Short2FloatOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
                if (Short2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Short2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToRawIntBits(Short2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Short2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToRawIntBits(Short2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Short2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2FloatOpenCustomHashMap.this.key;
            if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Short2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Short2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
    ...
    ShortFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2FloatOpenCustomHashMap.this.strategy.equals(Short2FloatOpenCustomHashMap.this.key[this.index], (Short)e.getKey()) && Float.floatToRawIntBits(Short2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
