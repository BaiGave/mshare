...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Short2BooleanOpenHashMap.this.value;
                    if (Short2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2BooleanOpenHashMap.this.n]);
                    }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2BooleanOpenHashMap.this.key;
            if (Short2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Short2BooleanOpenHashMap.this.n]);
            }
            int pos = Short2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
