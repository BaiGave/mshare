...
import it.unimi.dsi.fastutil.shorts.ShortDoubleBiConsumer;
...
Hash {
    ...
    public boolean containsValue(double v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (key[i] == 0 || Double.doubleToRawLongBits(value[i]) != Double.doubleToRawLongBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    @Override
    public double mergeDouble(short k, double v, DoubleBinaryOperator remappingFunction) {
        double newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ShortDoubleBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Short2DoubleOpenCustomHashMap.this.value;
                    if (Short2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2DoubleOpenCustomHashMap.this.n]);
                    }
    ...
    implements Short2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2DoubleOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
                return Short2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Short2DoubleOpenCustomHashMap.this.value[Short2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            short[] key = Short2DoubleOpenCustomHashMap.this.key;
            ...
            if (Short2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Double.doubleToRawLongBits(Short2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Short2DoubleOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
                if (Short2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Short2DoubleOpenCustomHashMap.this.value[Short2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Short2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double.doubleToRawLongBits(Short2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Short2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double.doubleToRawLongBits(Short2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Short2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2DoubleOpenCustomHashMap.this.key;
            if (Short2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Short2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Short2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
    ...
    ShortDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2DoubleOpenCustomHashMap.this.strategy.equals(Short2DoubleOpenCustomHashMap.this.key[this.index], (Short)e.getKey()) && Double.doubleToRawLongBits(Short2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
