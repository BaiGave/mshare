...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Short2ReferenceOpenHashMap.this.value;
                    if (Short2ReferenceOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2ReferenceOpenHashMap.this.n]);
                    }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2ReferenceOpenHashMap.this.key;
            if (Short2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Short2ReferenceOpenHashMap.this.n]);
            }
            int pos = Short2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
