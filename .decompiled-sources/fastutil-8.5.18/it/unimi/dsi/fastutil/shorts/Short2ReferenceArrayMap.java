...
Cloneable {
        ...
        public ObjectIterator<Short2ReferenceMap.Entry<V>> iterator() {
            return new ObjectIterator<Short2ReferenceMap.Entry<V>>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Short2ReferenceArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public ShortIterator iterator() {
            return new ShortIterator(){
                ...
                public void forEachRemaining(ShortConsumer action) {
                    short[] key = Short2ReferenceArrayMap.this.key;
                    int max = Short2ReferenceArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>(){
                ...
                public void forEachRemaining(Consumer<? super V> action) {
                    Object[] value = Short2ReferenceArrayMap.this.value;
                    int max = Short2ReferenceArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ShortReferencePair<V> {
        ...
        public short getShortKey() {
            return Short2ReferenceArrayMap.this.key[this.index];
        }
        ...
        @Override
        public V getValue() {
            return Short2ReferenceArrayMap.this.value[this.index];
        }
        ...
        public V setValue(V v) {
            Object oldValue = Short2ReferenceArrayMap.this.value[this.index];
            Short2ReferenceArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2ReferenceArrayMap.this.key[this.index] == (Short)e.getKey() && Short2ReferenceArrayMap.this.value[this.index] == e.getValue();
        }

        @Override
        public int hashCode() {
            return Short2ReferenceArrayMap.this.key[this.index] ^ (Short2ReferenceArrayMap.this.value[this.index] == null ? 0 : System.identityHashCode(Short2ReferenceArrayMap.this.value[this.index]));
        }

        public String toString() {
            return Short2ReferenceArrayMap.this.key[this.index] + "=>" + Short2ReferenceArrayMap.this.value[this.index];
        }
    }
}
