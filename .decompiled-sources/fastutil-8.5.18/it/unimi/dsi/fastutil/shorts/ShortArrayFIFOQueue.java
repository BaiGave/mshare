...
Serializable {
    ...
    public short[] toArray() {
        ...
        if (this.start <= this.end) {
            System.arraycopy(this.array, this.start, tmp, 0, this.end - this.start);
        } else {
            System.arraycopy(this.array, this.start, tmp, 0, this.length - this.start);
            System.arraycopy(this.array, 0, tmp, this.length - this.start, this.end);
        }
        return tmp;
    }
