...
Hash {
    ...
    @Override
    public byte mergeByte(short k, byte v, ByteBinaryOperator remappingFunction) {
        byte newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ShortByteBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Short2ByteOpenCustomHashMap.this.value;
                    if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2ByteOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2ByteOpenCustomHashMap.this.key;
            if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Short2ByteOpenCustomHashMap.this.n]);
            }
            int pos = Short2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
