...
Hash {
    ...
    @Override
    public char mergeChar(short k, char v, CharBinaryOperator remappingFunction) {
        char newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ShortCharBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Short2CharOpenHashMap.this.value;
                    if (Short2CharOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Short2CharOpenHashMap.this.n]);
                    }
    ...
    extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            short[] key = Short2CharOpenHashMap.this.key;
            if (Short2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Short2CharOpenHashMap.this.n]);
            }
            int pos = Short2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                short k = key[pos];
