...
Cloneable {
    ...
    implements Char2DoubleMap.FastEntrySet {
        ...
        public ObjectIterator<Char2DoubleMap.Entry> iterator() {
            return new ObjectIterator<Char2DoubleMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Char2DoubleArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public boolean contains(Object o) {
            ...
            return Char2DoubleArrayMap.this.containsKey(k) && Double.doubleToRawLongBits(Char2DoubleArrayMap.this.get(k)) == Double.doubleToRawLongBits((Double)e.getValue());
        }
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || Double.doubleToRawLongBits(v) != Double.doubleToRawLongBits(Char2DoubleArrayMap.this.value[oldPos])) {
                return false;
            }
        ...
        public CharIterator iterator() {
            return new CharIterator(){
                ...
                public void forEachRemaining(CharConsumer action) {
                    char[] key = Char2DoubleArrayMap.this.key;
                    int max = Char2DoubleArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                public void forEachRemaining(DoubleConsumer action) {
                    double[] value = Char2DoubleArrayMap.this.value;
                    int max = Char2DoubleArrayMap.this.size;
                    while (this.pos < max) {
    ...
    CharDoublePair {
        ...
        public char getCharKey() {
            return Char2DoubleArrayMap.this.key[this.index];
        }
        ...
        public double getDoubleValue() {
            return Char2DoubleArrayMap.this.value[this.index];
        }
        ...
        public double setValue(double v) {
            double oldValue = Char2DoubleArrayMap.this.value[this.index];
            Char2DoubleArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public Character getKey() {
            return Character.valueOf(Char2DoubleArrayMap.this.key[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2DoubleArrayMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Double.doubleToRawLongBits(Char2DoubleArrayMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }

        @Override
        public int hashCode() {
            return Char2DoubleArrayMap.this.key[this.index] ^ HashCommon.double2int(Char2DoubleArrayMap.this.value[this.index]);
        }

        public String toString() {
            return Char2DoubleArrayMap.this.key[this.index] + "=>" + Char2DoubleArrayMap.this.value[this.index];
        }
    }
}
