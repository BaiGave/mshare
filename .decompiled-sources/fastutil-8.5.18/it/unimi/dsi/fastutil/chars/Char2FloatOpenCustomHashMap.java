...
import it.unimi.dsi.fastutil.chars.CharFloatBiConsumer;
...
Hash {
    ...
    public boolean containsValue(float v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (key[i] == '\u0000' || Float.floatToRawIntBits(value[i]) != Float.floatToRawIntBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    @Override
    public float mergeFloat(char k, float v, FloatBinaryOperator remappingFunction) {
        float newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(CharFloatBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Char2FloatOpenCustomHashMap.this.value;
                    if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2FloatOpenCustomHashMap.this.n]);
                    }
    ...
    implements Char2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
                return Char2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            char[] key = Char2FloatOpenCustomHashMap.this.key;
            ...
            if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float.floatToRawIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
                if (Char2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Char2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToRawIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (!Char2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToRawIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Char2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2FloatOpenCustomHashMap.this.key;
            if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Char2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
    ...
    CharFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue()) && Float.floatToRawIntBits(Char2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
