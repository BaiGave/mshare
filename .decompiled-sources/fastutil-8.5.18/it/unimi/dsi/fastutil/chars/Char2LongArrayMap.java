...
Cloneable {
        ...
        public ObjectIterator<Char2LongMap.Entry> iterator() {
            return new ObjectIterator<Char2LongMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Char2LongArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public CharIterator iterator() {
            return new CharIterator(){
                ...
                public void forEachRemaining(CharConsumer action) {
                    char[] key = Char2LongArrayMap.this.key;
                    int max = Char2LongArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public LongIterator iterator() {
            return new LongIterator(){
                ...
                public void forEachRemaining(LongConsumer action) {
                    long[] value = Char2LongArrayMap.this.value;
                    int max = Char2LongArrayMap.this.size;
                    while (this.pos < max) {
    ...
    CharLongPair {
        ...
        public char getCharKey() {
            return Char2LongArrayMap.this.key[this.index];
        }
        ...
        public long getLongValue() {
            return Char2LongArrayMap.this.value[this.index];
        }
        ...
        public long setValue(long v) {
            long oldValue = Char2LongArrayMap.this.value[this.index];
            Char2LongArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public Character getKey() {
            return Character.valueOf(Char2LongArrayMap.this.key[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2LongArrayMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2LongArrayMap.this.value[this.index] == (Long)e.getValue();
        }

        @Override
        public int hashCode() {
            return Char2LongArrayMap.this.key[this.index] ^ HashCommon.long2int(Char2LongArrayMap.this.value[this.index]);
        }

        public String toString() {
            return Char2LongArrayMap.this.key[this.index] + "=>" + Char2LongArrayMap.this.value[this.index];
        }
    }
}
