...
Cloneable {
        ...
        public ObjectIterator<Char2BooleanMap.Entry> iterator() {
            return new ObjectIterator<Char2BooleanMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Char2BooleanArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public CharIterator iterator() {
            return new CharIterator(){
                ...
                public void forEachRemaining(CharConsumer action) {
                    char[] key = Char2BooleanArrayMap.this.key;
                    int max = Char2BooleanArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public BooleanIterator iterator() {
            return new BooleanIterator(){
                ...
                public void forEachRemaining(BooleanConsumer action) {
                    boolean[] value = Char2BooleanArrayMap.this.value;
                    int max = Char2BooleanArrayMap.this.size;
                    while (this.pos < max) {
    ...
    CharBooleanPair {
        ...
        public char getCharKey() {
            return Char2BooleanArrayMap.this.key[this.index];
        }
        ...
        public boolean getBooleanValue() {
            return Char2BooleanArrayMap.this.value[this.index];
        }
        ...
        public boolean setValue(boolean v) {
            boolean oldValue = Char2BooleanArrayMap.this.value[this.index];
            Char2BooleanArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public Character getKey() {
            return Character.valueOf(Char2BooleanArrayMap.this.key[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2BooleanArrayMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2BooleanArrayMap.this.value[this.index] == (Boolean)e.getValue();
        }

        @Override
        public int hashCode() {
            return Char2BooleanArrayMap.this.key[this.index] ^ (Char2BooleanArrayMap.this.value[this.index] ? 1231 : 1237);
        }

        public String toString() {
            return Char2BooleanArrayMap.this.key[this.index] + "=>" + Char2BooleanArrayMap.this.value[this.index];
        }
    }
}
