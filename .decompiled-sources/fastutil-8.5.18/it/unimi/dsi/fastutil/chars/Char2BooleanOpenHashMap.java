...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Char2BooleanOpenHashMap.this.value;
                    if (Char2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2BooleanOpenHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2BooleanOpenHashMap.this.key;
            if (Char2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Char2BooleanOpenHashMap.this.n]);
            }
            int pos = Char2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
