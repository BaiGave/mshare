...
Hash {
    ...
    @Override
    public short mergeShort(char k, short v, ShortBinaryOperator remappingFunction) {
        short newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(CharShortBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Char2ShortOpenCustomHashMap.this.value;
                    if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2ShortOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2ShortOpenCustomHashMap.this.key;
            if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Char2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
