...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Char2DoubleOpenHashMap.this.value;
                    if (Char2DoubleOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2DoubleOpenHashMap.this.n]);
                    }
    ...
    implements Char2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == '\u0000') {
                return Char2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            char[] key = Char2DoubleOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Double.doubleToRawLongBits(Char2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (k == '\u0000') {
                if (Char2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (curr == k) {
                if (Double.doubleToRawLongBits(Char2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2DoubleOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || Double.doubleToRawLongBits(Char2DoubleOpenHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Char2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2DoubleOpenHashMap.this.key;
            if (Char2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Char2DoubleOpenHashMap.this.n]);
            }
            int pos = Char2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
    ...
    CharDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2DoubleOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Double.doubleToRawLongBits(Char2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
