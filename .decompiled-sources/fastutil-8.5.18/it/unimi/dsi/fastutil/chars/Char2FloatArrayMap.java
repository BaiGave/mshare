...
Cloneable {
    ...
    implements Char2FloatMap.FastEntrySet {
        ...
        public ObjectIterator<Char2FloatMap.Entry> iterator() {
            return new ObjectIterator<Char2FloatMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Char2FloatArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public boolean contains(Object o) {
            ...
            return Char2FloatArrayMap.this.containsKey(k) && Float.floatToRawIntBits(Char2FloatArrayMap.this.get(k)) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || Float.floatToRawIntBits(v) != Float.floatToRawIntBits(Char2FloatArrayMap.this.value[oldPos])) {
                return false;
            }
        ...
        public CharIterator iterator() {
            return new CharIterator(){
                ...
                public void forEachRemaining(CharConsumer action) {
                    char[] key = Char2FloatArrayMap.this.key;
                    int max = Char2FloatArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public FloatIterator iterator() {
            return new FloatIterator(){
                ...
                public void forEachRemaining(FloatConsumer action) {
                    float[] value = Char2FloatArrayMap.this.value;
                    int max = Char2FloatArrayMap.this.size;
                    while (this.pos < max) {
    ...
    CharFloatPair {
        ...
        public char getCharKey() {
            return Char2FloatArrayMap.this.key[this.index];
        }
        ...
        public float getFloatValue() {
            return Char2FloatArrayMap.this.value[this.index];
        }
        ...
        public float setValue(float v) {
            float oldValue = Char2FloatArrayMap.this.value[this.index];
            Char2FloatArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public Character getKey() {
            return Character.valueOf(Char2FloatArrayMap.this.key[this.index]);
        }

        @Override
        @Deprecated
        public Float getValue() {
            return Float.valueOf(Char2FloatArrayMap.this.value[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2FloatArrayMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Float.floatToRawIntBits(Char2FloatArrayMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }

        @Override
        public int hashCode() {
            return Char2FloatArrayMap.this.key[this.index] ^ HashCommon.float2int(Char2FloatArrayMap.this.value[this.index]);
        }

        public String toString() {
            return Char2FloatArrayMap.this.key[this.index] + "=>" + Char2FloatArrayMap.this.value[this.index];
        }
    }
}
