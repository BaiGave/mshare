...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Char2FloatOpenHashMap.this.value;
                    if (Char2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2FloatOpenHashMap.this.n]);
                    }
    ...
    implements Char2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == '\u0000') {
                return Char2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            char[] key = Char2FloatOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Float.floatToRawIntBits(Char2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == '\u0000') {
                if (Char2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (curr == k) {
                if (Float.floatToRawIntBits(Char2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2FloatOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || Float.floatToRawIntBits(Char2FloatOpenHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Char2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2FloatOpenHashMap.this.key;
            if (Char2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Char2FloatOpenHashMap.this.n]);
            }
            int pos = Char2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
    ...
    CharFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2FloatOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Float.floatToRawIntBits(Char2FloatOpenHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
