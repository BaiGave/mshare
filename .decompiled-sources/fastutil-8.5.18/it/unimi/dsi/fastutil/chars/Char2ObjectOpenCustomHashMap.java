...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Char2ObjectOpenCustomHashMap.this.value;
                    if (Char2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2ObjectOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2ObjectOpenCustomHashMap.this.key;
            if (Char2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Char2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
