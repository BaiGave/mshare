...
Hash {
    ...
    @Override
    public void forEach(CharBooleanBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Char2BooleanOpenCustomHashMap.this.value;
                    if (Char2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2BooleanOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2BooleanOpenCustomHashMap.this.key;
            if (Char2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Char2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
