...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Char2ReferenceOpenHashMap.this.value;
                    if (Char2ReferenceOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2ReferenceOpenHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2ReferenceOpenHashMap.this.key;
            if (Char2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Char2ReferenceOpenHashMap.this.n]);
            }
            int pos = Char2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
