...
Serializable {
    ...
    implements Char2FloatMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Char2FloatMap.Entry) {
                Char2FloatMap.Entry e = (Char2FloatMap.Entry)o;
                return this.key == e.getCharKey() && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(e.getFloatValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Character)) {
            ...
            return this.key == ((Character)key).charValue() && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(((Float)value).floatValue());
        }
