...
Cloneable {
        ...
        public ObjectIterator<Char2IntMap.Entry> iterator() {
            return new ObjectIterator<Char2IntMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Char2IntArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public CharIterator iterator() {
            return new CharIterator(){
                ...
                public void forEachRemaining(CharConsumer action) {
                    char[] key = Char2IntArrayMap.this.key;
                    int max = Char2IntArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public IntIterator iterator() {
            return new IntIterator(){
                ...
                public void forEachRemaining(IntConsumer action) {
                    int[] value = Char2IntArrayMap.this.value;
                    int max = Char2IntArrayMap.this.size;
                    while (this.pos < max) {
    ...
    CharIntPair {
        ...
        public char getCharKey() {
            return Char2IntArrayMap.this.key[this.index];
        }
        ...
        public int getIntValue() {
            return Char2IntArrayMap.this.value[this.index];
        }
        ...
        public int setValue(int v) {
            int oldValue = Char2IntArrayMap.this.value[this.index];
            Char2IntArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public Character getKey() {
            return Character.valueOf(Char2IntArrayMap.this.key[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2IntArrayMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2IntArrayMap.this.value[this.index] == (Integer)e.getValue();
        }

        @Override
        public int hashCode() {
            return Char2IntArrayMap.this.key[this.index] ^ Char2IntArrayMap.this.value[this.index];
        }
