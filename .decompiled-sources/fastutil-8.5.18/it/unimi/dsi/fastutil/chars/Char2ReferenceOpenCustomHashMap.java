...
Hash {
    ...
    @Override
    public void forEach(CharObjectBiConsumer<? super V> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Char2ReferenceOpenCustomHashMap.this.value;
                    if (Char2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2ReferenceOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2ReferenceOpenCustomHashMap.this.key;
            if (Char2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2ReferenceOpenCustomHashMap.this.n]);
            }
            int pos = Char2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
