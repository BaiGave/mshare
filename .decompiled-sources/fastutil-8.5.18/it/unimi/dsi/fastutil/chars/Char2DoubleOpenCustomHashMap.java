...
import it.unimi.dsi.fastutil.chars.CharDoubleBiConsumer;
...
Hash {
    ...
    public boolean containsValue(double v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (key[i] == '\u0000' || Double.doubleToRawLongBits(value[i]) != Double.doubleToRawLongBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    @Override
    public double mergeDouble(char k, double v, DoubleBinaryOperator remappingFunction) {
        double newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(CharDoubleBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Char2DoubleOpenCustomHashMap.this.value;
                    if (Char2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2DoubleOpenCustomHashMap.this.n]);
                    }
    ...
    implements Char2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Char2DoubleOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
                return Char2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Char2DoubleOpenCustomHashMap.this.value[Char2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            char[] key = Char2DoubleOpenCustomHashMap.this.key;
            ...
            if (Char2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Double.doubleToRawLongBits(Char2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Char2DoubleOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
                if (Char2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Char2DoubleOpenCustomHashMap.this.value[Char2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Char2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double.doubleToRawLongBits(Char2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2DoubleOpenCustomHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (!Char2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double.doubleToRawLongBits(Char2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Char2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2DoubleOpenCustomHashMap.this.key;
            if (Char2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Char2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
    ...
    CharDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2DoubleOpenCustomHashMap.this.strategy.equals(Char2DoubleOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue()) && Double.doubleToRawLongBits(Char2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
