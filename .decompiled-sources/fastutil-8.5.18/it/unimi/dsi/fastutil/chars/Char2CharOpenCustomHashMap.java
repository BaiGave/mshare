...
Hash {
    ...
    @Override
    public char mergeChar(char k, char v, CharBinaryOperator remappingFunction) {
        char newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(CharCharBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Char2CharOpenCustomHashMap.this.value;
                    if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2CharOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2CharOpenCustomHashMap.this.key;
            if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2CharOpenCustomHashMap.this.n]);
            }
            int pos = Char2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
