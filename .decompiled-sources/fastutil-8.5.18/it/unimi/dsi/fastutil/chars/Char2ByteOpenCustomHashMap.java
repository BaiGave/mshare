...
Hash {
    ...
    @Override
    public byte mergeByte(char k, byte v, ByteBinaryOperator remappingFunction) {
        byte newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(CharByteBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Char2ByteOpenCustomHashMap.this.value;
                    if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2ByteOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2ByteOpenCustomHashMap.this.key;
            if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2ByteOpenCustomHashMap.this.n]);
            }
            int pos = Char2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
