...
RandomAccess {
    ...
    public ObjectBigListIterator<char[]> listIterator(final long start) {
        ...
        return new ObjectBigListIterator<char[]>(){
            ...
            long pos = 0L;
            boolean inSync;
            final /* synthetic */ CharArrayFrontCodedBigList this$0;
            {
                this.this$0 = this$0;
                if (start != 0L) {
            ...
            public char[] next() {
                ...
                if (this.i % (long)this.this$0.ratio == 0L) {
                    ...
                    length = CharArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    this.s = CharArrays.ensureCapacity(this.s, length, 0);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)CharArrayFrontCodedList.count(length), this.s, 0, length);
                    this.pos += (long)(length + CharArrayFrontCodedList.count(length));
                    this.inSync = true;
                } else if (this.inSync) {
                    length = CharArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    int common = CharArrayFrontCodedList.readInt(this.this$0.array, this.pos + (long)CharArrayFrontCodedList.count(length));
                    this.s = CharArrays.ensureCapacity(this.s, length + common, common);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)CharArrayFrontCodedList.count(length) + (long)CharArrayFrontCodedList.count(common), this.s, common, length);
