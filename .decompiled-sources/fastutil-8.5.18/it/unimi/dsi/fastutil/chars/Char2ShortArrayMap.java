...
Cloneable {
        ...
        public ObjectIterator<Char2ShortMap.Entry> iterator() {
            return new ObjectIterator<Char2ShortMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Char2ShortArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public CharIterator iterator() {
            return new CharIterator(){
                ...
                public void forEachRemaining(CharConsumer action) {
                    char[] key = Char2ShortArrayMap.this.key;
                    int max = Char2ShortArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ShortIterator iterator() {
            return new ShortIterator(){
                ...
                public void forEachRemaining(ShortConsumer action) {
                    short[] value = Char2ShortArrayMap.this.value;
                    int max = Char2ShortArrayMap.this.size;
                    while (this.pos < max) {
    ...
    CharShortPair {
        ...
        public char getCharKey() {
            return Char2ShortArrayMap.this.key[this.index];
        }
        ...
        public short getShortValue() {
            return Char2ShortArrayMap.this.value[this.index];
        }
        ...
        public short setValue(short v) {
            short oldValue = Char2ShortArrayMap.this.value[this.index];
            Char2ShortArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public Character getKey() {
            return Character.valueOf(Char2ShortArrayMap.this.key[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2ShortArrayMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2ShortArrayMap.this.value[this.index] == (Short)e.getValue();
        }

        @Override
        public int hashCode() {
            return Char2ShortArrayMap.this.key[this.index] ^ Char2ShortArrayMap.this.value[this.index];
        }
