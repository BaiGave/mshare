...
import it.unimi.dsi.fastutil.chars.CharLongBiConsumer;
...
Hash {
    ...
    @Override
    public long mergeLong(char k, long v, LongBinaryOperator remappingFunction) {
        long newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(CharLongBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Char2LongOpenCustomHashMap.this.value;
                    if (Char2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2LongOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2LongOpenCustomHashMap.this.key;
            if (Char2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2LongOpenCustomHashMap.this.n]);
            }
            int pos = Char2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
