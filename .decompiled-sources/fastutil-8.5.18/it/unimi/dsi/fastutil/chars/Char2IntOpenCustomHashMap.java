...
Hash {
    ...
    @Override
    public int mergeInt(char k, int v, IntBinaryOperator remappingFunction) {
        int newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(CharIntBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Char2IntOpenCustomHashMap.this.value;
                    if (Char2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Char2IntOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            char[] key = Char2IntOpenCustomHashMap.this.key;
            if (Char2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Char2IntOpenCustomHashMap.this.n]);
            }
            int pos = Char2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                char k = key[pos];
