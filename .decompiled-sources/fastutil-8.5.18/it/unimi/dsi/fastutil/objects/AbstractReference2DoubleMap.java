...
Serializable {
    ...
    implements Reference2DoubleMap.Entry<K> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Reference2DoubleMap.Entry) {
                Reference2DoubleMap.Entry e = (Reference2DoubleMap.Entry)o;
                return this.key == e.getKey() && Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits(e.getDoubleValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            Object value = e.getValue();
            ...
            return this.key == key && Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits((Double)value);
        }
