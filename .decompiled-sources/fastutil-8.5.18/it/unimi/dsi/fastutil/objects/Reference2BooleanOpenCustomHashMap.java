...
Hash {
    ...
    @Override
    public void forEach(ObjectBooleanBiConsumer<? super K> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Reference2BooleanOpenCustomHashMap.this.value;
                    if (Reference2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2BooleanOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2BooleanOpenCustomHashMap.this.key;
            if (Reference2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Reference2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
