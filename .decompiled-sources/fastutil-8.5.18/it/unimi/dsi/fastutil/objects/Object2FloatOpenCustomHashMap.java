...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Object2FloatOpenCustomHashMap.this.value;
                    if (Object2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2FloatOpenCustomHashMap.this.n]);
                    }
    ...
    implements Object2FloatMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
                return Object2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            K[] key = Object2FloatOpenCustomHashMap.this.key;
            ...
            if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float.floatToRawIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
                if (Object2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Object2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToRawIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToRawIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Object2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2FloatOpenCustomHashMap.this.key;
            if (Object2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Object2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Object2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
    ...
    ObjectFloatPair<K> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Object2FloatOpenCustomHashMap.this.strategy.equals(Object2FloatOpenCustomHashMap.this.key[this.index], e.getKey()) && Float.floatToRawIntBits(Object2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
