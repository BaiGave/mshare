...
Cloneable {
    ...
    implements Reference2DoubleMap.FastEntrySet<K> {
        ...
        public ObjectIterator<Reference2DoubleMap.Entry<K>> iterator() {
            return new ObjectIterator<Reference2DoubleMap.Entry<K>>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Reference2DoubleArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public boolean contains(Object o) {
            ...
            Object k = e.getKey();
            return Reference2DoubleArrayMap.this.containsKey(k) && Double.doubleToRawLongBits(Reference2DoubleArrayMap.this.getDouble(k)) == Double.doubleToRawLongBits((Double)e.getValue());
        }
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || Double.doubleToRawLongBits(v) != Double.doubleToRawLongBits(Reference2DoubleArrayMap.this.value[oldPos])) {
                return false;
            }
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>(){
                ...
                public void forEachRemaining(Consumer<? super K> action) {
                    Object[] key = Reference2DoubleArrayMap.this.key;
                    int max = Reference2DoubleArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                public void forEachRemaining(DoubleConsumer action) {
                    double[] value = Reference2DoubleArrayMap.this.value;
                    int max = Reference2DoubleArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ReferenceDoublePair<K> {
        ...
        @Override
        public K getKey() {
            return Reference2DoubleArrayMap.this.key[this.index];
        }
        ...
        public double getDoubleValue() {
            return Reference2DoubleArrayMap.this.value[this.index];
        }
        ...
        public double setValue(double v) {
            double oldValue = Reference2DoubleArrayMap.this.value[this.index];
            Reference2DoubleArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Reference2DoubleArrayMap.this.key[this.index] == e.getKey() && Double.doubleToRawLongBits(Reference2DoubleArrayMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }

        @Override
        public int hashCode() {
            return System.identityHashCode(Reference2DoubleArrayMap.this.key[this.index]) ^ HashCommon.double2int(Reference2DoubleArrayMap.this.value[this.index]);
        }

        public String toString() {
            return Reference2DoubleArrayMap.this.key[this.index] + "=>" + Reference2DoubleArrayMap.this.value[this.index];
        }
    }
}
