...
Hash {
    ...
    public boolean remove(Object k, float v) {
        ...
        if (k.equals(curr) && Float.floatToRawIntBits(v) == Float.floatToRawIntBits(this.value[pos])) {
        ...
        do {
            if ((curr = key[pos = pos + 1 & this.mask]) != null) continue;
            return false;
        } while (!k.equals(curr) || Float.floatToRawIntBits(v) != Float.floatToRawIntBits(this.value[pos]));
        this.removeEntry(pos);
        return true;
    }
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Object2FloatOpenHashMap.this.value;
                    if (Object2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2FloatOpenHashMap.this.n]);
                    }
    ...
    implements Object2FloatMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (k == null) {
                return Object2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Object2FloatOpenHashMap.this.value[Object2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            K[] key = Object2FloatOpenHashMap.this.key;
            ...
            if (k.equals(curr)) {
                return Float.floatToRawIntBits(Object2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == null) {
                if (Object2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Object2FloatOpenHashMap.this.value[Object2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (curr.equals(k)) {
                if (Float.floatToRawIntBits(Object2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2FloatOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (!curr.equals(k) || Float.floatToRawIntBits(Object2FloatOpenHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Object2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2FloatOpenHashMap.this.key;
            if (Object2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Object2FloatOpenHashMap.this.n]);
            }
            int pos = Object2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
    ...
    ObjectFloatPair<K> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Objects.equals(Object2FloatOpenHashMap.this.key[this.index], e.getKey()) && Float.floatToRawIntBits(Object2FloatOpenHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
