...
Hash {
    ...
    public boolean containsValue(double v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (key[i] == null || Double.doubleToRawLongBits(value[i]) != Double.doubleToRawLongBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    @Override
    public double mergeDouble(K k, double v, DoubleBinaryOperator remappingFunction) {
        double newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ObjectDoubleBiConsumer<? super K> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Reference2DoubleOpenCustomHashMap.this.value;
                    if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2DoubleOpenCustomHashMap.this.n]);
                    }
    ...
    implements Reference2DoubleMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
                return Reference2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            K[] key = Reference2DoubleOpenCustomHashMap.this.key;
            ...
            if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Double.doubleToRawLongBits(Reference2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
                if (Reference2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double.doubleToRawLongBits(Reference2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Reference2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double.doubleToRawLongBits(Reference2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Reference2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2DoubleOpenCustomHashMap.this.key;
            if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Reference2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
    ...
    ReferenceDoublePair<K> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Reference2DoubleOpenCustomHashMap.this.strategy.equals(Reference2DoubleOpenCustomHashMap.this.key[this.index], e.getKey()) && Double.doubleToRawLongBits(Reference2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
