...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Object2ByteOpenCustomHashMap.this.value;
                    if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2ByteOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2ByteOpenCustomHashMap.this.key;
            if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Object2ByteOpenCustomHashMap.this.n]);
            }
            int pos = Object2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
