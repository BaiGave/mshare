...
public final class Reference2FloatMaps {
    ...
    Cloneable {
        ...
        @Override
        public boolean containsValue(float v) {
            return Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(v);
        }

        @Override
        @Deprecated
        public boolean containsValue(Object ov) {
            return Float.floatToRawIntBits(((Float)ov).floatValue()) == Float.floatToRawIntBits(this.value);
        }
    ...
    Serializable {
         ...
         */
        @Override
        public void forEach(ObjectFloatBiConsumer<? super K> action) {
            Object object = this.sync;
            synchronized (object) {
