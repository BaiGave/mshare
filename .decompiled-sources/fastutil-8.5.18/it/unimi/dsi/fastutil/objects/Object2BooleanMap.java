...
Map<K, Boolean> {
    ...
    @SafeVarargs
    public static <K> Object2BooleanMap<K> ofEntries(Entry<K> ... entries) {
        if (entries.length == 0) {
            return Object2BooleanMaps.EMPTY_MAP;
        }
        if (entries.length == 1) {
            return Object2BooleanMaps.singleton(entries[0].getKey(), entries[0].getBooleanValue());
        }
        if (entries.length <= 8) {
            ...
            return Object2BooleanMaps.unmodifiable(new Object2BooleanArrayMap(keys, vals, entries.length));
        }
        Object2BooleanOpenHashMap newMap = new Object2BooleanOpenHashMap(entries.length, 0.75f);
        ...
        return Object2BooleanMaps.unmodifiable(newMap);
    }

    public static <K> Entry<K> entry(K key, boolean value) {
        return new AbstractObject2BooleanMap.BasicEntry<K>(key, value);
    }
