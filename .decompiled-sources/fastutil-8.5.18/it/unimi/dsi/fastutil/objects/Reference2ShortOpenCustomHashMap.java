...
Hash {
    ...
    @Override
    public short mergeShort(K k, short v, ShortBinaryOperator remappingFunction) {
        short newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ObjectShortBiConsumer<? super K> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Reference2ShortOpenCustomHashMap.this.value;
                    if (Reference2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2ShortOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2ShortOpenCustomHashMap.this.key;
            if (Reference2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Reference2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
