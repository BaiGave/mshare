...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Object2IntOpenCustomHashMap.this.value;
                    if (Object2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2IntOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2IntOpenCustomHashMap.this.key;
            if (Object2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Object2IntOpenCustomHashMap.this.n]);
            }
            int pos = Object2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
