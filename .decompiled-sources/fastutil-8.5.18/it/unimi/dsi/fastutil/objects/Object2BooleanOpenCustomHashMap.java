...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Object2BooleanOpenCustomHashMap.this.value;
                    if (Object2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2BooleanOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2BooleanOpenCustomHashMap.this.key;
            if (Object2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Object2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Object2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
