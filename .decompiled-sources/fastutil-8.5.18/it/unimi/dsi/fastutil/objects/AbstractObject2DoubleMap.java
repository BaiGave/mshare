...
Serializable {
    ...
    extends AbstractObjectSet<Object2DoubleMap.Entry<K>> {
        ...
        public boolean contains(Object o) {
            ...
            if (o instanceof Object2DoubleMap.Entry) {
                ...
                Object k = e.getKey();
                return this.map.containsKey(k) && Double.doubleToRawLongBits(this.map.getDouble(k)) == Double.doubleToRawLongBits(e.getDoubleValue());
            }
            ...
            return this.map.containsKey(k) && Double.doubleToRawLongBits(this.map.getDouble(k)) == Double.doubleToRawLongBits((Double)value);
        }
    ...
    implements Object2DoubleMap.Entry<K> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Object2DoubleMap.Entry) {
                Object2DoubleMap.Entry e = (Object2DoubleMap.Entry)o;
                return Objects.equals(this.key, e.getKey()) && Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits(e.getDoubleValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            Object value = e.getValue();
            ...
            return Objects.equals(this.key, key) && Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits((Double)value);
        }
