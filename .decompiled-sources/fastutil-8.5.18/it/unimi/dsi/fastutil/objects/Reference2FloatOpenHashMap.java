...
Hash {
    ...
    public boolean remove(Object k, float v) {
        ...
        if (k == curr && Float.floatToRawIntBits(v) == Float.floatToRawIntBits(this.value[pos])) {
        ...
        do {
            if ((curr = key[pos = pos + 1 & this.mask]) != null) continue;
            return false;
        } while (k != curr || Float.floatToRawIntBits(v) != Float.floatToRawIntBits(this.value[pos]));
        this.removeEntry(pos);
        return true;
    }
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Reference2FloatOpenHashMap.this.value;
                    if (Reference2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2FloatOpenHashMap.this.n]);
                    }
    ...
    implements Reference2FloatMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (k == null) {
                return Reference2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Reference2FloatOpenHashMap.this.value[Reference2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            K[] key = Reference2FloatOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Float.floatToRawIntBits(Reference2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == null) {
                if (Reference2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Reference2FloatOpenHashMap.this.value[Reference2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (curr == k) {
                if (Float.floatToRawIntBits(Reference2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2FloatOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (curr != k || Float.floatToRawIntBits(Reference2FloatOpenHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Reference2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2FloatOpenHashMap.this.key;
            if (Reference2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2FloatOpenHashMap.this.n]);
            }
            int pos = Reference2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
    ...
    ReferenceFloatPair<K> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Reference2FloatOpenHashMap.this.key[this.index] == e.getKey() && Float.floatToRawIntBits(Reference2FloatOpenHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
