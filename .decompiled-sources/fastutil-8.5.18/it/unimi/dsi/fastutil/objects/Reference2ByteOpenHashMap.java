...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Reference2ByteOpenHashMap.this.value;
                    if (Reference2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2ByteOpenHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2ByteOpenHashMap.this.key;
            if (Reference2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2ByteOpenHashMap.this.n]);
            }
            int pos = Reference2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
