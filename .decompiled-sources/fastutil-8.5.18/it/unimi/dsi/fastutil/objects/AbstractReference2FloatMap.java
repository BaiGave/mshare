...
Serializable {
    ...
    implements Reference2FloatMap.Entry<K> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Reference2FloatMap.Entry) {
                Reference2FloatMap.Entry e = (Reference2FloatMap.Entry)o;
                return this.key == e.getKey() && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(e.getFloatValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            Object value = e.getValue();
            ...
            return this.key == key && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(((Float)value).floatValue());
        }
