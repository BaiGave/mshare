...
import it.unimi.dsi.fastutil.objects.ObjectFloatBiConsumer;
...
Hash {
    ...
    public boolean containsValue(float v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (key[i] == null || Float.floatToRawIntBits(value[i]) != Float.floatToRawIntBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    @Override
    public float mergeFloat(K k, float v, FloatBinaryOperator remappingFunction) {
        float newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ObjectFloatBiConsumer<? super K> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Reference2FloatOpenCustomHashMap.this.value;
                    if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2FloatOpenCustomHashMap.this.n]);
                    }
    ...
    implements Reference2FloatMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
                return Reference2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            K[] key = Reference2FloatOpenCustomHashMap.this.key;
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float.floatToRawIntBits(Reference2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
                if (Reference2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToRawIntBits(Reference2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToRawIntBits(Reference2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Reference2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2FloatOpenCustomHashMap.this.key;
            if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Reference2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
    ...
    ReferenceFloatPair<K> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[this.index], e.getKey()) && Float.floatToRawIntBits(Reference2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
