...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Object2ReferenceOpenCustomHashMap.this.value;
                    if (Object2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2ReferenceOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2ReferenceOpenCustomHashMap.this.key;
            if (Object2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Object2ReferenceOpenCustomHashMap.this.n]);
            }
            int pos = Object2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
