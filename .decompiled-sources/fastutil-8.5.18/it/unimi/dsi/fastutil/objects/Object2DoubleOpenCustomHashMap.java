...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Object2DoubleOpenCustomHashMap.this.value;
                    if (Object2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2DoubleOpenCustomHashMap.this.n]);
                    }
    ...
    implements Object2DoubleMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (Object2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
                return Object2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Object2DoubleOpenCustomHashMap.this.value[Object2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            K[] key = Object2DoubleOpenCustomHashMap.this.key;
            ...
            if (Object2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Double.doubleToRawLongBits(Object2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Object2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
                if (Object2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Object2DoubleOpenCustomHashMap.this.value[Object2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Object2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double.doubleToRawLongBits(Object2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Object2DoubleOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Object2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double.doubleToRawLongBits(Object2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Object2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2DoubleOpenCustomHashMap.this.key;
            if (Object2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Object2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Object2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
    ...
    ObjectDoublePair<K> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Object2DoubleOpenCustomHashMap.this.strategy.equals(Object2DoubleOpenCustomHashMap.this.key[this.index], e.getKey()) && Double.doubleToRawLongBits(Object2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
