...
Cloneable {
        ...
        public ObjectIterator<Reference2BooleanMap.Entry<K>> iterator() {
            return new ObjectIterator<Reference2BooleanMap.Entry<K>>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Reference2BooleanArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>(){
                ...
                public void forEachRemaining(Consumer<? super K> action) {
                    Object[] key = Reference2BooleanArrayMap.this.key;
                    int max = Reference2BooleanArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public BooleanIterator iterator() {
            return new BooleanIterator(){
                ...
                public void forEachRemaining(BooleanConsumer action) {
                    boolean[] value = Reference2BooleanArrayMap.this.value;
                    int max = Reference2BooleanArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ReferenceBooleanPair<K> {
        ...
        @Override
        public K getKey() {
            return Reference2BooleanArrayMap.this.key[this.index];
        }
        ...
        public boolean getBooleanValue() {
            return Reference2BooleanArrayMap.this.value[this.index];
        }
        ...
        public boolean setValue(boolean v) {
            boolean oldValue = Reference2BooleanArrayMap.this.value[this.index];
            Reference2BooleanArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Reference2BooleanArrayMap.this.key[this.index] == e.getKey() && Reference2BooleanArrayMap.this.value[this.index] == (Boolean)e.getValue();
        }

        @Override
        public int hashCode() {
            return System.identityHashCode(Reference2BooleanArrayMap.this.key[this.index]) ^ (Reference2BooleanArrayMap.this.value[this.index] ? 1231 : 1237);
        }

        public String toString() {
            return Reference2BooleanArrayMap.this.key[this.index] + "=>" + Reference2BooleanArrayMap.this.value[this.index];
        }
    }
}
