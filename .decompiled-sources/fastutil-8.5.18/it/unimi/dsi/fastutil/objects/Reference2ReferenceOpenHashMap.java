...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Reference2ReferenceOpenHashMap.this.value;
                    if (Reference2ReferenceOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2ReferenceOpenHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2ReferenceOpenHashMap.this.key;
            if (Reference2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2ReferenceOpenHashMap.this.n]);
            }
            int pos = Reference2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
