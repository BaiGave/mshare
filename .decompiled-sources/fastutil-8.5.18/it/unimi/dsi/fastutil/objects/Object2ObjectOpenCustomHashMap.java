...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Object2ObjectOpenCustomHashMap.this.value;
                    if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2ObjectOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2ObjectOpenCustomHashMap.this.key;
            if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Object2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Object2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
