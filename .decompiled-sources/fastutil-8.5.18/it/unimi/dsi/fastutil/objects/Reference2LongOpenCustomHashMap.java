...
Hash {
    ...
    @Override
    public long mergeLong(K k, long v, LongBinaryOperator remappingFunction) {
        long newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ObjectLongBiConsumer<? super K> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Reference2LongOpenCustomHashMap.this.value;
                    if (Reference2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2LongOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2LongOpenCustomHashMap.this.key;
            if (Reference2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2LongOpenCustomHashMap.this.n]);
            }
            int pos = Reference2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
