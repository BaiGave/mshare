...
Hash {
    ...
    @Override
    public int mergeInt(K k, int v, IntBinaryOperator remappingFunction) {
        int newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ObjectIntBiConsumer<? super K> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Reference2IntOpenCustomHashMap.this.value;
                    if (Reference2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2IntOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2IntOpenCustomHashMap.this.key;
            if (Reference2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2IntOpenCustomHashMap.this.n]);
            }
            int pos = Reference2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
