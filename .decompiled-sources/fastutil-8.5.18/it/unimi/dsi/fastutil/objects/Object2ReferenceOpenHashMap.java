...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Object2ReferenceOpenHashMap.this.value;
                    if (Object2ReferenceOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2ReferenceOpenHashMap.this.n]);
                    }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2ReferenceOpenHashMap.this.key;
            if (Object2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Object2ReferenceOpenHashMap.this.n]);
            }
            int pos = Object2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
