...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Reference2LongOpenHashMap.this.value;
                    if (Reference2LongOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2LongOpenHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2LongOpenHashMap.this.key;
            if (Reference2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2LongOpenHashMap.this.n]);
            }
            int pos = Reference2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
