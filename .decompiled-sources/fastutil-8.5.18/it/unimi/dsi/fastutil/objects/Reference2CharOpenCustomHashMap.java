...
Hash {
    ...
    @Override
    public char mergeChar(K k, char v, CharBinaryOperator remappingFunction) {
        char newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ObjectCharBiConsumer<? super K> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Reference2CharOpenCustomHashMap.this.value;
                    if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2CharOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2CharOpenCustomHashMap.this.key;
            if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2CharOpenCustomHashMap.this.n]);
            }
            int pos = Reference2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
