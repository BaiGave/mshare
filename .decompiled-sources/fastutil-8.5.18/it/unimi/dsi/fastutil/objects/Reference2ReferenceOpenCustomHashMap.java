...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Reference2ReferenceOpenCustomHashMap.this.value;
                    if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2ReferenceOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2ReferenceOpenCustomHashMap.this.key;
            if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2ReferenceOpenCustomHashMap.this.n]);
            }
            int pos = Reference2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
