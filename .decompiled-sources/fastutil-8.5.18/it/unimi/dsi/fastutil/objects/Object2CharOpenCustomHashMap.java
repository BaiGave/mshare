...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Object2CharOpenCustomHashMap.this.value;
                    if (Object2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2CharOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2CharOpenCustomHashMap.this.key;
            if (Object2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Object2CharOpenCustomHashMap.this.n]);
            }
            int pos = Object2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
