...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Reference2ShortOpenHashMap.this.value;
                    if (Reference2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2ShortOpenHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2ShortOpenHashMap.this.key;
            if (Reference2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2ShortOpenHashMap.this.n]);
            }
            int pos = Reference2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
