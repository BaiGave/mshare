...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Object2BooleanOpenHashMap.this.value;
                    if (Object2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2BooleanOpenHashMap.this.n]);
                    }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2BooleanOpenHashMap.this.key;
            if (Object2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Object2BooleanOpenHashMap.this.n]);
            }
            int pos = Object2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
