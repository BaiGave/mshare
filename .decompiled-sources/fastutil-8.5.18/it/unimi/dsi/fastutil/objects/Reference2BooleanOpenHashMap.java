...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Reference2BooleanOpenHashMap.this.value;
                    if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2BooleanOpenHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2BooleanOpenHashMap.this.key;
            if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2BooleanOpenHashMap.this.n]);
            }
            int pos = Reference2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
