...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Object2ShortOpenCustomHashMap.this.value;
                    if (Object2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Object2ShortOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Object2ShortOpenCustomHashMap.this.key;
            if (Object2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Object2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Object2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
