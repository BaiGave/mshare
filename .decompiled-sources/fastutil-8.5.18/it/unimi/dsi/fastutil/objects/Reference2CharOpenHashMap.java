...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Reference2CharOpenHashMap.this.value;
                    if (Reference2CharOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2CharOpenHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2CharOpenHashMap.this.key;
            if (Reference2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2CharOpenHashMap.this.n]);
            }
            int pos = Reference2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
