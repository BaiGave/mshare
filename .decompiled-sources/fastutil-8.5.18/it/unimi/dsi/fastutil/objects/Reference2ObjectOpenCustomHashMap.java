...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Reference2ObjectOpenCustomHashMap.this.value;
                    if (Reference2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Reference2ObjectOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            K[] key = Reference2ObjectOpenCustomHashMap.this.key;
            if (Reference2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Reference2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Reference2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                Object k = key[pos];
