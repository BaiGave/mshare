...
Cloneable {
        ...
        public ObjectIterator<Long2ShortMap.Entry> iterator() {
            return new ObjectIterator<Long2ShortMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Long2ShortArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public LongIterator iterator() {
            return new LongIterator(){
                ...
                public void forEachRemaining(LongConsumer action) {
                    long[] key = Long2ShortArrayMap.this.key;
                    int max = Long2ShortArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ShortIterator iterator() {
            return new ShortIterator(){
                ...
                public void forEachRemaining(ShortConsumer action) {
                    short[] value = Long2ShortArrayMap.this.value;
                    int max = Long2ShortArrayMap.this.size;
                    while (this.pos < max) {
    ...
    LongShortPair {
        ...
        public long getLongKey() {
            return Long2ShortArrayMap.this.key[this.index];
        }
        ...
        public short getShortValue() {
            return Long2ShortArrayMap.this.value[this.index];
        }
        ...
        public short setValue(short v) {
            short oldValue = Long2ShortArrayMap.this.value[this.index];
            Long2ShortArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2ShortArrayMap.this.key[this.index] == (Long)e.getKey() && Long2ShortArrayMap.this.value[this.index] == (Short)e.getValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.long2int(Long2ShortArrayMap.this.key[this.index]) ^ Long2ShortArrayMap.this.value[this.index];
        }

        public String toString() {
            return Long2ShortArrayMap.this.key[this.index] + "=>" + Long2ShortArrayMap.this.value[this.index];
        }
    }
}
