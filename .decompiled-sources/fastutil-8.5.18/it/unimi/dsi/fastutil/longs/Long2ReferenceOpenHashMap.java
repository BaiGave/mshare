...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Long2ReferenceOpenHashMap.this.value;
                    if (Long2ReferenceOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2ReferenceOpenHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2ReferenceOpenHashMap.this.key;
            if (Long2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Long2ReferenceOpenHashMap.this.n]);
            }
            int pos = Long2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
