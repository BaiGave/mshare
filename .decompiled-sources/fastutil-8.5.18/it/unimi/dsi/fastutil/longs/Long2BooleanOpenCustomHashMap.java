...
Hash {
    ...
    @Override
    public void forEach(LongBooleanBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Long2BooleanOpenCustomHashMap.this.value;
                    if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2BooleanOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2BooleanOpenCustomHashMap.this.key;
            if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Long2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
