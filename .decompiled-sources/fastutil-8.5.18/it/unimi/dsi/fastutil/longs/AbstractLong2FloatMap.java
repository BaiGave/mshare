...
Serializable {
    ...
    implements Long2FloatMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Long2FloatMap.Entry) {
                Long2FloatMap.Entry e = (Long2FloatMap.Entry)o;
                return this.key == e.getLongKey() && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(e.getFloatValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Long)) {
            ...
            return this.key == (Long)key && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(((Float)value).floatValue());
        }
