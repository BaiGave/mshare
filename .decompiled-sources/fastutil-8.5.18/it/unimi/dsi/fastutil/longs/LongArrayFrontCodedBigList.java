...
RandomAccess {
    ...
    public ObjectBigListIterator<long[]> listIterator(final long start) {
        ...
        return new ObjectBigListIterator<long[]>(){
            ...
            long pos = 0L;
            boolean inSync;
            final /* synthetic */ LongArrayFrontCodedBigList this$0;
            {
                this.this$0 = this$0;
                if (start != 0L) {
            ...
            public long[] next() {
                ...
                if (this.i % (long)this.this$0.ratio == 0L) {
                    ...
                    length = LongArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    this.s = LongArrays.ensureCapacity(this.s, length, 0);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)LongArrayFrontCodedList.count(length), this.s, 0, length);
                    this.pos += (long)(length + LongArrayFrontCodedList.count(length));
                    this.inSync = true;
                } else if (this.inSync) {
                    length = LongArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    int common = LongArrayFrontCodedList.readInt(this.this$0.array, this.pos + (long)LongArrayFrontCodedList.count(length));
                    this.s = LongArrays.ensureCapacity(this.s, length + common, common);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)LongArrayFrontCodedList.count(length) + (long)LongArrayFrontCodedList.count(common), this.s, common, length);
