...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Long2ObjectOpenCustomHashMap.this.value;
                    if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2ObjectOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2ObjectOpenCustomHashMap.this.key;
            if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Long2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
