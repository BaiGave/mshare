...
Cloneable {
        ...
        public ObjectIterator<Long2ObjectMap.Entry<V>> iterator() {
            return new ObjectIterator<Long2ObjectMap.Entry<V>>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Long2ObjectArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public LongIterator iterator() {
            return new LongIterator(){
                ...
                public void forEachRemaining(LongConsumer action) {
                    long[] key = Long2ObjectArrayMap.this.key;
                    int max = Long2ObjectArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>(){
                ...
                public void forEachRemaining(Consumer<? super V> action) {
                    Object[] value = Long2ObjectArrayMap.this.value;
                    int max = Long2ObjectArrayMap.this.size;
                    while (this.pos < max) {
    ...
    LongObjectPair<V> {
        ...
        public long getLongKey() {
            return Long2ObjectArrayMap.this.key[this.index];
        }
        ...
        @Override
        public V getValue() {
            return Long2ObjectArrayMap.this.value[this.index];
        }
        ...
        public V setValue(V v) {
            Object oldValue = Long2ObjectArrayMap.this.value[this.index];
            Long2ObjectArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2ObjectArrayMap.this.key[this.index] == (Long)e.getKey() && Objects.equals(Long2ObjectArrayMap.this.value[this.index], e.getValue());
        }

        @Override
        public int hashCode() {
            return HashCommon.long2int(Long2ObjectArrayMap.this.key[this.index]) ^ (Long2ObjectArrayMap.this.value[this.index] == null ? 0 : Long2ObjectArrayMap.this.value[this.index].hashCode());
        }

        public String toString() {
            return Long2ObjectArrayMap.this.key[this.index] + "=>" + Long2ObjectArrayMap.this.value[this.index];
        }
    }
}
