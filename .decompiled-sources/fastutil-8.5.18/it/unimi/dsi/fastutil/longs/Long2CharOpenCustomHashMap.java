...
Hash {
    ...
    @Override
    public char mergeChar(long k, char v, CharBinaryOperator remappingFunction) {
        char newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(LongCharBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Long2CharOpenCustomHashMap.this.value;
                    if (Long2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2CharOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2CharOpenCustomHashMap.this.key;
            if (Long2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2CharOpenCustomHashMap.this.n]);
            }
            int pos = Long2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
