...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Long2FloatOpenHashMap.this.value;
                    if (Long2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2FloatOpenHashMap.this.n]);
                    }
    ...
    implements Long2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0L) {
                return Long2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            long[] key = Long2FloatOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Float.floatToRawIntBits(Long2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == 0L) {
                if (Long2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (curr == k) {
                if (Float.floatToRawIntBits(Long2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2FloatOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (curr != k || Float.floatToRawIntBits(Long2FloatOpenHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Long2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2FloatOpenHashMap.this.key;
            if (Long2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Long2FloatOpenHashMap.this.n]);
            }
            int pos = Long2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
    ...
    LongFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2FloatOpenHashMap.this.key[this.index] == (Long)e.getKey() && Float.floatToRawIntBits(Long2FloatOpenHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
