...
Cloneable {
    ...
    implements Long2DoubleMap.FastEntrySet {
        ...
        public ObjectIterator<Long2DoubleMap.Entry> iterator() {
            return new ObjectIterator<Long2DoubleMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Long2DoubleArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public boolean contains(Object o) {
            ...
            return Long2DoubleArrayMap.this.containsKey(k) && Double.doubleToRawLongBits(Long2DoubleArrayMap.this.get(k)) == Double.doubleToRawLongBits((Double)e.getValue());
        }
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || Double.doubleToRawLongBits(v) != Double.doubleToRawLongBits(Long2DoubleArrayMap.this.value[oldPos])) {
                return false;
            }
        ...
        public LongIterator iterator() {
            return new LongIterator(){
                ...
                public void forEachRemaining(LongConsumer action) {
                    long[] key = Long2DoubleArrayMap.this.key;
                    int max = Long2DoubleArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                public void forEachRemaining(DoubleConsumer action) {
                    double[] value = Long2DoubleArrayMap.this.value;
                    int max = Long2DoubleArrayMap.this.size;
                    while (this.pos < max) {
    ...
    LongDoublePair {
        ...
        public double setValue(double v) {
            double oldValue = Long2DoubleArrayMap.this.value[this.index];
            Long2DoubleArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2DoubleArrayMap.this.key[this.index] == (Long)e.getKey() && Double.doubleToRawLongBits(Long2DoubleArrayMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
        ...
        public String toString() {
            return Long2DoubleArrayMap.this.key[this.index] + "=>" + Long2DoubleArrayMap.this.value[this.index];
        }
    }
}
