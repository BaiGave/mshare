...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Long2DoubleOpenHashMap.this.value;
                    if (Long2DoubleOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2DoubleOpenHashMap.this.n]);
                    }
    ...
    implements Long2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0L) {
                return Long2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Long2DoubleOpenHashMap.this.value[Long2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            long[] key = Long2DoubleOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Double.doubleToRawLongBits(Long2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (k == 0L) {
                if (Long2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Long2DoubleOpenHashMap.this.value[Long2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (curr == k) {
                if (Double.doubleToRawLongBits(Long2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2DoubleOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (curr != k || Double.doubleToRawLongBits(Long2DoubleOpenHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Long2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2DoubleOpenHashMap.this.key;
            if (Long2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Long2DoubleOpenHashMap.this.n]);
            }
            int pos = Long2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
    ...
    LongDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2DoubleOpenHashMap.this.key[this.index] == (Long)e.getKey() && Double.doubleToRawLongBits(Long2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
