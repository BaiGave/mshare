...
Hash {
    ...
    @Override
    public long mergeLong(long k, long v, LongBinaryOperator remappingFunction) {
        long newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Long2LongOpenCustomHashMap.this.value;
                    if (Long2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2LongOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2LongOpenCustomHashMap.this.key;
            if (Long2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2LongOpenCustomHashMap.this.n]);
            }
            int pos = Long2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
