...
Hash {
    ...
    @Override
    public byte mergeByte(long k, byte v, ByteBinaryOperator remappingFunction) {
        byte newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(LongByteBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Long2ByteOpenCustomHashMap.this.value;
                    if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2ByteOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2ByteOpenCustomHashMap.this.key;
            if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2ByteOpenCustomHashMap.this.n]);
            }
            int pos = Long2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
