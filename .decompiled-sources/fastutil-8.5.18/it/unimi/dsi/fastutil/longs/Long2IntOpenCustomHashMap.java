...
Hash {
    ...
    @Override
    public int mergeInt(long k, int v, IntBinaryOperator remappingFunction) {
        int newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(LongIntBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Long2IntOpenCustomHashMap.this.value;
                    if (Long2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2IntOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2IntOpenCustomHashMap.this.key;
            if (Long2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2IntOpenCustomHashMap.this.n]);
            }
            int pos = Long2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
