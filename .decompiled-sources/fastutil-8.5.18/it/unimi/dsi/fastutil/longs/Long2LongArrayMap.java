...
Cloneable {
        ...
        public ObjectIterator<Long2LongMap.Entry> iterator() {
            return new ObjectIterator<Long2LongMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Long2LongArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public LongIterator iterator() {
            return new LongIterator(){
                ...
                public void forEachRemaining(LongConsumer action) {
                    long[] key = Long2LongArrayMap.this.key;
                    int max = Long2LongArrayMap.this.size;
                    while (this.pos < max) {
    ...
    extends AbstractLongCollection {
        ...
        public LongIterator iterator() {
            return new LongIterator(){
                ...
                @Override
                public void forEachRemaining(LongConsumer action) {
                    long[] value = Long2LongArrayMap.this.value;
                    int max = Long2LongArrayMap.this.size;
                    while (this.pos < max) {
    ...
    LongLongPair {
        ...
        public long getLongKey() {
            return Long2LongArrayMap.this.key[this.index];
        }
        ...
        public long getLongValue() {
            return Long2LongArrayMap.this.value[this.index];
        }
        ...
        public long setValue(long v) {
            long oldValue = Long2LongArrayMap.this.value[this.index];
            Long2LongArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2LongArrayMap.this.key[this.index] == (Long)e.getKey() && Long2LongArrayMap.this.value[this.index] == (Long)e.getValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.long2int(Long2LongArrayMap.this.key[this.index]) ^ HashCommon.long2int(Long2LongArrayMap.this.value[this.index]);
        }

        public String toString() {
            return Long2LongArrayMap.this.key[this.index] + "=>" + Long2LongArrayMap.this.value[this.index];
        }
    }
}
