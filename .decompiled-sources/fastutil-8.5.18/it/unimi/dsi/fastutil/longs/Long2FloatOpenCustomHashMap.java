...
import it.unimi.dsi.fastutil.longs.LongFloatBiConsumer;
...
Hash {
    ...
    public boolean containsValue(float v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (key[i] == 0L || Float.floatToRawIntBits(value[i]) != Float.floatToRawIntBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    @Override
    public float mergeFloat(long k, float v, FloatBinaryOperator remappingFunction) {
        float newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(LongFloatBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Long2FloatOpenCustomHashMap.this.value;
                    if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2FloatOpenCustomHashMap.this.n]);
                    }
    ...
    implements Long2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                return Long2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            long[] key = Long2FloatOpenCustomHashMap.this.key;
            ...
            if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float.floatToRawIntBits(Long2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                if (Long2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Long2FloatOpenCustomHashMap.this.value[Long2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Long2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToRawIntBits(Long2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2FloatOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Long2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToRawIntBits(Long2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Long2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2FloatOpenCustomHashMap.this.key;
            if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Long2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
    ...
    LongFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2FloatOpenCustomHashMap.this.strategy.equals(Long2FloatOpenCustomHashMap.this.key[this.index], (Long)e.getKey()) && Float.floatToRawIntBits(Long2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
