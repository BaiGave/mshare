...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Long2BooleanOpenHashMap.this.value;
                    if (Long2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2BooleanOpenHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2BooleanOpenHashMap.this.key;
            if (Long2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Long2BooleanOpenHashMap.this.n]);
            }
            int pos = Long2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
