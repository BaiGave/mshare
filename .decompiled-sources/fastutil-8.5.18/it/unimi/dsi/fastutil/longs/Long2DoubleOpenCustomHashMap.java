...
import it.unimi.dsi.fastutil.longs.LongDoubleBiConsumer;
...
Hash {
    ...
    public boolean containsValue(double v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (key[i] == 0L || Double.doubleToRawLongBits(value[i]) != Double.doubleToRawLongBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    @Override
    public double mergeDouble(long k, double v, DoubleBinaryOperator remappingFunction) {
        double newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(LongDoubleBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Long2DoubleOpenCustomHashMap.this.value;
                    if (Long2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2DoubleOpenCustomHashMap.this.n]);
                    }
    ...
    implements Long2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                return Long2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Long2DoubleOpenCustomHashMap.this.value[Long2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            long[] key = Long2DoubleOpenCustomHashMap.this.key;
            ...
            if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Double.doubleToRawLongBits(Long2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                if (Long2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Long2DoubleOpenCustomHashMap.this.value[Long2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Long2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double.doubleToRawLongBits(Long2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2DoubleOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Long2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double.doubleToRawLongBits(Long2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Long2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2DoubleOpenCustomHashMap.this.key;
            if (Long2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Long2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
    ...
    LongDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2DoubleOpenCustomHashMap.this.strategy.equals(Long2DoubleOpenCustomHashMap.this.key[this.index], (Long)e.getKey()) && Double.doubleToRawLongBits(Long2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
