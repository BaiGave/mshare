...
Cloneable {
        ...
        public ObjectIterator<Long2ReferenceMap.Entry<V>> iterator() {
            return new ObjectIterator<Long2ReferenceMap.Entry<V>>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Long2ReferenceArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public LongIterator iterator() {
            return new LongIterator(){
                ...
                public void forEachRemaining(LongConsumer action) {
                    long[] key = Long2ReferenceArrayMap.this.key;
                    int max = Long2ReferenceArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>(){
                ...
                public void forEachRemaining(Consumer<? super V> action) {
                    Object[] value = Long2ReferenceArrayMap.this.value;
                    int max = Long2ReferenceArrayMap.this.size;
                    while (this.pos < max) {
    ...
    LongReferencePair<V> {
        ...
        public long getLongKey() {
            return Long2ReferenceArrayMap.this.key[this.index];
        }
        ...
        @Override
        public V getValue() {
            return Long2ReferenceArrayMap.this.value[this.index];
        }
        ...
        public V setValue(V v) {
            Object oldValue = Long2ReferenceArrayMap.this.value[this.index];
            Long2ReferenceArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2ReferenceArrayMap.this.key[this.index] == (Long)e.getKey() && Long2ReferenceArrayMap.this.value[this.index] == e.getValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.long2int(Long2ReferenceArrayMap.this.key[this.index]) ^ (Long2ReferenceArrayMap.this.value[this.index] == null ? 0 : System.identityHashCode(Long2ReferenceArrayMap.this.value[this.index]));
        }

        public String toString() {
            return Long2ReferenceArrayMap.this.key[this.index] + "=>" + Long2ReferenceArrayMap.this.value[this.index];
        }
    }
}
