...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Long2ReferenceOpenCustomHashMap.this.value;
                    if (Long2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2ReferenceOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2ReferenceOpenCustomHashMap.this.key;
            if (Long2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2ReferenceOpenCustomHashMap.this.n]);
            }
            int pos = Long2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
