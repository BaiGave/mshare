...
Hash {
    ...
    @Override
    public short mergeShort(long k, short v, ShortBinaryOperator remappingFunction) {
        short newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(LongShortBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Long2ShortOpenCustomHashMap.this.value;
                    if (Long2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Long2ShortOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            long[] key = Long2ShortOpenCustomHashMap.this.key;
            if (Long2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Long2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Long2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                long k = key[pos];
