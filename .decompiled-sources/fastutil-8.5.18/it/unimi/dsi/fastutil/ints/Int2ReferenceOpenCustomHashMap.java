...
Hash {
    ...
    @Override
    public void forEach(IntObjectBiConsumer<? super V> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Int2ReferenceOpenCustomHashMap.this.value;
                    if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2ReferenceOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2ReferenceOpenCustomHashMap.this.key;
            if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2ReferenceOpenCustomHashMap.this.n]);
            }
            int pos = Int2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
