...
Serializable {
    ...
    implements Int2FloatMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Int2FloatMap.Entry) {
                Int2FloatMap.Entry e = (Int2FloatMap.Entry)o;
                return this.key == e.getIntKey() && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(e.getFloatValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Integer)) {
            ...
            return this.key == (Integer)key && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(((Float)value).floatValue());
        }
