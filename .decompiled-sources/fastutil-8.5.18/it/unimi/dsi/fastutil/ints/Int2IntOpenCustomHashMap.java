...
Hash {
    ...
    @Override
    public int mergeInt(int k, int v, IntBinaryOperator remappingFunction) {
        int newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(IntIntBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Int2IntOpenCustomHashMap.this.value;
                    if (Int2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2IntOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2IntOpenCustomHashMap.this.key;
            if (Int2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2IntOpenCustomHashMap.this.n]);
            }
            int pos = Int2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
