...
Hash {
    ...
    @Override
    public void forEach(IntBooleanBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Int2BooleanOpenCustomHashMap.this.value;
                    if (Int2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2BooleanOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2BooleanOpenCustomHashMap.this.key;
            if (Int2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Int2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
