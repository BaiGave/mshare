...
Cloneable {
        ...
        public ObjectIterator<Int2ReferenceMap.Entry<V>> iterator() {
            return new ObjectIterator<Int2ReferenceMap.Entry<V>>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Int2ReferenceArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public IntIterator iterator() {
            return new IntIterator(){
                ...
                public void forEachRemaining(IntConsumer action) {
                    int[] key = Int2ReferenceArrayMap.this.key;
                    int max = Int2ReferenceArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>(){
                ...
                public void forEachRemaining(Consumer<? super V> action) {
                    Object[] value = Int2ReferenceArrayMap.this.value;
                    int max = Int2ReferenceArrayMap.this.size;
                    while (this.pos < max) {
    ...
    IntReferencePair<V> {
        ...
        public int getIntKey() {
            return Int2ReferenceArrayMap.this.key[this.index];
        }
        ...
        @Override
        public V getValue() {
            return Int2ReferenceArrayMap.this.value[this.index];
        }
        ...
        public V setValue(V v) {
            Object oldValue = Int2ReferenceArrayMap.this.value[this.index];
            Int2ReferenceArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2ReferenceArrayMap.this.key[this.index] == (Integer)e.getKey() && Int2ReferenceArrayMap.this.value[this.index] == e.getValue();
        }

        @Override
        public int hashCode() {
            return Int2ReferenceArrayMap.this.key[this.index] ^ (Int2ReferenceArrayMap.this.value[this.index] == null ? 0 : System.identityHashCode(Int2ReferenceArrayMap.this.value[this.index]));
        }

        public String toString() {
            return Int2ReferenceArrayMap.this.key[this.index] + "=>" + Int2ReferenceArrayMap.this.value[this.index];
        }
    }
}
