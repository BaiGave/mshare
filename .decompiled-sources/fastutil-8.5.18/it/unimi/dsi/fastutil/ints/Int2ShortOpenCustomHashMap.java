...
import it.unimi.dsi.fastutil.ints.IntShortBiConsumer;
...
Hash {
    ...
    @Override
    public short mergeShort(int k, short v, ShortBinaryOperator remappingFunction) {
        short newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(IntShortBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Int2ShortOpenCustomHashMap.this.value;
                    if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2ShortOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2ShortOpenCustomHashMap.this.key;
            if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Int2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
