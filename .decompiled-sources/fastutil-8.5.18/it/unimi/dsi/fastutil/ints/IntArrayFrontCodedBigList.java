...
RandomAccess {
    ...
    public ObjectBigListIterator<int[]> listIterator(final long start) {
        ...
        return new ObjectBigListIterator<int[]>(){
            ...
            long pos = 0L;
            boolean inSync;
            final /* synthetic */ IntArrayFrontCodedBigList this$0;
            {
                this.this$0 = this$0;
                if (start != 0L) {
            ...
            public int[] next() {
                ...
                if (this.i % (long)this.this$0.ratio == 0L) {
                    ...
                    length = IntArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    this.s = IntArrays.ensureCapacity(this.s, length, 0);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)IntArrayFrontCodedList.count(length), this.s, 0, length);
                    this.pos += (long)(length + IntArrayFrontCodedList.count(length));
                    this.inSync = true;
                } else if (this.inSync) {
                    length = IntArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    int common = IntArrayFrontCodedList.readInt(this.this$0.array, this.pos + (long)IntArrayFrontCodedList.count(length));
                    this.s = IntArrays.ensureCapacity(this.s, length + common, common);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)IntArrayFrontCodedList.count(length) + (long)IntArrayFrontCodedList.count(common), this.s, common, length);
