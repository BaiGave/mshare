...
import it.unimi.dsi.fastutil.ints.IntFloatBiConsumer;
...
Hash {
    ...
    @Override
    public float mergeFloat(int k, float v, FloatBinaryOperator remappingFunction) {
        float newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(IntFloatBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Int2FloatOpenCustomHashMap.this.value;
                    if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2FloatOpenCustomHashMap.this.n]);
                    }
    ...
    implements Int2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Int2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            int[] key = Int2FloatOpenCustomHashMap.this.key;
            ...
            if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float.floatToRawIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                if (Int2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Int2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToRawIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Int2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToRawIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Int2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2FloatOpenCustomHashMap.this.key;
            if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Int2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
    ...
    IntFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[this.index], (Integer)e.getKey()) && Float.floatToRawIntBits(Int2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
