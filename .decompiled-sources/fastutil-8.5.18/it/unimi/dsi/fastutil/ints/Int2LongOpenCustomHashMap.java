...
Hash {
    ...
    @Override
    public long mergeLong(int k, long v, LongBinaryOperator remappingFunction) {
        long newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(IntLongBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Int2LongOpenCustomHashMap.this.value;
                    if (Int2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2LongOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2LongOpenCustomHashMap.this.key;
            if (Int2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2LongOpenCustomHashMap.this.n]);
            }
            int pos = Int2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
