...
Hash {
    ...
    @Override
    public char mergeChar(int k, char v, CharBinaryOperator remappingFunction) {
        char newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(IntCharBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Int2CharOpenCustomHashMap.this.value;
                    if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2CharOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2CharOpenCustomHashMap.this.key;
            if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2CharOpenCustomHashMap.this.n]);
            }
            int pos = Int2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
