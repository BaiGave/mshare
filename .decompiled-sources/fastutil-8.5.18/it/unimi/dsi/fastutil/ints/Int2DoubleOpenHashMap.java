...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Int2DoubleOpenHashMap.this.value;
                    if (Int2DoubleOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2DoubleOpenHashMap.this.n]);
                    }
    ...
    implements Int2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Int2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Int2DoubleOpenHashMap.this.value[Int2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            int[] key = Int2DoubleOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Double.doubleToRawLongBits(Int2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (k == 0) {
                if (Int2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Int2DoubleOpenHashMap.this.value[Int2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (curr == k) {
                if (Double.doubleToRawLongBits(Int2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Double.doubleToRawLongBits(Int2DoubleOpenHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Int2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2DoubleOpenHashMap.this.key;
            if (Int2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Int2DoubleOpenHashMap.this.n]);
            }
            int pos = Int2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
    ...
    IntDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2DoubleOpenHashMap.this.key[this.index] == (Integer)e.getKey() && Double.doubleToRawLongBits(Int2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
