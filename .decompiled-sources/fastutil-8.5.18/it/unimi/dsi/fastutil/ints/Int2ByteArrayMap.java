...
Cloneable {
        ...
        public ObjectIterator<Int2ByteMap.Entry> iterator() {
            return new ObjectIterator<Int2ByteMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Int2ByteArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public IntIterator iterator() {
            return new IntIterator(){
                ...
                public void forEachRemaining(IntConsumer action) {
                    int[] key = Int2ByteArrayMap.this.key;
                    int max = Int2ByteArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ByteIterator iterator() {
            return new ByteIterator(){
                ...
                public void forEachRemaining(ByteConsumer action) {
                    byte[] value = Int2ByteArrayMap.this.value;
                    int max = Int2ByteArrayMap.this.size;
                    while (this.pos < max) {
    ...
    IntBytePair {
        ...
        public int getIntKey() {
            return Int2ByteArrayMap.this.key[this.index];
        }
        ...
        public byte getByteValue() {
            return Int2ByteArrayMap.this.value[this.index];
        }
        ...
        public byte setValue(byte v) {
            byte oldValue = Int2ByteArrayMap.this.value[this.index];
            Int2ByteArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2ByteArrayMap.this.key[this.index] == (Integer)e.getKey() && Int2ByteArrayMap.this.value[this.index] == (Byte)e.getValue();
        }

        @Override
        public int hashCode() {
            return Int2ByteArrayMap.this.key[this.index] ^ Int2ByteArrayMap.this.value[this.index];
        }
