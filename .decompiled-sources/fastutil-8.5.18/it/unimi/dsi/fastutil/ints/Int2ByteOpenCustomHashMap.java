...
import it.unimi.dsi.fastutil.ints.IntByteBiConsumer;
...
Hash {
    ...
    @Override
    public byte mergeByte(int k, byte v, ByteBinaryOperator remappingFunction) {
        byte newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(IntByteBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Int2ByteOpenCustomHashMap.this.value;
                    if (Int2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2ByteOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2ByteOpenCustomHashMap.this.key;
            if (Int2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2ByteOpenCustomHashMap.this.n]);
            }
            int pos = Int2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
