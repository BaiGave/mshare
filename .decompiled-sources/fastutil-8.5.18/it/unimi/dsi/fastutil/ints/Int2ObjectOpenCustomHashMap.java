...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Int2ObjectOpenCustomHashMap.this.value;
                    if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2ObjectOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2ObjectOpenCustomHashMap.this.key;
            if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Int2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
