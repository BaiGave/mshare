...
Cloneable {
        ...
        public ObjectIterator<Int2CharMap.Entry> iterator() {
            return new ObjectIterator<Int2CharMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Int2CharArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public IntIterator iterator() {
            return new IntIterator(){
                ...
                public void forEachRemaining(IntConsumer action) {
                    int[] key = Int2CharArrayMap.this.key;
                    int max = Int2CharArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public CharIterator iterator() {
            return new CharIterator(){
                ...
                public void forEachRemaining(CharConsumer action) {
                    char[] value = Int2CharArrayMap.this.value;
                    int max = Int2CharArrayMap.this.size;
                    while (this.pos < max) {
    ...
    IntCharPair {
        ...
        public int getIntKey() {
            return Int2CharArrayMap.this.key[this.index];
        }
        ...
        public char getCharValue() {
            return Int2CharArrayMap.this.value[this.index];
        }
        ...
        public char setValue(char v) {
            char oldValue = Int2CharArrayMap.this.value[this.index];
            Int2CharArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public Character getValue() {
            return Character.valueOf(Int2CharArrayMap.this.value[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2CharArrayMap.this.key[this.index] == (Integer)e.getKey() && Int2CharArrayMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }

        @Override
        public int hashCode() {
            return Int2CharArrayMap.this.key[this.index] ^ Int2CharArrayMap.this.value[this.index];
        }
