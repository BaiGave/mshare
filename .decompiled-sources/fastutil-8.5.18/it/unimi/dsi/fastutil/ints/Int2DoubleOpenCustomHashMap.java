...
import it.unimi.dsi.fastutil.ints.IntDoubleBiConsumer;
...
Hash {
    ...
    @Override
    public double mergeDouble(int k, double v, DoubleBinaryOperator remappingFunction) {
        double newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Int2DoubleOpenCustomHashMap.this.value;
                    if (Int2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2DoubleOpenCustomHashMap.this.n]);
                    }
    ...
    implements Int2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Int2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            int[] key = Int2DoubleOpenCustomHashMap.this.key;
            ...
            if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Double.doubleToRawLongBits(Int2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, 0)) {
                if (Int2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Int2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double.doubleToRawLongBits(Int2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Int2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double.doubleToRawLongBits(Int2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Int2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2DoubleOpenCustomHashMap.this.key;
            if (Int2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Int2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Int2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
    ...
    IntDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[this.index], (Integer)e.getKey()) && Double.doubleToRawLongBits(Int2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
