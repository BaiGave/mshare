...
Serializable {
    ...
    implements Int2DoubleMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Int2DoubleMap.Entry) {
                Int2DoubleMap.Entry e = (Int2DoubleMap.Entry)o;
                return this.key == e.getIntKey() && Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits(e.getDoubleValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Integer)) {
            ...
            return this.key == (Integer)key && Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits((Double)value);
        }
