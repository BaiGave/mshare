...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Int2FloatOpenHashMap.this.value;
                    if (Int2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Int2FloatOpenHashMap.this.n]);
                    }
    ...
    implements Int2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Int2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            int[] key = Int2FloatOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Float.floatToRawIntBits(Int2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == 0) {
                if (Int2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (curr == k) {
                if (Float.floatToRawIntBits(Int2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2FloatOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Float.floatToRawIntBits(Int2FloatOpenHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Int2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            int[] key = Int2FloatOpenHashMap.this.key;
            if (Int2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Int2FloatOpenHashMap.this.n]);
            }
            int pos = Int2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                int k = key[pos];
    ...
    IntFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2FloatOpenHashMap.this.key[this.index] == (Integer)e.getKey() && Float.floatToRawIntBits(Int2FloatOpenHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
