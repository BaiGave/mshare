...
import it.unimi.dsi.fastutil.floats.FloatCharBiConsumer;
...
Hash {
    ...
    @Override
    public char mergeChar(float k, char v, CharBinaryOperator remappingFunction) {
        char newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(FloatCharBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Float2CharOpenHashMap.this.value;
                    if (Float2CharOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2CharOpenHashMap.this.n]);
                    }
    ...
    implements Float2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2CharOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Float2CharOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2CharOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || Float2CharOpenHashMap.this.value[pos] != v);
            Float2CharOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2CharOpenHashMap.this.key;
            if (Float2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2CharOpenHashMap.this.n]);
            }
            int pos = Float2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatCharPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2CharOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }
