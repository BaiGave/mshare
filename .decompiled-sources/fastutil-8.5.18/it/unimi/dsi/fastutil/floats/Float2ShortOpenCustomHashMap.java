...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Float2ShortOpenCustomHashMap.this.value;
                    if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2ShortOpenCustomHashMap.this.n]);
                    }
    ...
    implements Float2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2ShortOpenCustomHashMap.this.key;
            if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Float2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
