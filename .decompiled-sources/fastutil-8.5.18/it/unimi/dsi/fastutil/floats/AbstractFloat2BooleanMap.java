...
Serializable {
    ...
    implements Float2BooleanMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Float2BooleanMap.Entry) {
                Float2BooleanMap.Entry e = (Float2BooleanMap.Entry)o;
                return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(e.getFloatKey()) && this.value == e.getBooleanValue();
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Float)) {
            ...
            return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(((Float)key).floatValue()) && this.value == (Boolean)value;
        }
