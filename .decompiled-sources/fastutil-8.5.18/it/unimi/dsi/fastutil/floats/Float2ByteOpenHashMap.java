...
import it.unimi.dsi.fastutil.floats.FloatByteBiConsumer;
...
Hash {
    ...
    @Override
    public byte mergeByte(float k, byte v, ByteBinaryOperator remappingFunction) {
        byte newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(FloatByteBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Float2ByteOpenHashMap.this.value;
                    if (Float2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2ByteOpenHashMap.this.n]);
                    }
    ...
    implements Float2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ByteOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Float2ByteOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ByteOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || Float2ByteOpenHashMap.this.value[pos] != v);
            Float2ByteOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2ByteOpenHashMap.this.key;
            if (Float2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2ByteOpenHashMap.this.n]);
            }
            int pos = Float2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatBytePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2ByteOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float2ByteOpenHashMap.this.value[this.index] == (Byte)e.getValue();
        }
