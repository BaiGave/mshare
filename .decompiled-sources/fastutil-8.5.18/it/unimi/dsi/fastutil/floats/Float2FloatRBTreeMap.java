...
Cloneable {
    ...
    public boolean containsValue(float v) {
        ...
        while (j-- != 0) {
            ...
            if (Float.floatToRawIntBits(ev) != Float.floatToRawIntBits(v)) continue;
            return true;
        }
        return false;
    }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>(){
                ...
                public boolean remove(Object o) {
                    ...
                    Entry f = Float2FloatRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
                    if (f == null || Float.floatToRawIntBits(f.getFloatValue()) != Float.floatToRawIntBits(((Float)e.getValue()).floatValue())) {
                        return false;
                    }
    ...
    implements Cloneable {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
