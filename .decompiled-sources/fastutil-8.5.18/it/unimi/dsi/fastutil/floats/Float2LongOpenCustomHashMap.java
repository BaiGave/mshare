...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Float2LongOpenCustomHashMap.this.value;
                    if (Float2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2LongOpenCustomHashMap.this.n]);
                    }
    ...
    implements Float2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2LongOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2LongOpenCustomHashMap.this.key;
            if (Float2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2LongOpenCustomHashMap.this.n]);
            }
            int pos = Float2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
