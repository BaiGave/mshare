...
import it.unimi.dsi.fastutil.floats.FloatShortBiConsumer;
...
Hash {
    ...
    @Override
    public void forEach(FloatShortBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Float2ShortOpenHashMap.this.value;
                    if (Float2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2ShortOpenHashMap.this.n]);
                    }
    ...
    implements Float2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ShortOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Float2ShortOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ShortOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || Float2ShortOpenHashMap.this.value[pos] != v);
            Float2ShortOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2ShortOpenHashMap.this.key;
            if (Float2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2ShortOpenHashMap.this.n]);
            }
            int pos = Float2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatShortPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2ShortOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float2ShortOpenHashMap.this.value[this.index] == (Short)e.getValue();
        }
