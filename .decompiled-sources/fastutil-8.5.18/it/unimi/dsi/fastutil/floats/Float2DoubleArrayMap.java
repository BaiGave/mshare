...
Cloneable {
    ...
    implements Float2DoubleMap.FastEntrySet {
        ...
        public ObjectIterator<Float2DoubleMap.Entry> iterator() {
            return new ObjectIterator<Float2DoubleMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Float2DoubleArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public boolean contains(Object o) {
            ...
            return Float2DoubleArrayMap.this.containsKey(k) && Double.doubleToRawLongBits(Float2DoubleArrayMap.this.get(k)) == Double.doubleToRawLongBits((Double)e.getValue());
        }
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || Double.doubleToRawLongBits(v) != Double.doubleToRawLongBits(Float2DoubleArrayMap.this.value[oldPos])) {
                return false;
            }
        ...
        public FloatIterator iterator() {
            return new FloatIterator(){
                ...
                public void forEachRemaining(FloatConsumer action) {
                    float[] key = Float2DoubleArrayMap.this.key;
                    int max = Float2DoubleArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator(){
                ...
                public void forEachRemaining(DoubleConsumer action) {
                    double[] value = Float2DoubleArrayMap.this.value;
                    int max = Float2DoubleArrayMap.this.size;
                    while (this.pos < max) {
    ...
    FloatDoublePair {
        ...
        public float getFloatKey() {
            return Float2DoubleArrayMap.this.key[this.index];
        }
        ...
        public double getDoubleValue() {
            return Float2DoubleArrayMap.this.value[this.index];
        }
        ...
        public double setValue(double v) {
            double oldValue = Float2DoubleArrayMap.this.value[this.index];
            Float2DoubleArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        @Deprecated
        public Float getKey() {
            return Float.valueOf(Float2DoubleArrayMap.this.key[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2DoubleArrayMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Double.doubleToRawLongBits(Float2DoubleArrayMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }

        @Override
        public int hashCode() {
            return HashCommon.float2int(Float2DoubleArrayMap.this.key[this.index]) ^ HashCommon.double2int(Float2DoubleArrayMap.this.value[this.index]);
        }

        public String toString() {
            return Float2DoubleArrayMap.this.key[this.index] + "=>" + Float2DoubleArrayMap.this.value[this.index];
        }
    }
}
