...
Hash {
    ...
    public boolean remove(float k, float v) {
        ...
        if (this.strategy.equals(k, curr) && Float.floatToRawIntBits(v) == Float.floatToRawIntBits(this.value[pos])) {
        ...
        do {
            if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & this.mask]) != 0) continue;
            return false;
        } while (!this.strategy.equals(k, curr) || Float.floatToRawIntBits(v) != Float.floatToRawIntBits(this.value[pos]));
        this.removeEntry(pos);
        return true;
    }
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Float2FloatOpenCustomHashMap.this.value;
                    if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2FloatOpenCustomHashMap.this.n]);
                    }
    ...
    implements Float2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                return Float2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            float[] key = Float2FloatOpenCustomHashMap.this.key;
            ...
            if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float.floatToRawIntBits(Float2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                if (Float2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Float2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToRawIntBits(Float2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Float2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToRawIntBits(Float2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Float2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2FloatOpenCustomHashMap.this.key;
            if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Float2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue()) && Float.floatToRawIntBits(Float2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
