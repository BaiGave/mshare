...
Hash {
    ...
    @Override
    public void forEach(FloatObjectBiConsumer<? super V> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Float2ReferenceOpenHashMap.this.value;
                    if (Float2ReferenceOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2ReferenceOpenHashMap.this.n]);
                    }
    ...
    implements Float2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Float2ReferenceOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || Float2ReferenceOpenHashMap.this.value[pos] != v);
            Float2ReferenceOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2ReferenceOpenHashMap.this.key;
            if (Float2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2ReferenceOpenHashMap.this.n]);
            }
            int pos = Float2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatReferencePair<V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2ReferenceOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
        }
