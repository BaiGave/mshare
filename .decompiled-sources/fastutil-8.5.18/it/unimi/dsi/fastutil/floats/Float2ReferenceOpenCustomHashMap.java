...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Float2ReferenceOpenCustomHashMap.this.value;
                    if (Float2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2ReferenceOpenCustomHashMap.this.n]);
                    }
    ...
    implements Float2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ReferenceOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2ReferenceOpenCustomHashMap.this.key;
            if (Float2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2ReferenceOpenCustomHashMap.this.n]);
            }
            int pos = Float2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
