...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Float2BooleanOpenCustomHashMap.this.value;
                    if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2BooleanOpenCustomHashMap.this.n]);
                    }
    ...
    implements Float2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2BooleanOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2BooleanOpenCustomHashMap.this.key;
            if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Float2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
