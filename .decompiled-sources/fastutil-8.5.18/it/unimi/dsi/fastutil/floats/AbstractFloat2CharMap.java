...
Serializable {
    ...
    implements Float2CharMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Float2CharMap.Entry) {
                Float2CharMap.Entry e = (Float2CharMap.Entry)o;
                return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(e.getFloatKey()) && this.value == e.getCharValue();
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Float)) {
            ...
            return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(((Float)key).floatValue()) && this.value == ((Character)value).charValue();
        }
