...
Hash {
    ...
    public boolean addAndMoveToFirst(float k) {
        ...
        if (Float.floatToRawIntBits(k) == 0) {
            ...
            while (Float.floatToRawIntBits(key[pos]) != 0) {
                if (Float.floatToRawIntBits(k) == Float.floatToRawIntBits(key[pos])) {
    ...
    implements FloatListIterator {
        ...
        SetIterator(float from) {
            ...
            if (Float.floatToRawIntBits(FloatLinkedOpenHashSet.this.key[FloatLinkedOpenHashSet.this.last]) == Float.floatToRawIntBits(from)) {
