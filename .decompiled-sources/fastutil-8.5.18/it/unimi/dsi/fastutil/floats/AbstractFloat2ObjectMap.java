...
Serializable {
    ...
    implements Float2ObjectMap.Entry<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Float2ObjectMap.Entry) {
                Float2ObjectMap.Entry e = (Float2ObjectMap.Entry)o;
                return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(e.getFloatKey()) && Objects.equals(this.value, e.getValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Float)) {
            ...
            Object value = e.getValue();
            return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(((Float)key).floatValue()) && Objects.equals(this.value, value);
        }
