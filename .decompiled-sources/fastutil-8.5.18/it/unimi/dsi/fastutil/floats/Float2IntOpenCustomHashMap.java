...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Float2IntOpenCustomHashMap.this.value;
                    if (Float2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2IntOpenCustomHashMap.this.n]);
                    }
    ...
    implements Float2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2IntOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2IntOpenCustomHashMap.this.key;
            if (Float2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2IntOpenCustomHashMap.this.n]);
            }
            int pos = Float2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
