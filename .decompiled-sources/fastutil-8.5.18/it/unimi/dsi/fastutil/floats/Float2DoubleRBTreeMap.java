...
Cloneable {
    ...
    public boolean containsValue(double v) {
        ...
        while (j-- != 0) {
            ...
            if (Double.doubleToRawLongBits(ev) != Double.doubleToRawLongBits(v)) continue;
            return true;
        }
        return false;
    }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>(){
                ...
                public boolean remove(Object o) {
                    ...
                    Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
                    if (f == null || Double.doubleToRawLongBits(f.getDoubleValue()) != Double.doubleToRawLongBits((Double)e.getValue())) {
                        return false;
                    }
    ...
    implements Cloneable {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Double.doubleToRawLongBits(this.value) == Double.doubleToRawLongBits((Double)e.getValue());
        }
