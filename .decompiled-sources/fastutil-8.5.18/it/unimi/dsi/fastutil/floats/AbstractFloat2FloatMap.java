...
Serializable {
    ...
    implements Float2FloatMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Float2FloatMap.Entry) {
                Float2FloatMap.Entry e = (Float2FloatMap.Entry)o;
                return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(e.getFloatKey()) && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(e.getFloatValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Float)) {
            ...
            return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(((Float)key).floatValue()) && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(((Float)value).floatValue());
        }
