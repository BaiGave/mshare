...
Hash {
    ...
    public boolean containsValue(float v) {
        float[] key = this.key;
        float[] value = this.value;
        if (this.containsNullKey && Float.floatToRawIntBits(value[this.n]) == Float.floatToRawIntBits(v)) {
            return true;
        }
        int i = this.n;
        while (i-- != 0) {
            if (Float.floatToRawIntBits(key[i]) == 0 || Float.floatToRawIntBits(value[i]) != Float.floatToRawIntBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    public boolean remove(float k, float v) {
        if (Float.floatToRawIntBits(k) == 0) {
            if (this.containsNullKey && Float.floatToRawIntBits(v) == Float.floatToRawIntBits(this.value[this.n])) {
        ...
        if (Float.floatToRawIntBits(k) == Float.floatToRawIntBits(curr) && Float.floatToRawIntBits(v) == Float.floatToRawIntBits(this.value[pos])) {
        ...
        do {
            if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & this.mask]) != 0) continue;
            return false;
        } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr) || Float.floatToRawIntBits(v) != Float.floatToRawIntBits(this.value[pos]));
        this.removeEntry(pos);
        return true;
    }
    ...
    public boolean replace(float k, float oldValue, float v) {
        int pos = this.find(k);
        if (pos < 0 || Float.floatToRawIntBits(oldValue) != Float.floatToRawIntBits(this.value[pos])) {
            return false;
        }
        this.value[pos] = v;
        return true;
    ...
    @Override
    public float mergeFloat(float k, float v, FloatBinaryOperator remappingFunction) {
        float newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(FloatFloatBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Float2FloatOpenHashMap.this.value;
                    if (Float2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2FloatOpenHashMap.this.n]);
                    }
    ...
    public int hashCode() {
        ...
        while (j-- != 0) {
            ...
            h += (t ^= HashCommon.float2int(value[i]));
            ++i;
        }
        if (this.containsNullKey) {
            h += HashCommon.float2int(value[this.n]);
        }
        return h;
    }
    ...
    implements Float2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float.floatToRawIntBits(k) == 0) {
                return Float2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            float[] key = Float2FloatOpenHashMap.this.key;
            ...
            if (Float.floatToRawIntBits(k) == Float.floatToRawIntBits(curr)) {
                return Float.floatToRawIntBits(Float2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2FloatOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Float.floatToRawIntBits(Float2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Float.floatToRawIntBits(k) == 0) {
                if (Float2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Float.floatToRawIntBits(curr) == Float.floatToRawIntBits(k)) {
                if (Float.floatToRawIntBits(Float2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2FloatOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || Float.floatToRawIntBits(Float2FloatOpenHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Float2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2FloatOpenHashMap.this.key;
            if (Float2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2FloatOpenHashMap.this.n]);
            }
            int pos = Float2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2FloatOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float.floatToRawIntBits(Float2FloatOpenHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
