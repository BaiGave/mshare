...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public void forEach(ByteConsumer consumer) {
                    ...
                    byte[] value = Float2ByteOpenCustomHashMap.this.value;
                    if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2ByteOpenCustomHashMap.this.n]);
                    }
    ...
    implements Float2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ByteOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2ByteOpenCustomHashMap.this.key;
            if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2ByteOpenCustomHashMap.this.n]);
            }
            int pos = Float2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
