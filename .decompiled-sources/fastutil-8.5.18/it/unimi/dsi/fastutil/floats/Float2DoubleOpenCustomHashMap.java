...
Hash {
    ...
    public boolean remove(float k, double v) {
        ...
        if (this.strategy.equals(k, curr) && Double.doubleToRawLongBits(v) == Double.doubleToRawLongBits(this.value[pos])) {
        ...
        do {
            if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & this.mask]) != 0) continue;
            return false;
        } while (!this.strategy.equals(k, curr) || Double.doubleToRawLongBits(v) != Double.doubleToRawLongBits(this.value[pos]));
        this.removeEntry(pos);
        return true;
    }
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Float2DoubleOpenCustomHashMap.this.value;
                    if (Float2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2DoubleOpenCustomHashMap.this.n]);
                    }
    ...
    public int hashCode() {
        ...
        while (j-- != 0) {
            ...
            t = this.strategy.hashCode(key[i]);
    ...
    implements Float2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                return Float2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Float2DoubleOpenCustomHashMap.this.value[Float2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            float[] key = Float2DoubleOpenCustomHashMap.this.key;
            ...
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Double.doubleToRawLongBits(Float2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                if (Float2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Float2DoubleOpenCustomHashMap.this.value[Float2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double.doubleToRawLongBits(Float2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double.doubleToRawLongBits(Float2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Float2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2DoubleOpenCustomHashMap.this.key;
            if (Float2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Float2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float2DoubleOpenCustomHashMap.this.strategy.equals(Float2DoubleOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue()) && Double.doubleToRawLongBits(Float2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
