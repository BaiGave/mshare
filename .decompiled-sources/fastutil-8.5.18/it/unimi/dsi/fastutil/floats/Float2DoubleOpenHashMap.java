...
import it.unimi.dsi.fastutil.floats.FloatDoubleBiConsumer;
...
Hash {
    ...
    private int find(float k) {
        ...
        float curr = key[pos];
        if (Float.floatToRawIntBits(curr) == 0) {
            return -(pos + 1);
        }
        ...
        do {
            if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & this.mask]) != 0) continue;
            return -(pos + 1);
        } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
        return pos;
    }
    ...
    public double addTo(float k, double incr) {
        ...
        if (Float.floatToRawIntBits(k) == 0) {
            ...
            if (Float.floatToRawIntBits(curr) != 0) {
                ...
                while (Float.floatToRawIntBits(curr = key[pos = pos + 1 & this.mask]) != 0) {
                    if (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k)) continue;
                    return this.addToValue(pos, incr);
                }
            }
        }
    ...
    public boolean containsValue(double v) {
        float[] key = this.key;
        double[] value = this.value;
        if (this.containsNullKey && Double.doubleToRawLongBits(value[this.n]) == Double.doubleToRawLongBits(v)) {
            return true;
        }
        int i = this.n;
        while (i-- != 0) {
            if (Float.floatToRawIntBits(key[i]) == 0 || Double.doubleToRawLongBits(value[i]) != Double.doubleToRawLongBits(v)) continue;
            return true;
        }
        return false;
    }
    ...
    public boolean remove(float k, double v) {
        if (Float.floatToRawIntBits(k) == 0) {
            if (this.containsNullKey && Double.doubleToRawLongBits(v) == Double.doubleToRawLongBits(this.value[this.n])) {
        ...
        if (Float.floatToRawIntBits(k) == Float.floatToRawIntBits(curr) && Double.doubleToRawLongBits(v) == Double.doubleToRawLongBits(this.value[pos])) {
        ...
        do {
            if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & this.mask]) != 0) continue;
            return false;
        } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr) || Double.doubleToRawLongBits(v) != Double.doubleToRawLongBits(this.value[pos]));
        this.removeEntry(pos);
        return true;
    }
    ...
    public boolean replace(float k, double oldValue, double v) {
        int pos = this.find(k);
        if (pos < 0 || Double.doubleToRawLongBits(oldValue) != Double.doubleToRawLongBits(this.value[pos])) {
            return false;
        }
        this.value[pos] = v;
        return true;
    ...
    @Override
    public double mergeDouble(float k, double v, DoubleBinaryOperator remappingFunction) {
        double newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
        ...
        this.value[pos] = newValue = remappingFunction.applyAsDouble(this.value[pos], v);
        return this.value[pos];
    }
    ...
    @Override
    public void forEach(FloatDoubleBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        int pos = this.n;
        while (pos-- != 0) {
            if (Float.floatToRawIntBits(key[pos]) == 0) continue;
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Float2DoubleOpenHashMap.this.value;
                    if (Float2DoubleOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2DoubleOpenHashMap.this.n]);
                    }
    ...
    protected void rehash(int newN) {
        ...
        int j = this.realSize();
        while (j-- != 0) {
            while (Float.floatToRawIntBits(key[--i]) == 0) {
            }
            int pos = HashCommon.mix(HashCommon.float2int(key[i])) & mask;
            if (Float.floatToRawIntBits(newKey[pos]) != 0) {
                while (Float.floatToRawIntBits(newKey[pos = pos + 1 & mask]) != 0) {
                }
            }
            newKey[pos] = key[i];
    ...
    public int hashCode() {
        ...
        while (j-- != 0) {
            ...
            t = HashCommon.float2int(key[i]);
            h += (t ^= HashCommon.double2int(value[i]));
            ++i;
        }
        if (this.containsNullKey) {
            h += HashCommon.double2int(value[this.n]);
        }
        return h;
    }
    ...
    implements Float2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float.floatToRawIntBits(k) == 0) {
                return Float2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Float2DoubleOpenHashMap.this.value[Float2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            float[] key = Float2DoubleOpenHashMap.this.key;
            ...
            if (Float.floatToRawIntBits(k) == Float.floatToRawIntBits(curr)) {
                return Double.doubleToRawLongBits(Float2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Double.doubleToRawLongBits(Float2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
        }
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Float.floatToRawIntBits(k) == 0) {
                if (Float2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Float2DoubleOpenHashMap.this.value[Float2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Float.floatToRawIntBits(curr) == Float.floatToRawIntBits(k)) {
                if (Double.doubleToRawLongBits(Float2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || Double.doubleToRawLongBits(Float2DoubleOpenHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Float2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2DoubleOpenHashMap.this.key;
            if (Float2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2DoubleOpenHashMap.this.n]);
            }
            int pos = Float2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
                if (Float.floatToRawIntBits(k) == 0) continue;
                consumer.accept(k);
            }
        }
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public boolean tryAdvance(ConsumerType action) {
            ...
            while (this.pos < this.max) {
                if (Float.floatToRawIntBits(key[this.pos]) != 0) {
                    ++this.c;
        ...
        public long skip(long n) {
            ...
            while (this.pos < this.max && n > 0L) {
                if (Float.floatToRawIntBits(key[this.pos++]) == 0) continue;
                ++skipped;
                --n;
            }
            return skipped;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(key[p])) {
                    p = p + 1 & Float2DoubleOpenHashMap.this.mask;
                }
                return p;
            } while (Float.floatToRawIntBits(key[this.pos]) == 0);
            this.last = this.pos;
            return this.last;
        }
    ...
    FloatDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2DoubleOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Double.doubleToRawLongBits(Float2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
