...
Cloneable {
        ...
        public ObjectIterator<Float2LongMap.Entry> iterator() {
            return new ObjectIterator<Float2LongMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Float2LongArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public FloatIterator iterator() {
            return new FloatIterator(){
                ...
                public void forEachRemaining(FloatConsumer action) {
                    float[] key = Float2LongArrayMap.this.key;
                    int max = Float2LongArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public LongIterator iterator() {
            return new LongIterator(){
                ...
                public void forEachRemaining(LongConsumer action) {
                    long[] value = Float2LongArrayMap.this.value;
                    int max = Float2LongArrayMap.this.size;
                    while (this.pos < max) {
    ...
    FloatLongPair {
        ...
        public float getFloatKey() {
            return Float2LongArrayMap.this.key[this.index];
        }
        ...
        public long getLongValue() {
            return Float2LongArrayMap.this.value[this.index];
        }
        ...
        public long setValue(long v) {
            long oldValue = Float2LongArrayMap.this.value[this.index];
            Float2LongArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        @Deprecated
        public Float getKey() {
            return Float.valueOf(Float2LongArrayMap.this.key[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2LongArrayMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float2LongArrayMap.this.value[this.index] == (Long)e.getValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.float2int(Float2LongArrayMap.this.key[this.index]) ^ HashCommon.long2int(Float2LongArrayMap.this.value[this.index]);
        }

        public String toString() {
            return Float2LongArrayMap.this.key[this.index] + "=>" + Float2LongArrayMap.this.value[this.index];
        }
    }
}
