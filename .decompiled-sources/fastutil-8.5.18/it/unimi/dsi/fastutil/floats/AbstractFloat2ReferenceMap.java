...
Serializable {
    ...
    implements Float2ReferenceMap.Entry<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Float2ReferenceMap.Entry) {
                Float2ReferenceMap.Entry e = (Float2ReferenceMap.Entry)o;
                return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(e.getFloatKey()) && this.value == e.getValue();
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Float)) {
            ...
            Object value = e.getValue();
            return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(((Float)key).floatValue()) && this.value == value;
        }
