...
public final class Float2ReferenceFunctions {
    ...
    Cloneable {
        ...
        public boolean containsKey(float k) {
            return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(k);
        }

        @Override
        public V get(float k) {
            return (V)(Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(k) ? this.value : this.defRetValue);
        }

        @Override
        public V getOrDefault(float k, V defaultValue) {
            return Float.floatToRawIntBits(this.key) == Float.floatToRawIntBits(k) ? this.value : defaultValue;
        }
