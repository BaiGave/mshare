...
import it.unimi.dsi.fastutil.floats.FloatLongBiConsumer;
...
Hash {
    ...
    public boolean containsValue(long v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (Float.floatToRawIntBits(key[i]) == 0 || value[i] != v) continue;
            return true;
        }
        return false;
    }
    ...
    public boolean remove(float k, long v) {
        ...
        if (Float.floatToRawIntBits(k) == Float.floatToRawIntBits(curr) && v == this.value[pos]) {
        ...
        do {
            if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & this.mask]) != 0) continue;
            return false;
        } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr) || v != this.value[pos]);
        this.removeEntry(pos);
        return true;
    }
    ...
    @Override
    public long mergeLong(float k, long v, LongBinaryOperator remappingFunction) {
        long newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
        ...
        this.value[pos] = newValue = remappingFunction.applyAsLong(this.value[pos], v);
        return this.value[pos];
    }
    ...
    @Override
    public void forEach(FloatLongBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Float2LongOpenHashMap.this.value;
                    if (Float2LongOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2LongOpenHashMap.this.n]);
                    }
    ...
    public int hashCode() {
        ...
        while (j-- != 0) {
            ...
            h += (t ^= HashCommon.long2int(value[i]));
            ++i;
        }
        if (this.containsNullKey) {
            h += HashCommon.long2int(value[this.n]);
        }
        return h;
    }
    ...
    implements Float2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2LongOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Float2LongOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2LongOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || Float2LongOpenHashMap.this.value[pos] != v);
            Float2LongOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2LongOpenHashMap.this.key;
            if (Float2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2LongOpenHashMap.this.n]);
            }
            int pos = Float2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatLongPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2LongOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float2LongOpenHashMap.this.value[this.index] == (Long)e.getValue();
        }
