...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Float2ObjectOpenHashMap.this.value;
                    if (Float2ObjectOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2ObjectOpenHashMap.this.n]);
                    }
    ...
    implements Float2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ObjectOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Objects.equals(Float2ObjectOpenHashMap.this.value[pos], v);
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ObjectOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || !Objects.equals(Float2ObjectOpenHashMap.this.value[pos], v));
            Float2ObjectOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2ObjectOpenHashMap.this.key;
            if (Float2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2ObjectOpenHashMap.this.n]);
            }
            int pos = Float2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatObjectPair<V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2ObjectOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Objects.equals(Float2ObjectOpenHashMap.this.value[this.index], e.getValue());
        }
