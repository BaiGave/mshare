...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Float2ObjectOpenCustomHashMap.this.value;
                    if (Float2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2ObjectOpenCustomHashMap.this.n]);
                    }
    ...
    implements Float2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2ObjectOpenCustomHashMap.this.key;
            if (Float2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Float2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
