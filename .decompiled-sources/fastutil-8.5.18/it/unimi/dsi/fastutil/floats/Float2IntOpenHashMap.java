...
import it.unimi.dsi.fastutil.floats.FloatIntBiConsumer;
...
Hash {
    ...
    @Override
    public int mergeInt(float k, int v, IntBinaryOperator remappingFunction) {
        int newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
        ...
        this.value[pos] = newValue = remappingFunction.applyAsInt(this.value[pos], v);
        return this.value[pos];
    }
    ...
    @Override
    public void forEach(FloatIntBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Float2IntOpenHashMap.this.value;
                    if (Float2IntOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2IntOpenHashMap.this.n]);
                    }
    ...
    implements Float2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2IntOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Float2IntOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2IntOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || Float2IntOpenHashMap.this.value[pos] != v);
            Float2IntOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2IntOpenHashMap.this.key;
            if (Float2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2IntOpenHashMap.this.n]);
            }
            int pos = Float2IntOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatIntPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2IntOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float2IntOpenHashMap.this.value[this.index] == (Integer)e.getValue();
        }
