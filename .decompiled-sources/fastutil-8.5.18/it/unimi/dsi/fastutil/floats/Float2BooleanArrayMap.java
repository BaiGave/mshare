...
Cloneable {
        ...
        public ObjectIterator<Float2BooleanMap.Entry> iterator() {
            return new ObjectIterator<Float2BooleanMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Float2BooleanArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public FloatIterator iterator() {
            return new FloatIterator(){
                ...
                public void forEachRemaining(FloatConsumer action) {
                    float[] key = Float2BooleanArrayMap.this.key;
                    int max = Float2BooleanArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public BooleanIterator iterator() {
            return new BooleanIterator(){
                ...
                public void forEachRemaining(BooleanConsumer action) {
                    boolean[] value = Float2BooleanArrayMap.this.value;
                    int max = Float2BooleanArrayMap.this.size;
                    while (this.pos < max) {
    ...
    FloatBooleanPair {
        ...
        public float getFloatKey() {
            return Float2BooleanArrayMap.this.key[this.index];
        }
        ...
        public boolean getBooleanValue() {
            return Float2BooleanArrayMap.this.value[this.index];
        }
        ...
        public boolean setValue(boolean v) {
            boolean oldValue = Float2BooleanArrayMap.this.value[this.index];
            Float2BooleanArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        @Deprecated
        public Float getKey() {
            return Float.valueOf(Float2BooleanArrayMap.this.key[this.index]);
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2BooleanArrayMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float2BooleanArrayMap.this.value[this.index] == (Boolean)e.getValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.float2int(Float2BooleanArrayMap.this.key[this.index]) ^ (Float2BooleanArrayMap.this.value[this.index] ? 1231 : 1237);
        }

        public String toString() {
            return Float2BooleanArrayMap.this.key[this.index] + "=>" + Float2BooleanArrayMap.this.value[this.index];
        }
    }
}
