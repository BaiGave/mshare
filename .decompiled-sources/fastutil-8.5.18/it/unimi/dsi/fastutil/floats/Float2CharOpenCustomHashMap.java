...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Float2CharOpenCustomHashMap.this.value;
                    if (Float2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2CharOpenCustomHashMap.this.n]);
                    }
    ...
    implements Float2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2CharOpenCustomHashMap.this.key;
            if (Float2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Float2CharOpenCustomHashMap.this.n]);
            }
            int pos = Float2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
