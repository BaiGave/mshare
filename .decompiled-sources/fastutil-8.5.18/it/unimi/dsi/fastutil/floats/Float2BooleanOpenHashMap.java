...
import it.unimi.dsi.fastutil.floats.FloatBooleanBiConsumer;
...
Hash {
    ...
    @Override
    public void forEach(FloatBooleanBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Float2BooleanOpenHashMap.this.value;
                    if (Float2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Float2BooleanOpenHashMap.this.n]);
                    }
    ...
    implements Float2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2BooleanOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(k) != Float.floatToRawIntBits(curr));
            return Float2BooleanOpenHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            do {
                if (Float.floatToRawIntBits(curr = key[pos = pos + 1 & Float2BooleanOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToRawIntBits(curr) != Float.floatToRawIntBits(k) || Float2BooleanOpenHashMap.this.value[pos] != v);
            Float2BooleanOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            float[] key = Float2BooleanOpenHashMap.this.key;
            if (Float2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Float2BooleanOpenHashMap.this.n]);
            }
            int pos = Float2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                float k = key[pos];
    ...
    FloatBooleanPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToRawIntBits(Float2BooleanOpenHashMap.this.key[this.index]) == Float.floatToRawIntBits(((Float)e.getKey()).floatValue()) && Float2BooleanOpenHashMap.this.value[this.index] == (Boolean)e.getValue();
        }
