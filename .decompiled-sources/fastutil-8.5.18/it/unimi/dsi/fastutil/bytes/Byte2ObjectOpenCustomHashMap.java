...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Byte2ObjectOpenCustomHashMap.this.value;
                    if (Byte2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2ObjectOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
            if (Byte2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Byte2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
