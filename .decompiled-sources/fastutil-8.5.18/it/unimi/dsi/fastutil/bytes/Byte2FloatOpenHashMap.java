...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Byte2FloatOpenHashMap.this.value;
                    if (Byte2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2FloatOpenHashMap.this.n]);
                    }
    ...
    implements Byte2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Byte2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            byte[] key = Byte2FloatOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Float.floatToRawIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == 0) {
                if (Byte2FloatOpenHashMap.this.containsNullKey && Float.floatToRawIntBits(Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (curr == k) {
                if (Float.floatToRawIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2FloatOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Float.floatToRawIntBits(Byte2FloatOpenHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Byte2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2FloatOpenHashMap.this.key;
            if (Byte2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2FloatOpenHashMap.this.n]);
            }
            int pos = Byte2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
    ...
    ByteFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2FloatOpenHashMap.this.key[this.index] == (Byte)e.getKey() && Float.floatToRawIntBits(Byte2FloatOpenHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
