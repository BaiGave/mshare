...
Hash {
    ...
    @Override
    public void forEach(ByteBooleanBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Byte2BooleanOpenCustomHashMap.this.value;
                    if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2BooleanOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2BooleanOpenCustomHashMap.this.key;
            if (Byte2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Byte2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
