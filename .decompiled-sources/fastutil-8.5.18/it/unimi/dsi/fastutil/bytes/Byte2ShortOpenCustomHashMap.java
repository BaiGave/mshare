...
Hash {
    ...
    @Override
    public short mergeShort(byte k, short v, ShortBinaryOperator remappingFunction) {
        short newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ByteShortBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public void forEach(ShortConsumer consumer) {
                    ...
                    short[] value = Byte2ShortOpenCustomHashMap.this.value;
                    if (Byte2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2ShortOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2ShortOpenCustomHashMap.this.key;
            if (Byte2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Byte2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
