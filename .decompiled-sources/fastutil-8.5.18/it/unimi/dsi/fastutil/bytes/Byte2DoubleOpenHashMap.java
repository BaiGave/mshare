...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Byte2DoubleOpenHashMap.this.value;
                    if (Byte2DoubleOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2DoubleOpenHashMap.this.n]);
                    }
    ...
    implements Byte2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Byte2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            byte[] key = Byte2DoubleOpenHashMap.this.key;
            ...
            if (k == curr) {
                return Double.doubleToRawLongBits(Byte2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (k == 0) {
                if (Byte2DoubleOpenHashMap.this.containsNullKey && Double.doubleToRawLongBits(Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (curr == k) {
                if (Double.doubleToRawLongBits(Byte2DoubleOpenHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Double.doubleToRawLongBits(Byte2DoubleOpenHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Byte2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2DoubleOpenHashMap.this.key;
            if (Byte2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2DoubleOpenHashMap.this.n]);
            }
            int pos = Byte2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
    ...
    ByteDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2DoubleOpenHashMap.this.key[this.index] == (Byte)e.getKey() && Double.doubleToRawLongBits(Byte2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
