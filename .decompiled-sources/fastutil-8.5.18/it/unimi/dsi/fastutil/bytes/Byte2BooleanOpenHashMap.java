...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public void forEach(BooleanConsumer consumer) {
                    ...
                    boolean[] value = Byte2BooleanOpenHashMap.this.value;
                    if (Byte2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2BooleanOpenHashMap.this.n]);
                    }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2BooleanOpenHashMap.this.key;
            if (Byte2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2BooleanOpenHashMap.this.n]);
            }
            int pos = Byte2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
