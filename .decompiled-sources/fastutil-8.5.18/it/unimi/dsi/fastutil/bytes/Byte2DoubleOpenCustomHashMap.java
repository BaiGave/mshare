...
import it.unimi.dsi.fastutil.bytes.ByteDoubleBiConsumer;
...
Hash {
    ...
    @Override
    public double mergeDouble(byte k, double v, DoubleBinaryOperator remappingFunction) {
        double newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ByteDoubleBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public void forEach(DoubleConsumer consumer) {
                    ...
                    double[] value = Byte2DoubleOpenCustomHashMap.this.value;
                    if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2DoubleOpenCustomHashMap.this.n]);
                    }
    ...
    implements Byte2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                return Byte2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v);
            }
            byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Double.doubleToRawLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                if (Byte2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToRawLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]) == Double.doubleToRawLongBits(v)) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Double.doubleToRawLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToRawLongBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double.doubleToRawLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToRawLongBits(v));
            Byte2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
            if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Byte2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
    ...
    ByteDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[this.index], (Byte)e.getKey()) && Double.doubleToRawLongBits(Byte2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToRawLongBits((Double)e.getValue());
        }
