...
Hash {
    ...
    @Override
    public void forEach(ByteObjectBiConsumer<? super V> consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Byte2ReferenceOpenCustomHashMap.this.value;
                    if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2ReferenceOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2ReferenceOpenCustomHashMap.this.key;
            if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2ReferenceOpenCustomHashMap.this.n]);
            }
            int pos = Byte2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
