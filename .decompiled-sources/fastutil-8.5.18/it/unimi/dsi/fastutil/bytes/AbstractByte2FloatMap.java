...
Serializable {
    ...
    implements Byte2FloatMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Byte2FloatMap.Entry) {
                Byte2FloatMap.Entry e = (Byte2FloatMap.Entry)o;
                return this.key == e.getByteKey() && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(e.getFloatValue());
            }
            Map.Entry e = (Map.Entry)o;
            Object key = e.getKey();
            if (key == null || !(key instanceof Byte)) {
            ...
            return this.key == (Byte)key && Float.floatToRawIntBits(this.value) == Float.floatToRawIntBits(((Float)value).floatValue());
        }
