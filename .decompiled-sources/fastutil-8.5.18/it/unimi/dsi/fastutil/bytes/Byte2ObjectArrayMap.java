...
Cloneable {
        ...
        public ObjectIterator<Byte2ObjectMap.Entry<V>> iterator() {
            return new ObjectIterator<Byte2ObjectMap.Entry<V>>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Byte2ObjectArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public ByteIterator iterator() {
            return new ByteIterator(){
                ...
                public void forEachRemaining(ByteConsumer action) {
                    byte[] key = Byte2ObjectArrayMap.this.key;
                    int max = Byte2ObjectArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>(){
                ...
                public void forEachRemaining(Consumer<? super V> action) {
                    Object[] value = Byte2ObjectArrayMap.this.value;
                    int max = Byte2ObjectArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ByteObjectPair<V> {
        ...
        public byte getByteKey() {
            return Byte2ObjectArrayMap.this.key[this.index];
        }
        ...
        @Override
        public V getValue() {
            return Byte2ObjectArrayMap.this.value[this.index];
        }
        ...
        public V setValue(V v) {
            Object oldValue = Byte2ObjectArrayMap.this.value[this.index];
            Byte2ObjectArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2ObjectArrayMap.this.key[this.index] == (Byte)e.getKey() && Objects.equals(Byte2ObjectArrayMap.this.value[this.index], e.getValue());
        }

        @Override
        public int hashCode() {
            return Byte2ObjectArrayMap.this.key[this.index] ^ (Byte2ObjectArrayMap.this.value[this.index] == null ? 0 : Byte2ObjectArrayMap.this.value[this.index].hashCode());
        }

        public String toString() {
            return Byte2ObjectArrayMap.this.key[this.index] + "=>" + Byte2ObjectArrayMap.this.value[this.index];
        }
    }
}
