...
Cloneable {
        ...
        public ObjectIterator<Byte2BooleanMap.Entry> iterator() {
            return new ObjectIterator<Byte2BooleanMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Byte2BooleanArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public ByteIterator iterator() {
            return new ByteIterator(){
                ...
                public void forEachRemaining(ByteConsumer action) {
                    byte[] key = Byte2BooleanArrayMap.this.key;
                    int max = Byte2BooleanArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public BooleanIterator iterator() {
            return new BooleanIterator(){
                ...
                public void forEachRemaining(BooleanConsumer action) {
                    boolean[] value = Byte2BooleanArrayMap.this.value;
                    int max = Byte2BooleanArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ByteBooleanPair {
        ...
        public byte getByteKey() {
            return Byte2BooleanArrayMap.this.key[this.index];
        }
        ...
        public boolean getBooleanValue() {
            return Byte2BooleanArrayMap.this.value[this.index];
        }
        ...
        public boolean setValue(boolean v) {
            boolean oldValue = Byte2BooleanArrayMap.this.value[this.index];
            Byte2BooleanArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2BooleanArrayMap.this.key[this.index] == (Byte)e.getKey() && Byte2BooleanArrayMap.this.value[this.index] == (Boolean)e.getValue();
        }

        @Override
        public int hashCode() {
            return Byte2BooleanArrayMap.this.key[this.index] ^ (Byte2BooleanArrayMap.this.value[this.index] ? 1231 : 1237);
        }

        public String toString() {
            return Byte2BooleanArrayMap.this.key[this.index] + "=>" + Byte2BooleanArrayMap.this.value[this.index];
        }
    }
}
