...
import it.unimi.dsi.fastutil.bytes.ByteFloatBiConsumer;
...
Hash {
    ...
    @Override
    public float mergeFloat(byte k, float v, FloatBinaryOperator remappingFunction) {
        float newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ByteFloatBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public void forEach(FloatConsumer consumer) {
                    ...
                    float[] value = Byte2FloatOpenCustomHashMap.this.value;
                    if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2FloatOpenCustomHashMap.this.n]);
                    }
    ...
    implements Byte2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                return Byte2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v);
            }
            byte[] key = Byte2FloatOpenCustomHashMap.this.key;
            ...
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float.floatToRawIntBits(Byte2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v);
            }
            do {
        ...
        public boolean remove(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                if (Byte2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToRawIntBits(Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]) == Float.floatToRawIntBits(v)) {
            ...
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float.floatToRawIntBits(Byte2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToRawIntBits(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Float.floatToRawIntBits(Byte2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToRawIntBits(v));
            Byte2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2FloatOpenCustomHashMap.this.key;
            if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Byte2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
    ...
    ByteFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[this.index], (Byte)e.getKey()) && Float.floatToRawIntBits(Byte2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToRawIntBits(((Float)e.getValue()).floatValue());
        }
