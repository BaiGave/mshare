...
RandomAccess {
    ...
    public ObjectBigListIterator<byte[]> listIterator(final long start) {
        ...
        return new ObjectBigListIterator<byte[]>(){
            ...
            long pos = 0L;
            boolean inSync;
            final /* synthetic */ ByteArrayFrontCodedBigList this$0;
            {
                this.this$0 = this$0;
                if (start != 0L) {
            ...
            public byte[] next() {
                ...
                if (this.i % (long)this.this$0.ratio == 0L) {
                    ...
                    length = ByteArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    this.s = ByteArrays.ensureCapacity(this.s, length, 0);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)ByteArrayFrontCodedList.count(length), this.s, 0, length);
                    this.pos += (long)(length + ByteArrayFrontCodedList.count(length));
                    this.inSync = true;
                } else if (this.inSync) {
                    length = ByteArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    int common = ByteArrayFrontCodedList.readInt(this.this$0.array, this.pos + (long)ByteArrayFrontCodedList.count(length));
                    this.s = ByteArrays.ensureCapacity(this.s, length + common, common);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)ByteArrayFrontCodedList.count(length) + (long)ByteArrayFrontCodedList.count(common), this.s, common, length);
