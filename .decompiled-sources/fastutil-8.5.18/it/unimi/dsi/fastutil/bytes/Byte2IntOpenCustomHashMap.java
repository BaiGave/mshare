...
Hash {
    ...
    @Override
    public int mergeInt(byte k, int v, IntBinaryOperator remappingFunction) {
        int newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ByteIntBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public void forEach(IntConsumer consumer) {
                    ...
                    int[] value = Byte2IntOpenCustomHashMap.this.value;
                    if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2IntOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2IntOpenCustomHashMap.this.key;
            if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2IntOpenCustomHashMap.this.n]);
            }
            int pos = Byte2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
