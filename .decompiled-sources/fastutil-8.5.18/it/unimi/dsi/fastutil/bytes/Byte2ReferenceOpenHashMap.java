...
Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    V[] value = Byte2ReferenceOpenHashMap.this.value;
                    if (Byte2ReferenceOpenHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2ReferenceOpenHashMap.this.n]);
                    }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2ReferenceOpenHashMap.this.key;
            if (Byte2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2ReferenceOpenHashMap.this.n]);
            }
            int pos = Byte2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
