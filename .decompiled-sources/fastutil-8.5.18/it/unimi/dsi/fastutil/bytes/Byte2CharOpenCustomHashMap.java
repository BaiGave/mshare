...
Hash {
    ...
    @Override
    public char mergeChar(byte k, char v, CharBinaryOperator remappingFunction) {
        char newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ByteCharBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public void forEach(CharConsumer consumer) {
                    ...
                    char[] value = Byte2CharOpenCustomHashMap.this.value;
                    if (Byte2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2CharOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2CharOpenCustomHashMap.this.key;
            if (Byte2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2CharOpenCustomHashMap.this.n]);
            }
            int pos = Byte2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
