...
Cloneable {
        ...
        public ObjectIterator<Byte2IntMap.Entry> iterator() {
            return new ObjectIterator<Byte2IntMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Byte2IntArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public ByteIterator iterator() {
            return new ByteIterator(){
                ...
                public void forEachRemaining(ByteConsumer action) {
                    byte[] key = Byte2IntArrayMap.this.key;
                    int max = Byte2IntArrayMap.this.size;
                    while (this.pos < max) {
        ...
        public IntIterator iterator() {
            return new IntIterator(){
                ...
                public void forEachRemaining(IntConsumer action) {
                    int[] value = Byte2IntArrayMap.this.value;
                    int max = Byte2IntArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ByteIntPair {
        ...
        public byte getByteKey() {
            return Byte2IntArrayMap.this.key[this.index];
        }
        ...
        public int getIntValue() {
            return Byte2IntArrayMap.this.value[this.index];
        }
        ...
        public int setValue(int v) {
            int oldValue = Byte2IntArrayMap.this.value[this.index];
            Byte2IntArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2IntArrayMap.this.key[this.index] == (Byte)e.getKey() && Byte2IntArrayMap.this.value[this.index] == (Integer)e.getValue();
        }

        @Override
        public int hashCode() {
            return Byte2IntArrayMap.this.key[this.index] ^ Byte2IntArrayMap.this.value[this.index];
        }
