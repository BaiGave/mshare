...
Cloneable {
        ...
        public ObjectIterator<Byte2ByteMap.Entry> iterator() {
            return new ObjectIterator<Byte2ByteMap.Entry>(){
                ...
                public int skip(int n) {
                    ...
                    n = Math.min(n, Byte2ByteArrayMap.this.size - this.next);
                    this.next += n;
                    if (n != 0) {
        ...
        public ByteIterator iterator() {
            return new ByteIterator(){
                ...
                public void forEachRemaining(ByteConsumer action) {
                    byte[] key = Byte2ByteArrayMap.this.key;
                    int max = Byte2ByteArrayMap.this.size;
                    while (this.pos < max) {
    ...
    extends AbstractByteCollection {
        ...
        public ByteIterator iterator() {
            return new ByteIterator(){
                ...
                @Override
                public void forEachRemaining(ByteConsumer action) {
                    byte[] value = Byte2ByteArrayMap.this.value;
                    int max = Byte2ByteArrayMap.this.size;
                    while (this.pos < max) {
    ...
    ByteBytePair {
        ...
        public byte getByteKey() {
            return Byte2ByteArrayMap.this.key[this.index];
        }
        ...
        public byte getByteValue() {
            return Byte2ByteArrayMap.this.value[this.index];
        }
        ...
        public byte setValue(byte v) {
            byte oldValue = Byte2ByteArrayMap.this.value[this.index];
            Byte2ByteArrayMap.this.value[this.index] = v;
            return oldValue;
        }
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2ByteArrayMap.this.key[this.index] == (Byte)e.getKey() && Byte2ByteArrayMap.this.value[this.index] == (Byte)e.getValue();
        }

        @Override
        public int hashCode() {
            return Byte2ByteArrayMap.this.key[this.index] ^ Byte2ByteArrayMap.this.value[this.index];
        }
