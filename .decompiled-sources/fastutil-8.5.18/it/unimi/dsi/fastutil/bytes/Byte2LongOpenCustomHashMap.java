...
Hash {
    ...
    @Override
    public long mergeLong(byte k, long v, LongBinaryOperator remappingFunction) {
        long newValue;
        Objects.requireNonNull(remappingFunction);
        int pos = this.find(k);
        if (pos < 0) {
    ...
    @Override
    public void forEach(ByteLongBiConsumer consumer) {
        if (this.containsNullKey) {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public void forEach(LongConsumer consumer) {
                    ...
                    long[] value = Byte2LongOpenCustomHashMap.this.value;
                    if (Byte2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(value[Byte2LongOpenCustomHashMap.this.n]);
                    }
    ...
    extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            byte[] key = Byte2LongOpenCustomHashMap.this.key;
            if (Byte2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(key[Byte2LongOpenCustomHashMap.this.n]);
            }
            int pos = Byte2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                byte k = key[pos];
