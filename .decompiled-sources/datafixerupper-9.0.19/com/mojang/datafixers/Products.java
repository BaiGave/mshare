...
public interface Products {
    ...
    public static final class P2<F extends K1, T1, T2> {
        ...
        public <T3> P3<F, T1, T2, T3> and(App<F, T3> t3) {
            return new P3<F, T1, T2, T3>(this.t1, this.t2, t3);
        }

        public <T3, T4> P4<F, T1, T2, T3, T4> and(P2<F, T3, T4> p) {
            return new P4<F, T1, T2, T1, T2>(this.t1, this.t2, p.t1, p.t2);
        }

        public <T3, T4, T5> P5<F, T1, T2, T3, T4, T5> and(P3<F, T3, T4, T5> p) {
            return new P5(this.t1, this.t2, p.t1, p.t2, p.t3);
        }

        public <T3, T4, T5, T6> P6<F, T1, T2, T3, T4, T5, T6> and(P4<F, T3, T4, T5, T6> p) {
            return new P6(this.t1, this.t2, p.t1, p.t2, p.t3, p.t4);
        }

        public <T3, T4, T5, T6, T7> P7<F, T1, T2, T3, T4, T5, T6, T7> and(P5<F, T3, T4, T5, T6, T7> p) {
            return new P7(this.t1, this.t2, p.t1, p.t2, p.t3, p.t4, p.t5);
        }

        public <T3, T4, T5, T6, T7, T8> P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(P6<F, T3, T4, T5, T6, T7, T8> p) {
            return new P8(this.t1, this.t2, p.t1, p.t2, p.t3, p.t4, p.t5, p.t6);
        }
    ...
    public static final class P7<F extends K1, T1, T2, T3, T4, T5, T6, T7> {
        ...
        public <T8> P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(App<F, T8> t8) {
    ...
    public static final class P6<F extends K1, T1, T2, T3, T4, T5, T6> {
        ...
        public <T7> P7<F, T1, T2, T3, T4, T5, T6, T7> and(App<F, T7> t7) {
            return new P7<F, T1, T2, T3, T4, T5, T6, T7>(this.t1, this.t2, this.t3, this.t4, this.t5, this.t6, t7);
        }

        public <T7, T8> P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(P2<F, T7, T8> p) {
            return new P8(this.t1, this.t2, this.t3, this.t4, this.t5, this.t6, p.t1, p.t2);
        }
    ...
    public static final class P5<F extends K1, T1, T2, T3, T4, T5> {
        ...
        public <T6> P6<F, T1, T2, T3, T4, T5, T6> and(App<F, T6> t6) {
            return new P6<F, T1, T2, T3, T4, T5, T6>(this.t1, this.t2, this.t3, this.t4, this.t5, t6);
        }

        public <T6, T7> P7<F, T1, T2, T3, T4, T5, T6, T7> and(P2<F, T6, T7> p) {
            return new P7(this.t1, this.t2, this.t3, this.t4, this.t5, p.t1, p.t2);
        }

        public <T6, T7, T8> P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(P3<F, T6, T7, T8> p) {
            return new P8(this.t1, this.t2, this.t3, this.t4, this.t5, p.t1, p.t2, p.t3);
        }
    ...
    public static final class P4<F extends K1, T1, T2, T3, T4> {
        ...
        public <T5> P5<F, T1, T2, T3, T4, T5> and(App<F, T5> t5) {
            return new P5<F, T1, T2, T3, T4, T5>(this.t1, this.t2, this.t3, this.t4, t5);
        }

        public <T5, T6> P6<F, T1, T2, T3, T4, T5, T6> and(P2<F, T5, T6> p) {
            return new P6(this.t1, this.t2, this.t3, this.t4, p.t1, p.t2);
        }

        public <T5, T6, T7> P7<F, T1, T2, T3, T4, T5, T6, T7> and(P3<F, T5, T6, T7> p) {
            return new P7(this.t1, this.t2, this.t3, this.t4, p.t1, p.t2, p.t3);
        }

        public <T5, T6, T7, T8> P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(P4<F, T5, T6, T7, T8> p) {
            return new P8<F, T1, T2, T3, T4, T1, T2, T3, T4>(this.t1, this.t2, this.t3, this.t4, p.t1, p.t2, p.t3, p.t4);
        }
    ...
    public static final class P3<F extends K1, T1, T2, T3> {
        ...
        public <T4> P4<F, T1, T2, T3, T4> and(App<F, T4> t4) {
            return new P4<F, T1, T2, T3, T4>(this.t1, this.t2, this.t3, t4);
        }

        public <T4, T5> P5<F, T1, T2, T3, T4, T5> and(P2<F, T4, T5> p) {
            return new P5(this.t1, this.t2, this.t3, p.t1, p.t2);
        }

        public <T4, T5, T6> P6<F, T1, T2, T3, T4, T5, T6> and(P3<F, T4, T5, T6> p) {
            return new P6<F, T1, T2, T3, T1, T2, T3>(this.t1, this.t2, this.t3, p.t1, p.t2, p.t3);
        }

        public <T4, T5, T6, T7> P7<F, T1, T2, T3, T4, T5, T6, T7> and(P4<F, T4, T5, T6, T7> p) {
            return new P7(this.t1, this.t2, this.t3, p.t1, p.t2, p.t3, p.t4);
        }

        public <T4, T5, T6, T7, T8> P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(P5<F, T4, T5, T6, T7, T8> p) {
            return new P8(this.t1, this.t2, this.t3, p.t1, p.t2, p.t3, p.t4, p.t5);
        }
    ...
    public static final class P1<F extends K1, T1> {
        ...
        public <T2> P2<F, T1, T2> and(App<F, T2> t2) {
            return new P2<F, T1, T2>(this.t1, t2);
        }

        public <T2, T3> P3<F, T1, T2, T3> and(P2<F, T2, T3> p) {
            return new P3(this.t1, p.t1, p.t2);
        }

        public <T2, T3, T4> P4<F, T1, T2, T3, T4> and(P3<F, T2, T3, T4> p) {
            return new P4(this.t1, p.t1, p.t2, p.t3);
        }

        public <T2, T3, T4, T5> P5<F, T1, T2, T3, T4, T5> and(P4<F, T2, T3, T4, T5> p) {
            return new P5(this.t1, p.t1, p.t2, p.t3, p.t4);
        }

        public <T2, T3, T4, T5, T6> P6<F, T1, T2, T3, T4, T5, T6> and(P5<F, T2, T3, T4, T5, T6> p) {
            return new P6(this.t1, p.t1, p.t2, p.t3, p.t4, p.t5);
        }

        public <T2, T3, T4, T5, T6, T7> P7<F, T1, T2, T3, T4, T5, T6, T7> and(P6<F, T2, T3, T4, T5, T6, T7> p) {
            return new P7(this.t1, p.t1, p.t2, p.t3, p.t4, p.t5, p.t6);
        }

        public <T2, T3, T4, T5, T6, T7, T8> P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(P7<F, T2, T3, T4, T5, T6, T7, T8> p) {
            return new P8(this.t1, p.t1, p.t2, p.t3, p.t4, p.t5, p.t6, p.t7);
        }
