...
public final class Typed<A> {
    ...
    public <FT> FT getOrCreate(OpticFinder<FT> optic) {
        return DataFixUtils.or(this.getOptional(optic), () -> optic.type().point(this.ops)).orElseThrow(() -> new IllegalStateException("Could not create default value for type: " + String.valueOf(optic.type())));
    }
    ...
    public <FT> Typed<FT> getOrCreateTyped(OpticFinder<FT> optic) {
        return DataFixUtils.or(this.getOptionalTyped(optic), () -> optic.type().pointTyped(this.ops)).orElseThrow(() -> new IllegalStateException("Could not create default value for type: " + String.valueOf(optic.type())));
    }
