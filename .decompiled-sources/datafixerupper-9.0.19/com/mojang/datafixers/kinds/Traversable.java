...
extends Functor<T, Mu> {
    public static <F extends K1, Mu extends Mu> Traversable<F, Mu> unbox(App<Mu, F> proofBox) {
    ...
    default public <F extends K1, A> App<F, App<T, A>> flip(Applicative<F, ?> applicative, App<T, App<F, A>> input) {
