...
public final class NumberOutput {
    ...
    public static int outputLong(long v, char[] b, int off) {
        ...
        long upper = v / 1000000000L;
        v -= upper * 1000000000L;
        if (upper < 1000000000L) {
            off = NumberOutput._outputUptoBillion((int)upper, b, off);
        } else {
            long hi = upper / 1000000000L;
            off = NumberOutput._leading3((int)hi, b, off);
            off = NumberOutput._outputFullBillion((int)(upper -= hi * 1000000000L), b, off);
        }
