...
import com.azure.json.implementation.jackson.core.json.JsonGeneratorImpl;
...
extends JsonGeneratorImpl {
    ...
    private void _writeStringSegment2(char[] cbuf, int offset, int end) throws IOException {
    ...
    private void _writeStringSegmentASCII2(char[] cbuf, int offset, int end) throws IOException {
        if (this._outputTail + 6 * (end - offset) > this._outputEnd) {
            this._flushBuffer();
        }
        int outputPtr = this._outputTail;
    ...
    private void _writeStringSegmentASCII2(String text, int offset, int end) throws IOException {
        if (this._outputTail + 6 * (end - offset) > this._outputEnd) {
            this._flushBuffer();
        }
        int outputPtr = this._outputTail;
    ...
    private void _writeCustomStringSegment2(char[] cbuf, int offset, int end) throws IOException {
        if (this._outputTail + 6 * (end - offset) > this._outputEnd) {
            this._flushBuffer();
        }
        int outputPtr = this._outputTail;
    ...
    private void _writeCustomStringSegment2(String text, int offset, int end) throws IOException {
        if (this._outputTail + 6 * (end - offset) > this._outputEnd) {
            this._flushBuffer();
        }
        int outputPtr = this._outputTail;
    ...
    private void _writeUTF8Segment(byte[] utf8, int offset, int len) throws IOException {
        int[] escCodes = this._outputEscapes;
        int ptr = offset;
        int end = offset + len;
        while (ptr < end) {
    ...
    private void _writeUTF8Segment2(byte[] utf8, int offset, int len) throws IOException {
        int outputPtr = this._outputTail;
        ...
        while (offset < len) {
            byte b;
            if ((b = utf8[offset++]) < 0 || escCodes[b] == 0) {
