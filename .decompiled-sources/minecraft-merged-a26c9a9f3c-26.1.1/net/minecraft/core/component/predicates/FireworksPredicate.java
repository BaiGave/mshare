...
{
    public static final Codec<FireworksPredicate> CODEC = RecordCodecBuilder.create(i -> i.group(CollectionPredicate.codec(FireworkExplosionPredicate.FireworkPredicate.CODEC).optionalFieldOf("explosions").forGetter(FireworksPredicate::explosions), MinMaxBounds.Ints.CODEC.optionalFieldOf("flight_duration", MinMaxBounds.Ints.ANY).forGetter(FireworksPredicate::flightDuration)).apply((Applicative<FireworksPredicate, ?>)i, FireworksPredicate::new));
