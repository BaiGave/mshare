...
{
    public static final Codec<WritableBookPredicate> CODEC = RecordCodecBuilder.create(i -> i.group(CollectionPredicate.codec(PagePredicate.CODEC).optionalFieldOf("pages").forGetter(WritableBookPredicate::pages)).apply((Applicative<WritableBookPredicate, ?>)i, WritableBookPredicate::new));
