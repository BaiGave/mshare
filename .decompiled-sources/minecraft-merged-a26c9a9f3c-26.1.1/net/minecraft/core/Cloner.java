...
public class Cloner<T> {
    ...
    public T clone(T value, HolderLookup.Provider from, HolderLookup.Provider to) {
        RegistryOps<Object> sourceOps = from.createSerializationContext(JavaOps.INSTANCE);
        RegistryOps<Object> targetOps = to.createSerializationContext(JavaOps.INSTANCE);
