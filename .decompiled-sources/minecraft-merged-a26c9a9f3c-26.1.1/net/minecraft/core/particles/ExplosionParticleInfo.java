...
public record ExplosionParticleInfo(ParticleOptions particle, float scaling, float speed) {
    public static final MapCodec<ExplosionParticleInfo> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ParticleTypes.CODEC.fieldOf("particle")).forGetter(ExplosionParticleInfo::particle), Codec.FLOAT.optionalFieldOf("scaling", Float.valueOf(1.0f)).forGetter(ExplosionParticleInfo::scaling), Codec.FLOAT.optionalFieldOf("speed", Float.valueOf(1.0f)).forGetter(ExplosionParticleInfo::speed)).apply((Applicative<ExplosionParticleInfo, ?>)i, ExplosionParticleInfo::new));
