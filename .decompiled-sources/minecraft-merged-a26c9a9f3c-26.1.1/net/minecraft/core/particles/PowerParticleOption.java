...
implements ParticleOptions {
    ...
    public static MapCodec<PowerParticleOption> codec(ParticleType<PowerParticleOption> type) {
        return Codec.FLOAT.xmap(power -> new PowerParticleOption(type, power.floatValue()), o -> Float.valueOf(o.power)).optionalFieldOf("power", PowerParticleOption.create(type, 1.0f));
    }
