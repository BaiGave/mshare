...
implements ParticleOptions {
    private static final Codec<PositionSource> SAFE_POSITION_SOURCE_CODEC = PositionSource.CODEC.validate(e -> e instanceof EntityPositionSource ? DataResult.error(() -> "Entity position sources are not allowed") : DataResult.success(e));
    public static final MapCodec<VibrationParticleOption> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)SAFE_POSITION_SOURCE_CODEC.fieldOf("destination")).forGetter(VibrationParticleOption::getDestination), ((MapCodec)Codec.INT.fieldOf("arrival_in_ticks")).forGetter(VibrationParticleOption::getArrivalInTicks)).apply((Applicative<VibrationParticleOption, ?>)i, VibrationParticleOption::new));
