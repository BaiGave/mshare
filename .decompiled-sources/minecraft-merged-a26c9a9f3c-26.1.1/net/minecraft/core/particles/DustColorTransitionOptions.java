...
extends ScalableParticleOptionsBase {
    ...
    public static final MapCodec<DustColorTransitionOptions> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ExtraCodecs.RGB_COLOR_CODEC.fieldOf("from_color")).forGetter(o -> o.fromColor), ((MapCodec)ExtraCodecs.RGB_COLOR_CODEC.fieldOf("to_color")).forGetter(o -> o.toColor), ((MapCodec)SCALE.fieldOf("scale")).forGetter(ScalableParticleOptionsBase::getScale)).apply((Applicative<DustColorTransitionOptions, ?>)i, DustColorTransitionOptions::new));
