...
extends SimpleCriterionTrigger<TriggerInstance> {
    ...
    {
        public static final Codec<TriggerInstance> CODEC = RecordCodecBuilder.create(i -> i.group(EntityPredicate.ADVANCEMENT_CODEC.optionalFieldOf("player").forGetter(TriggerInstance::player)).apply((Applicative<TriggerInstance, ?>)i, TriggerInstance::new));
