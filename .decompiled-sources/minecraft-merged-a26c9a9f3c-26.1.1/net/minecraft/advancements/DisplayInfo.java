...
public class DisplayInfo {
    public static final Codec<DisplayInfo> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)ItemStackTemplate.CODEC.fieldOf("icon")).forGetter(DisplayInfo::getIcon), ((MapCodec)ComponentSerialization.CODEC.fieldOf("title")).forGetter(DisplayInfo::getTitle), ((MapCodec)ComponentSerialization.CODEC.fieldOf("description")).forGetter(DisplayInfo::getDescription), ClientAsset.ResourceTexture.CODEC.optionalFieldOf("background").forGetter(DisplayInfo::getBackground), AdvancementType.CODEC.optionalFieldOf("frame", AdvancementType.TASK).forGetter(DisplayInfo::getType), Codec.BOOL.optionalFieldOf("show_toast", true).forGetter(DisplayInfo::shouldShowToast), Codec.BOOL.optionalFieldOf("announce_to_chat", true).forGetter(DisplayInfo::shouldAnnounceChat), Codec.BOOL.optionalFieldOf("hidden", false).forGetter(DisplayInfo::isHidden)).apply((Applicative<DisplayInfo, ?>)i, DisplayInfo::new));
