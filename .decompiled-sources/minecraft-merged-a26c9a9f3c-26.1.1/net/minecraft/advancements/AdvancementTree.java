...
public class AdvancementTree {
    ...
    private final Map<Identifier, AdvancementNode> nodes = new Object2ObjectOpenHashMap<Identifier, AdvancementNode>();
    private final Set<AdvancementNode> roots = new ObjectLinkedOpenHashSet<AdvancementNode>();
    private final Set<AdvancementNode> tasks = new ObjectLinkedOpenHashSet<AdvancementNode>();
