...
public class IdentifierPattern {
    public static final Codec<IdentifierPattern> CODEC = RecordCodecBuilder.create(i -> i.group(ExtraCodecs.PATTERN.optionalFieldOf("namespace").forGetter(o -> o.namespacePattern), ExtraCodecs.PATTERN.optionalFieldOf("path").forGetter(o -> o.pathPattern)).apply((Applicative<IdentifierPattern, ?>)i, IdentifierPattern::new));
