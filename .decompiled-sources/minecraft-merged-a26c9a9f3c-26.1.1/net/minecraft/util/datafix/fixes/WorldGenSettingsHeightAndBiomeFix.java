...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(NAME, worldGenSettingsType, worldGenSettingsTypeNew, (Typed<?> input) -> {
            OptionalDynamic<?> wasIncreasedOpt = input.get(DSL.remainderFinder()).get(WAS_PREVIOUSLY_INCREASED_KEY);
