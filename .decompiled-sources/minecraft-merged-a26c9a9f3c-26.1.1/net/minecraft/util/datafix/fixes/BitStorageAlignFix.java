...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        OpticFinder<Pair<String, Dynamic<?>>> paletteFinder = DSL.fieldFinder("Palette", DSL.list(blockStateType));
        return this.fixTypeEverywhereTyped("BitStorageAlignFix", chunkType, this.getOutputSchema().getType(References.CHUNK), (Typed<?> chunk) -> chunk.updateTyped(levelFinder, level -> this.updateHeightmaps(BitStorageAlignFix.updateSections(sectionsFinder, sectionFinder, paletteFinder, level))));
    }
