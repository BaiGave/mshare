...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemShulkerBoxColorFix", itemStackType, input -> {
            ...
            if (idOpt.isPresent() && Objects.equals(((Pair)idOpt.get()).getSecond(), "minecraft:shulker_box") && (tagOpt = input.getOptionalTyped(tagF)).isPresent() && (blockEntityOpt = (tag = tagOpt.get()).getOptionalTyped(blockEntityF)).isPresent()) {
