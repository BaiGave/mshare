...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("BeehiveFieldRenameFix", entityType, newEntityType, (Typed<?> input) -> ExtraDataFixUtils.cast(newEntityType, input.updateTyped(beehiveF, beehive -> beehive.update(DSL.remainderFinder(), this::fixBeehive).updateTyped(beesF, bees -> bees.updateTyped(beeF, bee -> bee.update(DSL.remainderFinder(), this::fixBee))))));
    }
}
