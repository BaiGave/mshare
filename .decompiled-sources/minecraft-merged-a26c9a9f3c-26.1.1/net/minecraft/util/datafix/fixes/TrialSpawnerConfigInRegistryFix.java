...
extends NamedEntityFix {
    ...
    public Dynamic<?> fixTag(Dynamic<Tag> input) {
        ...
        Identifier registryLocation = VanillaTrialChambers.CONFIGS_TO_KEY.get(Pair.of(normalConfig.get(), ominousConfig.get()));
    ...
    private static final class VanillaTrialChambers {
        ...
        private static void register(Identifier location, String normalNbt, String ominousNbt) {
            try {
                ...
                CONFIGS_TO_KEY.put(Pair.of(dynamicNormal, VanillaTrialChambers.asDynamic(ominousTag)), location);
                CONFIGS_TO_KEY.put(Pair.of(dynamicNormal, VanillaTrialChambers.asDynamic(ominousMergedTag)), location);
                CONFIGS_TO_KEY.put(Pair.of(dynamicNormal, VanillaTrialChambers.asDynamic(ominousMergedTagDefaultsOmitted)), location);
            }
        ...
        private static Dynamic<Tag> asDynamic(CompoundTag normalTag) {
            return new Dynamic<Tag>(NbtOps.INSTANCE, normalTag);
        }
