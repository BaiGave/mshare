...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), (Typed<?> itemStack) -> itemStack.update(id, newItemType, oldId -> oldId.map(l -> Pair.of(References.ITEM_NAME.typeName(), ItemIdFix.getItem(l)), r -> r)));
    }
}
