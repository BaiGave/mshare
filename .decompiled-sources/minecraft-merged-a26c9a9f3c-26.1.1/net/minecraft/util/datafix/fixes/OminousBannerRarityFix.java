...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(this.fixTypeEverywhereTyped("Ominous Banner block entity common rarity to uncommon rarity fix", blockEntityType, input -> {
            ...
            return blockEntityId.equals("minecraft:banner") ? this.fix((Typed<?>)input, blockEntityComponentsFieldFinder, itemNameFinder, (OpticFinder<Pair<String, String>>)textComponentFinder) : input;
            ...
            return itemStackId.equals("minecraft:white_banner") ? this.fix((Typed<?>)input, itemStackComponentsFieldFinder, itemNameFinder, (OpticFinder<Pair<String, String>>)textComponentFinder) : input;
        }));
    }
