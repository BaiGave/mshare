...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder fixerUpper, FileFixerUpper.Builder fileFixerUpper) {
        ...
        fixerUpper.addFixer(BlockRenameFix.create(v1475, "Flowing fixer", DataFixers.createRenamer(ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava"))));
        ...
        fixerUpper.addFixer(ItemRenameFix.create(v1484, "Rename seagrass items", DataFixers.createRenamer(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
        fixerUpper.addFixer(BlockRenameFix.create(v1484, "Rename seagrass blocks", DataFixers.createRenamer(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
        ...
        fixerUpper.addFixer(ItemRenameFix.create(v1487, "Rename prismarine_brick(s)_* blocks", DataFixers.createRenamer(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
        fixerUpper.addFixer(BlockRenameFix.create(v1487, "Rename prismarine_brick(s)_* items", DataFixers.createRenamer(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
        Schema v1488 = fixerUpper.addSchema(1488, V1488::new);
        fixerUpper.addFixer(BlockRenameFix.create(v1488, "Rename kelp/kelptop", DataFixers.createRenamer(ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant"))));
        ...
        fixerUpper.addFixer(new DataFix(v1488, false){
            ...
            protected TypeRewriteRule makeRule() {
                ...
                OpticFinder<?> componentFinder = DSL.typeFinder(this.getInputSchema().getType(References.TEXT_COMPONENT));
        ...
        fixerUpper.addFixer(ItemRenameFix.create(v1490, "Rename melon_block/melon/speckled_melon", DataFixers.createRenamer(ImmutableMap.of("minecraft:melon_block", "minecraft:melon", "minecraft:melon", "minecraft:melon_slice", "minecraft:speckled_melon", "minecraft:glistering_melon_slice"))));
        ...
        fixerUpper.addFixer(new NamespacedTypeRenameFix(v1502, "Recipes fix", References.RECIPE, DataFixers.createRenamer(RecipesFix.RECIPES)));
        ...
        fixerUpper.addFixer(new NamespacedTypeRenameFix(v1510, "Recipes renamening fix", References.RECIPE, DataFixers.createRenamer(RecipesRenameningFix.RECIPES)));
        ...
        fixerUpper.addFixer(BlockRenameFix.create(v1802, "Rename sign blocks & stone slabs", DataFixers.createRenamer(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign"))));
        fixerUpper.addFixer(ItemRenameFix.create(v1802, "Rename sign item & stone slabs", DataFixers.createRenamer(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign"))));
        ...
        fixerUpper.addFixer(new NamespacedTypeRenameFix(v2100, "Rename sugar recipe", References.RECIPE, DataFixers.createRenamer("minecraft:sugar", "minecraft:sugar_from_sugar_cane")));
        fixerUpper.addFixer(new AdvancementsRenameFix(v2100, false, "Rename sugar recipe advancement", DataFixers.createRenamer("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
        ...
        fixerUpper.addFixer(new AdvancementsRenameFix(v2503, false, "Composter category change", DataFixers.createRenamer("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
        ...
        fixerUpper.addFixer(ItemRenameFix.create(v2508, "Renamed fungi items to fungus", DataFixers.createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        fixerUpper.addFixer(BlockRenameFix.create(v2508, "Renamed fungi blocks to fungus", DataFixers.createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        ...
        fixerUpper.addFixer(ItemRenameFix.create(v2528, "Rename soul fire torch and soul fire lantern", DataFixers.createRenamer(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        fixerUpper.addFixer(BlockRenameFix.create(v2528, "Rename soul fire torch and soul fire lantern", DataFixers.createRenamer(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        ...
        fixerUpper.addFixer(new NamespacedTypeRenameFix(v2552, "Nether biome rename", References.BIOME, DataFixers.createRenamer("minecraft:nether", "minecraft:nether_wastes")));
        Schema v2553 = fixerUpper.addSchema(2553, SAME_NAMESPACED);
        fixerUpper.addFixer(new NamespacedTypeRenameFix(v2553, "Biomes fix", References.BIOME, DataFixers.createRenamer(BiomeFix.BIOMES)));
        ...
        fixerUpper.addFixer(ItemRenameFix.create(v2690, "Renamed copper block items to new oxidized terms", DataFixers.createRenamer(copperBlocksToRename)));
        fixerUpper.addFixer(BlockRenameFix.create(v2690, "Renamed copper blocks to new oxidized terms", DataFixers.createRenamer(copperBlocksToRename)));
        ...
        fixerUpper.addFixer(ItemRenameFix.create(v2691, "Rename copper item suffixes", DataFixers.createRenamer(waxedCopperRename)));
        fixerUpper.addFixer(BlockRenameFix.create(v2691, "Rename copper blocks suffixes", DataFixers.createRenamer(waxedCopperRename)));
        ...
        fixerUpper.addFixer(ItemRenameFix.create(v2696, "Renamed grimstone block items to deepslate", DataFixers.createRenamer(grimstoneBlocksToRename)));
        fixerUpper.addFixer(BlockRenameFix.create(v2696, "Renamed grimstone blocks to deepslate", DataFixers.createRenamer(grimstoneBlocksToRename)));
        Schema v2700 = fixerUpper.addSchema(2700, SAME_NAMESPACED);
        fixerUpper.addFixer(BlockRenameFix.create(v2700, "Renamed cave vines blocks", DataFixers.createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
        ...
        fixerUpper.addFixer(ItemRenameFix.create(v2717, "Rename azalea_leaves_flowers", DataFixers.createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        fixerUpper.addFixer(BlockRenameFix.create(v2717, "Rename azalea_leaves_flowers items", DataFixers.createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        ...
        fixerUpper.addFixer(new NamespacedTypeRenameFix(v2838, "Caves and Cliffs biome renames", References.BIOME, DataFixers.createRenamer(CavesAndCliffsRenames.RENAMES)));
        ...
        fixerUpper.addFixer(new NamespacedTypeRenameFix(v2843, "Remove Deep Warm Ocean", References.BIOME, DataFixers.createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
        Schema v2846 = fixerUpper.addSchema(2846, SAME_NAMESPACED);
        fixerUpper.addFixer(new AdvancementsRenameFix(v2846, false, "Rename some C&C part 2 advancements", DataFixers.createRenamer(ImmutableMap.of("minecraft:husbandry/play_jukebox_in_meadows", "minecraft:adventure/play_jukebox_in_meadows", "minecraft:adventure/caves_and_cliff", "minecraft:adventure/fall_from_world_height", "minecraft:adventure/ride_strider_in_overworld_lava", "minecraft:nether/ride_strider_in_overworld_lava"))));
        ...
        fixerUpper.addFixer(new CriteriaRenameFix(v3086, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", s -> catAdvancementMigrationMap.getOrDefault(s, (String)s)));
        Schema v3087 = fixerUpper.addSchema(3087, SAME_NAMESPACED);
        fixerUpper.addFixer(new EntityVariantFix(v3087, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap(), m -> {
        ...
        fixerUpper.addFixer(new CriteriaRenameFix(v3097, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", s -> renamedCatCriteria.getOrDefault(s, (String)s)));
        ...
        fixerUpper.addFixer(new NamespacedTypeRenameFix(v3440, "Replace experimental 1.20 overworld", References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, DataFixers.createRenamer("minecraft:overworld_update_1_20", "minecraft:overworld")));
        ...
        fixerUpper.addFixer(new RemapChunkStatusFix(v3450, "Remove liquid_carvers and heightmap chunk statuses", DataFixers.createRenamer(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
        ...
        fixerUpper.addFixer(new AttributesRenameLegacy(v3814, "Rename jump strength attribute", DataFixers.createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
        ...
        fixerUpper.addFixer(new BlockEntityFurnaceBurnTimeFix((Schema)v4181, "minecraft:furnace"));
        fixerUpper.addFixer(new BlockEntityFurnaceBurnTimeFix((Schema)v4181, "minecraft:smoker"));
        fixerUpper.addFixer(new BlockEntityFurnaceBurnTimeFix((Schema)v4181, "minecraft:blast_furnace"));
        Schema schema2 = fixerUpper.addSchema(4187, SAME_NAMESPACED);
        fixerUpper.addFixer(new EntityAttributeBaseValueFix((Schema)v4187, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", value -> value == 48.0 ? 16.0 : value));
        fixerUpper.addFixer(new EntityAttributeBaseValueFix((Schema)v4187, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", value -> value == 48.0 ? 16.0 : value));
        fixerUpper.addFixer(new EntityAttributeBaseValueFix((Schema)v4187, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", value -> value == 48.0 ? 16.0 : value));
        fixerUpper.addFixer(new EntityAttributeBaseValueFix((Schema)v4187, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", value -> value == 40.0 ? 16.0 : value));
        fixerUpper.addFixer(new EntityAttributeBaseValueFix((Schema)v4187, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", value -> value == 16.0 ? 12.0 : value));
        fixerUpper.addFixer(new EntityAttributeBaseValueFix((Schema)v4187, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", value -> value == 16.0 ? 24.0 : value));
        Schema schema3 = fixerUpper.addSchema(4290, V4290::new);
        fixerUpper.addFixer(new UnflattenTextComponentFix((Schema)v4290));
        Schema schema4 = fixerUpper.addSchema(4291, SAME_NAMESPACED);
        fixerUpper.addFixer(new LegacyHoverEventFix((Schema)v4291));
        fixerUpper.addFixer(new TextComponentStringifiedFlagsFix((Schema)v4291));
        Schema schema5 = fixerUpper.addSchema(4292, V4292::new);
        fixerUpper.addFixer(new TextComponentHoverAndClickEventFix((Schema)v4292));
        Schema schema6 = fixerUpper.addSchema(4293, SAME_NAMESPACED);
        fixerUpper.addFixer(new DropChancesFormatFix((Schema)v4293));
        Schema schema7 = fixerUpper.addSchema(4294, SAME_NAMESPACED);
        fixerUpper.addFixer(new BlockPropertyRenameAndFix((Schema)v4294, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", value -> value.equals("true") ? "awake" : "uprooted"));
        Schema schema8 = fixerUpper.addSchema(4295, SAME_NAMESPACED);
        fixerUpper.addFixer(new BlendingDataFix((Schema)blendingSchema));
        Schema schema9 = fixerUpper.addSchema(4296, SAME_NAMESPACED);
        fixerUpper.addFixer(new AreaEffectCloudDurationScaleFix((Schema)v4296));
        Schema schema10 = fixerUpper.addSchema(4297, SAME_NAMESPACED);
        fixerUpper.addFixer(new ForcedChunkToTicketFix((Schema)v4297));
        Schema schema11 = fixerUpper.addSchema(4299, SAME_NAMESPACED);
        fixerUpper.addFixer(new EntitySpawnerItemVariantComponentFix((Schema)v4299));
        Schema schema12 = fixerUpper.addSchema(4300, V4300::new);
        fixerUpper.addFixer(new SaddleEquipmentSlotFix((Schema)v4300));
        Schema schema13 = fixerUpper.addSchema(4301, V4301::new);
        fixerUpper.addFixer(new EquipmentFormatFix((Schema)v4301));
        Schema schema14 = fixerUpper.addSchema(4302, V4302::new);
        fixerUpper.addFixer(new AddNewChoices((Schema)v4302, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
        Schema schema15 = fixerUpper.addSchema(4303, SAME_NAMESPACED);
        fixerUpper.addFixer(new EntityFallDistanceFloatToDoubleFix((Schema)v4303, References.ENTITY));
        fixerUpper.addFixer(new EntityFallDistanceFloatToDoubleFix((Schema)v4303, References.PLAYER));
        Schema schema16 = fixerUpper.addSchema(4305, SAME_NAMESPACED);
        fixerUpper.addFixer(new BlockPropertyRenameAndFix((Schema)v4305, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", a -> a));
        Schema schema17 = fixerUpper.addSchema(4306, V4306::new);
        fixerUpper.addFixer(new ThrownPotionSplitFix((Schema)v4306));
        Schema schema18 = fixerUpper.addSchema(4307, V4307::new);
        fixerUpper.addFixer(new TooltipDisplayComponentFix((Schema)v4307));
        Schema schema19 = fixerUpper.addSchema(4309, SAME_NAMESPACED);
        fixerUpper.addFixer(new RaidRenamesDataFix((Schema)v4309));
        fixerUpper.addFixer(new ChunkTicketUnpackPosFix((Schema)v4309));
        Schema schema20 = fixerUpper.addSchema(4311, SAME_NAMESPACED);
        fixerUpper.addFixer(new AdvancementsRenameFix((Schema)v4311, false, "Use lodestone category change", DataFixers.createRenamer("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")));
        Schema schema21 = fixerUpper.addSchema(4312, V4312::new);
        fixerUpper.addFixer(new PlayerEquipmentFix((Schema)v4312));
        Schema schema22 = fixerUpper.addSchema(4314, SAME_NAMESPACED);
        fixerUpper.addFixer(new InlineBlockPosFormatFix((Schema)v4314));
        Schema schema23 = fixerUpper.addSchema(4420, V4420::new);
        fixerUpper.addFixer(new NamedEntityConvertUncheckedFix((Schema)v4420, "AreaEffectCloudCustomParticleFix", References.ENTITY, "minecraft:area_effect_cloud"));
        Schema schema24 = fixerUpper.addSchema(4421, V4421::new);
        fixerUpper.addFixer(new AddNewChoices((Schema)v4421, "Added Happy Ghast", References.ENTITY));
        Schema schema25 = fixerUpper.addSchema(4424, SAME_NAMESPACED);
        fixerUpper.addFixer(new FeatureFlagRemoveFix((Schema)v4424, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
        fixerUpper.addFixer(new AddFieldFix((Schema)v4424, References.PLAYER, "style", field -> field.createString("minecraft:default"), "locator_bar_icon"));
        fixerUpper.addFixer(new AddFieldFix((Schema)v4424, References.ENTITY, "style", field -> field.createString("minecraft:default"), "locator_bar_icon"));
        Schema schema26 = fixerUpper.addSchema(4531, V4531::new);
        fixerUpper.addFixer(new AddNewChoices((Schema)v4531, "Added Copper Golem", References.ENTITY));
        Schema schema27 = fixerUpper.addSchema(4532, V4532::new);
        fixerUpper.addFixer(new AddNewChoices((Schema)v4532, "Added Copper Golem Statue Block Entity", References.BLOCK_ENTITY));
        Schema schema28 = fixerUpper.addSchema(4533, V4533::new);
        fixerUpper.addFixer(new AddNewChoices((Schema)v4533, "Added Shelf", References.BLOCK_ENTITY));
        Schema schema29 = fixerUpper.addSchema(4535, SAME_NAMESPACED);
        fixerUpper.addFixer(new CopperGolemWeatherStateFix((Schema)v4535));
        Schema schema30 = fixerUpper.addSchema(4537, SAME_NAMESPACED);
        fixerUpper.addFixer(new ChunkDeleteLightFix((Schema)v4537));
        ...
        fixerUpper.addFixer(new AddNewChoices((Schema)v4543, "Added Mannequin", References.ENTITY));
        Schema schema33 = fixerUpper.addSchema(4544, SAME_NAMESPACED);
        fixerUpper.addFixer(new LegacyWorldBorderFix((Schema)v4544));
        Schema schema34 = fixerUpper.addSchema(4548, SAME_NAMESPACED);
        fixerUpper.addFixer(new WorldSpawnDataFix((Schema)v4548));
        fixerUpper.addFixer(new PlayerRespawnDataFix((Schema)v4548));
        Schema schema35 = fixerUpper.addSchema(4648, V4648::new);
        fixerUpper.addFixer(new AddNewChoices((Schema)v4648, "Added Nautilus and Zombie Nautilus", References.ENTITY));
        Schema schema36 = fixerUpper.addSchema(4649, SAME_NAMESPACED);
        fixerUpper.addFixer(new TridentAnimationFix((Schema)v4649));
        Schema schema37 = fixerUpper.addSchema(4650, SAME_NAMESPACED);
        fixerUpper.addFixer(new DebugProfileOverlayReferenceFix((Schema)v4650));
        Schema schema38 = fixerUpper.addSchema(4651, SAME_NAMESPACED);
        fixerUpper.addFixer(new OptionsGraphicsModeSplitFix((Schema)v4651, "cutoutLeaves", "false", "true", "true"));
        fixerUpper.addFixer(new OptionsGraphicsModeSplitFix((Schema)v4651, "weatherRadius", "5", "10", "10"));
        fixerUpper.addFixer(new OptionsGraphicsModeSplitFix((Schema)v4651, "vignette", "false", "true", "true"));
        fixerUpper.addFixer(new OptionsGraphicsModeSplitFix((Schema)v4651, "improvedTransparency", "false", "false", "true"));
        fixerUpper.addFixer(new OptionsSetGraphicsPresetToCustomFix((Schema)v4651));
        Schema schema39 = fixerUpper.addSchema(4656, V4656::new);
        fixerUpper.addFixer(new AddNewChoices((Schema)v4656, "Added Parched and Camel Husk", References.ENTITY));
        Schema schema40 = fixerUpper.addSchema(4657, SAME_NAMESPACED);
        fixerUpper.addFixer(new WorldBorderWarningTimeFix((Schema)v4657));
        Schema schema41 = fixerUpper.addSchema(4658, SAME_NAMESPACED);
        fixerUpper.addFixer(new GameRuleRegistryFix((Schema)v4658));
        Schema schema42 = fixerUpper.addSchema(4661, SAME_NAMESPACED);
        fixerUpper.addFixer(new OptionsMusicToastFix((Schema)v4661, false));
        Schema schema43 = fixerUpper.addSchema(4763, SAME_NAMESPACED);
        fixerUpper.addFixer(new DebugProfileLookingAtSplitFix((Schema)v4763));
        fixerUpper.addFixer(new VillagerSetVillagerDataFinalized((Schema)v4763));
        fixerUpper.addFixer(new ZombieVillagerSetVillagerDataFinalized((Schema)v4763));
        Schema schema44 = fixerUpper.addSchema(4766, SAME_NAMESPACED);
        fixerUpper.addFixer(new DayTimeToClockFix((Schema)v4766));
        Schema schema45 = fixerUpper.addSchema(4769, SAME_NAMESPACED);
        fixerUpper.addFixer(new NamespacedTypeRenameFix((Schema)v4769, "Rename stonecutter recipes", References.RECIPE, DataFixers.createRenamer(StonecutterRecipeRenameFix.RECIPE_RENAMES)));
        fixerUpper.addFixer(new AdvancementsRenameFix((Schema)v4769, false, "Rename stonecutter recipe advancements", DataFixers.createRenamer(StonecutterRecipeRenameFix.ADVANCEMENT_RENAMES)));
        Schema schema46 = fixerUpper.addSchema(4771, V4771::new);
        fixerUpper.addFixer(new LevelDatDifficultyFix((Schema)v4771));
        fixerUpper.addFixer(new LevelDatToSavedDataPreparationFix((Schema)v4771));
