...
extends NamespacedSchema {
    ...
    protected static final Hook.HookFunction ADD_NAMES = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> ops, T value) {
            return V99.addNames(new Dynamic<T>(ops, value), V704.ITEM_TO_BLOCKENTITY, ITEM_TO_ENTITY);
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:arrow", (String name) -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(map, "minecraft:chest_minecart", (String name) -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), "Items", DSL.list(References.ITEM_STACK.in(schema))));
        V705.registerMob(schema, map, "minecraft:chicken");
        schema.register(map, "minecraft:commandblock_minecart", (String name) -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), "LastOutput", References.TEXT_COMPONENT.in(schema)));
        ...
        schema.register(map, "minecraft:enderman", (String name) -> DSL.optionalFields("carried", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(map, "minecraft:falling_block", (String name) -> DSL.optionalFields("Block", References.BLOCK_NAME.in(schema), "TileEntityData", References.BLOCK_ENTITY.in(schema)));
        ...
        schema.register(map, "minecraft:furnace_minecart", (String name) -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(map, "minecraft:hopper_minecart", (String name) -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), "Items", DSL.list(References.ITEM_STACK.in(schema))));
        ...
        schema.register(map, "minecraft:minecart", (String name) -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(map, "minecraft:potion", (String name) -> DSL.optionalFields("Potion", References.ITEM_STACK.in(schema), "inTile", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(map, "minecraft:spawner_minecart", (String name) -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), References.UNTAGGED_SPAWNER.in(schema)));
        schema.register(map, "minecraft:spectral_arrow", (String name) -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(map, "minecraft:tnt_minecart", (String name) -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema)));
    ...
    public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
        ...
        schema.registerType(true, References.ENTITY, () -> DSL.and(References.ENTITY_EQUIPMENT.in(schema), DSL.optionalFields("CustomName", DSL.constType(DSL.string()), DSL.taggedChoiceLazy("id", V705.namespacedString(), entityTypes))));
