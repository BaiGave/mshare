...
extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:area_effect_cloud", (String name) -> DSL.optionalFields("Particle", References.PARTICLE.in(schema)));
        V1460.registerMob(schema, map, "minecraft:armor_stand");
        schema.register(map, "minecraft:arrow", (String name) -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(schema)));
        ...
        schema.register(map, "minecraft:chest_minecart", (String name) -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema), "Items", DSL.list(References.ITEM_STACK.in(schema))));
        V1460.registerMob(schema, map, "minecraft:chicken");
        schema.register(map, "minecraft:commandblock_minecart", (String name) -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema), "LastOutput", References.TEXT_COMPONENT.in(schema)));
        V1460.registerMob(schema, map, "minecraft:cow");
        V1460.registerMob(schema, map, "minecraft:creeper");
        schema.register(map, "minecraft:donkey", (String name) -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema)));
        ...
        schema.register(map, "minecraft:enderman", (String name) -> DSL.optionalFields("carriedBlockState", References.BLOCK_STATE.in(schema)));
        ...
        schema.register(map, "minecraft:falling_block", (String name) -> DSL.optionalFields("BlockState", References.BLOCK_STATE.in(schema), "TileEntityData", References.BLOCK_ENTITY.in(schema)));
        schema.registerSimple(map, "minecraft:fireball");
        schema.register(map, "minecraft:fireworks_rocket", (String name) -> DSL.optionalFields("FireworksItem", References.ITEM_STACK.in(schema)));
        schema.register(map, "minecraft:furnace_minecart", (String name) -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema)));
        ...
        schema.register(map, "minecraft:hopper_minecart", (String name) -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema), "Items", DSL.list(References.ITEM_STACK.in(schema))));
        schema.register(map, "minecraft:horse", (String name) -> DSL.optionalFields("ArmorItem", References.ITEM_STACK.in(schema), "SaddleItem", References.ITEM_STACK.in(schema)));
        V1460.registerMob(schema, map, "minecraft:husk");
        V1460.registerMob(schema, map, "minecraft:illusion_illager");
        schema.register(map, "minecraft:item", (String name) -> DSL.optionalFields("Item", References.ITEM_STACK.in(schema)));
        schema.register(map, "minecraft:item_frame", (String name) -> DSL.optionalFields("Item", References.ITEM_STACK.in(schema)));
        schema.registerSimple(map, "minecraft:leash_knot");
        schema.register(map, "minecraft:llama", (String name) -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema), "DecorItem", References.ITEM_STACK.in(schema)));
        schema.registerSimple(map, "minecraft:llama_spit");
        V1460.registerMob(schema, map, "minecraft:magma_cube");
        schema.register(map, "minecraft:minecart", (String name) -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema)));
        V1460.registerMob(schema, map, "minecraft:mooshroom");
        schema.register(map, "minecraft:mule", (String name) -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema)));
        ...
        schema.register(map, "minecraft:potion", (String name) -> DSL.optionalFields("Potion", References.ITEM_STACK.in(schema)));
        ...
        schema.register(map, "minecraft:skeleton_horse", (String name) -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema)));
        ...
        schema.register(map, "minecraft:spawner_minecart", (String name) -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema), References.UNTAGGED_SPAWNER.in(schema)));
        schema.register(map, "minecraft:spectral_arrow", (String name) -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(schema)));
        ...
        schema.register(map, "minecraft:tnt_minecart", (String name) -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema)));
        V1460.registerMob(schema, map, "minecraft:vex");
        schema.register(map, "minecraft:villager", (String name) -> DSL.optionalFields("Inventory", DSL.list(References.ITEM_STACK.in(schema)), "Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in(schema)))));
        ...
        schema.register(map, "minecraft:zombie_horse", (String name) -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema)));
        V1460.registerMob(schema, map, "minecraft:zombie_pigman");
        schema.register(map, "minecraft:zombie_villager", (String name) -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in(schema)))));
        return map;
    }
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:jukebox", (String name) -> DSL.optionalFields("RecordItem", References.ITEM_STACK.in(schema)));
        ...
        schema.register(map, "minecraft:mob_spawner", (String name) -> References.UNTAGGED_SPAWNER.in(schema));
        schema.register(map, "minecraft:piston", (String name) -> DSL.optionalFields("blockState", References.BLOCK_STATE.in(schema)));
    ...
    public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
        ...
        schema.registerType(true, References.BLOCK_ENTITY, () -> DSL.optionalFields("components", References.DATA_COMPONENTS.in(schema), DSL.taggedChoiceLazy("id", V1460.namespacedString(), blockEntityTypes)));
        ...
        schema.registerType(true, References.ENTITY, () -> DSL.and(References.ENTITY_EQUIPMENT.in(schema), DSL.optionalFields("CustomName", References.TEXT_COMPONENT.in(schema), DSL.taggedChoiceLazy("id", V1460.namespacedString(), entityTypes))));
        ...
        schema.registerType(false, References.STATS, () -> DSL.optionalFields("stats", DSL.optionalFields(Pair.of("minecraft:mined", DSL.compoundList(References.BLOCK_NAME.in(schema), DSL.constType(DSL.intType()))), Pair.of("minecraft:crafted", (TypeTemplate)itemStats.get()), Pair.of("minecraft:used", (TypeTemplate)itemStats.get()), Pair.of("minecraft:broken", (TypeTemplate)itemStats.get()), Pair.of("minecraft:picked_up", (TypeTemplate)itemStats.get()), Pair.of("minecraft:dropped", (TypeTemplate)itemStats.get()), Pair.of("minecraft:killed", DSL.compoundList(References.ENTITY_NAME.in(schema), DSL.constType(DSL.intType()))), Pair.of("minecraft:killed_by", DSL.compoundList(References.ENTITY_NAME.in(schema), DSL.constType(DSL.intType()))), Pair.of("minecraft:custom", DSL.compoundList(DSL.constType(V1460.namespacedString()), DSL.constType(DSL.intType()))))));
