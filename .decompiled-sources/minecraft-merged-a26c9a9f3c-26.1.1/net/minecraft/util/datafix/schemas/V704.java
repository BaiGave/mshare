...
extends Schema {
    ...
    protected static final Hook.HookFunction ADD_NAMES = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> ops, T value) {
            return V99.addNames(new Dynamic<T>(ops, value), ITEM_TO_BLOCKENTITY, V99.ITEM_TO_ENTITY);
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        BlockEntityIdFix.ID_MAP.forEach((oldId, newId) -> map.put((String)newId, Objects.requireNonNull((Supplier)map.remove(oldId), () -> "Didn't find " + oldId + " in schema")));
        return map;
    }
