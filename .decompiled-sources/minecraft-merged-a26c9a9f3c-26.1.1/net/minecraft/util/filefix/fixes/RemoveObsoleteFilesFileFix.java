...
extends FileFix {
    ...
    public void makeFixer() {
        ...
        Streams.concat(LegacyStructureFileFix.OVERWORLD_LEGACY_STRUCTURES.stream(), Stream.of("Village"), LegacyStructureFileFix.NETHER_LEGACY_STRUCTURES.stream(), LegacyStructureFileFix.END_LEGACY_STRUCTURES.stream()).forEach(leftoverStructure -> {
