...
TestPosFinder {
    ...
    public static class Builder {
        ...
        public TestFinder failedTests(CommandContext<CommandSourceStack> sourceStack, boolean onlyRequiredTests) {
            return this.build(sourceStack.getSource(), () -> FailedTestTracker.getLastFailedTests().filter(test -> !onlyRequiredTests || ((GameTestInstance)test.value()).required()), NO_STRUCTURES);
        }
        ...
        public TestFinder byResourceSelection(CommandContext<CommandSourceStack> sourceStack, Collection<Holder.Reference<GameTestInstance>> holders) {
            return this.build(sourceStack.getSource(), holders::stream, NO_STRUCTURES);
        }
