...
public interface TestEnvironmentDefinition<SavedDataType> {
    ...
    {
        public static final MapCodec<AllOf> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.listOf().fieldOf("definitions")).forGetter(AllOf::definitions)).apply((Applicative<AllOf, ?>)i, AllOf::new));
    ...
    {
        public static final MapCodec<SetGameRules> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)GameRuleMap.CODEC.fieldOf("rules")).forGetter(SetGameRules::gameRulesMap)).apply((Applicative<SetGameRules, ?>)i, SetGameRules::new));
    ...
    {
        public static final MapCodec<ClockTime> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)WorldClock.CODEC.fieldOf("clock")).forGetter(ClockTime::clock), ((MapCodec)ExtraCodecs.NON_NEGATIVE_INT.fieldOf("time")).forGetter(ClockTime::time)).apply((Applicative<ClockTime, ?>)i, ClockTime::new));
    ...
    {
        public static final MapCodec<Timelines> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Timeline.CODEC.listOf().fieldOf("timelines")).forGetter(Timelines::timelines)).apply((Applicative<Timelines, ?>)i, Timelines::new));
    ...
    {
        public static final MapCodec<Weather> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Type.CODEC.fieldOf("weather")).forGetter(Weather::weather)).apply((Applicative<Weather, ?>)i, Weather::new));
    ...
    public record Functions(Optional<Identifier> setupFunction, Optional<Identifier> teardownFunction) implements TestEnvironmentDefinition<Unit>
    {
        ...
        public static final MapCodec<Functions> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Identifier.CODEC.optionalFieldOf("setup").forGetter(Functions::setupFunction), Identifier.CODEC.optionalFieldOf("teardown").forGetter(Functions::teardownFunction)).apply((Applicative<Functions, ?>)i, Functions::new));
