...
extends GameTestInstance {
    public static final MapCodec<FunctionGameTestInstance> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ResourceKey.codec(Registries.TEST_FUNCTION).fieldOf("function")).forGetter(FunctionGameTestInstance::function), TestData.CODEC.forGetter(GameTestInstance::info)).apply((Applicative<FunctionGameTestInstance, ?>)i, FunctionGameTestInstance::new));
