...
public class TreeFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        FeatureUtils.register(context, JUNGLE_TREE, Feature.TREE, TreeFeatures.createJungleTree().decorators(ImmutableList.of(new CocoaDecorator(0.2f), TrunkVineDecorator.INSTANCE, new LeaveVineDecorator(0.25f))).ignoreVines().build());
        ...
        FeatureUtils.register(context, SUPER_BIRCH_BEES_0002, Feature.TREE, TreeFeatures.createSuperBirch().decorators(ImmutableList.of(beehive0002)).build());
        FeatureUtils.register(context, SUPER_BIRCH_BEES, Feature.TREE, TreeFeatures.createSuperBirch().decorators(ImmutableList.of(beehive)).build());
        FeatureUtils.register(context, SWAMP_OAK, Feature.TREE, TreeFeatures.createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(ImmutableList.of(new LeaveVineDecorator(0.25f))).build());
        ...
        FeatureUtils.register(context, OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createOak().decorators(ImmutableList.of(sparseLeafLitter, thickLeafLitter)).build());
        FeatureUtils.register(context, DARK_OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createDarkOak().ignoreVines().decorators(ImmutableList.of(sparseLeafLitter, thickLeafLitter)).build());
        FeatureUtils.register(context, BIRCH_LEAF_LITTER, Feature.TREE, TreeFeatures.createBirch().decorators(ImmutableList.of(sparseLeafLitter, thickLeafLitter)).build());
