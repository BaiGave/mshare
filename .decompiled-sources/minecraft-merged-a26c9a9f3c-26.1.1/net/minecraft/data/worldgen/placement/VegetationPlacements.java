...
public class VegetationPlacements {
    ...
    private static ImmutableList.Builder<PlacementModifier> treePlacementBase(PlacementModifier frequency) {
        return ((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().add(frequency)).add(InSquarePlacement.spread())).add(TREE_THRESHOLD)).add(PlacementUtils.HEIGHTMAP_OCEAN_FLOOR)).add(BiomeFilter.biome());
    }
    ...
    public static List<PlacementModifier> treePlacement(PlacementModifier frequency, Block sapling) {
        return ((ImmutableList.Builder)VegetationPlacements.treePlacementBase(frequency).add((Object)BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(sapling.defaultBlockState(), BlockPos.ZERO)))).build();
    }
