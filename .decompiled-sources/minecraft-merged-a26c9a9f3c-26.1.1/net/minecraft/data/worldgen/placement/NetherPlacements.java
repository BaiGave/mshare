...
public class NetherPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> crimsonRoots = configuredFeatures.getOrThrow(NetherFeatures.CRIMSON_ROOTS);
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> soulFire = configuredFeatures.getOrThrow(NetherFeatures.SOUL_FIRE);
        Holder.Reference<ConfiguredFeature<?, ?>> fire = configuredFeatures.getOrThrow(NetherFeatures.FIRE);
        ...
        PlacementUtils.register(context, PATCH_SOUL_FIRE, soulFire, NetherPlacements.firePlacement(Blocks.SOUL_SOIL));
        PlacementUtils.register(context, PATCH_FIRE, fire, NetherPlacements.firePlacement(Blocks.NETHERRACK));
    }
