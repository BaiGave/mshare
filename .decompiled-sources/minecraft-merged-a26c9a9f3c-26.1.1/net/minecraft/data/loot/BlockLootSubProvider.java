...
FabricBlockLootSubProvider {
    ...
    public static LootTable.Builder createSelfDropDispatchTable(Block original, LootItemCondition.Builder condition, LootPoolEntryContainer.Builder<?> entry) {
    ...
    public final LootTable.Builder createSilkTouchOnlyTable(ItemLike drop) {
    ...
    public final LootTable.Builder createPotFlowerItemTable(ItemLike flower) {
    ...
    public <T extends Comparable<T> & StringRepresentable> LootTable.Builder createSinglePropConditionTable(Block drop, Property<T> property, T value) {
    ...
    public LootTable.Builder createLeavesDrops(Block original, Block sapling, float ... saplingChances) {
        HolderGetter enchantments = this.registries.lookupOrThrow(Registries.ENCHANTMENT);
    ...
    public LootTable.Builder createOakLeavesDrops(Block original, Block sapling, float ... saplingChances) {
        HolderGetter enchantments = this.registries.lookupOrThrow(Registries.ENCHANTMENT);
    ...
    public LootTable.Builder createCropDrops(Block original, Item cropDrop, Item seedDrop, LootItemCondition.Builder isMaxAge) {
        HolderGetter enchantments = this.registries.lookupOrThrow(Registries.ENCHANTMENT);
    ...
    public static LootTable.Builder createCandleCakeDrops(Block candle) {
