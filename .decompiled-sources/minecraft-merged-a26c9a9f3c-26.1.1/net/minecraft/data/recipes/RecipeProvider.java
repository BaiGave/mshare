...
public abstract class RecipeProvider {
    ...
    public final <T extends AbstractCookingRecipe> void oreCooking(AbstractCookingRecipe.Factory<T> factory, List<ItemLike> smeltables, RecipeCategory craftingCategory, CookingBookCategory cookingCategory, ItemLike result, float experience, int cookingTime, String group, String fromDesc) {
    ...
    public final RecipeBuilder buttonBuilder(ItemLike result, Ingredient base) {
    ...
    public final RecipeBuilder fenceBuilder(ItemLike result, Ingredient base) {
    ...
    public final RecipeBuilder fenceGateBuilder(ItemLike result, Ingredient planks) {
    ...
    public final RecipeBuilder pressurePlateBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
    ...
    public final RecipeBuilder signBuilder(ItemLike result, Ingredient planks) {
    ...
    public final RecipeBuilder wallBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
        return this.shaped(category, result, 6).define(Character.valueOf('#'), base).pattern("###").pattern("###");
    }

    public final RecipeBuilder bricksBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
        return this.shaped(category, result, 4).define(Character.valueOf('#'), base).pattern("##").pattern("##");
    }

    public final RecipeBuilder tilesBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
        return this.shaped(category, result, 4).define(Character.valueOf('#'), base).pattern("##").pattern("##");
    }
    ...
    public final RecipeBuilder polishedBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
    ...
    public final ShapedRecipeBuilder cutBuilder(RecipeCategory category, ItemLike result, Ingredient base) {
        return this.shaped(category, result, 4).define(Character.valueOf('#'), base).pattern("##").pattern("##");
    }
    ...
    public final void smeltingResultFromBase(ItemLike result, ItemLike base) {
    ...
    public final void nineBlockStorageRecipes(RecipeCategory unpackedFormCategory, ItemLike unpackedForm, RecipeCategory packedFormCategory, ItemLike packedForm, String packingRecipeId, @Nullable String packingRecipeGroup, String unpackingRecipeId, @Nullable String unpackingRecipeGroup) {
    ...
    public final <T extends AbstractCookingRecipe> void simpleCookingRecipe(String source, AbstractCookingRecipe.Factory<T> factory, int cookingTime, ItemLike base, ItemLike result, float experience) {
    ...
    public void waxRecipes(FeatureFlagSet flagSet) {
        HoneycombItem.WAXABLES.get().forEach((block, waxedBlock) -> {
            ...
            Pair<RecipeCategory, String> pair = HoneycombItem.WAXED_RECIPES.getOrDefault(waxedBlock, Pair.of(RecipeCategory.BUILDING_BLOCKS, RecipeProvider.getItemName(waxedBlock)));
    ...
    public final void generateCraftingRecipe(BlockFamily family, BlockFamily.Variant variant, Block result, ItemLike base) {
    ...
    public final void generateStonecutterRecipe(BlockFamily family, BlockFamily.Variant variant, Block base) {
    ...
    public final Block getBaseBlockForCrafting(BlockFamily family, BlockFamily.Variant variant) {
    ...
    public final Criterion<InventoryChangeTrigger.TriggerInstance> has(MinMaxBounds.Ints count, ItemLike item) {
