...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArgumentAcceptingOptionSpec<String> inputOption = parser.accepts("input", "Input folder").withRequiredArg();
        ...
        List<Path> input = optionSet.valuesOf(inputOption).stream().map(x$0 -> Paths.get(x$0, new String[0])).toList();
