...
implements DataProvider {
    ...
    public <T> PackMetadataGenerator add(MetadataSectionType<T> type, T value) {
        this.elements.put(type.name(), () -> type.codec().encodeStart(JsonOps.INSTANCE, (JsonElement)value).getOrThrow(IllegalArgumentException::new).getAsJsonObject());
        return this;
    }
    ...
    public CompletableFuture<?> run(CachedOutput cache) {
        ...
        this.elements.forEach((id, data) -> result.add((String)id, (JsonElement)data.get()));
