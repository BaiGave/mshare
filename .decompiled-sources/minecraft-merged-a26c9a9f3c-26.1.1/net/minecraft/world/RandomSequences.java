...
extends SavedData {
    public static final Codec<RandomSequences> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Codec.INT.fieldOf("salt")).forGetter(RandomSequences::salt), Codec.BOOL.optionalFieldOf("include_world_seed", true).forGetter(RandomSequences::includeWorldSeed), Codec.BOOL.optionalFieldOf("include_sequence_id", true).forGetter(RandomSequences::includeSequenceId), ((MapCodec)Codec.unboundedMap(Identifier.CODEC, RandomSequence.CODEC).fieldOf("sequences")).forGetter(rs -> rs.sequences)).apply((Applicative<RandomSequences, ?>)i, RandomSequences::new));
