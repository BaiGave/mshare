...
public class RandomSequence {
    public static final Codec<RandomSequence> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)XoroshiroRandomSource.CODEC.fieldOf("source")).forGetter(r -> r.source)).apply((Applicative<RandomSequence, ?>)i, RandomSequence::new));
