...
public class DamageSources {
    ...
    public final DamageSource source(ResourceKey<DamageType> key) {
        return new DamageSource(this.damageTypes.getOrThrow(key));
    }

    public final DamageSource source(ResourceKey<DamageType> key, @Nullable Entity cause) {
        return new DamageSource(this.damageTypes.getOrThrow(key), cause);
    }

    public final DamageSource source(ResourceKey<DamageType> key, @Nullable Entity directEntity, @Nullable Entity causingEntity) {
