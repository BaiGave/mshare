...
public record TeleportRandomlyConsumeEffect(float diameter) implements ConsumeEffect
{
    ...
    public static final MapCodec<TeleportRandomlyConsumeEffect> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(ExtraCodecs.POSITIVE_FLOAT.optionalFieldOf("diameter", Float.valueOf(16.0f)).forGetter(TeleportRandomlyConsumeEffect::diameter)).apply((Applicative<TeleportRandomlyConsumeEffect, ?>)i, TeleportRandomlyConsumeEffect::new));
