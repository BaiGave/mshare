...
implements TooltipComponent {
    ...
    private static DataResult<Fraction> computeContentWeight(List<? extends ItemInstance> items) {
        try {
            ...
            for (ItemInstance itemInstance : items) {
                ...
                weight = weight.add(itemWeight.getOrThrow().multiplyBy(Fraction.getFraction(itemInstance.count(), 1)));
            }
    ...
    public static class Mutable {
        ...
        public BundleContents toImmutable() {
            ...
            return new BundleContents((List<ItemStackTemplate>)((Object)builder.build()), this.selectedItem);
        }
    }
}
