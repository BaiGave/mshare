...
public record AttackRange(float minReach, float maxReach, float minCreativeReach, float maxCreativeReach, float hitboxMargin, float mobFactor) {
    public static final Codec<AttackRange> CODEC = RecordCodecBuilder.create(i -> i.group(ExtraCodecs.floatRange(0.0f, 64.0f).optionalFieldOf("min_reach", Float.valueOf(0.0f)).forGetter(AttackRange::minReach), ExtraCodecs.floatRange(0.0f, 64.0f).optionalFieldOf("max_reach", Float.valueOf(3.0f)).forGetter(AttackRange::maxReach), ExtraCodecs.floatRange(0.0f, 64.0f).optionalFieldOf("min_creative_reach", Float.valueOf(0.0f)).forGetter(AttackRange::minCreativeReach), ExtraCodecs.floatRange(0.0f, 64.0f).optionalFieldOf("max_creative_reach", Float.valueOf(5.0f)).forGetter(AttackRange::maxCreativeReach), ExtraCodecs.floatRange(0.0f, 1.0f).optionalFieldOf("hitbox_margin", Float.valueOf(0.3f)).forGetter(AttackRange::hitboxMargin), Codec.floatRange(0.0f, 2.0f).optionalFieldOf("mob_factor", Float.valueOf(1.0f)).forGetter(AttackRange::mobFactor)).apply((Applicative<AttackRange, ?>)i, AttackRange::new));
