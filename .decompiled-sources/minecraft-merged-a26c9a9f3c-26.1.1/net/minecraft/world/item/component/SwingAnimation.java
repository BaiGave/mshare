...
public record SwingAnimation(SwingAnimationType type, int duration) {
    ...
    public static final Codec<SwingAnimation> CODEC = RecordCodecBuilder.create(i -> i.group(SwingAnimationType.CODEC.optionalFieldOf("type", SwingAnimation.DEFAULT.type).forGetter(SwingAnimation::type), ExtraCodecs.POSITIVE_INT.optionalFieldOf("duration", SwingAnimation.DEFAULT.duration).forGetter(SwingAnimation::duration)).apply((Applicative<SwingAnimation, ?>)i, SwingAnimation::new));
