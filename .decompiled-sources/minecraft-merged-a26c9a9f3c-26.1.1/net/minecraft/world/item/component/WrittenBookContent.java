...
TooltipProvider
{
    ...
    public @Nullable WrittenBookContent resolve(ResolutionContext context, HolderLookup.Provider registries) {
        ...
        ImmutableList.Builder newPages = ImmutableList.builderWithExpectedSize(this.pages.size());
        ...
        return new WrittenBookContent(this.title, this.author, this.generation, (List<Filterable<Component>>)((Object)newPages.build()), true);
    }
    ...
    private static boolean isPageTooLarge(Component page, HolderLookup.Provider registries) {
        ...
        return json.isSuccess() && GsonHelper.encodesLongerThan(json.getOrThrow(), Short.MAX_VALUE);
    }
