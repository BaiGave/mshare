...
public class Items {
    ...
    public static final Item NETHER_STAR = Items.registerItem("nether_star", new Item.Properties().rarity(Rarity.RARE).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).delayedComponent(DataComponents.DAMAGE_RESISTANT, context -> new DamageResistant(context.getOrThrow(DamageTypeTags.IS_EXPLOSION))));
    ...
    public static final Item STONE_SPEAR = Items.registerItem("stone_spear", new Item.Properties().spear(ToolMaterial.STONE, 0.75f, 0.82f, 0.7f, 4.5f, 13.0f, 9.0f, 5.1f, 13.75f, 4.6f));
    public static final Item COPPER_SPEAR = Items.registerItem("copper_spear", new Item.Properties().spear(ToolMaterial.COPPER, 0.85f, 0.82f, 0.65f, 4.0f, 12.0f, 8.25f, 5.1f, 12.5f, 4.6f));
    public static final Item IRON_SPEAR = Items.registerItem("iron_spear", new Item.Properties().spear(ToolMaterial.IRON, 0.95f, 0.95f, 0.6f, 2.5f, 11.0f, 6.75f, 5.1f, 11.25f, 4.6f));
    public static final Item GOLDEN_SPEAR = Items.registerItem("golden_spear", new Item.Properties().spear(ToolMaterial.GOLD, 0.95f, 0.7f, 0.7f, 3.5f, 13.0f, 8.5f, 5.1f, 13.75f, 4.6f));
    public static final Item DIAMOND_SPEAR = Items.registerItem("diamond_spear", new Item.Properties().spear(ToolMaterial.DIAMOND, 1.05f, 1.075f, 0.5f, 3.0f, 10.0f, 6.5f, 5.1f, 10.0f, 4.6f));
    public static final Item NETHERITE_SPEAR = Items.registerItem("netherite_spear", new Item.Properties().spear(ToolMaterial.NETHERITE, 1.15f, 1.2f, 0.4f, 2.5f, 9.0f, 5.5f, 5.1f, 8.75f, 4.6f).fireResistant());
    ...
    public static final Item FLOWER_BANNER_PATTERN = Items.registerItem("flower_banner_pattern", new Item.Properties().stacksTo(1).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_FLOWER)));
    public static final Item CREEPER_BANNER_PATTERN = Items.registerItem("creeper_banner_pattern", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_CREEPER)));
    public static final Item SKULL_BANNER_PATTERN = Items.registerItem("skull_banner_pattern", new Item.Properties().stacksTo(1).rarity(Rarity.RARE).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_SKULL)));
    public static final Item MOJANG_BANNER_PATTERN = Items.registerItem("mojang_banner_pattern", new Item.Properties().stacksTo(1).rarity(Rarity.RARE).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_MOJANG)));
    public static final Item GLOBE_BANNER_PATTERN = Items.registerItem("globe_banner_pattern", new Item.Properties().stacksTo(1).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_GLOBE)));
    public static final Item PIGLIN_BANNER_PATTERN = Items.registerItem("piglin_banner_pattern", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_PIGLIN)));
    public static final Item FLOW_BANNER_PATTERN = Items.registerItem("flow_banner_pattern", new Item.Properties().stacksTo(1).rarity(Rarity.RARE).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_FLOW)));
    public static final Item GUSTER_BANNER_PATTERN = Items.registerItem("guster_banner_pattern", new Item.Properties().stacksTo(1).rarity(Rarity.RARE).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_GUSTER)));
    public static final Item FIELD_MASONED_BANNER_PATTERN = Items.registerItem("field_masoned_banner_pattern", new Item.Properties().stacksTo(1).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_FIELD_MASONED)));
    public static final Item BORDURE_INDENTED_BANNER_PATTERN = Items.registerItem("bordure_indented_banner_pattern", new Item.Properties().stacksTo(1).delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(BannerPatternTags.PATTERN_ITEM_BORDURE_INDENTED)));
    ...
    private static Item registerBlock(Block block, BiFunction<Block, Item.Properties, Item> itemFactory, Item.Properties properties) {
        return Items.registerItem(Items.blockIdToItemId(block.builtInRegistryHolder().key()), (Item.Properties p) -> (Item)itemFactory.apply(block, (Item.Properties)p), properties.useBlockDescriptionPrefix().requiredFeatures(block.requiredFeatures()));
    }
