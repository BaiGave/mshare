...
extends NormalCraftingRecipe {
    public static final MapCodec<ImbueRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Recipe.CommonInfo.MAP_CODEC.forGetter(o -> o.commonInfo), CraftingRecipe.CraftingBookInfo.MAP_CODEC.forGetter(o -> o.bookInfo), ((MapCodec)Ingredient.CODEC.fieldOf("source")).forGetter(o -> o.source), ((MapCodec)Ingredient.CODEC.fieldOf("material")).forGetter(o -> o.material), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result)).apply((Applicative<ImbueRecipe, ?>)i, ImbueRecipe::new));
