...
extends CustomRecipe {
    public static final MapCodec<FireworkStarRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Codec.simpleMap(FireworkExplosion.Shape.CODEC, Ingredient.CODEC, StringRepresentable.keys(FireworkExplosion.Shape.values())).fieldOf("shapes").forGetter(o -> o.shapes), ((MapCodec)Ingredient.CODEC.fieldOf("trail")).forGetter(o -> o.trail), ((MapCodec)Ingredient.CODEC.fieldOf("twinkle")).forGetter(o -> o.twinkle), ((MapCodec)Ingredient.CODEC.fieldOf("fuel")).forGetter(o -> o.fuel), ((MapCodec)Ingredient.CODEC.fieldOf("dye")).forGetter(o -> o.dye), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result)).apply((Applicative<FireworkStarRecipe, ?>)i, FireworkStarRecipe::new));
