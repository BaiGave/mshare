...
extends SimpleSmithingRecipe {
    public static final MapCodec<SmithingTransformRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Recipe.CommonInfo.MAP_CODEC.forGetter(o -> o.commonInfo), Ingredient.CODEC.optionalFieldOf("template").forGetter(o -> o.template), ((MapCodec)Ingredient.CODEC.fieldOf("base")).forGetter(o -> o.base), Ingredient.CODEC.optionalFieldOf("addition").forGetter(o -> o.addition), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result)).apply((Applicative<SmithingTransformRecipe, ?>)i, SmithingTransformRecipe::new));
