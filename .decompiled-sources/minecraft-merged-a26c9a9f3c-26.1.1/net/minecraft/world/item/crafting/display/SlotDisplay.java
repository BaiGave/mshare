...
public interface SlotDisplay {
    ...
    {
        public static final MapCodec<WithRemainder> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.fieldOf("input")).forGetter(WithRemainder::input), ((MapCodec)CODEC.fieldOf("remainder")).forGetter(WithRemainder::remainder)).apply((Applicative<WithRemainder, ?>)i, WithRemainder::new));
    ...
    {
        public static final MapCodec<Composite> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.listOf().fieldOf("contents")).forGetter(Composite::contents)).apply((Applicative<Composite, ?>)i, Composite::new));
    ...
    {
        public static final MapCodec<TagSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)TagKey.codec(Registries.ITEM).fieldOf("tag")).forGetter(TagSlotDisplay::tag)).apply((Applicative<TagSlotDisplay, ?>)i, TagSlotDisplay::new));
    ...
    {
        public static final MapCodec<ItemStackSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ItemStackTemplate.CODEC.fieldOf("item")).forGetter(ItemStackSlotDisplay::stack)).apply((Applicative<ItemStackSlotDisplay, ?>)i, ItemStackSlotDisplay::new));
    ...
    {
        public static final MapCodec<ItemSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Item.CODEC.fieldOf("item")).forGetter(ItemSlotDisplay::item)).apply((Applicative<ItemSlotDisplay, ?>)i, ItemSlotDisplay::new));
    ...
    {
        public static final MapCodec<SmithingTrimDemoSlotDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.fieldOf("base")).forGetter(SmithingTrimDemoSlotDisplay::base), ((MapCodec)CODEC.fieldOf("material")).forGetter(SmithingTrimDemoSlotDisplay::material), ((MapCodec)TrimPattern.CODEC.fieldOf("pattern")).forGetter(SmithingTrimDemoSlotDisplay::pattern)).apply((Applicative<SmithingTrimDemoSlotDisplay, ?>)i, SmithingTrimDemoSlotDisplay::new));
    ...
    {
        public static final MapCodec<DyedSlotDemo> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.fieldOf("dye")).forGetter(DyedSlotDemo::dye), ((MapCodec)CODEC.fieldOf("target")).forGetter(DyedSlotDemo::target)).apply((Applicative<DyedSlotDemo, ?>)i, DyedSlotDemo::new));
    ...
    {
        public static final MapCodec<OnlyWithComponent> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.fieldOf("contents")).forGetter(OnlyWithComponent::source), ((MapCodec)DataComponentType.CODEC.fieldOf("component")).forGetter(OnlyWithComponent::component)).apply((Applicative<OnlyWithComponent, ?>)i, OnlyWithComponent::new));
    ...
    {
        public static final MapCodec<WithAnyPotion> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.fieldOf("contents")).forGetter(WithAnyPotion::display)).apply((Applicative<WithAnyPotion, ?>)i, WithAnyPotion::new));
