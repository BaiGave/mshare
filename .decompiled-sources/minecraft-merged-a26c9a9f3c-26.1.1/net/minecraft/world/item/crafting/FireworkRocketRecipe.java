...
extends CustomRecipe {
    public static final MapCodec<FireworkRocketRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Ingredient.CODEC.fieldOf("shell")).forGetter(o -> o.shell), ((MapCodec)Ingredient.CODEC.fieldOf("fuel")).forGetter(o -> o.fuel), ((MapCodec)Ingredient.CODEC.fieldOf("star")).forGetter(o -> o.star), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result)).apply((Applicative<FireworkRocketRecipe, ?>)i, FireworkRocketRecipe::new));
