...
extends NormalCraftingRecipe {
    public static final MapCodec<ShapelessRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Recipe.CommonInfo.MAP_CODEC.forGetter(o -> o.commonInfo), CraftingRecipe.CraftingBookInfo.MAP_CODEC.forGetter(o -> o.bookInfo), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result), ((MapCodec)Ingredient.CODEC.listOf(1, 9).fieldOf("ingredients")).forGetter(o -> o.ingredients)).apply((Applicative<ShapelessRecipe, ?>)i, ShapelessRecipe::new));
