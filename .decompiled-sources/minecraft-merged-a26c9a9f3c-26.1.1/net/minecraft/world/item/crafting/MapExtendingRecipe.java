...
extends CustomRecipe {
    public static final MapCodec<MapExtendingRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Ingredient.CODEC.fieldOf("map")).forGetter(o -> o.map), ((MapCodec)Ingredient.CODEC.fieldOf("material")).forGetter(o -> o.material), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result)).apply((Applicative<MapExtendingRecipe, ?>)i, MapExtendingRecipe::new));
