...
extends NormalCraftingRecipe {
    public static final MapCodec<DyeRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Recipe.CommonInfo.MAP_CODEC.forGetter(o -> o.commonInfo), CraftingRecipe.CraftingBookInfo.MAP_CODEC.forGetter(o -> o.bookInfo), ((MapCodec)Ingredient.CODEC.fieldOf("target")).forGetter(o -> o.target), ((MapCodec)Ingredient.CODEC.fieldOf("dye")).forGetter(o -> o.dye), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result)).apply((Applicative<DyeRecipe, ?>)i, DyeRecipe::new));
