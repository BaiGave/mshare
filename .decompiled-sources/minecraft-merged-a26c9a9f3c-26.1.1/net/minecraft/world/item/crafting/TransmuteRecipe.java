...
extends NormalCraftingRecipe {
    ...
    public static final MapCodec<TransmuteRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Recipe.CommonInfo.MAP_CODEC.forGetter(o -> o.commonInfo), CraftingRecipe.CraftingBookInfo.MAP_CODEC.forGetter(o -> o.bookInfo), ((MapCodec)Ingredient.CODEC.fieldOf("input")).forGetter(o -> o.input), ((MapCodec)Ingredient.CODEC.fieldOf("material")).forGetter(o -> o.material), MATERIAL_COUNT_BOUNDS.optionalFieldOf("material_count", DEFAULT_MATERIAL_COUNT).forGetter(o -> o.materialCount), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result), Codec.BOOL.optionalFieldOf("add_material_count_to_result", false).forGetter(o -> o.addMaterialCountToResult)).apply((Applicative<TransmuteRecipe, ?>)i, TransmuteRecipe::new));
