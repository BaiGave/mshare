...
FabricIngredient {
    ...
    public SlotDisplay display() {
        return (SlotDisplay)((Object)this.values.unwrap().map(SlotDisplay.TagSlotDisplay::new, l -> new SlotDisplay.Composite(l.stream().map(Ingredient::displayForSingleItem).toList())));
    }
