...
extends CustomRecipe {
    ...
    public static final MapCodec<BookCloningRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Ingredient.CODEC.fieldOf("source")).forGetter(o -> o.source), ((MapCodec)Ingredient.CODEC.fieldOf("material")).forGetter(o -> o.material), ALLOWED_GENERATION_CODEC.optionalFieldOf("allowed_generations", DEFAULT_BOOK_GENERATION_RANGES).forGetter(o -> o.allowedGenerations), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result)).apply((Applicative<BookCloningRecipe, ?>)i, BookCloningRecipe::new));
