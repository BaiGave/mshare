...
extends CustomRecipe {
    public static final MapCodec<FireworkStarFadeRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Ingredient.CODEC.fieldOf("target")).forGetter(o -> o.target), ((MapCodec)Ingredient.CODEC.fieldOf("dye")).forGetter(o -> o.dye), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result)).apply((Applicative<FireworkStarFadeRecipe, ?>)i, FireworkStarFadeRecipe::new));
