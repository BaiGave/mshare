...
implements Recipe<SingleRecipeInput> {
    ...
    public static <T extends SingleItemRecipe> MapCodec<T> simpleMapCodec(Factory<T> factory) {
        return RecordCodecBuilder.mapCodec(i -> i.group(Recipe.CommonInfo.MAP_CODEC.forGetter(o -> o.commonInfo), ((MapCodec)Ingredient.CODEC.fieldOf("ingredient")).forGetter(SingleItemRecipe::input), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(SingleItemRecipe::result)).apply((Applicative<SingleItemRecipe, ?>)i, factory::create));
    }
