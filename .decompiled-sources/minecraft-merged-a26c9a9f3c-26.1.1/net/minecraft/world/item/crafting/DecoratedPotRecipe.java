...
extends CustomRecipe {
    public static final MapCodec<DecoratedPotRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Ingredient.CODEC.fieldOf("back")).forGetter(o -> o.backPattern), ((MapCodec)Ingredient.CODEC.fieldOf("left")).forGetter(o -> o.leftPattern), ((MapCodec)Ingredient.CODEC.fieldOf("right")).forGetter(o -> o.rightPattern), ((MapCodec)Ingredient.CODEC.fieldOf("front")).forGetter(o -> o.frontPattern), ((MapCodec)ItemStackTemplate.CODEC.fieldOf("result")).forGetter(o -> o.result)).apply((Applicative<DecoratedPotRecipe, ?>)i, DecoratedPotRecipe::new));
