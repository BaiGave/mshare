...
extends SimpleSmithingRecipe {
    public static final MapCodec<SmithingTrimRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Recipe.CommonInfo.MAP_CODEC.forGetter(o -> o.commonInfo), ((MapCodec)Ingredient.CODEC.fieldOf("template")).forGetter(o -> o.template), ((MapCodec)Ingredient.CODEC.fieldOf("base")).forGetter(o -> o.base), ((MapCodec)Ingredient.CODEC.fieldOf("addition")).forGetter(o -> o.addition), ((MapCodec)TrimPattern.CODEC.fieldOf("pattern")).forGetter(o -> o.pattern)).apply((Applicative<SmithingTrimRecipe, ?>)i, SmithingTrimRecipe::new));
