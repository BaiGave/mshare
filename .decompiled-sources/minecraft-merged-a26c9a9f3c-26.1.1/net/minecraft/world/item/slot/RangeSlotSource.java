...
implements SlotSource {
    public static final MapCodec<RangeSlotSource> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)LootContextArg.ENTITY_OR_BLOCK.fieldOf("source")).forGetter(t -> t.source), ((MapCodec)SlotRanges.CODEC.fieldOf("slots")).forGetter(t -> t.slotRange)).apply((Applicative<RangeSlotSource, ?>)i, RangeSlotSource::new));
