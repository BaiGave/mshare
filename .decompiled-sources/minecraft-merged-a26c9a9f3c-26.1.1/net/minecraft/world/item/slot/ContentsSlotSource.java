...
extends TransformedSlotSource {
    public static final MapCodec<ContentsSlotSource> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> ContentsSlotSource.commonFields(i).and(((MapCodec)ContainerComponentManipulators.CODEC.fieldOf("component")).forGetter(t -> t.component)).apply((Applicative<ContentsSlotSource, ?>)i, ContentsSlotSource::new));
