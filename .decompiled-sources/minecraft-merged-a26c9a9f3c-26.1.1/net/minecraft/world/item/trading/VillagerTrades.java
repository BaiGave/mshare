...
public class VillagerTrades {
    ...
    public static Holder<VillagerTrade> bootstrap(BootstrapContext<VillagerTrade> context) {
        ...
        for (Pair<ResourceKey<VillagerTrade>, Item> pair : List.of(Pair.of(WANDERING_TRADER_EMERALD_ACACIA_LOG, Items.ACACIA_LOG), Pair.of(WANDERING_TRADER_EMERALD_BIRCH_LOG, Items.BIRCH_LOG), Pair.of(WANDERING_TRADER_EMERALD_DARK_OAK_LOG, Items.DARK_OAK_LOG), Pair.of(WANDERING_TRADER_EMERALD_JUNGLE_LOG, Items.JUNGLE_LOG), Pair.of(WANDERING_TRADER_EMERALD_OAK_LOG, Items.OAK_LOG), Pair.of(WANDERING_TRADER_EMERALD_SPRUCE_LOG, Items.SPRUCE_LOG), Pair.of(WANDERING_TRADER_EMERALD_CHERRY_LOG, Items.CHERRY_LOG), Pair.of(WANDERING_TRADER_EMERALD_MANGROVE_LOG, Items.MANGROVE_LOG), Pair.of(WANDERING_TRADER_EMERALD_PALE_OAK_LOG, Items.PALE_OAK_LOG))) {
            context.register(pair.getLeft(), new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(pair.getRight(), 8), 4, 1, 0.05f, Optional.empty(), List.of()));
        }
        ...
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(Pair.of(WANDERING_TRADER_EMERALD_BRAIN_CORAL_BLOCK, Items.BRAIN_CORAL_BLOCK), Pair.of(WANDERING_TRADER_EMERALD_BUBBLE_CORAL_BLOCK, Items.BUBBLE_CORAL_BLOCK), Pair.of(WANDERING_TRADER_EMERALD_FIRE_CORAL_BLOCK, Items.FIRE_CORAL_BLOCK), Pair.of(WANDERING_TRADER_EMERALD_HORN_CORAL_BLOCK, Items.HORN_CORAL_BLOCK), Pair.of(WANDERING_TRADER_EMERALD_TUBE_CORAL_BLOCK, Items.TUBE_CORAL_BLOCK))) {
            context.register(entry.getLeft(), new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 3), new ItemStackTemplate(entry.getRight()), 8, 1, 0.05f, Optional.empty(), List.of()));
        }
    ...
    private static void registerWanderingTraderSeeds(BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(Pair.of(WANDERING_TRADER_EMERALD_WHEAT_SEEDS, Items.WHEAT_SEEDS), Pair.of(WANDERING_TRADER_EMERALD_BEETROOT_SEEDS, Items.BEETROOT_SEEDS), Pair.of(WANDERING_TRADER_EMERALD_PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS), Pair.of(WANDERING_TRADER_EMERALD_MELON_SEEDS, Items.MELON_SEEDS))) {
            context.register(entry.getLeft(), new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(entry.getRight()), 12, 1, 0.05f, Optional.empty(), List.of()));
        }
    }
    ...
    private static void registerWanderingTraderSaplings(BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(Pair.of(WANDERING_TRADER_EMERALD_ACACIA_SAPLING, Items.ACACIA_SAPLING), Pair.of(WANDERING_TRADER_EMERALD_BIRCH_SAPLING, Items.BIRCH_SAPLING), Pair.of(WANDERING_TRADER_EMERALD_DARK_OAK_SAPLING, Items.DARK_OAK_SAPLING), Pair.of(WANDERING_TRADER_EMERALD_JUNGLE_SAPLING, Items.JUNGLE_SAPLING), Pair.of(WANDERING_TRADER_EMERALD_OAK_SAPLING, Items.OAK_SAPLING), Pair.of(WANDERING_TRADER_EMERALD_SPRUCE_SAPLING, Items.SPRUCE_SAPLING), Pair.of(WANDERING_TRADER_EMERALD_CHERRY_SAPLING, Items.CHERRY_SAPLING), Pair.of(WANDERING_TRADER_EMERALD_PALE_OAK_SAPLING, Items.PALE_OAK_SAPLING), Pair.of(WANDERING_TRADER_EMERALD_MANGROVE_PROPAGULE, Items.MANGROVE_PROPAGULE))) {
            context.register(entry.getLeft(), new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 5), new ItemStackTemplate(entry.getRight()), 8, 1, 0.05f, Optional.empty(), List.of()));
        }
    }
    ...
    private static void registerMasonLevelThreeBlocks(BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> block : List.of(Pair.of(MASON_3_EMERALD_DRIPSTONE_BLOCK, Items.DRIPSTONE_BLOCK), Pair.of(MASON_3_EMERALD_POLISHED_ANDESITE, Items.POLISHED_ANDESITE), Pair.of(MASON_3_EMERALD_POLISHED_DIORITE, Items.POLISHED_DIORITE), Pair.of(MASON_3_EMERALD_POLISHED_GRANTITE, Items.POLISHED_GRANITE))) {
            VillagerTrades.register(context, block.getLeft(), new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(block.getRight(), 4), 16, 10, 0.05f, Optional.empty(), List.of()));
        }
    }
    ...
    private static void registerMasonLevelThreeStones(BootstrapContext<VillagerTrade> context) {
        for (Pair<ResourceKey<VillagerTrade>, Item> stone : List.of(Pair.of(MASON_3_GRANITE_EMERALD, Items.GRANITE), Pair.of(MASON_3_ANDESITE_EMERALD, Items.ANDESITE), Pair.of(MASON_3_DIORITE_EMERALD, Items.DIORITE))) {
            VillagerTrades.register(context, stone.getLeft(), new VillagerTrade(new TradeCost((ItemLike)stone.getRight(), 16), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05f, Optional.empty(), List.of()));
        }
    }

    private static void registerBoatTrades(BootstrapContext<VillagerTrade> context, HolderGetter<VillagerType> villagerVariants) {
        List<ImmutableTriple<ResourceKey<VillagerTrade>, Item, List<ResourceKey<VillagerType>>>> boatMappings = List.of(ImmutableTriple.of(FISHERMAN_5_OAK_BOAT_EMERALD, Items.OAK_BOAT, List.of(VillagerType.PLAINS)), ImmutableTriple.of(FISHERMAN_5_SPRUCE_BOAT_EMERALD, Items.SPRUCE_BOAT, List.of(VillagerType.TAIGA, VillagerType.SNOW)), ImmutableTriple.of(FISHERMAN_5_JUNGLE_BOAT_EMERALD, Items.JUNGLE_BOAT, List.of(VillagerType.DESERT, VillagerType.JUNGLE)), ImmutableTriple.of(FISHERMAN_5_ACACIA_BOAT_EMERALD, Items.ACACIA_BOAT, List.of(VillagerType.SAVANNA)), ImmutableTriple.of(FISHERMAN_5_DARK_OAK_BOAT_EMERALD, Items.DARK_OAK_BOAT, List.of(VillagerType.SWAMP)));
        for (ImmutableTriple<ResourceKey<VillagerTrade>, Item, List<ResourceKey<VillagerType>>> entry : boatMappings) {
    ...
    private static void registerWoolSales(BootstrapContext<VillagerTrade> context) {
        List<Pair<ResourceKey<VillagerTrade>, Item>> entries = List.of(Pair.of(SHEPHERD_1_WHITE_WOOL_EMERALD, Items.WHITE_WOOL), Pair.of(SHEPHERD_1_BROWN_WOOL_EMERALD, Items.BROWN_WOOL), Pair.of(SHEPHERD_1_GRAY_WOOL_EMERALD, Items.GRAY_WOOL), Pair.of(SHEPHERD_1_BLACK_WOOL_EMERALD, Items.BLACK_WOOL));
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : entries) {
            VillagerTrades.register(context, entry.getLeft(), new VillagerTrade(new TradeCost((ItemLike)entry.getRight(), 18), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05f, Optional.empty(), List.of()));
        }
    }

    private static void registerLevelTwoDyeTrades(BootstrapContext<VillagerTrade> context) {
        List<Pair<ResourceKey<VillagerTrade>, Item>> entries = List.of(Pair.of(SHEPHERD_2_WHITE_DYE_EMERALD, Items.WHITE_DYE), Pair.of(SHEPHERD_2_GRAY_DYE_EMERALD, Items.GRAY_DYE), Pair.of(SHEPHERD_2_BLACK_DYE_EMERALD, Items.BLACK_DYE), Pair.of(SHEPHERD_2_LIGHT_BLUE_DYE_EMERALD, Items.LIGHT_BLUE_DYE), Pair.of(SHEPHERD_2_LIME_DYE_EMERALD, Items.LIME_DYE));
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : entries) {
            VillagerTrades.register(context, entry.getLeft(), new VillagerTrade(new TradeCost((ItemLike)entry.getRight(), 12), new ItemStackTemplate(Items.EMERALD), 16, 10, 0.05f, Optional.empty(), List.of()));
        }
    }

    private static void registerLevelThreeDyeTrades(BootstrapContext<VillagerTrade> context) {
        List<Pair<ResourceKey<VillagerTrade>, Item>> entries = List.of(Pair.of(SHEPHERD_3_YELLOW_DYE_EMERALD, Items.YELLOW_DYE), Pair.of(SHEPHERD_3_LIGHT_GRAY_DYE_EMERALD, Items.LIGHT_GRAY_DYE), Pair.of(SHEPHERD_3_ORANGE_DYE_EMERALD, Items.ORANGE_DYE), Pair.of(SHEPHERD_3_RED_DYE_EMERALD, Items.RED_DYE), Pair.of(SHEPHERD_3_PINK_DYE_EMERALD, Items.PINK_DYE));
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : entries) {
            VillagerTrades.register(context, entry.getLeft(), new VillagerTrade(new TradeCost((ItemLike)entry.getRight(), 12), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05f, Optional.empty(), List.of()));
        }
    }

    private static void registerLevelFourDyeTrades(BootstrapContext<VillagerTrade> context) {
        List<Pair<ResourceKey<VillagerTrade>, Item>> entries = List.of(Pair.of(SHEPHERD_4_BROWN_DYE_EMERALD, Items.BROWN_DYE), Pair.of(SHEPHERD_4_PURPLE_DYE_EMERALD, Items.PURPLE_DYE), Pair.of(SHEPHERD_4_BLUE_DYE_EMERALD, Items.BLUE_DYE), Pair.of(SHEPHERD_4_GREEN_DYE_EMERALD, Items.GREEN_DYE), Pair.of(SHEPHERD_4_MAGENTA_DYE_EMERALD, Items.MAGENTA_DYE), Pair.of(SHEPHERD_4_CYAN_DYE_EMERALD, Items.CYAN_DYE));
        for (Pair<ResourceKey<VillagerTrade>, Item> entry : entries) {
            VillagerTrades.register(context, entry.getLeft(), new VillagerTrade(new TradeCost((ItemLike)entry.getRight(), 12), new ItemStackTemplate(Items.EMERALD), 16, 30, 0.05f, Optional.empty(), List.of()));
        }
    }

    private static void registerWoolPurchases(BootstrapContext<VillagerTrade> context) {
        List<Pair> entries = List.of(Pair.of(SHEPHERD_2_EMERALD_WHITE_WOOL, Items.WHITE_WOOL), Pair.of(SHEPHERD_2_EMERALD_ORANGE_WOOL, Items.ORANGE_WOOL), Pair.of(SHEPHERD_2_EMERALD_MAGENTA_WOOL, Items.MAGENTA_WOOL), Pair.of(SHEPHERD_2_EMERALD_BLUE_WOOL, Items.BLUE_WOOL), Pair.of(SHEPHERD_2_EMERALD_LIGHT_BLUE_WOOL, Items.LIGHT_BLUE_WOOL), Pair.of(SHEPHERD_2_EMERALD_YELLOW_WOOL, Items.YELLOW_WOOL), Pair.of(SHEPHERD_2_EMERALD_LIME_WOOL, Items.LIME_WOOL), Pair.of(SHEPHERD_2_EMERALD_PINK_WOOL, Items.PINK_WOOL), Pair.of(SHEPHERD_2_EMERALD_GRAY_WOOL, Items.GRAY_WOOL), Pair.of(SHEPHERD_2_EMERALD_LIGHT_GRAY_WOOL, Items.LIGHT_GRAY_WOOL), Pair.of(SHEPHERD_2_EMERALD_CYAN_WOOL, Items.CYAN_WOOL), Pair.of(SHEPHERD_2_EMERALD_PURPLE_WOOL, Items.PURPLE_WOOL), Pair.of(SHEPHERD_2_EMERALD_BROWN_WOOL, Items.BROWN_WOOL), Pair.of(SHEPHERD_2_EMERALD_GREEN_WOOL, Items.GREEN_WOOL), Pair.of(SHEPHERD_2_EMERALD_RED_WOOL, Items.RED_WOOL), Pair.of(SHEPHERD_2_EMERALD_BLACK_WOOL, Items.BLACK_WOOL));
