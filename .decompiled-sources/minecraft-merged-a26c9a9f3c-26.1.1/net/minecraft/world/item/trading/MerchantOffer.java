...
public class MerchantOffer {
    public static final Codec<MerchantOffer> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)ItemCost.CODEC.fieldOf("buy")).forGetter(o -> o.baseCostA), ItemCost.CODEC.lenientOptionalFieldOf("buyB").forGetter(o -> o.costB), ((MapCodec)ItemStack.CODEC.fieldOf("sell")).forGetter(o -> o.result), Codec.INT.lenientOptionalFieldOf("uses", 0).forGetter(o -> o.uses), Codec.INT.lenientOptionalFieldOf("maxUses", 4).forGetter(o -> o.maxUses), Codec.BOOL.lenientOptionalFieldOf("rewardExp", true).forGetter(o -> o.rewardExp), Codec.INT.lenientOptionalFieldOf("specialPrice", 0).forGetter(o -> o.specialPriceDiff), Codec.INT.lenientOptionalFieldOf("demand", 0).forGetter(o -> o.demand), Codec.FLOAT.lenientOptionalFieldOf("priceMultiplier", Float.valueOf(0.0f)).forGetter(o -> Float.valueOf(o.priceMultiplier)), Codec.INT.lenientOptionalFieldOf("xp", 1).forGetter(o -> o.xp)).apply((Applicative<MerchantOffer, ?>)i, MerchantOffer::new));
