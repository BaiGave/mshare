...
public interface LevelBasedValue {
    ...
    public static final Codec<LevelBasedValue> CODEC = Codec.either(Constant.CODEC, DISPATCH_CODEC).xmap(either -> either.map(l -> l, r -> r), levelBasedValue -> {
    ...
    {
        public static final MapCodec<Clamped> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.fieldOf("value")).forGetter(Clamped::value), ((MapCodec)Codec.FLOAT.fieldOf("min")).forGetter(Clamped::min), ((MapCodec)Codec.FLOAT.fieldOf("max")).forGetter(Clamped::max)).apply((Applicative<Clamped, ?>)i, Clamped::new)).validate(u -> {
            if (u.max <= u.min) {
    ...
    {
        public static final MapCodec<Fraction> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.fieldOf("numerator")).forGetter(Fraction::numerator), ((MapCodec)CODEC.fieldOf("denominator")).forGetter(Fraction::denominator)).apply((Applicative<Fraction, ?>)i, Fraction::new));
    ...
    {
        public static final MapCodec<LevelsSquared> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.FLOAT.fieldOf("added")).forGetter(LevelsSquared::added)).apply((Applicative<LevelsSquared, ?>)i, LevelsSquared::new));
    ...
    {
        public static final MapCodec<Linear> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.FLOAT.fieldOf("base")).forGetter(Linear::base), ((MapCodec)Codec.FLOAT.fieldOf("per_level_above_first")).forGetter(Linear::perLevelAboveFirst)).apply((Applicative<Linear, ?>)i, Linear::new));
    ...
    {
        public static final MapCodec<Exponent> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)CODEC.fieldOf("base")).forGetter(Exponent::base), ((MapCodec)CODEC.fieldOf("power")).forGetter(Exponent::power)).apply((Applicative<Exponent, ?>)i, Exponent::new));
    ...
    {
        public static final MapCodec<Lookup> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.FLOAT.listOf().fieldOf("values")).forGetter(Lookup::values), ((MapCodec)CODEC.fieldOf("fallback")).forGetter(Lookup::fallback)).apply((Applicative<Lookup, ?>)i, Lookup::new));
    ...
    public record Constant(float value) implements LevelBasedValue
    {
        ...
        public static final MapCodec<Constant> TYPED_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.FLOAT.fieldOf("value")).forGetter(Constant::value)).apply((Applicative<Constant, ?>)i, Constant::new));
