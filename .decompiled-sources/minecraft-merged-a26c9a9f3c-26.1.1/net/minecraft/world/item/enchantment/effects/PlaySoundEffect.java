...
{
    public static final MapCodec<PlaySoundEffect> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ExtraCodecs.compactListCodec(SoundEvent.CODEC, SoundEvent.CODEC.sizeLimitedListOf(255)).fieldOf("sound")).forGetter(PlaySoundEffect::soundEvents), ((MapCodec)FloatProviders.codec(1.0E-5f, 10.0f).fieldOf("volume")).forGetter(PlaySoundEffect::volume), ((MapCodec)FloatProviders.codec(1.0E-5f, 2.0f).fieldOf("pitch")).forGetter(PlaySoundEffect::pitch)).apply((Applicative<PlaySoundEffect, ?>)i, PlaySoundEffect::new));
