...
public record RunFunction(Identifier function) implements EnchantmentEntityEffect
{
    ...
    public static final MapCodec<RunFunction> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("function")).forGetter(RunFunction::function)).apply((Applicative<RunFunction, ?>)i, RunFunction::new));
