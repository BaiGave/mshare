...
{
    public static final MapCodec<ApplyExhaustion> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)LevelBasedValue.CODEC.fieldOf("amount")).forGetter(ApplyExhaustion::amount)).apply((Applicative<ApplyExhaustion, ?>)i, ApplyExhaustion::new));
