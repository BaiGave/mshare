...
public record Enchantable(int value) {
    public static final Codec<Enchantable> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)ExtraCodecs.POSITIVE_INT.fieldOf("value")).forGetter(Enchantable::value)).apply((Applicative<Enchantable, ?>)i, Enchantable::new));
