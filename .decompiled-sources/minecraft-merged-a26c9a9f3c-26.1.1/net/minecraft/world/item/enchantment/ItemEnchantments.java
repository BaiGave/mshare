...
implements TooltipProvider {
    public static final ItemEnchantments EMPTY = new ItemEnchantments(new Object2IntOpenHashMap<Holder<Enchantment>>());
    private static final Codec<Integer> LEVEL_CODEC = Codec.intRange(1, 255);
    public static final Codec<ItemEnchantments> CODEC = Codec.unboundedMap(Enchantment.CODEC, LEVEL_CODEC).xmap(map -> new ItemEnchantments(new Object2IntOpenHashMap<Holder<Enchantment>>((Map<Holder<Enchantment>, Integer>)map)), enchantments -> enchantments.enchantments);
    ...
    public void addToTooltip(Item.TooltipContext context, Consumer<Component> consumer, TooltipFlag flag, DataComponentGetter components) {
        ...
        for (Holder holder : order) {
            int level = this.enchantments.getInt(holder);
            if (level <= 0) continue;
    ...
    public static class Mutable {
        ...
        public Mutable(ItemEnchantments enchantments) {
            this.enchantments.putAll((Map<Holder<Enchantment>, Integer>)enchantments.enchantments);
        }
