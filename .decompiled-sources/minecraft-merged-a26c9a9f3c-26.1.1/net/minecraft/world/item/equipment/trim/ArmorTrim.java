...
{
    public static final Codec<ArmorTrim> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)TrimMaterial.CODEC.fieldOf("material")).forGetter(ArmorTrim::material), ((MapCodec)TrimPattern.CODEC.fieldOf("pattern")).forGetter(ArmorTrim::pattern)).apply((Applicative<ArmorTrim, ?>)i, ArmorTrim::new));
