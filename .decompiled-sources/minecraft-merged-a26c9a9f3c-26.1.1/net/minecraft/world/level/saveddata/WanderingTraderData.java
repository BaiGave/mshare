...
extends SavedData {
    public static final Codec<WanderingTraderData> CODEC = RecordCodecBuilder.create(i -> i.group(Codec.INT.optionalFieldOf("spawn_delay", 24000).forGetter(data -> data.spawnDelay), Codec.INT.optionalFieldOf("spawn_chance", 25).forGetter(data -> data.spawnChance)).apply((Applicative<WanderingTraderData, ?>)i, WanderingTraderData::new));
