...
extends SavedData {
    ...
    public static final Codec<MapIndex> CODEC = RecordCodecBuilder.create(i -> i.group(Codec.INT.optionalFieldOf("map", -1).forGetter(m -> m.lastMapId)).apply((Applicative<MapIndex, ?>)i, MapIndex::new));
