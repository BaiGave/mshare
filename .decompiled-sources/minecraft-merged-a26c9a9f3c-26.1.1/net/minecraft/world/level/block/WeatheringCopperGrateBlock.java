...
implements WeatheringCopper {
    public static final MapCodec<WeatheringCopperGrateBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)WeatheringCopper.WeatherState.CODEC.fieldOf("weathering_state")).forGetter(WeatheringCopperGrateBlock::getAge), WeatheringCopperGrateBlock.propertiesCodec()).apply((Applicative<WeatheringCopperGrateBlock, ?>)i, WeatheringCopperGrateBlock::new));
