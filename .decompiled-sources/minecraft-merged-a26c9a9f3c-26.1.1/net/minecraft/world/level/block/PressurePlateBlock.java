...
extends BasePressurePlateBlock {
    public static final MapCodec<PressurePlateBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)BlockSetType.CODEC.fieldOf("block_set_type")).forGetter(b -> b.type), PressurePlateBlock.propertiesCodec()).apply((Applicative<PressurePlateBlock, ?>)i, PressurePlateBlock::new));
