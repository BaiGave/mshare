...
extends BaseCoralPlantTypeBlock {
    public static final MapCodec<CoralPlantBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(CoralBlock.DEAD_CORAL_FIELD.forGetter(b -> b.deadBlock), CoralPlantBlock.propertiesCodec()).apply((Applicative<CoralPlantBlock, ?>)i, CoralPlantBlock::new));
