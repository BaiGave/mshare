...
extends InfestedBlock {
    public static final MapCodec<InfestedRotatedPillarBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)BuiltInRegistries.BLOCK.byNameCodec().fieldOf("host")).forGetter(InfestedBlock::getHostBlock), InfestedRotatedPillarBlock.propertiesCodec()).apply((Applicative<InfestedRotatedPillarBlock, ?>)i, InfestedRotatedPillarBlock::new));
