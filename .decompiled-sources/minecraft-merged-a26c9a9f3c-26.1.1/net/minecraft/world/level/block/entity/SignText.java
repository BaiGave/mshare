...
public class SignText {
    ...
    public static final Codec<SignText> DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)LINES_CODEC.fieldOf("messages")).forGetter(o -> o.messages), LINES_CODEC.lenientOptionalFieldOf("filtered_messages").forGetter(SignText::filteredMessages), ((MapCodec)DyeColor.CODEC.fieldOf("color")).orElse(DyeColor.BLACK).forGetter(o -> o.color), ((MapCodec)Codec.BOOL.fieldOf("has_glowing_text")).orElse(false).forGetter(o -> o.hasGlowingText)).apply((Applicative<SignText, ?>)i, SignText::load));
