...
extends Block {
    ...
    public static final MapCodec<CoralBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(DEAD_CORAL_FIELD.forGetter(b -> b.deadBlock), CoralBlock.propertiesCodec()).apply((Applicative<CoralBlock, ?>)i, CoralBlock::new));
