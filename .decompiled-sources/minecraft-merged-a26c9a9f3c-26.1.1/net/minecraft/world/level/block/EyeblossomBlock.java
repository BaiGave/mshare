...
extends FlowerBlock {
    public static final MapCodec<EyeblossomBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.BOOL.fieldOf("open")).forGetter(e -> e.type.open), EyeblossomBlock.propertiesCodec()).apply((Applicative<EyeblossomBlock, ?>)i, EyeblossomBlock::new));
