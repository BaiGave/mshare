...
implements WeatheringCopper {
    public static final MapCodec<WeatheringCopperChainBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)WeatheringCopper.WeatherState.CODEC.fieldOf("weathering_state")).forGetter(WeatheringCopperChainBlock::getAge), WeatheringCopperChainBlock.propertiesCodec()).apply((Applicative<WeatheringCopperChainBlock, ?>)i, WeatheringCopperChainBlock::new));
