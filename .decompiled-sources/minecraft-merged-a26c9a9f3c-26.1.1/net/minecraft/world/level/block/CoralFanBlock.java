...
extends BaseCoralFanBlock {
    public static final MapCodec<CoralFanBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(CoralBlock.DEAD_CORAL_FIELD.forGetter(b -> b.deadBlock), CoralFanBlock.propertiesCodec()).apply((Applicative<CoralFanBlock, ?>)i, CoralFanBlock::new));
