...
extends FallingBlock {
    public static final MapCodec<ColoredFallingBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ColorRGBA.CODEC.fieldOf("falling_dust_color")).forGetter(b -> b.dustColor), ColoredFallingBlock.propertiesCodec()).apply((Applicative<ColoredFallingBlock, ?>)i, ColoredFallingBlock::new));
