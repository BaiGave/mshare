...
extends BaseCoralWallFanBlock {
    public static final MapCodec<CoralWallFanBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(CoralBlock.DEAD_CORAL_FIELD.forGetter(b -> b.deadBlock), CoralWallFanBlock.propertiesCodec()).apply((Applicative<CoralWallFanBlock, ?>)i, CoralWallFanBlock::new));
