...
extends AbstractSkullBlock {
    public static final MapCodec<SkullBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Type.CODEC.fieldOf("kind")).forGetter(AbstractSkullBlock::getType), SkullBlock.propertiesCodec()).apply((Applicative<SkullBlock, ?>)i, SkullBlock::new));
    ...
    extends StringRepresentable {
        public static final Map<String, Type> TYPES = new Object2ObjectArrayMap<String, Type>();
