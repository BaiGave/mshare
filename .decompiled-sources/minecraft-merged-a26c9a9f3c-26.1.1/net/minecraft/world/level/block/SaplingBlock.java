...
implements BonemealableBlock {
    public static final MapCodec<SaplingBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)TreeGrower.CODEC.fieldOf("tree")).forGetter(b -> b.treeGrower), SaplingBlock.propertiesCodec()).apply((Applicative<SaplingBlock, ?>)i, SaplingBlock::new));
