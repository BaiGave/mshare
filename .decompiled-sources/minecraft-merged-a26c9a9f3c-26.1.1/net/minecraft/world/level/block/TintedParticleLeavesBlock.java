...
extends LeavesBlock {
    public static final MapCodec<TintedParticleLeavesBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ExtraCodecs.floatRange(0.0f, 1.0f).fieldOf("leaf_particle_chance")).forGetter(e -> Float.valueOf(e.leafParticleChance)), TintedParticleLeavesBlock.propertiesCodec()).apply((Applicative<TintedParticleLeavesBlock, ?>)i, TintedParticleLeavesBlock::new));
