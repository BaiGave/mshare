...
implements BonemealableBlock {
    public static final MapCodec<NetherFungusBlock> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ResourceKey.codec(Registries.CONFIGURED_FEATURE).fieldOf("feature")).forGetter(b -> b.feature), ((MapCodec)BuiltInRegistries.BLOCK.byNameCodec().fieldOf("grows_on")).forGetter(b -> b.requiredBlock), ((MapCodec)TagKey.codec(Registries.BLOCK).fieldOf("support_blocks")).forGetter(b -> b.supportBlocks), NetherFungusBlock.propertiesCodec()).apply((Applicative<NetherFungusBlock, ?>)i, NetherFungusBlock::new));
    ...
    public NetherFungusBlock(ResourceKey<ConfiguredFeature<?, ?>> feature, Block requiredBlock, TagKey<Block> supportBlocks, BlockBehaviour.Properties properties) {
        super(properties);
