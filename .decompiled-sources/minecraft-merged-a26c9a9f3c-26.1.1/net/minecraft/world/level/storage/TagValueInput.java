...
implements ValueInput {
    ...
    public <T> Optional<T> read(MapCodec<T> codec) {
        ...
        DataResult dataResult = ops.getMap(this.input).flatMap(map -> codec.decode(ops, map));
        Objects.requireNonNull(dataResult);
        DataResult dataResult2 = dataResult;
        int n = 0;
        return switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, dataResult2, n)) {
    ...
    implements ValueInput.TypedInputList<T> {
        ...
        public Stream<T> stream() {
            return Streams.mapWithIndex(this.list.stream(), (value, index) -> {
                ...
                int index$1 = 0;
                return switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, selector0$temp, index$1)) {
                    default -> throw new MatchException(null, null);
                    case 0 -> {
                    ...
                    case 1 -> {
                        ...
                        this.reportIndexUnwrapProblem((int)index, (Tag)value, error);
            ...
            return new AbstractIterator<T>(this){
                ...
                protected @Nullable T computeNext() {
                    while (iterator.hasNext()) {
                        ...
                        int index = iterator.nextIndex();
                        Tag value = (Tag)iterator.next();
                        Objects.requireNonNull(this.this$0.codec.parse(this.this$0.context.ops(), value));
                        int n = 0;
