...
extends LootItemConditionalFunction {
    public static final MapCodec<SetEnchantmentsFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetEnchantmentsFunction.commonFields(i).and(i.group(Codec.unboundedMap(Enchantment.CODEC, NumberProviders.CODEC).optionalFieldOf("enchantments", Map.of()).forGetter(f -> f.enchantments), ((MapCodec)Codec.BOOL.fieldOf("add")).orElse(false).forGetter(f -> f.add))).apply((Applicative<SetEnchantmentsFunction, ?>)i, SetEnchantmentsFunction::new));
