...
{
    public static final MapCodec<BinomialDistributionGenerator> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)NumberProviders.CODEC.fieldOf("n")).forGetter(BinomialDistributionGenerator::n), ((MapCodec)NumberProviders.CODEC.fieldOf("p")).forGetter(BinomialDistributionGenerator::p)).apply((Applicative<BinomialDistributionGenerator, ?>)i, BinomialDistributionGenerator::new));
