...
{
    public static final MapCodec<LootItemEntityPropertyCondition> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(EntityPredicate.CODEC.optionalFieldOf("predicate").forGetter(LootItemEntityPropertyCondition::predicate), ((MapCodec)LootContext.EntityTarget.CODEC.fieldOf("entity")).forGetter(LootItemEntityPropertyCondition::entityTarget)).apply((Applicative<LootItemEntityPropertyCondition, ?>)i, LootItemEntityPropertyCondition::new));
