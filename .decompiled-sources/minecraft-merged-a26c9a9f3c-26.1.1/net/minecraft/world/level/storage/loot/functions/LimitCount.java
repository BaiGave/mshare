...
extends LootItemConditionalFunction {
    public static final MapCodec<LimitCount> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> LimitCount.commonFields(i).and(((MapCodec)IntRange.CODEC.fieldOf("limit")).forGetter(f -> f.limit)).apply((Applicative<LimitCount, ?>)i, LimitCount::new));
