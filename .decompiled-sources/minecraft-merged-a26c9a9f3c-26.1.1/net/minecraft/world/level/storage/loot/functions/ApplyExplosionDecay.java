...
extends LootItemConditionalFunction {
    public static final MapCodec<ApplyExplosionDecay> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> ApplyExplosionDecay.commonFields(i).apply(i, ApplyExplosionDecay::new));
