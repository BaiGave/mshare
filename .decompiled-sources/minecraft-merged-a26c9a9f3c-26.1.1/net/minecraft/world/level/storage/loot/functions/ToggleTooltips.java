...
extends LootItemConditionalFunction {
    public static final MapCodec<ToggleTooltips> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> ToggleTooltips.commonFields(i).and(((MapCodec)Codec.unboundedMap(DataComponentType.CODEC, Codec.BOOL).fieldOf("toggles")).forGetter(e -> e.values)).apply((Applicative<ToggleTooltips, ?>)i, ToggleTooltips::new));
