...
public record ConditionReference(ResourceKey<LootItemCondition> name) implements LootItemCondition
{
    ...
    public static final MapCodec<ConditionReference> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ResourceKey.codec(Registries.PREDICATE).fieldOf("name")).forGetter(ConditionReference::name)).apply((Applicative<ConditionReference, ?>)i, ConditionReference::new));
