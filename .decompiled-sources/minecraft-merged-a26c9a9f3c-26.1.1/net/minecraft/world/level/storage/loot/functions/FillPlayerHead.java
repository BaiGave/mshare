...
extends LootItemConditionalFunction {
    public static final MapCodec<FillPlayerHead> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> FillPlayerHead.commonFields(i).and(((MapCodec)LootContext.EntityTarget.CODEC.fieldOf("entity")).forGetter(f -> f.entityTarget)).apply((Applicative<FillPlayerHead, ?>)i, FillPlayerHead::new));
