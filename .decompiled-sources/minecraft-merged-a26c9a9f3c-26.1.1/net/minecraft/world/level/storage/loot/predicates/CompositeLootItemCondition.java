...
implements LootItemCondition {
    ...
    protected static <T extends CompositeLootItemCondition> MapCodec<T> createCodec(Function<List<LootItemCondition>, T> factory) {
        return RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)LootItemCondition.DIRECT_CODEC.listOf().fieldOf("terms")).forGetter(condition -> condition.terms)).apply((Applicative<CompositeLootItemCondition, ?>)i, factory));
    }
