...
{
    public static final MapCodec<ValueCheckCondition> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)NumberProviders.CODEC.fieldOf("value")).forGetter(ValueCheckCondition::value), ((MapCodec)IntRange.CODEC.fieldOf("range")).forGetter(ValueCheckCondition::range)).apply((Applicative<ValueCheckCondition, ?>)i, ValueCheckCondition::new));
