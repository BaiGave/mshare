...
extends LootPoolSingletonContainer {
    public static final MapCodec<TagEntry> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)TagKey.codec(Registries.ITEM).fieldOf("name")).forGetter(e -> e.tag), ((MapCodec)Codec.BOOL.fieldOf("expand")).forGetter(e -> e.expand)).and(TagEntry.singletonFields(i)).apply(i, TagEntry::new));
