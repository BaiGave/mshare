...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<EnchantRandomlyFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> EnchantRandomlyFunction.commonFields(i).and(i.group(RegistryCodecs.homogeneousList(Registries.ENCHANTMENT).optionalFieldOf("options").forGetter(f -> f.options), Codec.BOOL.optionalFieldOf("only_compatible", true).forGetter(f -> f.onlyCompatible), Codec.BOOL.optionalFieldOf("include_additional_cost_component", false).forGetter(f -> f.includeAdditionalCostComponent))).apply((Applicative<EnchantRandomlyFunction, ?>)i, EnchantRandomlyFunction::new));
