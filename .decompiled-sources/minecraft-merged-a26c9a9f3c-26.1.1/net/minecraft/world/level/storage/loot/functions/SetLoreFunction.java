...
extends LootItemConditionalFunction {
    public static final MapCodec<SetLoreFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetLoreFunction.commonFields(i).and(i.group(((MapCodec)ComponentSerialization.CODEC.sizeLimitedListOf(256).fieldOf("lore")).forGetter(f -> f.lore), ListOperation.codec(256).forGetter(f -> f.mode), LootContext.EntityTarget.CODEC.optionalFieldOf("entity").forGetter(f -> f.resolutionContext))).apply((Applicative<SetLoreFunction, ?>)i, SetLoreFunction::new));
