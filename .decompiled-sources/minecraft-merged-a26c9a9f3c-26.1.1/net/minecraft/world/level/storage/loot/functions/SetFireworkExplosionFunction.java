...
extends LootItemConditionalFunction {
    public static final MapCodec<SetFireworkExplosionFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetFireworkExplosionFunction.commonFields(i).and(i.group(FireworkExplosion.Shape.CODEC.optionalFieldOf("shape").forGetter(f -> f.shape), FireworkExplosion.COLOR_LIST_CODEC.optionalFieldOf("colors").forGetter(f -> f.colors), FireworkExplosion.COLOR_LIST_CODEC.optionalFieldOf("fade_colors").forGetter(f -> f.fadeColors), Codec.BOOL.optionalFieldOf("trail").forGetter(f -> f.trail), Codec.BOOL.optionalFieldOf("twinkle").forGetter(f -> f.twinkle))).apply((Applicative<SetFireworkExplosionFunction, ?>)i, SetFireworkExplosionFunction::new));
