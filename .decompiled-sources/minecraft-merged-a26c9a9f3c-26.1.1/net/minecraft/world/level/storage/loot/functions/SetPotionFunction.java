...
extends LootItemConditionalFunction {
    public static final MapCodec<SetPotionFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetPotionFunction.commonFields(i).and(((MapCodec)Potion.CODEC.fieldOf("id")).forGetter(f -> f.potion)).apply((Applicative<SetPotionFunction, ?>)i, SetPotionFunction::new));
