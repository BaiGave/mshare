...
extends LootPoolSingletonContainer {
    public static final MapCodec<DynamicLoot> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("name")).forGetter(e -> e.name)).and(DynamicLoot.singletonFields(i)).apply(i, DynamicLoot::new));
