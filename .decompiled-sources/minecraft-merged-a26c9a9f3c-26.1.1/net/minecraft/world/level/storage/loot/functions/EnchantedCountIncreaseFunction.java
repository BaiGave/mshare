...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<EnchantedCountIncreaseFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> EnchantedCountIncreaseFunction.commonFields(i).and(i.group(((MapCodec)Enchantment.CODEC.fieldOf("enchantment")).forGetter(f -> f.enchantment), ((MapCodec)NumberProviders.CODEC.fieldOf("count")).forGetter(f -> f.count), Codec.INT.optionalFieldOf("limit", 0).forGetter(f -> f.limit))).apply((Applicative<EnchantedCountIncreaseFunction, ?>)i, EnchantedCountIncreaseFunction::new));
