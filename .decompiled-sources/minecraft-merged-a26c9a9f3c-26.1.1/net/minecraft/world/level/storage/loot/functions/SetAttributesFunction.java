...
extends LootItemConditionalFunction {
    public static final MapCodec<SetAttributesFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetAttributesFunction.commonFields(i).and(i.group(((MapCodec)Modifier.CODEC.listOf().fieldOf("modifiers")).forGetter(f -> f.modifiers), Codec.BOOL.optionalFieldOf("replace", true).forGetter(f -> f.replace))).apply((Applicative<SetAttributesFunction, ?>)i, SetAttributesFunction::new));
    ...
    private record Modifier(Identifier id, Holder<Attribute> attribute, AttributeModifier.Operation operation, NumberProvider amount, List<EquipmentSlotGroup> slots) implements LootContextUser
    {
        ...
        public static final Codec<Modifier> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("id")).forGetter(Modifier::id), ((MapCodec)Attribute.CODEC.fieldOf("attribute")).forGetter(Modifier::attribute), ((MapCodec)AttributeModifier.Operation.CODEC.fieldOf("operation")).forGetter(Modifier::operation), ((MapCodec)NumberProviders.CODEC.fieldOf("amount")).forGetter(Modifier::amount), ((MapCodec)SLOTS_CODEC.fieldOf("slot")).forGetter(Modifier::slots)).apply((Applicative<Modifier, ?>)i, Modifier::new));
