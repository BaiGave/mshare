...
extends LootItemConditionalFunction {
    public static final MapCodec<CopyNameFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> CopyNameFunction.commonFields(i).and(((MapCodec)LootContextArg.ENTITY_OR_BLOCK.fieldOf("source")).forGetter(f -> f.source)).apply((Applicative<CopyNameFunction, ?>)i, CopyNameFunction::new));
