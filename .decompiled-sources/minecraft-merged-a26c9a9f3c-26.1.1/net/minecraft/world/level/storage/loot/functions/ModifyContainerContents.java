...
extends LootItemConditionalFunction {
    public static final MapCodec<ModifyContainerContents> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> ModifyContainerContents.commonFields(i).and(i.group(((MapCodec)ContainerComponentManipulators.CODEC.fieldOf("component")).forGetter(f -> f.component), ((MapCodec)LootItemFunctions.ROOT_CODEC.fieldOf("modifier")).forGetter(f -> f.modifier))).apply((Applicative<ModifyContainerContents, ?>)i, ModifyContainerContents::new));
