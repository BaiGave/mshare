...
{
    public static final MapCodec<TimeCheck> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)WorldClock.CODEC.fieldOf("clock")).forGetter(TimeCheck::clock), Codec.LONG.optionalFieldOf("period").forGetter(TimeCheck::period), ((MapCodec)IntRange.CODEC.fieldOf("value")).forGetter(TimeCheck::value)).apply((Applicative<TimeCheck, ?>)i, TimeCheck::new));
