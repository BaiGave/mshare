...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<SetItemDamageFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetItemDamageFunction.commonFields(i).and(i.group(((MapCodec)NumberProviders.CODEC.fieldOf("damage")).forGetter(f -> f.damage), ((MapCodec)Codec.BOOL.fieldOf("add")).orElse(false).forGetter(f -> f.add))).apply((Applicative<SetItemDamageFunction, ?>)i, SetItemDamageFunction::new));
