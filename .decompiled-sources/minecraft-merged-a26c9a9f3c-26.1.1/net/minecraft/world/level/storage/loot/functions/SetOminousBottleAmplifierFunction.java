...
extends LootItemConditionalFunction {
    static final MapCodec<SetOminousBottleAmplifierFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetOminousBottleAmplifierFunction.commonFields(i).and(((MapCodec)NumberProviders.CODEC.fieldOf("amplifier")).forGetter(f -> f.amplifier)).apply((Applicative<SetOminousBottleAmplifierFunction, ?>)i, SetOminousBottleAmplifierFunction::new));
