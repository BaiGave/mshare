...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<FunctionReference> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> FunctionReference.commonFields(i).and(((MapCodec)ResourceKey.codec(Registries.ITEM_MODIFIER).fieldOf("name")).forGetter(f -> f.name)).apply((Applicative<FunctionReference, ?>)i, FunctionReference::new));
