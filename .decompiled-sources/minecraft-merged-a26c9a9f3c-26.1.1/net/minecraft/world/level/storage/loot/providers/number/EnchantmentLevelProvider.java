...
{
    public static final MapCodec<EnchantmentLevelProvider> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)LevelBasedValue.CODEC.fieldOf("amount")).forGetter(EnchantmentLevelProvider::amount)).apply((Applicative<EnchantmentLevelProvider, ?>)i, EnchantmentLevelProvider::new));
