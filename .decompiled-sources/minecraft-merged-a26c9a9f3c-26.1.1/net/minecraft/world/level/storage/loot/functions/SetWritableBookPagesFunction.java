...
extends LootItemConditionalFunction {
    public static final MapCodec<SetWritableBookPagesFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetWritableBookPagesFunction.commonFields(i).and(i.group(((MapCodec)WritableBookContent.PAGES_CODEC.fieldOf("pages")).forGetter(f -> f.pages), ListOperation.codec(100).forGetter(f -> f.pageOperation))).apply((Applicative<SetWritableBookPagesFunction, ?>)i, SetWritableBookPagesFunction::new));
