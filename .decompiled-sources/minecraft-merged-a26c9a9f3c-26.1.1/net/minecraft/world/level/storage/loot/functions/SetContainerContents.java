...
extends LootItemConditionalFunction {
    public static final MapCodec<SetContainerContents> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetContainerContents.commonFields(i).and(i.group(((MapCodec)ContainerComponentManipulators.CODEC.fieldOf("component")).forGetter(f -> f.component), ((MapCodec)LootPoolEntries.CODEC.listOf().fieldOf("entries")).forGetter(f -> f.entries))).apply((Applicative<SetContainerContents, ?>)i, SetContainerContents::new));
