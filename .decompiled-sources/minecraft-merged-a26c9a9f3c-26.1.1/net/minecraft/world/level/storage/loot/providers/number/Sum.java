...
{
    public static final MapCodec<Sum> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)NumberProviders.CODEC.listOf().fieldOf("summands")).forGetter(Sum::summands)).apply((Applicative<Sum, ?>)i, Sum::new));
