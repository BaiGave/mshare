...
extends LootItemConditionalFunction {
    public static final MapCodec<SetCustomDataFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetCustomDataFunction.commonFields(i).and(((MapCodec)TagParser.LENIENT_CODEC.fieldOf("tag")).forGetter(f -> f.tag)).apply((Applicative<SetCustomDataFunction, ?>)i, SetCustomDataFunction::new));
