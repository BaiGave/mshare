...
extends LootItemConditionalFunction {
    ...
    public static final MapCodec<ApplyBonusCount> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> ApplyBonusCount.commonFields(i).and(i.group(((MapCodec)Enchantment.CODEC.fieldOf("enchantment")).forGetter(f -> f.enchantment), FORMULA_CODEC.forGetter(f -> f.formula))).apply((Applicative<ApplyBonusCount, ?>)i, ApplyBonusCount::new));
    ...
    {
        public static final Codec<UniformBonusCount> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Codec.INT.fieldOf("bonusMultiplier")).forGetter(UniformBonusCount::bonusMultiplier)).apply((Applicative<UniformBonusCount, ?>)i, UniformBonusCount::new));
    ...
    {
        private static final Codec<BinomialWithBonusCount> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Codec.INT.fieldOf("extra")).forGetter(BinomialWithBonusCount::extraRounds), ((MapCodec)Codec.FLOAT.fieldOf("probability")).forGetter(BinomialWithBonusCount::probability)).apply((Applicative<BinomialWithBonusCount, ?>)i, BinomialWithBonusCount::new));
