...
extends LootItemConditionalFunction {
    public static final MapCodec<SetRandomDyesFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetRandomDyesFunction.commonFields(i).and(((MapCodec)NumberProviders.CODEC.fieldOf("number_of_dyes")).forGetter(f -> f.numberOfDyes)).apply((Applicative<SetRandomDyesFunction, ?>)i, SetRandomDyesFunction::new));
