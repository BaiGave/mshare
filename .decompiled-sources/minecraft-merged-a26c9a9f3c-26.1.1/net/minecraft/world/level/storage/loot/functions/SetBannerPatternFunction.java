...
extends LootItemConditionalFunction {
    public static final MapCodec<SetBannerPatternFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> SetBannerPatternFunction.commonFields(i).and(i.group(((MapCodec)BannerPatternLayers.CODEC.fieldOf("patterns")).forGetter(f -> f.patterns), ((MapCodec)Codec.BOOL.fieldOf("append")).forGetter(f -> f.append))).apply((Applicative<SetBannerPatternFunction, ?>)i, SetBannerPatternFunction::new));
