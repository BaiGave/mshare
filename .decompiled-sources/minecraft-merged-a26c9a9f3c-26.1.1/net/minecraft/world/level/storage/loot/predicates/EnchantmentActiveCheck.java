...
{
    public static final MapCodec<EnchantmentActiveCheck> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.BOOL.fieldOf("active")).forGetter(EnchantmentActiveCheck::active)).apply((Applicative<EnchantmentActiveCheck, ?>)i, EnchantmentActiveCheck::new));
