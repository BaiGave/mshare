...
extends Feature<Configuration> {
    ...
    {
        public static final Codec<Configuration> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)BlockStateProvider.CODEC.fieldOf("fluid")).forGetter(Configuration::fluid), ((MapCodec)BlockStateProvider.CODEC.fieldOf("barrier")).forGetter(Configuration::barrier)).apply((Applicative<Configuration, ?>)i, Configuration::new));
    }
}
