...
extends TreeDecorator {
    public static final MapCodec<CocoaDecorator> CODEC = ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("probability")).xmap(CocoaDecorator::new, d -> Float.valueOf(d.probability));
