...
extends TrunkPlacer {
    public static final MapCodec<ForkingTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(i -> ForkingTrunkPlacer.trunkPlacerParts(i).apply(i, ForkingTrunkPlacer::new));
