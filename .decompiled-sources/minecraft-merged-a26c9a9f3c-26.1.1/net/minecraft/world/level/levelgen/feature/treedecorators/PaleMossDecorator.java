...
extends TreeDecorator {
    public static final MapCodec<PaleMossDecorator> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("leaves_probability")).forGetter(p -> Float.valueOf(p.leavesProbability)), ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("trunk_probability")).forGetter(p -> Float.valueOf(p.trunkProbability)), ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("ground_probability")).forGetter(p -> Float.valueOf(p.groundProbability))).apply((Applicative<PaleMossDecorator, ?>)i, PaleMossDecorator::new));
