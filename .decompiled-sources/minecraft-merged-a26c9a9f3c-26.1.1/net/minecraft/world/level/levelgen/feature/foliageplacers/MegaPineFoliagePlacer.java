...
extends FoliagePlacer {
    public static final MapCodec<MegaPineFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(i -> MegaPineFoliagePlacer.foliagePlacerParts(i).and(((MapCodec)IntProviders.codec(0, 24).fieldOf("crown_height")).forGetter(p -> p.crownHeight)).apply((Applicative<MegaPineFoliagePlacer, ?>)i, MegaPineFoliagePlacer::new));
