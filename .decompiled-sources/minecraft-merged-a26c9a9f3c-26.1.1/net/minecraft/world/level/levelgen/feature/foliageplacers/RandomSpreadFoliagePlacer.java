...
extends FoliagePlacer {
    public static final MapCodec<RandomSpreadFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(i -> RandomSpreadFoliagePlacer.foliagePlacerParts(i).and(i.group(((MapCodec)IntProviders.codec(1, 512).fieldOf("foliage_height")).forGetter(c -> c.foliageHeight), ((MapCodec)Codec.intRange(0, 256).fieldOf("leaf_placement_attempts")).forGetter(c -> c.leafPlacementAttempts))).apply((Applicative<RandomSpreadFoliagePlacer, ?>)i, RandomSpreadFoliagePlacer::new));
