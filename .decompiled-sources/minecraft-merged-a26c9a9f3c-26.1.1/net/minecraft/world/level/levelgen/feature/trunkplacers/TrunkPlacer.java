...
public abstract class TrunkPlacer {
    ...
    protected static <P extends TrunkPlacer> Products.P3<RecordCodecBuilder.Mu<P>, Integer, Integer, Integer> trunkPlacerParts(RecordCodecBuilder.Instance<P> instance) {
        return instance.group(((MapCodec)Codec.intRange(0, 32).fieldOf("base_height")).forGetter(p -> p.baseHeight), ((MapCodec)Codec.intRange(0, 24).fieldOf("height_rand_a")).forGetter(p -> p.heightRandA), ((MapCodec)Codec.intRange(0, 24).fieldOf("height_rand_b")).forGetter(p -> p.heightRandB));
    }
