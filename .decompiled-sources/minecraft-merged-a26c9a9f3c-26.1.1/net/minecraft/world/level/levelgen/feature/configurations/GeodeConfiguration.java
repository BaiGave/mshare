...
implements FeatureConfiguration {
    ...
    public static final Codec<GeodeConfiguration> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)GeodeBlockSettings.CODEC.fieldOf("blocks")).forGetter(c -> c.geodeBlockSettings), ((MapCodec)GeodeLayerSettings.CODEC.fieldOf("layers")).forGetter(c -> c.geodeLayerSettings), ((MapCodec)GeodeCrackSettings.CODEC.fieldOf("crack")).forGetter(c -> c.geodeCrackSettings), ((MapCodec)CHANCE_RANGE.fieldOf("use_potential_placements_chance")).orElse(0.35).forGetter(c -> c.usePotentialPlacementsChance), ((MapCodec)CHANCE_RANGE.fieldOf("use_alternate_layer0_chance")).orElse(0.0).forGetter(c -> c.useAlternateLayer0Chance), ((MapCodec)Codec.BOOL.fieldOf("placements_require_layer0_alternate")).orElse(true).forGetter(c -> c.placementsRequireLayer0Alternate), ((MapCodec)IntProviders.codec(1, 20).fieldOf("outer_wall_distance")).orElse(UniformInt.of(4, 5)).forGetter(c -> c.outerWallDistance), ((MapCodec)IntProviders.codec(1, 20).fieldOf("distribution_points")).orElse(UniformInt.of(3, 4)).forGetter(c -> c.distributionPoints), ((MapCodec)IntProviders.codec(0, 10).fieldOf("point_offset")).orElse(UniformInt.of(1, 2)).forGetter(c -> c.pointOffset), ((MapCodec)Codec.INT.fieldOf("min_gen_offset")).orElse(-16).forGetter(c -> c.minGenOffset), ((MapCodec)Codec.INT.fieldOf("max_gen_offset")).orElse(16).forGetter(c -> c.maxGenOffset), ((MapCodec)CHANCE_RANGE.fieldOf("noise_multiplier")).orElse(0.05).forGetter(c -> c.noiseMultiplier), ((MapCodec)Codec.INT.fieldOf("invalid_blocks_threshold")).forGetter(c -> c.invalidBlocksThreshold)).apply((Applicative<GeodeConfiguration, ?>)i, GeodeConfiguration::new));
