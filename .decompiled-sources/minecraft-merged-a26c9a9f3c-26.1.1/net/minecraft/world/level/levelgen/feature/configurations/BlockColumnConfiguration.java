...
{
    public static final Codec<BlockColumnConfiguration> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Layer.CODEC.listOf().fieldOf("layers")).forGetter(BlockColumnConfiguration::layers), ((MapCodec)Direction.CODEC.fieldOf("direction")).forGetter(BlockColumnConfiguration::direction), ((MapCodec)BlockPredicate.CODEC.fieldOf("allowed_placement")).forGetter(BlockColumnConfiguration::allowedPlacement), ((MapCodec)Codec.BOOL.fieldOf("prioritize_tip")).forGetter(BlockColumnConfiguration::prioritizeTip)).apply((Applicative<BlockColumnConfiguration, ?>)i, BlockColumnConfiguration::new));
    ...
    public record Layer(IntProvider height, BlockStateProvider state) {
        public static final Codec<Layer> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)IntProviders.NON_NEGATIVE_CODEC.fieldOf("height")).forGetter(Layer::height), ((MapCodec)BlockStateProvider.CODEC.fieldOf("provider")).forGetter(Layer::state)).apply((Applicative<Layer, ?>)i, Layer::new));
    }
}
