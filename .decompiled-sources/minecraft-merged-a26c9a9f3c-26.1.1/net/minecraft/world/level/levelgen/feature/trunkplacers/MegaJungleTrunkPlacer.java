...
extends GiantTrunkPlacer {
    public static final MapCodec<MegaJungleTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(i -> MegaJungleTrunkPlacer.trunkPlacerParts(i).apply(i, MegaJungleTrunkPlacer::new));
