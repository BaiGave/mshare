...
extends FoliagePlacer {
    public static final MapCodec<AcaciaFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(i -> AcaciaFoliagePlacer.foliagePlacerParts(i).apply(i, AcaciaFoliagePlacer::new));
