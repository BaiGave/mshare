...
extends TrunkPlacer {
    ...
    public static final MapCodec<CherryTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(i -> CherryTrunkPlacer.trunkPlacerParts(i).and(i.group(((MapCodec)IntProviders.codec(1, 3).fieldOf("branch_count")).forGetter(t -> t.branchCount), ((MapCodec)IntProviders.codec(2, 16).fieldOf("branch_horizontal_length")).forGetter(t -> t.branchHorizontalLength), ((MapCodec)IntProviders.validateCodec(-16, 0, BRANCH_START_CODEC).fieldOf("branch_start_offset_from_top")).forGetter(t -> t.branchStartOffsetFromTop), ((MapCodec)IntProviders.codec(-16, 16).fieldOf("branch_end_offset_from_top")).forGetter(t -> t.branchEndOffsetFromTop))).apply((Applicative<CherryTrunkPlacer, ?>)i, CherryTrunkPlacer::new));
