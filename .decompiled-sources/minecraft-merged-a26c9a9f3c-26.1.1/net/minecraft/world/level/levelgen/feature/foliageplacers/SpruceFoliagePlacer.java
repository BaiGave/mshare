...
extends FoliagePlacer {
    public static final MapCodec<SpruceFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(i -> SpruceFoliagePlacer.foliagePlacerParts(i).and(((MapCodec)IntProviders.codec(0, 24).fieldOf("trunk_height")).forGetter(p -> p.trunkHeight)).apply((Applicative<SpruceFoliagePlacer, ?>)i, SpruceFoliagePlacer::new));
