...
{
    public static final Codec<SimpleBlockConfiguration> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)BlockStateProvider.CODEC.fieldOf("to_place")).forGetter(c -> c.toPlace), Codec.BOOL.optionalFieldOf("schedule_tick", false).forGetter(c -> c.scheduleTick)).apply((Applicative<SimpleBlockConfiguration, ?>)i, SimpleBlockConfiguration::new));
