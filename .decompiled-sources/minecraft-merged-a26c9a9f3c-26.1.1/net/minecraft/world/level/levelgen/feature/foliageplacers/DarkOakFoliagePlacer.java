...
extends FoliagePlacer {
    public static final MapCodec<DarkOakFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(i -> DarkOakFoliagePlacer.foliagePlacerParts(i).apply(i, DarkOakFoliagePlacer::new));
