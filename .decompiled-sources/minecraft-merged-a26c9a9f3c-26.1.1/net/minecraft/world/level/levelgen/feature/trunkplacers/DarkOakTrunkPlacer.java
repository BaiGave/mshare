...
extends TrunkPlacer {
    public static final MapCodec<DarkOakTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(i -> DarkOakTrunkPlacer.trunkPlacerParts(i).apply(i, DarkOakTrunkPlacer::new));
