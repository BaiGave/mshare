...
extends FoliagePlacer {
    public static final MapCodec<MegaJungleFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(i -> MegaJungleFoliagePlacer.foliagePlacerParts(i).and(((MapCodec)Codec.intRange(0, 16).fieldOf("height")).forGetter(p -> p.height)).apply((Applicative<MegaJungleFoliagePlacer, ?>)i, MegaJungleFoliagePlacer::new));
