...
public abstract class Structure {
    ...
    public record StructureSettings(HolderSet<Biome> biomes, Map<MobCategory, StructureSpawnOverride> spawnOverrides, GenerationStep.Decoration step, TerrainAdjustment terrainAdaptation) {
        ...
        public static final MapCodec<StructureSettings> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)RegistryCodecs.homogeneousList(Registries.BIOME).fieldOf("biomes")).forGetter(StructureSettings::biomes), Codec.simpleMap(MobCategory.CODEC, StructureSpawnOverride.CODEC, StringRepresentable.keys(MobCategory.values())).fieldOf("spawn_overrides").forGetter(StructureSettings::spawnOverrides), ((MapCodec)GenerationStep.Decoration.CODEC.fieldOf("step")).forGetter(StructureSettings::step), TerrainAdjustment.CODEC.optionalFieldOf("terrain_adaptation", StructureSettings.DEFAULT.terrainAdaptation).forGetter(StructureSettings::terrainAdaptation)).apply((Applicative<StructureSettings, ?>)i, StructureSettings::new));
