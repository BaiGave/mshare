...
extends StructurePoolElement {
    public static final MapCodec<FeaturePoolElement> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)PlacedFeature.CODEC.fieldOf("feature")).forGetter(e -> e.feature), FeaturePoolElement.projectionCodec()).apply((Applicative<FeaturePoolElement, ?>)i, FeaturePoolElement::new));
