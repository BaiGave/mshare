...
extends RuleTest {
    public static final MapCodec<RandomBlockMatchTest> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)BuiltInRegistries.BLOCK.byNameCodec().fieldOf("block")).forGetter(t -> t.block), ((MapCodec)Codec.FLOAT.fieldOf("probability")).forGetter(t -> Float.valueOf(t.probability))).apply((Applicative<RandomBlockMatchTest, ?>)i, RandomBlockMatchTest::new));
