...
extends Structure {
    public static final MapCodec<ShipwreckStructure> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(ShipwreckStructure.settingsCodec(i), ((MapCodec)Codec.BOOL.fieldOf("is_beached")).forGetter(s -> s.isBeached)).apply((Applicative<ShipwreckStructure, ?>)i, ShipwreckStructure::new));
