...
extends Structure {
    public static final MapCodec<OceanRuinStructure> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(OceanRuinStructure.settingsCodec(i), ((MapCodec)Type.CODEC.fieldOf("biome_temp")).forGetter(c -> c.biomeTemp), ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("large_probability")).forGetter(c -> Float.valueOf(c.largeProbability)), ((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("cluster_probability")).forGetter(c -> Float.valueOf(c.clusterProbability))).apply((Applicative<OceanRuinStructure, ?>)i, OceanRuinStructure::new));
