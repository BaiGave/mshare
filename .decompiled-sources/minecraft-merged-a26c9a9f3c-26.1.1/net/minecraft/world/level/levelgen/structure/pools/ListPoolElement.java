...
extends StructurePoolElement {
    public static final MapCodec<ListPoolElement> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)StructurePoolElement.CODEC.listOf().fieldOf("elements")).forGetter(e -> e.elements), ListPoolElement.projectionCodec()).apply((Applicative<ListPoolElement, ?>)i, ListPoolElement::new));
