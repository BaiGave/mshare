...
public class ProcessorRule {
    ...
    public static final Codec<ProcessorRule> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)RuleTest.CODEC.fieldOf("input_predicate")).forGetter(r -> r.inputPredicate), ((MapCodec)RuleTest.CODEC.fieldOf("location_predicate")).forGetter(r -> r.locPredicate), PosRuleTest.CODEC.lenientOptionalFieldOf("position_predicate", PosAlwaysTrueTest.INSTANCE).forGetter(r -> r.posPredicate), ((MapCodec)BlockState.CODEC.fieldOf("output_state")).forGetter(r -> r.outputState), RuleBlockEntityModifier.CODEC.lenientOptionalFieldOf("block_entity_modifier", DEFAULT_BLOCK_ENTITY_MODIFIER).forGetter(r -> r.blockEntityModifier)).apply((Applicative<ProcessorRule, ?>)i, ProcessorRule::new));
