...
extends StructureProcessor {
    public static final MapCodec<GravityProcessor> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Heightmap.Types.CODEC.fieldOf("heightmap")).orElse(Heightmap.Types.WORLD_SURFACE_WG).forGetter(p -> p.heightmap), ((MapCodec)Codec.INT.fieldOf("offset")).orElse(0).forGetter(p -> p.offset)).apply((Applicative<GravityProcessor, ?>)i, GravityProcessor::new));
