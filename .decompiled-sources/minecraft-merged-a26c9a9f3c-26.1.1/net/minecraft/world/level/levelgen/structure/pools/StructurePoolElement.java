...
public abstract class StructurePoolElement {
    ...
    public static Function<StructureTemplatePool.Projection, LegacySinglePoolElement> legacy(String location) {
        return p -> new LegacySinglePoolElement(Either.left(Identifier.parse(location)), EMPTY, (StructureTemplatePool.Projection)p, Optional.empty());
    }
    ...
    public static Function<StructureTemplatePool.Projection, LegacySinglePoolElement> legacy(String location, Holder<StructureProcessorList> processors) {
        return p -> new LegacySinglePoolElement(Either.left(Identifier.parse(location)), processors, (StructureTemplatePool.Projection)p, Optional.empty());
    }

    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String location) {
        return p -> new SinglePoolElement(Either.left(Identifier.parse(location)), EMPTY, (StructureTemplatePool.Projection)p, Optional.empty());
    }
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String location, Holder<StructureProcessorList> processors) {
        return p -> new SinglePoolElement(Either.left(Identifier.parse(location)), processors, (StructureTemplatePool.Projection)p, Optional.empty());
    }
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String location, LiquidSettings overrideLiquidSettings) {
        return p -> new SinglePoolElement(Either.left(Identifier.parse(location)), EMPTY, (StructureTemplatePool.Projection)p, Optional.of(overrideLiquidSettings));
    }
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String location, Holder<StructureProcessorList> processors, LiquidSettings overrideLiquidSettings) {
        return p -> new SinglePoolElement(Either.left(Identifier.parse(location)), processors, (StructureTemplatePool.Projection)p, Optional.of(overrideLiquidSettings));
    }
