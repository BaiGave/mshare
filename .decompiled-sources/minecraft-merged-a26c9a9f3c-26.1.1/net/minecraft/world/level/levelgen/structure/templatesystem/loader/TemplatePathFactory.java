...
public class TemplatePathFactory {
    ...
    public Path createAndValidatePathToStructure(Identifier resourceLocation) {
        ...
        List<String> decomposedPath = FileUtil.decomposePath(resourceLocation.getPath()).getOrThrow(msg -> new IdentifierException("Invalid file path '" + String.valueOf(resourceLocation) + "': " + msg));
