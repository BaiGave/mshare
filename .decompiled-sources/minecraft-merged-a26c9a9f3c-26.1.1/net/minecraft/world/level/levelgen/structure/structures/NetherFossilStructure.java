...
extends Structure {
    public static final MapCodec<NetherFossilStructure> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(NetherFossilStructure.settingsCodec(i), ((MapCodec)HeightProvider.CODEC.fieldOf("height")).forGetter(c -> c.height)).apply((Applicative<NetherFossilStructure, ?>)i, NetherFossilStructure::new));
