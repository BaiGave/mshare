...
public record StructureSpawnOverride(BoundingBoxType boundingBox, WeightedList<MobSpawnSettings.SpawnerData> spawns) {
    public static final Codec<StructureSpawnOverride> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)BoundingBoxType.CODEC.fieldOf("bounding_box")).forGetter(StructureSpawnOverride::boundingBox), ((MapCodec)WeightedList.codec(MobSpawnSettings.SpawnerData.CODEC).fieldOf("spawns")).forGetter(StructureSpawnOverride::spawns)).apply((Applicative<StructureSpawnOverride, ?>)i, StructureSpawnOverride::new));
