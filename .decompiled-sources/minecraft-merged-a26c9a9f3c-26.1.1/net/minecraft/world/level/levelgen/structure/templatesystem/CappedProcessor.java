...
extends StructureProcessor {
    public static final MapCodec<CappedProcessor> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)StructureProcessorType.SINGLE_CODEC.fieldOf("delegate")).forGetter(c -> c.delegate), ((MapCodec)IntProviders.POSITIVE_CODEC.fieldOf("limit")).forGetter(c -> c.limit)).apply((Applicative<CappedProcessor, ?>)i, CappedProcessor::new));
