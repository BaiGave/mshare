...
extends Structure {
    public static final MapCodec<MineshaftStructure> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(MineshaftStructure.settingsCodec(i), ((MapCodec)Type.CODEC.fieldOf("mineshaft_type")).forGetter(c -> c.type)).apply((Applicative<MineshaftStructure, ?>)i, MineshaftStructure::new));
