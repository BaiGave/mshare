...
public final class DensityFunctions {
    ...
    public static final Codec<DensityFunction> DIRECT_CODEC = Codec.either(NOISE_VALUE_CODEC, CODEC).xmap(either -> either.map(DensityFunctions::constant, Function.identity()), function -> {
    ...
    private static <A, O> KeyDispatchDataCodec<O> singleArgumentCodec(Codec<A> argumentCodec, Function<A, O> constructor, Function<O, A> getter) {
        return KeyDispatchDataCodec.of(((MapCodec)argumentCodec.fieldOf("argument")).xmap(constructor, getter));
    }
    ...
    private static <O> KeyDispatchDataCodec<O> doubleFunctionArgumentCodec(BiFunction<DensityFunction, DensityFunction, O> constructor, Function<O, DensityFunction> firstArgumentGetter, Function<O, DensityFunction> secondArgumentGetter) {
        return KeyDispatchDataCodec.of(RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument1")).forGetter(firstArgumentGetter), ((MapCodec)DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument2")).forGetter(secondArgumentGetter)).apply(i, constructor)));
    }
    ...
    {
        public static final MapCodec<Noise> DATA_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)DensityFunction.NoiseHolder.CODEC.fieldOf("noise")).forGetter(Noise::noise), ((MapCodec)Codec.DOUBLE.fieldOf("xz_scale")).forGetter(Noise::xzScale), ((MapCodec)Codec.DOUBLE.fieldOf("y_scale")).forGetter(Noise::yScale)).apply((Applicative<Noise, ?>)i, Noise::new));
    ...
    {
        private static final MapCodec<Clamp> DATA_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)DensityFunction.DIRECT_CODEC.fieldOf("input")).forGetter(Clamp::input), ((MapCodec)NOISE_VALUE_CODEC.fieldOf("min")).forGetter(Clamp::minValue), ((MapCodec)NOISE_VALUE_CODEC.fieldOf("max")).forGetter(Clamp::maxValue)).apply((Applicative<Clamp, ?>)i, Clamp::new));
    ...
    {
        private static final MapCodec<YClampedGradient> DATA_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.intRange(DimensionType.MIN_Y * 2, DimensionType.MAX_Y * 2).fieldOf("from_y")).forGetter(YClampedGradient::fromY), ((MapCodec)Codec.intRange(DimensionType.MIN_Y * 2, DimensionType.MAX_Y * 2).fieldOf("to_y")).forGetter(YClampedGradient::toY), ((MapCodec)NOISE_VALUE_CODEC.fieldOf("from_value")).forGetter(YClampedGradient::fromValue), ((MapCodec)NOISE_VALUE_CODEC.fieldOf("to_value")).forGetter(YClampedGradient::toValue)).apply((Applicative<YClampedGradient, ?>)i, YClampedGradient::new));
    ...
    {
        private static final MapCodec<FindTopSurface> DATA_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)DensityFunction.HOLDER_HELPER_CODEC.fieldOf("density")).forGetter(FindTopSurface::density), ((MapCodec)DensityFunction.HOLDER_HELPER_CODEC.fieldOf("upper_bound")).forGetter(FindTopSurface::upperBound), ((MapCodec)Codec.intRange(DimensionType.MIN_Y * 2, DimensionType.MAX_Y * 2).fieldOf("lower_bound")).forGetter(FindTopSurface::lowerBound), ((MapCodec)ExtraCodecs.POSITIVE_INT.fieldOf("cell_height")).forGetter(FindTopSurface::cellHeight)).apply((Applicative<FindTopSurface, ?>)i, FindTopSurface::new));
