...
public class WorldPreset {
    public static final Codec<WorldPreset> DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Codec.unboundedMap(ResourceKey.codec(Registries.LEVEL_STEM), LevelStem.CODEC).fieldOf("dimensions")).forGetter(e -> e.dimensions)).apply((Applicative<WorldPreset, ?>)i, WorldPreset::new)).validate(WorldPreset::requireOverworld);
