...
extends StateTestingPredicate {
    ...
    public static final MapCodec<MatchingFluidsPredicate> CODEC = RecordCodecBuilder.mapCodec(i -> MatchingFluidsPredicate.stateTestingCodec(i).and(((MapCodec)RegistryCodecs.homogeneousList(Registries.FLUID).fieldOf("fluids")).forGetter(c -> c.fluids)).apply((Applicative<MatchingFluidsPredicate, ?>)i, MatchingFluidsPredicate::new));
