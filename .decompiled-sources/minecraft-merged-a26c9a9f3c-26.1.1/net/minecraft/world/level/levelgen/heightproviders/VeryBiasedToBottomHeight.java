...
extends HeightProvider {
    public static final MapCodec<VeryBiasedToBottomHeight> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)VerticalAnchor.CODEC.fieldOf("min_inclusive")).forGetter(u -> u.minInclusive), ((MapCodec)VerticalAnchor.CODEC.fieldOf("max_inclusive")).forGetter(u -> u.maxInclusive), Codec.intRange(1, Integer.MAX_VALUE).optionalFieldOf("inner", 1).forGetter(u -> u.inner)).apply((Applicative<VeryBiasedToBottomHeight, ?>)i, VeryBiasedToBottomHeight::new));
