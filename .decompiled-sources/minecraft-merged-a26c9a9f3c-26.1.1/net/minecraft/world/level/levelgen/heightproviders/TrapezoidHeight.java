...
extends HeightProvider {
    public static final MapCodec<TrapezoidHeight> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)VerticalAnchor.CODEC.fieldOf("min_inclusive")).forGetter(u -> u.minInclusive), ((MapCodec)VerticalAnchor.CODEC.fieldOf("max_inclusive")).forGetter(u -> u.maxInclusive), Codec.INT.optionalFieldOf("plateau", 0).forGetter(u -> u.plateau)).apply((Applicative<TrapezoidHeight, ?>)i, TrapezoidHeight::new));
