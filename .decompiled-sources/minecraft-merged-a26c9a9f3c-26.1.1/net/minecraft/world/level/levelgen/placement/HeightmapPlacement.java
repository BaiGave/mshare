...
extends PlacementModifier {
    public static final MapCodec<HeightmapPlacement> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Heightmap.Types.CODEC.fieldOf("heightmap")).forGetter(c -> c.heightmap)).apply((Applicative<HeightmapPlacement, ?>)i, HeightmapPlacement::new));
