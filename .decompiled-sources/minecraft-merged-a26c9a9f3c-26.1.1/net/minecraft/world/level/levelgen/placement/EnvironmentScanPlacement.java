...
extends PlacementModifier {
    ...
    public static final MapCodec<EnvironmentScanPlacement> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Direction.VERTICAL_CODEC.fieldOf("direction_of_search")).forGetter(c -> c.directionOfSearch), ((MapCodec)BlockPredicate.CODEC.fieldOf("target_condition")).forGetter(c -> c.targetCondition), BlockPredicate.CODEC.optionalFieldOf("allowed_search_condition", BlockPredicate.alwaysTrue()).forGetter(c -> c.allowedSearchCondition), ((MapCodec)Codec.intRange(1, 32).fieldOf("max_steps")).forGetter(c -> c.maxSteps)).apply((Applicative<EnvironmentScanPlacement, ?>)i, EnvironmentScanPlacement::new));
