...
extends PlacementModifier {
    public static final MapCodec<FixedPlacement> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)BlockPos.CODEC.listOf().fieldOf("positions")).forGetter(c -> c.positions)).apply((Applicative<FixedPlacement, ?>)i, FixedPlacement::new));
