...
extends PlacementFilter {
    public static final MapCodec<SurfaceWaterDepthFilter> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.INT.fieldOf("max_water_depth")).forGetter(c -> c.maxWaterDepth)).apply((Applicative<SurfaceWaterDepthFilter, ?>)i, SurfaceWaterDepthFilter::new));
