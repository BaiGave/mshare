...
public record PlacedFeature(Holder<ConfiguredFeature<?, ?>> feature, List<PlacementModifier> placement) {
    public static final Codec<PlacedFeature> DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)ConfiguredFeature.CODEC.fieldOf("feature")).forGetter(c -> c.feature), ((MapCodec)PlacementModifier.CODEC.listOf().fieldOf("placement")).forGetter(c -> c.placement)).apply((Applicative<PlacedFeature, ?>)i, PlacedFeature::new));
