...
extends PlacementModifier {
    public static final MapCodec<CountOnEveryLayerPlacement> CODEC = ((MapCodec)IntProviders.codec(0, 256).fieldOf("count")).xmap(CountOnEveryLayerPlacement::new, c -> c.count);
