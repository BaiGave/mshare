...
implements DensityFunction.SimpleFunction {
    ...
    private static final MapCodec<BlendedNoise> DATA_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)SCALE_RANGE.fieldOf("xz_scale")).forGetter(n -> n.xzScale), ((MapCodec)SCALE_RANGE.fieldOf("y_scale")).forGetter(n -> n.yScale), ((MapCodec)SCALE_RANGE.fieldOf("xz_factor")).forGetter(n -> n.xzFactor), ((MapCodec)SCALE_RANGE.fieldOf("y_factor")).forGetter(n -> n.yFactor), ((MapCodec)Codec.doubleRange(1.0, 8.0).fieldOf("smear_scale_multiplier")).forGetter(n -> n.smearScaleMultiplier)).apply((Applicative<BlendedNoise, ?>)i, BlendedNoise::createUnseeded));
