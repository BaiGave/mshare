...
public class PerlinNoise {
    ...
    public static PerlinNoise createLegacyForBlendedNoise(RandomSource random, IntStream octaves) {
        return new PerlinNoise(random, PerlinNoise.makeAmplitudes(new IntRBTreeSet(octaves.boxed().collect(ImmutableList.toImmutableList()))), false);
    }
    ...
    public static PerlinNoise create(RandomSource random, IntStream octaves) {
        return PerlinNoise.create(random, octaves.boxed().collect(ImmutableList.toImmutableList()));
    }

    public static PerlinNoise create(RandomSource random, List<Integer> octaveSet) {
        return new PerlinNoise(random, PerlinNoise.makeAmplitudes(new IntRBTreeSet(octaveSet)), true);
    }
