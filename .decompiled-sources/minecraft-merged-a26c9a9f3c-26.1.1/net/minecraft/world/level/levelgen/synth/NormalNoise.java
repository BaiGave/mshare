...
public class NormalNoise {
    ...
    public static NormalNoise create(RandomSource random, int firstOctave, double ... amplitudes) {
        return NormalNoise.create(random, new NoiseParameters(firstOctave, new DoubleArrayList(amplitudes)));
    }
    ...
    public record NoiseParameters(int firstOctave, DoubleList amplitudes) {
        public static final Codec<NoiseParameters> DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Codec.INT.fieldOf("firstOctave")).forGetter(NoiseParameters::firstOctave), ((MapCodec)Codec.DOUBLE.listOf().fieldOf("amplitudes")).forGetter(NoiseParameters::amplitudes)).apply((Applicative<NoiseParameters, ?>)i, NoiseParameters::new));
