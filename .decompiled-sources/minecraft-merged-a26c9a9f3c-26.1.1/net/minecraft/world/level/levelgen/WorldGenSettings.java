...
extends SavedData {
    public static final Codec<WorldGenSettings> CODEC = RecordCodecBuilder.create(i -> i.group(WorldOptions.CODEC.forGetter(WorldGenSettings::options), WorldDimensions.CODEC.forGetter(WorldGenSettings::dimensions)).apply((Applicative<WorldGenSettings, ?>)i, i.stable(WorldGenSettings::new)));
