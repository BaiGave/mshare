...
implements AutoCloseable {
    ...
    private void requestChunkLoad(long chunkKey) {
        this.chunkLoadStatuses.put(chunkKey, ChunkLoadStatus.PENDING);
    ...
    public void processPendingLoads() {
        ...
        while ((loadedChunk = this.loadingInbox.poll()) != null) {
            ...
            this.chunkLoadStatuses.put(loadedChunk.getPos().pack(), ChunkLoadStatus.LOADED);
        }
    }
        ...
        public void onMove() {
            ...
            if (newSectionPos != this.currentSectionKey) {
                ...
                if (!this.currentSection.remove(this.entity)) {
                    LOGGER.warn("Entity {} wasn't found in section {} (moving to {})", this.entity, SectionPos.of(this.currentSectionKey), newSectionPos);
                }
