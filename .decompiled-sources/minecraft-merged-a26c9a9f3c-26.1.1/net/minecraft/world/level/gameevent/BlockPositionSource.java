...
{
    public static final MapCodec<BlockPositionSource> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)BlockPos.CODEC.fieldOf("pos")).forGetter(BlockPositionSource::pos)).apply((Applicative<BlockPositionSource, ?>)i, BlockPositionSource::new));
