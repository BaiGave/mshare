...
public final class Path {
    public static final StreamCodec<FriendlyByteBuf, Path> STREAM_CODEC = StreamCodec.of((output, value) -> value.writeToStream((FriendlyByteBuf)output), Path::createFromStream);
    ...
    public void writeToStream(FriendlyByteBuf buffer) {
        ...
        buffer.writeCollection(this.nodes, (out, node) -> node.writeToStream((FriendlyByteBuf)out));
    ...
    public record DebugData(Node[] openSet, Node[] closedSet, Set<Target> targetNodes) {
        public void write(FriendlyByteBuf output) {
            output.writeCollection(this.targetNodes, (out, target) -> target.writeToStream((FriendlyByteBuf)out));
