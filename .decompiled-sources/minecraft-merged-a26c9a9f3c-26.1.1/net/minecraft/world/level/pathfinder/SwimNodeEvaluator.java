...
extends NodeEvaluator {
    ...
    private final Long2ObjectMap<PathType> pathTypesByPosCache = new Long2ObjectOpenHashMap<PathType>();
    ...
    public int getNeighbors(Node[] neighbors, Node pos) {
        int count = 0;
        EnumMap<Direction, Node> nodes = Maps.newEnumMap(Direction.class);
