...
public final class Biome {
    public static final Codec<Biome> DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group(ClimateSettings.CODEC.forGetter(b -> b.climateSettings), EnvironmentAttributeMap.CODEC_ONLY_POSITIONAL.optionalFieldOf("attributes", EnvironmentAttributeMap.EMPTY).forGetter(b -> b.attributes), ((MapCodec)BiomeSpecialEffects.CODEC.fieldOf("effects")).forGetter(b -> b.specialEffects), BiomeGenerationSettings.CODEC.forGetter(b -> b.generationSettings), MobSpawnSettings.CODEC.forGetter(b -> b.mobSettings)).apply((Applicative<Biome, ?>)i, Biome::new));
    public static final Codec<Biome> NETWORK_CODEC = RecordCodecBuilder.create(i -> i.group(ClimateSettings.CODEC.forGetter(b -> b.climateSettings), EnvironmentAttributeMap.NETWORK_CODEC.optionalFieldOf("attributes", EnvironmentAttributeMap.EMPTY).forGetter(b -> b.attributes), ((MapCodec)BiomeSpecialEffects.CODEC.fieldOf("effects")).forGetter(b -> b.specialEffects)).apply((Applicative<Biome, ?>)i, (climateSettings, attributes, specialEffects) -> new Biome((ClimateSettings)climateSettings, (EnvironmentAttributeMap)attributes, (BiomeSpecialEffects)specialEffects, BiomeGenerationSettings.EMPTY, MobSpawnSettings.EMPTY)));
    ...
    private static final PerlinSimplexNoise FROZEN_TEMPERATURE_NOISE = new PerlinSimplexNoise((RandomSource)new WorldgenRandom(new LegacyRandomSource(3456L)), ImmutableList.of(Integer.valueOf(-2), Integer.valueOf(-1), Integer.valueOf(0)));
    ...
    private record ClimateSettings(boolean hasPrecipitation, float temperature, TemperatureModifier temperatureModifier, float downfall) {
        public static final MapCodec<ClimateSettings> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.BOOL.fieldOf("has_precipitation")).forGetter(b -> b.hasPrecipitation), ((MapCodec)Codec.FLOAT.fieldOf("temperature")).forGetter(b -> Float.valueOf(b.temperature)), TemperatureModifier.CODEC.optionalFieldOf("temperature_modifier", TemperatureModifier.NONE).forGetter(b -> b.temperatureModifier), ((MapCodec)Codec.FLOAT.fieldOf("downfall")).forGetter(b -> Float.valueOf(b.downfall))).apply((Applicative<ClimateSettings, ?>)i, ClimateSettings::new));
    }
