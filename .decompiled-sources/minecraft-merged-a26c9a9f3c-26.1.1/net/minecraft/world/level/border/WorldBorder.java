...
extends SavedData {
    ...
    public record Settings(double centerX, double centerZ, double damagePerBlock, double safeZone, int warningBlocks, int warningTime, double size, long lerpTime, double lerpTarget) {
        ...
        public static final Codec<Settings> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Codec.doubleRange(-2.9999984E7, 2.9999984E7).fieldOf("center_x")).forGetter(Settings::centerX), ((MapCodec)Codec.doubleRange(-2.9999984E7, 2.9999984E7).fieldOf("center_z")).forGetter(Settings::centerZ), ((MapCodec)Codec.DOUBLE.fieldOf("damage_per_block")).forGetter(Settings::damagePerBlock), ((MapCodec)Codec.DOUBLE.fieldOf("safe_zone")).forGetter(Settings::safeZone), ((MapCodec)Codec.INT.fieldOf("warning_blocks")).forGetter(Settings::warningBlocks), ((MapCodec)Codec.INT.fieldOf("warning_time")).forGetter(Settings::warningTime), ((MapCodec)Codec.DOUBLE.fieldOf("size")).forGetter(Settings::size), ((MapCodec)Codec.LONG.fieldOf("lerp_time")).forGetter(Settings::lerpTime), ((MapCodec)Codec.DOUBLE.fieldOf("lerp_target")).forGetter(Settings::lerpTarget)).apply((Applicative<Settings, ?>)i, Settings::new));
