...
public record LevelStem(Holder<DimensionType> type, ChunkGenerator generator) {
    public static final Codec<LevelStem> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)DimensionType.CODEC.fieldOf("type")).forGetter(LevelStem::type), ((MapCodec)ChunkGenerator.CODEC.fieldOf("generator")).forGetter(LevelStem::generator)).apply((Applicative<LevelStem, ?>)i, i.stable(LevelStem::new)));
