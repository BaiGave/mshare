...
public final class Shapes {
    ...
    public static boolean blockOccludes(VoxelShape shape, VoxelShape occluder, Direction direction) {
        ...
        return DoubleMath.fuzzyEquals(first.max(axis), 1.0, 1.0E-7) && DoubleMath.fuzzyEquals(second.min(axis), 0.0, 1.0E-7) && !Shapes.joinIsNotEmpty(new SliceShape(first, axis, first.shape.getSize(axis) - 1), new SliceShape(second, axis, 0), op);
    }
