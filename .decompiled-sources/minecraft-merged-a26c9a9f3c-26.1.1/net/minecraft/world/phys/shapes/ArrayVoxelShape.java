...
extends VoxelShape {
    ...
    protected ArrayVoxelShape(DiscreteVoxelShape shape, double[] xs, double[] ys, double[] zs) {
        this(shape, DoubleArrayList.wrap(Arrays.copyOf(xs, shape.getXSize() + 1)), DoubleArrayList.wrap(Arrays.copyOf(ys, shape.getYSize() + 1)), DoubleArrayList.wrap(Arrays.copyOf(zs, shape.getZSize() + 1)));
    }
