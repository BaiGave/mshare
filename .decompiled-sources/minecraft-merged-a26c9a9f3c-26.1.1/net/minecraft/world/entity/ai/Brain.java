...
public class Brain<E extends LivingEntity> {
    ...
    public static <E extends LivingEntity> Provider<E> provider(Collection<? extends SensorType<? extends Sensor<? super E>>> sensorTypes) {
        return new Provider<LivingEntity>(ImmutableList.of(), sensorTypes, livingEntity -> List.of());
    }
    ...
    public List<BehaviorControl<? super E>> getRunningBehaviors() {
        ObjectArrayList<BehaviorControl<BehaviorControl<E>>> runningBehaviours = new ObjectArrayList<BehaviorControl<BehaviorControl<E>>>();
    ...
    private boolean activityRequirementsAreMet(Activity activity) {
        ...
        for (Pair<MemoryModuleType<?>, MemoryStatus> memoryRequirement : this.activityRequirements.get(activity)) {
            ...
            if (this.checkMemory(memoryType, memoryStatus = memoryRequirement.getSecond())) continue;
            return false;
        }
        return true;
    }
    ...
    public record Packed(MemoryMap memories) {
        ...
        public static final Codec<Packed> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)MemoryMap.CODEC.fieldOf("memories")).forGetter(Packed::memories)).apply((Applicative<Packed, ?>)i, Packed::new));
    }
}
