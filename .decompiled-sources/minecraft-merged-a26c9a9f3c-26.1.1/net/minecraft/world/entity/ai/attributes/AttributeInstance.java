...
public class AttributeInstance {
    ...
    private final Map<Identifier, AttributeModifier> modifierById = new Object2ObjectArrayMap<Identifier, AttributeModifier>();
    private final Map<Identifier, AttributeModifier> permanentModifiers = new Object2ObjectArrayMap<Identifier, AttributeModifier>();
    ...
    public record Packed(Holder<Attribute> attribute, double baseValue, List<AttributeModifier> modifiers) {
        public static final Codec<Packed> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)BuiltInRegistries.ATTRIBUTE.holderByNameCodec().fieldOf("id")).forGetter(Packed::attribute), ((MapCodec)Codec.DOUBLE.fieldOf("base")).orElse(0.0).forGetter(Packed::baseValue), AttributeModifier.CODEC.listOf().optionalFieldOf("modifiers", List.of()).forGetter(Packed::modifiers)).apply((Applicative<Packed, ?>)i, Packed::new));
