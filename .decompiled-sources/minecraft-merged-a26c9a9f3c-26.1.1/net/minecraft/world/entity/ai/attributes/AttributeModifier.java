...
public record AttributeModifier(Identifier id, double amount, Operation operation) {
    public static final MapCodec<AttributeModifier> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("id")).forGetter(AttributeModifier::id), ((MapCodec)Codec.DOUBLE.fieldOf("amount")).forGetter(AttributeModifier::amount), ((MapCodec)Operation.CODEC.fieldOf("operation")).forGetter(AttributeModifier::operation)).apply((Applicative<AttributeModifier, ?>)i, AttributeModifier::new));
