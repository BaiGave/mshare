...
public class SetHiddenState {
    ...
    public static BehaviorControl<LivingEntity> create(int seconds, int closeEnoughDist) {
        ...
        return BehaviorBuilder.create(i -> i.group(i.present(MemoryModuleType.HIDING_PLACE), i.present(MemoryModuleType.HEARD_BELL_TIME)).apply(i, (hidingPlace, heardBellTime) -> (level, body, timestamp) -> {
