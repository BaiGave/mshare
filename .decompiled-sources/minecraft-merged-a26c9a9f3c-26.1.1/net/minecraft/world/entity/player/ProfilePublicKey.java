...
public record ProfilePublicKey(Data data) {
    ...
    public record Data(Instant expiresAt, PublicKey key, byte[] keySignature) {
        ...
        public static final Codec<Data> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)ExtraCodecs.INSTANT_ISO8601.fieldOf("expires_at")).forGetter(Data::expiresAt), ((MapCodec)Crypt.PUBLIC_KEY_CODEC.fieldOf("key")).forGetter(Data::key), ((MapCodec)ExtraCodecs.BASE64_STRING.fieldOf("signature_v2")).forGetter(Data::keySignature)).apply((Applicative<Data, ?>)i, Data::new));
