...
public class Abilities {
    ...
    public record Packed(boolean invulnerable, boolean flying, boolean mayFly, boolean instabuild, boolean mayBuild, float flyingSpeed, float walkingSpeed) {
        public static final Codec<Packed> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Codec.BOOL.fieldOf("invulnerable")).orElse(false).forGetter(Packed::invulnerable), ((MapCodec)Codec.BOOL.fieldOf("flying")).orElse(false).forGetter(Packed::flying), ((MapCodec)Codec.BOOL.fieldOf("mayfly")).orElse(false).forGetter(Packed::mayFly), ((MapCodec)Codec.BOOL.fieldOf("instabuild")).orElse(false).forGetter(Packed::instabuild), ((MapCodec)Codec.BOOL.fieldOf("mayBuild")).orElse(true).forGetter(Packed::mayBuild), ((MapCodec)Codec.FLOAT.fieldOf("flySpeed")).orElse(Float.valueOf(0.05f)).forGetter(Packed::flyingSpeed), ((MapCodec)Codec.FLOAT.fieldOf("walkSpeed")).orElse(Float.valueOf(0.1f)).forGetter(Packed::walkingSpeed)).apply((Applicative<Packed, ?>)i, Packed::new));
    }
}
