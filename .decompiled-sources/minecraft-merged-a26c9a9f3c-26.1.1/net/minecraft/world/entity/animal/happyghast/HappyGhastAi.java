...
public class HappyGhastAi {
    ...
    private static ActivityData<HappyGhast> initIdleActivity() {
        return ActivityData.create(Activity.IDLE, ImmutableList.of(Pair.of(1, new FollowTemptation(mob -> Float.valueOf(1.25f), mob -> 3.0, true)), Pair.of(2, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, mob -> Float.valueOf(1.1f), MemoryModuleType.NEAREST_VISIBLE_PLAYER, true)), Pair.of(3, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, mob -> Float.valueOf(1.1f), MemoryModuleType.NEAREST_VISIBLE_ADULT, true)), Pair.of(4, new RunOne(ImmutableList.of(Pair.of(RandomStroll.fly(1.0f), 1), Pair.of(SetWalkTargetFromLookTarget.create(1.0f, 3), 1))))));
    }
