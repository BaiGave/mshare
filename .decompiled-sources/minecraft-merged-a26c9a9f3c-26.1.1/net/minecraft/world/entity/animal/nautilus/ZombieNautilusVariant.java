...
{
    public static final Codec<ZombieNautilusVariant> DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group(ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(ZombieNautilusVariant::modelAndTexture), ((MapCodec)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions")).forGetter(ZombieNautilusVariant::spawnConditions)).apply((Applicative<ZombieNautilusVariant, ?>)i, ZombieNautilusVariant::new));
    public static final Codec<ZombieNautilusVariant> NETWORK_CODEC = RecordCodecBuilder.create(i -> i.group(ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(ZombieNautilusVariant::modelAndTexture)).apply((Applicative<ZombieNautilusVariant, ?>)i, ZombieNautilusVariant::new));
