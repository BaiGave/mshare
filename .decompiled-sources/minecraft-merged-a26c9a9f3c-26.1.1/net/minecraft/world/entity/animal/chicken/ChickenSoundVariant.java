...
public record ChickenSoundVariant(ChickenSoundSet adultSounds, ChickenSoundSet babySounds) {
    ...
    private static Codec<ChickenSoundVariant> codec() {
        return RecordCodecBuilder.create(i -> i.group(((MapCodec)ChickenSoundSet.CODEC.fieldOf("adult_sounds")).forGetter(ChickenSoundVariant::adultSounds), ((MapCodec)ChickenSoundSet.CODEC.fieldOf("baby_sounds")).forGetter(ChickenSoundVariant::babySounds)).apply((Applicative<ChickenSoundVariant, ?>)i, ChickenSoundVariant::new));
    }
    ...
    public record ChickenSoundSet(Holder<SoundEvent> ambientSound, Holder<SoundEvent> hurtSound, Holder<SoundEvent> deathSound, Holder<SoundEvent> stepSound) {
        private static Codec<ChickenSoundSet> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)SoundEvent.CODEC.fieldOf("ambient_sound")).forGetter(ChickenSoundSet::ambientSound), ((MapCodec)SoundEvent.CODEC.fieldOf("hurt_sound")).forGetter(ChickenSoundSet::hurtSound), ((MapCodec)SoundEvent.CODEC.fieldOf("death_sound")).forGetter(ChickenSoundSet::deathSound), ((MapCodec)SoundEvent.CODEC.fieldOf("step_sound")).forGetter(ChickenSoundSet::stepSound)).apply((Applicative<ChickenSoundSet, ?>)i, ChickenSoundSet::new));
    }
}
