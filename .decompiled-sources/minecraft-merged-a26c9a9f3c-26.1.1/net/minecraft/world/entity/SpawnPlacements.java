...
public class SpawnPlacements {
    ...
    public static <T extends Mob> void register(EntityType<T> type, SpawnPlacementType placementType, Heightmap.Types heightmap, SpawnPredicate<T> spawnPredicate) {
