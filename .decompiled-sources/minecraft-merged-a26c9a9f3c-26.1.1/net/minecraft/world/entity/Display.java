...
extends Entity {
    ...
    private static final IntSet RENDER_STATE_IDS = IntSet.of(DATA_TRANSLATION_ID.id(), DATA_SCALE_ID.id(), DATA_LEFT_ROTATION_ID.id(), DATA_RIGHT_ROTATION_ID.id(), DATA_BILLBOARD_RENDER_CONSTRAINTS_ID.id(), DATA_BRIGHTNESS_OVERRIDE_ID.id(), DATA_SHADOW_RADIUS_ID.id(), DATA_SHADOW_STRENGTH_ID.id());
    ...
    public final void setTransformationInterpolationDuration(int duration) {
    ...
    public final void setTransformationInterpolationDelay(int ticks) {
    ...
    public final void setPosRotInterpolationDuration(int duration) {
    ...
    public final void setBillboardConstraints(BillboardConstraints constraints) {
        this.entityData.set(DATA_BILLBOARD_RENDER_CONSTRAINTS_ID, constraints.getId());
    }

    public final BillboardConstraints getBillboardConstraints() {
    ...
    public final void setViewRange(float range) {
    ...
    public final void setShadowRadius(float size) {
    ...
    public final void setShadowStrength(float strength) {
    ...
    public final void setHeight(float width) {
    ...
    public final void setGlowColorOverride(int value) {
    ...
    extends Display {
        ...
        private static final IntSet TEXT_RENDER_STATE_IDS = IntSet.of(DATA_TEXT_ID.id(), DATA_LINE_WIDTH_ID.id(), DATA_BACKGROUND_COLOR_ID.id(), DATA_TEXT_OPACITY_ID.id(), DATA_STYLE_FLAGS_ID.id());
        ...
        public final void setTextOpacity(byte opacity) {
        ...
        protected void readAdditionalSaveData(ValueInput input) {
            ...
            if (text.isPresent()) {
                try {
                    ...
                    LOGGER.warn("Failed to parse display entity text {}", (Object)text, (Object)e);
                }
            }
        }
    ...
    extends Display {
        ...
        public final void setItemTransform(ItemDisplayContext transform) {
