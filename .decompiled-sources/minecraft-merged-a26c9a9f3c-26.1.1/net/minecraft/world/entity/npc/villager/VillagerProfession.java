...
public record VillagerProfession(Component name, Predicate<Holder<PoiType>> heldJobSite, Predicate<Holder<PoiType>> acquirableJobSite, ImmutableSet<Item> requestedItems, ImmutableSet<Block> secondaryPoi, @Nullable SoundEvent workSound, Int2ObjectMap<ResourceKey<TradeSet>> tradeSetsByLevel) {
    ...
    private static VillagerProfession register(Registry<VillagerProfession> registry, ResourceKey<VillagerProfession> name, Predicate<Holder<PoiType>> heldJobSite, Predicate<Holder<PoiType>> acquirableJobSite, @Nullable SoundEvent workSound) {
        return VillagerProfession.register(registry, name, heldJobSite, acquirableJobSite, ImmutableSet.of(), ImmutableSet.of(), workSound, Int2ObjectMap.ofEntries(new Int2ObjectMap.Entry[0]));
    }
    ...
    private static VillagerProfession register(Registry<VillagerProfession> registry, ResourceKey<VillagerProfession> name, Predicate<Holder<PoiType>> heldJobSite, Predicate<Holder<PoiType>> acquirableJobSite, @Nullable SoundEvent workSound, Int2ObjectMap<ResourceKey<TradeSet>> trades) {
        return VillagerProfession.register(registry, name, heldJobSite, acquirableJobSite, ImmutableSet.of(), ImmutableSet.of(), workSound, trades);
    }
    ...
    public static VillagerProfession bootstrap(Registry<VillagerProfession> registry) {
        ...
        VillagerProfession.register(registry, ARMORER, PoiTypes.ARMORER, SoundEvents.VILLAGER_WORK_ARMORER, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.ARMORER_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.ARMORER_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.ARMORER_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.ARMORER_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.ARMORER_LEVEL_5)));
        VillagerProfession.register(registry, BUTCHER, PoiTypes.BUTCHER, SoundEvents.VILLAGER_WORK_BUTCHER, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.BUTCHER_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.BUTCHER_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.BUTCHER_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.BUTCHER_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.BUTCHER_LEVEL_5)));
        VillagerProfession.register(registry, CARTOGRAPHER, PoiTypes.CARTOGRAPHER, SoundEvents.VILLAGER_WORK_CARTOGRAPHER, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.CARTOGRAPHER_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.CARTOGRAPHER_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.CARTOGRAPHER_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.CARTOGRAPHER_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.CARTOGRAPHER_LEVEL_5)));
        VillagerProfession.register(registry, CLERIC, PoiTypes.CLERIC, SoundEvents.VILLAGER_WORK_CLERIC, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.CLERIC_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.CLERIC_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.CLERIC_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.CLERIC_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.CLERIC_LEVEL_5)));
        VillagerProfession.register(registry, FARMER, PoiTypes.FARMER, ImmutableSet.of(Items.WHEAT, Items.WHEAT_SEEDS, Items.BEETROOT_SEEDS, Items.BONE_MEAL), ImmutableSet.of(Blocks.FARMLAND), SoundEvents.VILLAGER_WORK_FARMER, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.FARMER_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.FARMER_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.FARMER_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.FARMER_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.FARMER_LEVEL_5)));
        VillagerProfession.register(registry, FISHERMAN, PoiTypes.FISHERMAN, SoundEvents.VILLAGER_WORK_FISHERMAN, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.FISHERMAN_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.FISHERMAN_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.FISHERMAN_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.FISHERMAN_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.FISHERMAN_LEVEL_5)));
        VillagerProfession.register(registry, FLETCHER, PoiTypes.FLETCHER, SoundEvents.VILLAGER_WORK_FLETCHER, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.FLETCHER_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.FLETCHER_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.FLETCHER_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.FLETCHER_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.FLETCHER_LEVEL_5)));
        VillagerProfession.register(registry, LEATHERWORKER, PoiTypes.LEATHERWORKER, SoundEvents.VILLAGER_WORK_LEATHERWORKER, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.LEATHERWORKER_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.LEATHERWORKER_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.LEATHERWORKER_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.LEATHERWORKER_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.LEATHERWORKER_LEVEL_5)));
        VillagerProfession.register(registry, LIBRARIAN, PoiTypes.LIBRARIAN, SoundEvents.VILLAGER_WORK_LIBRARIAN, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.LIBRARIAN_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.LIBRARIAN_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.LIBRARIAN_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.LIBRARIAN_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.LIBRARIAN_LEVEL_5)));
        VillagerProfession.register(registry, MASON, PoiTypes.MASON, SoundEvents.VILLAGER_WORK_MASON, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.MASON_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.MASON_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.MASON_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.MASON_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.MASON_LEVEL_5)));
        ...
        return VillagerProfession.register(registry, WEAPONSMITH, PoiTypes.WEAPONSMITH, SoundEvents.VILLAGER_WORK_WEAPONSMITH, Int2ObjectMap.ofEntries(Int2ObjectMap.entry(1, TradeSets.WEAPONSMITH_LEVEL_1), Int2ObjectMap.entry(2, TradeSets.WEAPONSMITH_LEVEL_2), Int2ObjectMap.entry(3, TradeSets.WEAPONSMITH_LEVEL_3), Int2ObjectMap.entry(4, TradeSets.WEAPONSMITH_LEVEL_4), Int2ObjectMap.entry(5, TradeSets.WEAPONSMITH_LEVEL_5)));
    }
