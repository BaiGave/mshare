...
public class Scoreboard {
    ...
    private final Object2ObjectMap<String, Objective> objectivesByName = new Object2ObjectOpenHashMap<String, Objective>(16, 0.5f);
    private final Reference2ObjectMap<ObjectiveCriteria, List<Objective>> objectivesByCriteria = new Reference2ObjectOpenHashMap<ObjectiveCriteria, List<Objective>>();
    private final Map<String, PlayerScores> playerScores = new Object2ObjectOpenHashMap<String, PlayerScores>(16, 0.5f);
    private final Map<DisplaySlot, Objective> displayObjectives = new EnumMap<DisplaySlot, Objective>(DisplaySlot.class);
    private final Object2ObjectMap<String, PlayerTeam> teamsByName = new Object2ObjectOpenHashMap<String, PlayerTeam>();
    private final Object2ObjectMap<String, PlayerTeam> teamsByPlayer = new Object2ObjectOpenHashMap<String, PlayerTeam>();
    ...
    public final void forAllObjectives(ObjectiveCriteria criteria, ScoreHolder name, Consumer<ScoreAccess> operation) {
        this.objectivesByCriteria.getOrDefault(criteria, Collections.emptyList()).forEach(o -> operation.accept(this.getOrCreatePlayerScore(name, (Objective)o, true)));
    }
    ...
    public void removeObjective(Objective objective) {
        ...
        List objectives = (List)this.objectivesByCriteria.get(objective.getCriteria());
        if (objectives != null) {
