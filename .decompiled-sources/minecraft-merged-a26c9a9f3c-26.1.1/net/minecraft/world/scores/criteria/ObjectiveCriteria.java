...
public class ObjectiveCriteria {
    ...
    public static ObjectiveCriteria registerCustom(String name, boolean readOnly, RenderType renderType) {
        ObjectiveCriteria result = new ObjectiveCriteria(name, readOnly, renderType);
        CUSTOM_CRITERIA.put(name, result);
        return result;
    }

    public static ObjectiveCriteria registerCustom(String name) {
