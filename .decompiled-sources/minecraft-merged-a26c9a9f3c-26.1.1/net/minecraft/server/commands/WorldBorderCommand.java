...
public class WorldBorderCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("worldborder").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(Commands.literal("add").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("distance", DoubleArgumentType.doubleArg(-5.9999968E7, 5.9999968E7)).executes(c -> WorldBorderCommand.setSize((CommandSourceStack)c.getSource(), ((CommandSourceStack)c.getSource()).getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(c, "distance"), 0L))).then(Commands.argument("time", TimeArgument.time(0)).executes(c -> WorldBorderCommand.setSize((CommandSourceStack)c.getSource(), ((CommandSourceStack)c.getSource()).getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(c, "distance"), ((CommandSourceStack)c.getSource()).getLevel().getWorldBorder().getLerpTime() + (long)IntegerArgumentType.getInteger(c, "time"))))))).then(Commands.literal("set").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("distance", DoubleArgumentType.doubleArg(-5.9999968E7, 5.9999968E7)).executes(c -> WorldBorderCommand.setSize((CommandSourceStack)c.getSource(), DoubleArgumentType.getDouble(c, "distance"), 0L))).then(Commands.argument("time", TimeArgument.time(0)).executes(c -> WorldBorderCommand.setSize((CommandSourceStack)c.getSource(), DoubleArgumentType.getDouble(c, "distance"), IntegerArgumentType.getInteger(c, "time"))))))).then(Commands.literal("center").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("pos", Vec2Argument.vec2()).executes(c -> WorldBorderCommand.setCenter((CommandSourceStack)c.getSource(), Vec2Argument.getVec2(c, "pos")))))).then(((LiteralArgumentBuilder)Commands.literal("damage").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("amount").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("damagePerBlock", FloatArgumentType.floatArg(0.0f)).executes(c -> WorldBorderCommand.setDamageAmount((CommandSourceStack)c.getSource(), FloatArgumentType.getFloat(c, "damagePerBlock")))))).then(Commands.literal("buffer").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("distance", FloatArgumentType.floatArg(0.0f)).executes(c -> WorldBorderCommand.setDamageBuffer((CommandSourceStack)c.getSource(), FloatArgumentType.getFloat(c, "distance"))))))).then(Commands.literal("get").executes(c -> WorldBorderCommand.getSize((CommandSourceStack)c.getSource())))).then(((LiteralArgumentBuilder)Commands.literal("warning").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("distance").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("distance", IntegerArgumentType.integer(0)).executes(c -> WorldBorderCommand.setWarningDistance((CommandSourceStack)c.getSource(), IntegerArgumentType.getInteger(c, "distance")))))).then(Commands.literal("time").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("time", TimeArgument.time(0)).executes(c -> WorldBorderCommand.setWarningTime((CommandSourceStack)c.getSource(), IntegerArgumentType.getInteger(c, "time")))))));
    }
