...
public class HelpCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("help").executes(s -> {
            ...
            Map<CommandNode<CommandSourceStack>, String> usage = dispatcher.getSmartUsage(Iterables.getLast(command.getContext().getNodes()).getNode(), (CommandSourceStack)s.getSource());
            for (String line : usage.values()) {
