...
public class ScheduleCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("schedule").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(Commands.literal("function").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("function", FunctionArgument.functions()).suggests(FunctionCommand.SUGGEST_FUNCTION).then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("time", TimeArgument.time()).executes(c -> ScheduleCommand.schedule((CommandSourceStack)c.getSource(), FunctionArgument.getFunctionOrTag(c, "function"), IntegerArgumentType.getInteger(c, "time"), true))).then(Commands.literal("append").executes(c -> ScheduleCommand.schedule((CommandSourceStack)c.getSource(), FunctionArgument.getFunctionOrTag(c, "function"), IntegerArgumentType.getInteger(c, "time"), false)))).then(Commands.literal("replace").executes(c -> ScheduleCommand.schedule((CommandSourceStack)c.getSource(), FunctionArgument.getFunctionOrTag(c, "function"), IntegerArgumentType.getInteger(c, "time"), true))))))).then(Commands.literal("clear").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("function", StringArgumentType.greedyString()).suggests(SUGGEST_SCHEDULE).executes(c -> ScheduleCommand.remove((CommandSourceStack)c.getSource(), StringArgumentType.getString(c, "function"))))));
    }
