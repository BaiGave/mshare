...
public class TeamMsgCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        LiteralCommandNode<CommandSourceStack> msg = dispatcher.register((LiteralArgumentBuilder)Commands.literal("teammsg").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("message", MessageArgument.message()).executes(c -> {
            ...
            if (!receivers.isEmpty()) {
                MessageArgument.resolveChatMessage(c, "message", message -> TeamMsgCommand.sendMessage(source, entity, team, receivers, message));
            }
