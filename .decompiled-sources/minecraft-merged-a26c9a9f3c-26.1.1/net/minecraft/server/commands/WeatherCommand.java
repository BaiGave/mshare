...
public class WeatherCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("weather").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(((LiteralArgumentBuilder)Commands.literal("clear").executes(c -> WeatherCommand.setClear((CommandSourceStack)c.getSource(), -1))).then(Commands.argument("duration", TimeArgument.time(1)).executes(c -> WeatherCommand.setClear((CommandSourceStack)c.getSource(), IntegerArgumentType.getInteger(c, "duration")))))).then(((LiteralArgumentBuilder)Commands.literal("rain").executes(c -> WeatherCommand.setRain((CommandSourceStack)c.getSource(), -1))).then(Commands.argument("duration", TimeArgument.time(1)).executes(c -> WeatherCommand.setRain((CommandSourceStack)c.getSource(), IntegerArgumentType.getInteger(c, "duration")))))).then(((LiteralArgumentBuilder)Commands.literal("thunder").executes(c -> WeatherCommand.setThunder((CommandSourceStack)c.getSource(), -1))).then(Commands.argument("duration", TimeArgument.time(1)).executes(c -> WeatherCommand.setThunder((CommandSourceStack)c.getSource(), IntegerArgumentType.getInteger(c, "duration"))))));
    }
