...
public class ForceLoadCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("forceload").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(Commands.literal("add").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("from", ColumnPosArgument.columnPos()).executes(c -> ForceLoadCommand.changeForceLoad((CommandSourceStack)c.getSource(), ColumnPosArgument.getColumnPos(c, "from"), ColumnPosArgument.getColumnPos(c, "from"), true))).then(Commands.argument("to", ColumnPosArgument.columnPos()).executes(c -> ForceLoadCommand.changeForceLoad((CommandSourceStack)c.getSource(), ColumnPosArgument.getColumnPos(c, "from"), ColumnPosArgument.getColumnPos(c, "to"), true)))))).then(((LiteralArgumentBuilder)Commands.literal("remove").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("from", ColumnPosArgument.columnPos()).executes(c -> ForceLoadCommand.changeForceLoad((CommandSourceStack)c.getSource(), ColumnPosArgument.getColumnPos(c, "from"), ColumnPosArgument.getColumnPos(c, "from"), false))).then(Commands.argument("to", ColumnPosArgument.columnPos()).executes(c -> ForceLoadCommand.changeForceLoad((CommandSourceStack)c.getSource(), ColumnPosArgument.getColumnPos(c, "from"), ColumnPosArgument.getColumnPos(c, "to"), false))))).then(Commands.literal("all").executes(c -> ForceLoadCommand.removeAll((CommandSourceStack)c.getSource()))))).then(((LiteralArgumentBuilder)Commands.literal("query").executes(c -> ForceLoadCommand.listForceLoad((CommandSourceStack)c.getSource()))).then(Commands.argument("pos", ColumnPosArgument.columnPos()).executes(c -> ForceLoadCommand.queryForceLoad((CommandSourceStack)c.getSource(), ColumnPosArgument.getColumnPos(c, "pos"))))));
    }
