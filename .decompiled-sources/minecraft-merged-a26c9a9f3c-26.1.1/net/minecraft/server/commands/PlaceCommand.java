...
public class PlaceCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("place").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(Commands.literal("feature").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("feature", ResourceKeyArgument.key(Registries.CONFIGURED_FEATURE)).executes(c -> PlaceCommand.placeFeature((CommandSourceStack)c.getSource(), ResourceKeyArgument.getConfiguredFeature(c, "feature"), BlockPos.containing(((CommandSourceStack)c.getSource()).getPosition())))).then(Commands.argument("pos", BlockPosArgument.blockPos()).executes(c -> PlaceCommand.placeFeature((CommandSourceStack)c.getSource(), ResourceKeyArgument.getConfiguredFeature(c, "feature"), BlockPosArgument.getLoadedBlockPos(c, "pos"))))))).then(Commands.literal("jigsaw").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("pool", ResourceKeyArgument.key(Registries.TEMPLATE_POOL)).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("target", IdentifierArgument.id()).then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("max_depth", IntegerArgumentType.integer(1, 20)).executes(c -> PlaceCommand.placeJigsaw((CommandSourceStack)c.getSource(), ResourceKeyArgument.getStructureTemplatePool(c, "pool"), IdentifierArgument.getId(c, "target"), IntegerArgumentType.getInteger(c, "max_depth"), BlockPos.containing(((CommandSourceStack)c.getSource()).getPosition())))).then(Commands.argument("position", BlockPosArgument.blockPos()).executes(c -> PlaceCommand.placeJigsaw((CommandSourceStack)c.getSource(), ResourceKeyArgument.getStructureTemplatePool(c, "pool"), IdentifierArgument.getId(c, "target"), IntegerArgumentType.getInteger(c, "max_depth"), BlockPosArgument.getLoadedBlockPos(c, "position"))))))))).then(Commands.literal("structure").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("structure", ResourceKeyArgument.key(Registries.STRUCTURE)).executes(c -> PlaceCommand.placeStructure((CommandSourceStack)c.getSource(), ResourceKeyArgument.getStructure(c, "structure"), BlockPos.containing(((CommandSourceStack)c.getSource()).getPosition())))).then(Commands.argument("pos", BlockPosArgument.blockPos()).executes(c -> PlaceCommand.placeStructure((CommandSourceStack)c.getSource(), ResourceKeyArgument.getStructure(c, "structure"), BlockPosArgument.getLoadedBlockPos(c, "pos"))))))).then(Commands.literal("template").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("template", IdentifierArgument.id()).suggests(SUGGEST_TEMPLATES).executes(c -> PlaceCommand.placeTemplate((CommandSourceStack)c.getSource(), IdentifierArgument.getId(c, "template"), BlockPos.containing(((CommandSourceStack)c.getSource()).getPosition()), Rotation.NONE, Mirror.NONE, 1.0f, 0, false))).then(((RequiredArgumentBuilder)Commands.argument("pos", BlockPosArgument.blockPos()).executes(c -> PlaceCommand.placeTemplate((CommandSourceStack)c.getSource(), IdentifierArgument.getId(c, "template"), BlockPosArgument.getLoadedBlockPos(c, "pos"), Rotation.NONE, Mirror.NONE, 1.0f, 0, false))).then(((RequiredArgumentBuilder)Commands.argument("rotation", TemplateRotationArgument.templateRotation()).executes(c -> PlaceCommand.placeTemplate((CommandSourceStack)c.getSource(), IdentifierArgument.getId(c, "template"), BlockPosArgument.getLoadedBlockPos(c, "pos"), TemplateRotationArgument.getRotation(c, "rotation"), Mirror.NONE, 1.0f, 0, false))).then(((RequiredArgumentBuilder)Commands.argument("mirror", TemplateMirrorArgument.templateMirror()).executes(c -> PlaceCommand.placeTemplate((CommandSourceStack)c.getSource(), IdentifierArgument.getId(c, "template"), BlockPosArgument.getLoadedBlockPos(c, "pos"), TemplateRotationArgument.getRotation(c, "rotation"), TemplateMirrorArgument.getMirror(c, "mirror"), 1.0f, 0, false))).then(((RequiredArgumentBuilder)Commands.argument("integrity", FloatArgumentType.floatArg(0.0f, 1.0f)).executes(c -> PlaceCommand.placeTemplate((CommandSourceStack)c.getSource(), IdentifierArgument.getId(c, "template"), BlockPosArgument.getLoadedBlockPos(c, "pos"), TemplateRotationArgument.getRotation(c, "rotation"), TemplateMirrorArgument.getMirror(c, "mirror"), FloatArgumentType.getFloat(c, "integrity"), 0, false))).then(((RequiredArgumentBuilder)Commands.argument("seed", IntegerArgumentType.integer()).executes(c -> PlaceCommand.placeTemplate((CommandSourceStack)c.getSource(), IdentifierArgument.getId(c, "template"), BlockPosArgument.getLoadedBlockPos(c, "pos"), TemplateRotationArgument.getRotation(c, "rotation"), TemplateMirrorArgument.getMirror(c, "mirror"), FloatArgumentType.getFloat(c, "integrity"), IntegerArgumentType.getInteger(c, "seed"), false))).then(Commands.literal("strict").executes(c -> PlaceCommand.placeTemplate((CommandSourceStack)c.getSource(), IdentifierArgument.getId(c, "template"), BlockPosArgument.getLoadedBlockPos(c, "pos"), TemplateRotationArgument.getRotation(c, "rotation"), TemplateMirrorArgument.getMirror(c, "mirror"), FloatArgumentType.getFloat(c, "integrity"), IntegerArgumentType.getInteger(c, "seed"), true)))))))))));
    }
