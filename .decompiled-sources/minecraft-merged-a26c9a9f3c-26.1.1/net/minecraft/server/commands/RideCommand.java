...
public class RideCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("ride").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(((RequiredArgumentBuilder)Commands.argument("target", EntityArgument.entity()).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("mount").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("vehicle", EntityArgument.entity()).executes(c -> RideCommand.mount((CommandSourceStack)c.getSource(), EntityArgument.getEntity(c, "target"), EntityArgument.getEntity(c, "vehicle")))))).then(Commands.literal("dismount").executes(c -> RideCommand.dismount((CommandSourceStack)c.getSource(), EntityArgument.getEntity(c, "target"))))));
    }
