...
public class BossBarCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher, CommandBuildContext context) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("bossbar").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(Commands.literal("add").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("id", IdentifierArgument.id()).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("name", ComponentArgument.textComponent(context)).executes(c -> BossBarCommands.createBar((CommandSourceStack)c.getSource(), IdentifierArgument.getId(c, "id"), ComponentArgument.getResolvedComponent(c, "name"))))))).then(Commands.literal("remove").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("id", IdentifierArgument.id()).suggests(SUGGEST_BOSS_BAR).executes(c -> BossBarCommands.removeBar((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c)))))).then(Commands.literal("list").executes(c -> BossBarCommands.listBars((CommandSourceStack)c.getSource())))).then(Commands.literal("set").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", IdentifierArgument.id()).suggests(SUGGEST_BOSS_BAR).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("name").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("name", ComponentArgument.textComponent(context)).executes(c -> BossBarCommands.setName((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), ComponentArgument.getResolvedComponent(c, "name")))))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("color").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("pink").executes(c -> BossBarCommands.setColor((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarColor.PINK)))).then(Commands.literal("blue").executes(c -> BossBarCommands.setColor((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarColor.BLUE)))).then(Commands.literal("red").executes(c -> BossBarCommands.setColor((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarColor.RED)))).then(Commands.literal("green").executes(c -> BossBarCommands.setColor((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarColor.GREEN)))).then(Commands.literal("yellow").executes(c -> BossBarCommands.setColor((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarColor.YELLOW)))).then(Commands.literal("purple").executes(c -> BossBarCommands.setColor((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarColor.PURPLE)))).then(Commands.literal("white").executes(c -> BossBarCommands.setColor((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarColor.WHITE))))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("style").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("progress").executes(c -> BossBarCommands.setStyle((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarOverlay.PROGRESS)))).then(Commands.literal("notched_6").executes(c -> BossBarCommands.setStyle((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarOverlay.NOTCHED_6)))).then(Commands.literal("notched_10").executes(c -> BossBarCommands.setStyle((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarOverlay.NOTCHED_10)))).then(Commands.literal("notched_12").executes(c -> BossBarCommands.setStyle((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarOverlay.NOTCHED_12)))).then(Commands.literal("notched_20").executes(c -> BossBarCommands.setStyle((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BossEvent.BossBarOverlay.NOTCHED_20))))).then(Commands.literal("value").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("value", IntegerArgumentType.integer(0)).executes(c -> BossBarCommands.setValue((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), IntegerArgumentType.getInteger(c, "value")))))).then(Commands.literal("max").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("max", IntegerArgumentType.integer(1)).executes(c -> BossBarCommands.setMax((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), IntegerArgumentType.getInteger(c, "max")))))).then(Commands.literal("visible").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("visible", BoolArgumentType.bool()).executes(c -> BossBarCommands.setVisible((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), BoolArgumentType.getBool(c, "visible")))))).then(((LiteralArgumentBuilder)Commands.literal("players").executes(c -> BossBarCommands.setPlayers((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), Collections.emptyList()))).then(Commands.argument("targets", EntityArgument.players()).executes(c -> BossBarCommands.setPlayers((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c), EntityArgument.getOptionalPlayers(c, "targets")))))))).then(Commands.literal("get").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", IdentifierArgument.id()).suggests(SUGGEST_BOSS_BAR).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal("value").executes(c -> BossBarCommands.getValue((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c))))).then(Commands.literal("max").executes(c -> BossBarCommands.getMax((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c))))).then(Commands.literal("visible").executes(c -> BossBarCommands.getVisible((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c))))).then(Commands.literal("players").executes(c -> BossBarCommands.getPlayers((CommandSourceStack)c.getSource(), BossBarCommands.getBossBar(c)))))));
    }
