...
public class DifficultyCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        for (Difficulty difficulty : Difficulty.values()) {
            command.then((ArgumentBuilder<CommandSourceStack, ?>)Commands.literal(difficulty.getSerializedName()).executes(c -> DifficultyCommand.setDifficulty((CommandSourceStack)c.getSource(), difficulty)));
        }
