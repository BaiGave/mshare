...
public class FetchProfileCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("fetchprofile").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(Commands.literal("name").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("name", StringArgumentType.greedyString()).executes(c -> FetchProfileCommand.resolveName((CommandSourceStack)c.getSource(), StringArgumentType.getString(c, "name")))))).then(Commands.literal("id").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("id", UuidArgument.uuid()).executes(c -> FetchProfileCommand.resolveId((CommandSourceStack)c.getSource(), UuidArgument.getUuid(c, "id")))))).then(Commands.literal("entity").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("entity", EntityArgument.entity()).executes(c -> FetchProfileCommand.printForEntity((CommandSourceStack)c.getSource(), EntityArgument.getEntity(c, "entity"))))));
    }
