...
public class GameRuleCommand {
    ...
    private static <T> LiteralArgumentBuilder<CommandSourceStack> buildRuleArguments(GameRule<T> gameRule, LiteralArgumentBuilder<CommandSourceStack> ruleLiteral) {
        return (LiteralArgumentBuilder)((LiteralArgumentBuilder)ruleLiteral.executes(c -> GameRuleCommand.queryRule((CommandSourceStack)c.getSource(), gameRule))).then(Commands.argument("value", gameRule.argument()).executes(c -> GameRuleCommand.setRule(c, gameRule)));
    }
