...
public class DebugMobSpawningCommand {
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        for (MobCategory mobCategory : MobCategory.values()) {
            base.then(Commands.literal(mobCategory.getName()).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("at", BlockPosArgument.blockPos()).executes(c -> DebugMobSpawningCommand.spawnMobs((CommandSourceStack)c.getSource(), mobCategory, BlockPosArgument.getLoadedBlockPos(c, "at")))));
        }
