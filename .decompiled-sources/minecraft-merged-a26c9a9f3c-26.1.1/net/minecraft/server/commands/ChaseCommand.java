...
public class ChaseCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("chase").then((ArgumentBuilder<CommandSourceStack, ?>)((LiteralArgumentBuilder)Commands.literal("follow").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("host", StringArgumentType.string()).executes(c -> ChaseCommand.follow((CommandSourceStack)c.getSource(), StringArgumentType.getString(c, "host"), 10000))).then(Commands.argument("port", IntegerArgumentType.integer(1, 65535)).executes(c -> ChaseCommand.follow((CommandSourceStack)c.getSource(), StringArgumentType.getString(c, "host"), IntegerArgumentType.getInteger(c, "port")))))).executes(c -> ChaseCommand.follow((CommandSourceStack)c.getSource(), DEFAULT_CONNECT_HOST, 10000)))).then(((LiteralArgumentBuilder)Commands.literal("lead").then((ArgumentBuilder<CommandSourceStack, ?>)((RequiredArgumentBuilder)Commands.argument("bind_address", StringArgumentType.string()).executes(c -> ChaseCommand.lead((CommandSourceStack)c.getSource(), StringArgumentType.getString(c, "bind_address"), 10000))).then(Commands.argument("port", IntegerArgumentType.integer(1024, 65535)).executes(c -> ChaseCommand.lead((CommandSourceStack)c.getSource(), StringArgumentType.getString(c, "bind_address"), IntegerArgumentType.getInteger(c, "port")))))).executes(c -> ChaseCommand.lead((CommandSourceStack)c.getSource(), DEFAULT_BIND_ADDRESS, 10000)))).then(Commands.literal("stop").executes(c -> ChaseCommand.stop((CommandSourceStack)c.getSource()))));
    }
