...
public class DebugConfigCommand {
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher, CommandBuildContext context) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("debugconfig").requires(Commands.hasPermission(Commands.LEVEL_ADMINS))).then(Commands.literal("config").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("target", EntityArgument.player()).executes(c -> DebugConfigCommand.config((CommandSourceStack)c.getSource(), EntityArgument.getPlayer(c, "target")))))).then(Commands.literal("unconfig").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("target", UuidArgument.uuid()).suggests((c, p) -> SharedSuggestionProvider.suggest(DebugConfigCommand.getUuidsInConfig(((CommandSourceStack)c.getSource()).getServer()), p)).executes(c -> DebugConfigCommand.unconfig((CommandSourceStack)c.getSource(), UuidArgument.getUuid(c, "target")))))).then(Commands.literal("dialog").then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("target", UuidArgument.uuid()).suggests((c, p) -> SharedSuggestionProvider.suggest(DebugConfigCommand.getUuidsInConfig(((CommandSourceStack)c.getSource()).getServer()), p)).then((ArgumentBuilder<CommandSourceStack, ?>)Commands.argument("dialog", ResourceOrIdArgument.dialog(context)).executes(c -> DebugConfigCommand.showDialog((CommandSourceStack)c.getSource(), UuidArgument.getUuid(c, "target"), ResourceOrIdArgument.getDialog(c, "dialog")))))));
    }
