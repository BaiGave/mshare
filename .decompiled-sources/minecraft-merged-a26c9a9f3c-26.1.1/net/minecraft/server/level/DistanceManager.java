...
public abstract class DistanceManager {
    ...
    protected final Set<ChunkHolder> chunksToUpdateFutures = new ReferenceOpenHashSet<ChunkHolder>();
    ...
    public void forEachEntityTickingChunk(LongConsumer consumer) {
        for (Long2ByteMap.Entry entry : Long2ByteMaps.fastIterable(this.simulationChunkTracker.chunks)) {
