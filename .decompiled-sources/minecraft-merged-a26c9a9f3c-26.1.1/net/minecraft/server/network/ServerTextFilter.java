...
implements AutoCloseable {
    ...
    implements TextFilter {
        ...
        public CompletableFuture<List<FilteredText>> processMessageBundle(List<String> messages) {
            List requests = messages.stream().map(message -> this.this$0.requestMessageProcessing(this.profile, (String)message, this.this$0.chatIgnoreStrategy, this.streamExecutor)).collect(ImmutableList.toImmutableList());
