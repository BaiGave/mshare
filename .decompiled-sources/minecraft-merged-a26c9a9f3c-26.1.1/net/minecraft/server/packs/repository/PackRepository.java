...
public class PackRepository {
    ...
    public void reload() {
        List currentlySelectedNames = this.selected.stream().map(Pack::getId).collect(ImmutableList.toImmutableList());
    ...
    public boolean addPack(String packId) {
        ...
        if (pack != null && !this.selected.contains(pack)) {
            ArrayList<Pack> selectedCopy = Lists.newArrayList(this.selected);
