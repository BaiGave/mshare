...
public interface PermissionCheck {
    ...
    {
        public static final MapCodec<Require> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Permission.CODEC.fieldOf("permission")).forGetter(Require::permission)).apply((Applicative<Require, ?>)i, Require::new));
