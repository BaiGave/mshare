...
PacketContextProvider {
    ...
    public void handleServerLinks(ClientboundServerLinksPacket packet) {
        ...
        ImmutableList.Builder trustedEntries = ImmutableList.builderWithExpectedSize(untrustedEntries.size());
        ...
        this.serverLinks = new ServerLinks((List<ServerLinks.Entry>)((Object)trustedEntries.build()));
    }
    ...
    extends ConfirmScreen {
        ...
        public PackConfirmScreen update(Minecraft minecraft, UUID id, URL url, String hash, boolean required, @Nullable Component prompt) {
            ImmutableCollection extendedRequests = ((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builderWithExpectedSize(this.requests.size() + 1).addAll(this.requests)).add(new PendingRequest(id, url, hash))).build();
            return new PackConfirmScreen(this.this$0, minecraft, this.parentScreen, (List<PendingRequest>)((Object)extendedRequests), required, prompt);
        }
