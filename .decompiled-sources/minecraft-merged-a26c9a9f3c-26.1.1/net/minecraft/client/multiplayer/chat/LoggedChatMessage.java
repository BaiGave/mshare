...
extends LoggedChatEvent {
    ...
    {
        public static final MapCodec<Player> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ExtraCodecs.AUTHLIB_GAME_PROFILE.fieldOf("profile")).forGetter(Player::profile), PlayerChatMessage.MAP_CODEC.forGetter(Player::message), ChatTrustLevel.CODEC.optionalFieldOf("trust_level", ChatTrustLevel.SECURE).forGetter(Player::trustLevel)).apply((Applicative<Player, ?>)i, Player::new));
    ...
    {
        public static final MapCodec<System> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ComponentSerialization.CODEC.fieldOf("message")).forGetter(System::message), ((MapCodec)ExtraCodecs.INSTANT_ISO8601.fieldOf("time_stamp")).forGetter(System::timeStamp)).apply((Applicative<System, ?>)i, System::new));
