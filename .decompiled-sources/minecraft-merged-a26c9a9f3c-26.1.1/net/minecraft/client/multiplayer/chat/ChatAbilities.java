...
public class ChatAbilities {
    ...
    private static Predicate<GuiMessage> selectVisibleMessages(ChatAbilities chatAbilities) {
        ...
        ImmutableCollection visibleSources = visibleSourcesBuilder.build();
        return arg_0 -> ChatAbilities.lambda$selectVisibleMessages$0((ImmutableSet)visibleSources, arg_0);
    }
    ...
    private static /* synthetic */ boolean lambda$selectVisibleMessages$0(ImmutableSet visibleSources, GuiMessage guiMessage) {
        return visibleSources.contains((Object)guiMessage.source());
    }
