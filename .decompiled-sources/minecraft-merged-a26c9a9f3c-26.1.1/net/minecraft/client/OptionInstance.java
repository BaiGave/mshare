...
public final class OptionInstance<T> {
    ...
    public void set(T value) {
        Object newValue = this.values.validateValue(value).orElseGet(() -> {
            LOGGER.error("Illegal option value {} for {}", (Object)value, (Object)this.caption.getString());
    ...
    public static enum UnitDouble implements SliderableValueSet<Double>
    {
        ...
        public Codec<Double> codec() {
            return Codec.withAlternative(Codec.doubleRange(0.0, 1.0), Codec.BOOL, b -> b != false ? 1.0 : 0.0);
        }
    }
    ...
    SliderableOrCyclableValueSet<Integer>
    {
        ...
        public Codec<Integer> codec() {
            return Codec.INT.validate(value -> {
                ...
                return DataResult.error(() -> "Value " + value + " outside of range [" + this.minInclusive + ":" + maxExclusive + "]", value);
            });
        }
