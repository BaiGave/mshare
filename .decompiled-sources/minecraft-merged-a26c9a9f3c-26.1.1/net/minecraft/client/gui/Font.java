...
public class Font {
    ...
    public void drawInBatch(String str, float x, float y, int color, boolean dropShadow, Matrix4fc pose, MultiBufferSource bufferSource, DisplayMode displayMode, int backgroundColor, int packedLightCoords) {
    ...
    public void drawInBatch(Component str, float x, float y, int color, boolean dropShadow, Matrix4fc pose, MultiBufferSource bufferSource, DisplayMode displayMode, int backgroundColor, int packedLightCoords) {
        PreparedText preparedText = this.prepareText(str.getVisualOrderText(), x, y, color, dropShadow, false, backgroundColor);
        preparedText.visit(GlyphVisitor.forMultiBufferSource(bufferSource, pose, displayMode, packedLightCoords));
    }

    public void drawInBatch(FormattedCharSequence str, float x, float y, int color, boolean dropShadow, Matrix4fc pose, MultiBufferSource bufferSource, DisplayMode displayMode, int backgroundColor, int packedLightCoords) {
        PreparedText preparedText = this.prepareText(str, x, y, color, dropShadow, false, backgroundColor);
        preparedText.visit(GlyphVisitor.forMultiBufferSource(bufferSource, pose, displayMode, packedLightCoords));
    }

    public void drawInBatch8xOutline(FormattedCharSequence str, float x, float y, int color, int outlineColor, Matrix4fc pose, MultiBufferSource bufferSource, int packedLightCoords) {
    ...
    public static interface GlyphVisitor {
        public static GlyphVisitor forMultiBufferSource(final MultiBufferSource bufferSource, final Matrix4fc pose, final DisplayMode displayMode, final int lightCoords) {
