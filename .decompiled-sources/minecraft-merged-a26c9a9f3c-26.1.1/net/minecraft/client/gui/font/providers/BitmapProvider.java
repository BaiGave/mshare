...
implements GlyphProvider {
    ...
    public record Definition(Identifier file, int height, int ascent, int[][] codepointGrid) implements GlyphProviderDefinition
    {
        ...
        public static final MapCodec<Definition> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("file")).forGetter(Definition::file), Codec.INT.optionalFieldOf("height", 8).forGetter(Definition::height), ((MapCodec)Codec.INT.fieldOf("ascent")).forGetter(Definition::ascent), ((MapCodec)CODEPOINT_GRID_CODEC.fieldOf("chars")).forGetter(Definition::codepointGrid)).apply((Applicative<Definition, ?>)i, Definition::new)).validate(Definition::validate);
