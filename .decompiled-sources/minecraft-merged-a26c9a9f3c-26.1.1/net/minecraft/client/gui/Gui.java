...
public class Gui {
    ...
    public Gui(Minecraft minecraft) {
        ...
        this.contextualInfoBarRenderers = ImmutableMap.of(ContextualInfo.EMPTY, () -> ContextualBarRenderer.EMPTY, ContextualInfo.EXPERIENCE, () -> new ExperienceBarRenderer(minecraft), ContextualInfo.LOCATOR, () -> new LocatorBarRenderer(minecraft), ContextualInfo.JUMPABLE_VEHICLE, () -> new JumpableVehicleBarRenderer(minecraft));
    ...
    private void extractHotbarAndDecorations(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        if (nextContextualInfo != this.contextualInfoBar.getKey()) {
            this.contextualInfoBar = Pair.of(nextContextualInfo, this.contextualInfoBarRenderers.get((Object)nextContextualInfo).get());
        }
