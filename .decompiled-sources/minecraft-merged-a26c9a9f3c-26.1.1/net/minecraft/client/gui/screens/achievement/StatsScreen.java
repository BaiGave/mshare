...
extends Screen {
    ...
    extends ObjectSelectionList<Entry> {
        ...
        public GeneralStatisticsList(StatsScreen statsScreen, Minecraft minecraft) {
            ...
            ObjectArrayList<Stat<Identifier>> stats = new ObjectArrayList<Stat<Identifier>>(Stats.CUSTOM.iterator());
            stats.sort((Comparator<Stat<Identifier>>)Comparator.comparing(k -> I18n.get(StatsScreen.getTranslationKey(k), new Object[0])));
            for (Stat stat : stats) {
