...
implements ClientAdvancements.Listener {
    ...
    private void extractInside(GuiGraphicsExtractor graphics, int xo, int yo) {
        ...
        if (tab == null) {
            ...
            int midX = xo + 9 + 117;
            graphics.centeredText(this.font, NO_ADVANCEMENTS_LABEL, midX, yo + 18 + 56 - this.font.lineHeight / 2, -1);
            graphics.centeredText(this.font, VERY_SAD_LABEL, midX, yo + 18 + 113 - this.font.lineHeight, -1);
            return;
        }
