...
extends Screen {
            ...
            this.gameRules.visitGameRuleTypes(new GameRuleTypeVisitor(){
                ...
                private <T> void addEntry(GameRule<T> gameRule, EntryFactory<T> factory) {
                    ...
                    if (optionalDescription.isPresent()) {
                        ImmutableCollection.Builder result = ImmutableList.builder().add(actualName.getVisualOrderText());
                        this.this$1.this$0.font.split(optionalDescription.get(), 150).forEach(((ImmutableList.Builder)result)::add);
                        tooltip = ((ImmutableList.Builder)((ImmutableList.Builder)result).add(defaultValue.getVisualOrderText())).build();
                    ...
                    entries.computeIfAbsent(gameRule.category(), k -> Maps.newHashMap()).put(gameRule, factory.create(readableName, (List<FormattedCharSequence>)((Object)tooltip), (String)narration, gameRule));
                }
            });
    ...
    extends RuleEntry {
        ...
        @Override
        public List<? extends NarratableEntry> narratables() {
            return ImmutableList.of(new NarratableEntry(this){
