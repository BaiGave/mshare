...
extends Screen {
    ...
    protected void init() {
        ...
        this.packs.forEach((pack, selected) -> switchGridBuilder.addSwitch(ExperimentsScreen.getHumanReadableTitle(pack), () -> this.packs.getBoolean(pack), newSelected -> this.packs.put((Pack)pack, (boolean)newSelected)).withInfo(pack.getDescription()));
