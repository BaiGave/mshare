...
implements AutoCloseable {
    ...
    private final Map<Object, OversizedItemRenderer> oversizedItemRenderers = new Object2ObjectOpenHashMap<Object, OversizedItemRenderer>();
    ...
    private final Map<VertexFormat, MappableRingBuffer> vertexBuffers = new Object2ObjectOpenHashMap<VertexFormat, MappableRingBuffer>();
    ...
    public GuiRenderer(GuiRenderState renderState, MultiBufferSource.BufferSource bufferSource, SubmitNodeCollector submitNodeCollector, FeatureRenderDispatcher featureRenderDispatcher, List<PictureInPictureRenderer<?>> pictureInPictureRenderers) {
        ...
        ImmutableMap.Builder<Class<?>, PictureInPictureRenderer<?>> builder = ImmutableMap.builder();
        ...
        this.renderState.forEachText(text -> {
            ...
            text.ensurePrepared().visit(new Font.GlyphVisitor(){
                ...
                private void accept(TextRenderable glyph) {
                    this.this$0.renderState.addGlyphToCurrentLayer(new GlyphRenderState(pose, glyph, scissor));
                }
            });
        });
    }
    ...
    private void recordDraws() {
        ...
        Object2IntOpenHashMap<VertexFormat> offsets = new Object2IntOpenHashMap<VertexFormat>();
    ...
    private Object2IntMap<VertexFormat> calculatedRequiredVertexBufferSizes() {
        Object2IntOpenHashMap<VertexFormat> requiredVertexBufferSizes = new Object2IntOpenHashMap<VertexFormat>();
        for (MeshToDraw meshToDraw : this.meshesToDraw) {
