...
public class SpearAnimations {
    ...
    public static void firstPersonUse(float ticksSinceKineticHitFeedback, PoseStack poseStack, float timeHeld, HumanoidArm arm, ItemStack itemStack) {
        ...
        poseStack.rotateAround(Axis.YN.rotationDegrees((float)invert * (-90.0f * SpearAnimations.progress(params.raiseProgress(), 0.5f, 0.55f) + 90.0f * params.swayProgress() + 2.0f * params.swayScaleSlow())), (float)invert * 0.15f, 0.0f, 0.0f);
