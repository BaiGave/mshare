...
public record PropertyValueList(List<Property.Value<?>> values) {
    ...
    public PropertyValueList extend(PropertyValueList other) {
        return new PropertyValueList((List<Property.Value<?>>)((Object)((ImmutableList.Builder)((ImmutableList.Builder)ImmutableList.builder().addAll(this.values)).addAll(other.values)).build()));
    }
