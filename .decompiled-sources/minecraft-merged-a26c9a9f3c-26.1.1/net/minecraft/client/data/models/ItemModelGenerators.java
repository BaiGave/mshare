...
public class ItemModelGenerators {
    ...
    public final Identifier createFlatItemModel(Item item, ModelTemplate template) {
        return template.create(ModelLocationUtils.getModelLocation(item), TextureMapping.layer0(item), this.modelOutput);
    }

    public final void generateFlatItem(Item item, ModelTemplate template) {
        this.itemModelOutput.accept(item, ItemModelUtils.plainModel(this.createFlatItemModel(item, template)));
    }

    public final Identifier createFlatItemModel(Item item, String suffix, ModelTemplate template) {
    ...
    public final Identifier createFlatItemModel(Item item, Item textureDonor, ModelTemplate template) {
        return template.create(ModelLocationUtils.getModelLocation(item), TextureMapping.layer0(textureDonor), this.modelOutput);
    }

    public final void generateFlatItem(Item item, Item textureDonor, ModelTemplate template) {
        this.itemModelOutput.accept(item, ItemModelUtils.plainModel(this.createFlatItemModel(item, textureDonor, template)));
    }

    public final void generateItemWithTintedOverlay(Item item, ItemTintSource overlayTint) {
        this.generateItemWithTintedOverlay(item, "_overlay", overlayTint);
    }

    public final void generateItemWithTintedOverlay(Item item, String overlaySuffix, ItemTintSource overlayTint) {
    ...
    public final void generateItemWithTintedBaseLayer(Item item, int defaultColor) {
    ...
    public final List<RangeSelectItemModel.Entry> createCompassModels(Item compass) {
    ...
    public final void generateStandardCompassItem(Item compass) {
    ...
    public final void generateRecoveryCompassItem(Item compass) {
    ...
    public final void generateClockItem(Item clock) {
        ArrayList<RangeSelectItemModel.Entry> overrides = new ArrayList<RangeSelectItemModel.Entry>();
    ...
    public final Identifier generateLayeredItem(Item target, Material layer0, Material layer1) {
        return ModelTemplates.TWO_LAYERED_ITEM.create(target, TextureMapping.layered(layer0, layer1), this.modelOutput);
    }

    public final Identifier generateLayeredItem(Identifier target, Material layer0, Material layer1) {
        return ModelTemplates.TWO_LAYERED_ITEM.create(target, TextureMapping.layered(layer0, layer1), this.modelOutput);
    }

    public final void generateLayeredItem(Identifier target, Material layer0, Material layer1, Material layer2) {
        ModelTemplates.THREE_LAYERED_ITEM.create(target, TextureMapping.layered(layer0, layer1, layer2), this.modelOutput);
    }

    public final void generateTrimmableItem(Item armor, ResourceKey<EquipmentAsset> equipmentAssetId, Identifier slotTrimPrefix, boolean hasDyedLayer) {
    ...
    public final void generateBundleModels(Item bundle) {
    ...
    public final Identifier generateBundleCoverModel(Item item, ModelTemplate template, String suffix) {
    ...
    public final void generateBooleanDispatch(Item item, ConditionalItemModelProperty property, ItemModel.Unbaked modelOnTrue, ItemModel.Unbaked modelOnFalse) {
    ...
    public final void addPotionTint(Item item, Identifier model) {
    ...
    public final void generateDyedItem(Item item, int defaultColor) {
