...
public class ModelDiscovery {
    ...
    private final Object2ObjectMap<Identifier, ModelWrapper> modelWrappers = new Object2ObjectOpenHashMap<Identifier, ModelWrapper>();
    ...
    public void addSpecialModel(Identifier id, UnbakedModel model) {
        ...
        ModelWrapper previous = this.modelWrappers.put(id, this.createAndQueueWrapper(id, model));
        if (previous != null) {
