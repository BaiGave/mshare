...
public class TextureSlots {
    ...
    public static Data parseTextureMap(JsonObject texturesObject) {
        ...
        for (Map.Entry<String, JsonElement> entry : texturesObject.entrySet()) {
            TextureSlots.parseEntry(entry.getKey(), entry.getValue(), builder);
        }
    ...
    public static class Resolver {
        ...
        public TextureSlots resolve(ModelDebugName debugNameProvider) {
            ...
            Object2ObjectArrayMap<String, Material> resolved = new Object2ObjectArrayMap<String, Material>();
                ...
                data.values.forEach((slot, contents) -> {
                    ...
                    switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{Value.class, Reference.class}, (SlotContents)selector0$temp, index$1)) {
                        ...
                        case 0: {
                            ...
                            resolved.put((String)slot, value.material());
                            break;
                        }
                        case 1: {
