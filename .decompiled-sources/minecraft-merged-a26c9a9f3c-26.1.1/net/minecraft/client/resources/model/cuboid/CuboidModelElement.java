    ...
    implements JsonDeserializer<CuboidModelElement> {
        ...
        private @Nullable CuboidRotation getRotation(JsonObject object) {
            if (object.has(FIELD_ROTATION)) {
                ...
                return new CuboidRotation(origin, (CuboidRotation.RotationValue)((Object)rotationValue), rescale);
            }
            return null;
        }
        ...
        private Map<Direction, CuboidFace> filterNullFromFaces(JsonDeserializationContext context, JsonObject object) {
            EnumMap<Direction, CuboidFace> result = Maps.newEnumMap(Direction.class);
            ...
            for (Map.Entry<String, JsonElement> entry : faceObjects.entrySet()) {
                ...
                result.put(direction, (CuboidFace)context.deserialize(entry.getValue(), (Type)((Object)CuboidFace.class)));
            }
            return result;
        }
