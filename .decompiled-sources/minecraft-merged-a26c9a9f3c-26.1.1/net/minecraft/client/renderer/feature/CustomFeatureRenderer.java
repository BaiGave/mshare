...
public class CustomFeatureRenderer {
    ...
    public static class Storage {
        ...
        private final Set<RenderType> solidCustomGeometrySubmitsUsage = new ObjectOpenHashSet<RenderType>();
        private final Set<RenderType> translucentCustomGeometrySubmitsUsage = new ObjectOpenHashSet<RenderType>();
