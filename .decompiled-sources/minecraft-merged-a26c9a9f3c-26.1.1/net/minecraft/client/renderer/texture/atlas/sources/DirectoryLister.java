...
{
    public static final MapCodec<DirectoryLister> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.STRING.fieldOf("source")).forGetter(DirectoryLister::sourcePath), ((MapCodec)Codec.STRING.fieldOf("prefix")).forGetter(DirectoryLister::idPrefix)).apply((Applicative<DirectoryLister, ?>)i, DirectoryLister::new));
