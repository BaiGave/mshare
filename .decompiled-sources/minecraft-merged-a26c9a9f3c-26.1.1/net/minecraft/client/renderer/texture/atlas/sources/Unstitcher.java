...
public record Unstitcher(Identifier resource, List<Region> regions, double xDivisor, double yDivisor) implements SpriteSource
{
    ...
    public record Region(Identifier sprite, double x, double y, double width, double height) {
        public static final Codec<Region> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("sprite")).forGetter(Region::sprite), ((MapCodec)Codec.DOUBLE.fieldOf("x")).forGetter(Region::x), ((MapCodec)Codec.DOUBLE.fieldOf("y")).forGetter(Region::y), ((MapCodec)Codec.DOUBLE.fieldOf("width")).forGetter(Region::width), ((MapCodec)Codec.DOUBLE.fieldOf("height")).forGetter(Region::height)).apply((Applicative<Region, ?>)i, Region::new));
    }
