...
AutoCloseable {
    ...
    public void renderLevel(GraphicsResourceAllocator resourceAllocator, DeltaTracker deltaTracker, boolean renderOutline, CameraRenderState cameraState, Matrix4fc modelViewMatrix, GpuBufferSlice terrainFog, Vector4f fogColor, boolean shouldRenderSky, ChunkSectionsToRender chunkSectionsToRender) {
    ...
    private void addMainPass(FrameGraphBuilder frame, Frustum frustum, Matrix4fc modelViewMatrix, GpuBufferSlice terrainFog, boolean renderOutline, LevelRenderState levelRenderState, DeltaTracker deltaTracker, ProfilerFiller profiler, ChunkSectionsToRender chunkSectionsToRender) {
    ...
    public ChunkSectionsToRender prepareChunkRenders(Matrix4fc modelViewMatrix) {
        ListIterator iterator = this.visibleSections.listIterator(0);
            ...
            try {
                ...
                while (iterator.hasNext()) {
                    ...
                    for (ChunkSectionLayer layer : ChunkSectionLayer.values()) {
                        ...
                        List draws = drawGroups.get((Object)layer).computeIfAbsent(combinedHash, n -> new ArrayList());
    ...
    private void compileSections(Camera camera) {
        ...
        ArrayList<SectionRenderDispatcher.RenderSection> sectionsToCompile = Lists.newArrayList();
