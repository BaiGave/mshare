...
implements ItemModel {
    ...
    {
        public static final MapCodec<Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ItemModels.CODEC.listOf().fieldOf("models")).forGetter(Unbaked::models), Transformation.EXTENDED_CODEC.optionalFieldOf("transformation").forGetter(Unbaked::transformation)).apply((Applicative<Unbaked, ?>)i, Unbaked::new));
