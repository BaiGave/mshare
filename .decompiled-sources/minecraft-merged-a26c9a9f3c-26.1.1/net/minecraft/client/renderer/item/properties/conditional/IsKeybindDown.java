...
public record IsKeybindDown(KeyMapping keybind) implements ConditionalItemModelProperty
{
    ...
    public static final MapCodec<IsKeybindDown> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)KEYBIND_CODEC.fieldOf("keybind")).forGetter(IsKeybindDown::keybind)).apply((Applicative<IsKeybindDown, ?>)i, IsKeybindDown::new));
