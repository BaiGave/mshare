...
public record Charge() implements SelectItemModelProperty<CrossbowItem.ChargeType>
{
    ...
    public static final SelectItemModelProperty.Type<Charge, CrossbowItem.ChargeType> TYPE = SelectItemModelProperty.Type.create(MapCodec.unit(new Charge()), VALUE_CODEC);
