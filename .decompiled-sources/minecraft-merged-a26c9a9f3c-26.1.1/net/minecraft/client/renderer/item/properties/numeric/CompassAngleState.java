...
extends NeedleDirectionHelper {
    public static final MapCodec<CompassAngleState> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Codec.BOOL.optionalFieldOf("wobble", true).forGetter(NeedleDirectionHelper::wobble), ((MapCodec)CompassTarget.CODEC.fieldOf("target")).forGetter(CompassAngleState::target)).apply((Applicative<CompassAngleState, ?>)i, CompassAngleState::new));
