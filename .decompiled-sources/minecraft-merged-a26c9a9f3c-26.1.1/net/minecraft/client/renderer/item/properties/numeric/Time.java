...
implements RangeSelectItemModelProperty {
    public static final MapCodec<Time> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(Codec.BOOL.optionalFieldOf("wobble", true).forGetter(NeedleDirectionHelper::wobble), ((MapCodec)TimeSource.CODEC.fieldOf("source")).forGetter(o -> o.source)).apply((Applicative<Time, ?>)i, Time::new));
