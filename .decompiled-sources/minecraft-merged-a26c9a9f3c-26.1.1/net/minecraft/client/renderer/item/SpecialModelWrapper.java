...
implements ItemModel {
    ...
    {
        public static final MapCodec<Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("base")).forGetter(Unbaked::base), Transformation.EXTENDED_CODEC.optionalFieldOf("transformation").forGetter(Unbaked::transformation), ((MapCodec)SpecialModelRenderers.CODEC.fieldOf("model")).forGetter(Unbaked::specialModel)).apply((Applicative<Unbaked, ?>)i, Unbaked::new));
