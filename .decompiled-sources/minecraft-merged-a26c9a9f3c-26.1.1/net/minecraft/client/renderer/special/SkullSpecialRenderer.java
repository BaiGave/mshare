...
implements NoDataSpecialModelRenderer {
    ...
    {
        public static final MapCodec<Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)SkullBlock.Type.CODEC.fieldOf("kind")).forGetter(Unbaked::kind), Identifier.CODEC.optionalFieldOf("texture").forGetter(Unbaked::textureOverride), Codec.FLOAT.optionalFieldOf("animation", Float.valueOf(0.0f)).forGetter(Unbaked::animation)).apply((Applicative<Unbaked, ?>)i, Unbaked::new));
