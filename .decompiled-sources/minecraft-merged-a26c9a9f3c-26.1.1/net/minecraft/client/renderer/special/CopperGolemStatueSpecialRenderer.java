...
implements NoDataSpecialModelRenderer {
    ...
    {
        public static final MapCodec<Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("texture")).forGetter(Unbaked::texture), ((MapCodec)CopperGolemStatueBlock.Pose.CODEC.fieldOf("pose")).forGetter(Unbaked::pose)).apply((Applicative<Unbaked, ?>)i, Unbaked::new));
