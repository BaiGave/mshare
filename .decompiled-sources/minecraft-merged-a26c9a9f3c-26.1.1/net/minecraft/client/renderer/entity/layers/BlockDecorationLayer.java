...
extends RenderLayer<S, M> {
    private static final Matrix4fc UNIT_CUBE_BOTTOM_CENTER_TO_ANTENNA_CENTER = new Matrix4f().translation(-0.5f, 0.0f, -0.5f).rotateAround(Axis.ZP.rotationDegrees(180.0f), 0.5f, 0.5f, 0.5f);
