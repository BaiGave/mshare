...
implements RenderLayerParent<S, M> {
    ...
    protected void setupRotations(S state, PoseStack poseStack, float bodyRot, float entityScale) {
        ...
        if (((LivingEntityRenderState)state).deathTime > 0.0f) {
            ...
            poseStack.mulPose(Axis.XP.rotationDegrees(-90.0f - ((LivingEntityRenderState)state).xRot));
            poseStack.mulPose(Axis.YP.rotationDegrees(((LivingEntityRenderState)state).ageInTicks * -75.0f));
