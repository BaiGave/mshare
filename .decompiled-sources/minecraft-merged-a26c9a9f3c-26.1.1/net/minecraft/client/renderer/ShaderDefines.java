...
public record ShaderDefines(Map<String, String> values, Set<String> flags) {
    ...
    public ShaderDefines withOverrides(ShaderDefines defines) {
        ...
        ImmutableSet.Builder newFlags = ImmutableSet.builderWithExpectedSize(this.flags.size() + defines.flags.size());
        newFlags.addAll(this.flags);
        newFlags.addAll(defines.flags);
        return new ShaderDefines(newValues.buildKeepingLast(), (Set<String>)((Object)newFlags.build()));
    }
    ...
    public static class Builder {
        ...
        public Builder define(String key, String value) {
            ...
            this.values.put(key, Builder.escapeNewLines(value));
            return this;
        }
