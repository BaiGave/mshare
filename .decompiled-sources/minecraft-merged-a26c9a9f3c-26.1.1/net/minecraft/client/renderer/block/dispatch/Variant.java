...
{
    public static final MapCodec<Variant> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("model")).forGetter(Variant::modelLocation), SimpleModelState.MAP_CODEC.forGetter(Variant::modelState)).apply((Applicative<Variant, ?>)i, Variant::new));
