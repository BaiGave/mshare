...
public final class RecipeBookSettings {
    ...
    public static final MapCodec<RecipeBookSettings> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(TypeSettings.CRAFTING_MAP_CODEC.forGetter(o -> o.crafting), TypeSettings.FURNACE_MAP_CODEC.forGetter(o -> o.furnace), TypeSettings.BLAST_FURNACE_MAP_CODEC.forGetter(o -> o.blastFurnace), TypeSettings.SMOKER_MAP_CODEC.forGetter(o -> o.smoker)).apply((Applicative<RecipeBookSettings, ?>)i, RecipeBookSettings::new));
    ...
    public record TypeSettings(boolean open, boolean filtering) {
        ...
        private static MapCodec<TypeSettings> codec(String openFieldName, String filteringFieldName) {
            return RecordCodecBuilder.mapCodec(i -> i.group(Codec.BOOL.optionalFieldOf(openFieldName, false).forGetter(TypeSettings::open), Codec.BOOL.optionalFieldOf(filteringFieldName, false).forGetter(TypeSettings::filtering)).apply((Applicative<TypeSettings, ?>)i, TypeSettings::new));
        }
    }
}
