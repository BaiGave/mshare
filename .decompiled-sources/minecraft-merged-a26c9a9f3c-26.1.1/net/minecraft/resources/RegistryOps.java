    ...
    public static <E, O> RecordCodecBuilder<O, HolderGetter<E>> retrieveGetter(ResourceKey<? extends Registry<? extends E>> registryKey) {
        return ExtraCodecs.retrieveContext(ops -> {
            if (ops instanceof RegistryOps) {
                ...
                return registryOps.lookupProvider.lookup(registryKey).map(r -> DataResult.success(r.getter(), r.elementsLifecycle())).orElseGet(() -> DataResult.error(() -> "Unknown registry: " + String.valueOf(registryKey)));
            }
