...
extends ByteBuf {
    ...
    public <T> FriendlyByteBuf writeWithCodec(DynamicOps<Tag> ops, Codec<T> codec, T value) {
        Tag tag = codec.encodeStart(ops, (Tag)value).getOrThrow(msg -> new EncoderException("Failed to encode: " + msg + " " + String.valueOf(value)));
        this.writeNbt(tag);
        return this;
    }
    ...
    public <T> void writeJsonWithCodec(Codec<T> codec, T value) {
        DataResult<JsonElement> result = codec.encodeStart(JsonOps.INSTANCE, (JsonElement)value);
        this.writeUtf(GSON.toJson(result.getOrThrow(error -> new EncoderException("Failed to encode: " + error + " " + String.valueOf(value)))));
    }
    ...
    public void writeVector3f(Vector3f v) {
        FriendlyByteBuf.writeVector3f(this, v);
    }
    ...
    public void writeQuaternion(Quaternionf q) {
        FriendlyByteBuf.writeQuaternion(this, q);
    }
