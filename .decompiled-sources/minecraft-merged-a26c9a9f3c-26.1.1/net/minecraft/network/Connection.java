...
implements PacketContextProvider {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Packet<?> packet) {
        ...
        if (packetListener.shouldHandleMessage(packet)) {
            try {
                ...
                LOGGER.error("Received {} that couldn't be processed", (Object)packet.getClass(), (Object)exception);
    ...
    public <T extends PacketListener> void setupInboundProtocol(ProtocolInfo<T> protocol, T packetListener) {
        ...
        Connection.syncAfterConfigurationChange(this.channel.writeAndFlush(configMessage));
    }
    ...
    public void setupOutboundProtocol(ProtocolInfo<?> protocol) {
        ...
        Connection.syncAfterConfigurationChange(this.channel.writeAndFlush(configMessage.andThen(ctx -> {
