...
{
    public static final MapCodec<StorageDataSource> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("storage")).forGetter(StorageDataSource::id)).apply((Applicative<StorageDataSource, ?>)i, StorageDataSource::new));
