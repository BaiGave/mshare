...
public record BlockDataSource(CompilableString<Coordinates> coordinates) implements DataSource
{
    ...
    public static final MapCodec<BlockDataSource> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)BLOCK_POS_CODEC.fieldOf("block")).forGetter(BlockDataSource::coordinates)).apply((Applicative<BlockDataSource, ?>)i, BlockDataSource::new));
