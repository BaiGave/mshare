...
implements ComponentContents {
    public static final MapCodec<KeybindContents> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.STRING.fieldOf("keybind")).forGetter(o -> o.name)).apply((Applicative<KeybindContents, ?>)i, KeybindContents::new));
