...
extends ComponentContents {
    public static final MapCodec<PlainTextContents> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.STRING.fieldOf("text")).forGetter(PlainTextContents::text)).apply((Applicative<PlainTextContents, ?>)i, PlainTextContents::create));
