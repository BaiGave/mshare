...
public record ChatType(ChatTypeDecoration chat, ChatTypeDecoration narration) {
    public static final Codec<ChatType> DIRECT_CODEC = RecordCodecBuilder.create((RecordCodecBuilder.Instance<O> i) -> i.group(((MapCodec)ChatTypeDecoration.CODEC.fieldOf("chat")).forGetter(ChatType::chat), ((MapCodec)ChatTypeDecoration.CODEC.fieldOf("narration")).forGetter(ChatType::narration)).apply((Applicative<ChatType, ?>)i, ChatType::new));
