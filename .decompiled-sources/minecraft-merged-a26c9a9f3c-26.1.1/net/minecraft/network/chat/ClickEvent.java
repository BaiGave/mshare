...
public interface ClickEvent {
    ...
    {
        public static final MapCodec<Custom> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Identifier.CODEC.fieldOf("id")).forGetter(Custom::id), ExtraCodecs.NBT.optionalFieldOf("payload").forGetter(Custom::payload)).apply((Applicative<Custom, ?>)i, Custom::new));
    ...
    {
        public static final MapCodec<CopyToClipboard> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.STRING.fieldOf("value")).forGetter(CopyToClipboard::value)).apply((Applicative<CopyToClipboard, ?>)i, CopyToClipboard::new));
    ...
    {
        public static final MapCodec<ChangePage> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ExtraCodecs.POSITIVE_INT.fieldOf("page")).forGetter(ChangePage::page)).apply((Applicative<ChangePage, ?>)i, ChangePage::new));
    ...
    {
        public static final MapCodec<ShowDialog> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Dialog.CODEC.fieldOf("dialog")).forGetter(ShowDialog::dialog)).apply((Applicative<ShowDialog, ?>)i, ShowDialog::new));
    ...
    {
        public static final MapCodec<SuggestCommand> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ExtraCodecs.CHAT_STRING.fieldOf("command")).forGetter(SuggestCommand::command)).apply((Applicative<SuggestCommand, ?>)i, SuggestCommand::new));
    ...
    {
        public static final MapCodec<RunCommand> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ExtraCodecs.CHAT_STRING.fieldOf("command")).forGetter(RunCommand::command)).apply((Applicative<RunCommand, ?>)i, RunCommand::new));
    ...
    {
        public static final MapCodec<OpenFile> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)Codec.STRING.fieldOf("path")).forGetter(OpenFile::path)).apply((Applicative<OpenFile, ?>)i, OpenFile::new));
    ...
    {
        public static final MapCodec<OpenUrl> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(((MapCodec)ExtraCodecs.UNTRUSTED_URI.fieldOf("url")).forGetter(OpenUrl::uri)).apply((Applicative<OpenUrl, ?>)i, OpenUrl::new));
