...
implements FabricEntitySelectorParser {
    ...
    public static final BiConsumer<Vec3, List<? extends Entity>> ORDER_NEAREST = (p, c) -> c.sort((a, b) -> Doubles.compare(a.distanceToSqr((Vec3)p), b.distanceToSqr((Vec3)p)));
    public static final BiConsumer<Vec3, List<? extends Entity>> ORDER_FURTHEST = (p, c) -> c.sort((a, b) -> Doubles.compare(b.distanceToSqr((Vec3)p), a.distanceToSqr((Vec3)p)));
