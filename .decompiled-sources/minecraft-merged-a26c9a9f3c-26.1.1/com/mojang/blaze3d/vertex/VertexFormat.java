...
public class VertexFormat {
    ...
    public static class Builder {
        ...
        public VertexFormat build() {
            ...
            ImmutableList<VertexFormatElement> elements = ((ImmutableCollection)elementMap.values()).asList();
            ImmutableList<String> names = ((ImmutableCollection)((Object)elementMap.keySet())).asList();
