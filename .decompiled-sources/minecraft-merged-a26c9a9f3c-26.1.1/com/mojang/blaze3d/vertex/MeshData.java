    ...
    public record SortState(CompactVectorArray centroids, VertexFormat.IndexType indexType) {
        ...
        private IntConsumer indexWriter(long pointer, VertexFormat.IndexType indexType) {
            ...
            return switch (indexType) {
                ...
                case VertexFormat.IndexType.SHORT -> value -> MemoryUtil.memPutShort(nextIndex.getAndAdd(2L), (short)value);
                case VertexFormat.IndexType.INT -> value -> MemoryUtil.memPutInt(nextIndex.getAndAdd(4L), value);
            };
        }
    }
}
