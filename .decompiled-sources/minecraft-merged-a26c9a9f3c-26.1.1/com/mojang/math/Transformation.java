...
public final class Transformation {
    ...
    public static final Codec<Transformation> CODEC = RecordCodecBuilder.create(i -> i.group(((MapCodec)ExtraCodecs.VECTOR3F.fieldOf("translation")).forGetter(Transformation::translation), ((MapCodec)ExtraCodecs.QUATERNIONF.fieldOf("left_rotation")).forGetter(Transformation::leftRotation), ((MapCodec)ExtraCodecs.VECTOR3F.fieldOf("scale")).forGetter(Transformation::scale), ((MapCodec)ExtraCodecs.QUATERNIONF.fieldOf("right_rotation")).forGetter(Transformation::rightRotation)).apply((Applicative<Transformation, ?>)i, Transformation::new));
