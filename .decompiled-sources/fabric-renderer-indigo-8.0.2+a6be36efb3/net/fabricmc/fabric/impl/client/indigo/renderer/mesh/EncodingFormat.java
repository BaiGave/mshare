...
import net.fabricmc.fabric.impl.client.indigo.renderer.mesh.ItemRenderType;
...
public final class EncodingFormat {
    ...
    private static final  @Nullable ItemStackRenderState.FoilType[] NULLABLE_FOIL_TYPES = ArrayUtils.add(ItemStackRenderState.FoilType.values(), null);
    ...
    private static final int CULL_MASK = EncodingFormat.bitMask(CULL_BIT_LENGTH, 0);
    private static final int LIGHT_MASK = EncodingFormat.bitMask(LIGHT_BIT_LENGTH, LIGHT_BIT_OFFSET);
    private static final int NORMALS_MASK = EncodingFormat.bitMask(4, NORMALS_BIT_OFFSET);
    private static final int GEOMETRY_MASK = EncodingFormat.bitMask(3, GEOMETRY_BIT_OFFSET);
    private static final int QUAD_ATLAS_MASK = EncodingFormat.bitMask(QUAD_ATLAS_BIT_LENGTH, QUAD_ATLAS_BIT_OFFSET);
    private static final int CHUNK_LAYER_MASK = EncodingFormat.bitMask(CHUNK_LAYER_BIT_LENGTH, CHUNK_LAYER_BIT_OFFSET);
    private static final int ITEM_RENDER_TYPE_MASK = EncodingFormat.bitMask(ITEM_RENDER_TYPE_BIT_LENGTH, ITEM_RENDER_TYPE_BIT_OFFSET);
    private static final int EMISSIVE_MASK = EncodingFormat.bitMask(1, EMISSIVE_BIT_OFFSET);
    private static final int DIFFUSE_MASK = EncodingFormat.bitMask(1, DIFFUSE_BIT_OFFSET);
    private static final int AO_MASK = EncodingFormat.bitMask(AO_BIT_LENGTH, AO_BIT_OFFSET);
    private static final int FOIL_TYPE_MASK = EncodingFormat.bitMask(FOIL_TYPE_BIT_LENGTH, FOIL_TYPE_BIT_OFFSET);
    private static final int SHADE_MODE_MASK = EncodingFormat.bitMask(SHADE_MODE_BIT_LENGTH, SHADE_MODE_BIT_OFFSET);
    private static final int ANIMATED_MASK = EncodingFormat.bitMask(1, ANIMATED_BIT_OFFSET);
    ...
    static  @Nullable ItemStackRenderState.FoilType foilType(int bits) {
        return NULLABLE_FOIL_TYPES[(bits & FOIL_TYPE_MASK) >>> FOIL_TYPE_BIT_OFFSET];
    }

    static int foilType(int bits,  @Nullable ItemStackRenderState.FoilType foilType) {
