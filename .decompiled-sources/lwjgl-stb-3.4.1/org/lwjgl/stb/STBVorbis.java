...
public class STBVorbis {
    ...
    public static long stb_vorbis_open_pushdata(@NativeType(value="unsigned char const *") ByteBuffer datablock, @NativeType(value="int *") IntBuffer datablock_memory_consumed_in_bytes, @NativeType(value="int *") IntBuffer error, @NativeType(value="stb_vorbis_alloc const *") @Nullable STBVorbisAlloc alloc_buffer) {
        if (Checks.CHECKS) {
    ...
    public static int stb_vorbis_decode_frame_pushdata(@NativeType(value="stb_vorbis *") long f, @NativeType(value="unsigned char const *") ByteBuffer datablock, @NativeType(value="int *") @Nullable IntBuffer channels, @NativeType(value="float ***") PointerBuffer output, @NativeType(value="int *") IntBuffer samples) {
        if (Checks.CHECKS) {
            Checks.check(f);
    ...
    public static @Nullable ShortBuffer stb_vorbis_decode_filename(@NativeType(value="char const *") CharSequence filename, @NativeType(value="int *") IntBuffer channels, @NativeType(value="int *") IntBuffer sample_rate) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)channels, 1);
            Checks.check((Buffer)sample_rate, 1);
        }
     ...
     */
    @NativeType(value="int")
    public static @Nullable ShortBuffer stb_vorbis_decode_memory(@NativeType(value="unsigned char const *") ByteBuffer mem, @NativeType(value="int *") IntBuffer channels, @NativeType(value="int *") IntBuffer sample_rate) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)channels, 1);
            Checks.check((Buffer)sample_rate, 1);
        }
    ...
    @NativeType(value="stb_vorbis *")
    public static long stb_vorbis_open_memory(@NativeType(value="unsigned char const *") ByteBuffer mem, @NativeType(value="int *") IntBuffer error, @NativeType(value="stb_vorbis_alloc const *") @Nullable STBVorbisAlloc alloc_buffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)error, 1);
            if (alloc_buffer != null) {
                STBVorbisAlloc.validate(alloc_buffer.address());
    ...
    @NativeType(value="stb_vorbis *")
    public static long stb_vorbis_open_filename(@NativeType(value="char const *") ByteBuffer filename, @NativeType(value="int *") IntBuffer error, @NativeType(value="stb_vorbis_alloc const *") @Nullable STBVorbisAlloc alloc_buffer) {
        if (Checks.CHECKS) {
            Checks.checkNT1(filename);
            Checks.check((Buffer)error, 1);
            if (alloc_buffer != null) {
     ...
     */
    @NativeType(value="stb_vorbis *")
    public static long stb_vorbis_open_filename(@NativeType(value="char const *") CharSequence filename, @NativeType(value="int *") IntBuffer error, @NativeType(value="stb_vorbis_alloc const *") @Nullable STBVorbisAlloc alloc_buffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)error, 1);
            if (alloc_buffer != null) {
                STBVorbisAlloc.validate(alloc_buffer.address());
    ...
    public static int stb_vorbis_get_frame_float(@NativeType(value="stb_vorbis *") long f, @NativeType(value="int *") @Nullable IntBuffer channels, @NativeType(value="float ***") PointerBuffer output) {
        if (Checks.CHECKS) {
            Checks.check(f);
            Checks.checkSafe((Buffer)channels, 1);
            Checks.check(output, 1);
    ...
    @NativeType(value="stb_vorbis *")
    public static long stb_vorbis_open_pushdata(@NativeType(value="unsigned char const *") ByteBuffer datablock, @NativeType(value="int *") int[] datablock_memory_consumed_in_bytes, @NativeType(value="int *") int[] error, @NativeType(value="stb_vorbis_alloc const *") @Nullable STBVorbisAlloc alloc_buffer) {
        if (Checks.CHECKS) {
    ...
    public static int stb_vorbis_decode_frame_pushdata(@NativeType(value="stb_vorbis *") long f, @NativeType(value="unsigned char const *") ByteBuffer datablock, @NativeType(value="int *") int @Nullable [] channels, @NativeType(value="float ***") PointerBuffer output, @NativeType(value="int *") int[] samples) {
        if (Checks.CHECKS) {
            Checks.check(f);
    ...
    @NativeType(value="stb_vorbis *")
    public static long stb_vorbis_open_memory(@NativeType(value="unsigned char const *") ByteBuffer mem, @NativeType(value="int *") int[] error, @NativeType(value="stb_vorbis_alloc const *") @Nullable STBVorbisAlloc alloc_buffer) {
        if (Checks.CHECKS) {
            Checks.check(error, 1);
            if (alloc_buffer != null) {
                STBVorbisAlloc.validate(alloc_buffer.address());
    ...
    @NativeType(value="stb_vorbis *")
    public static long stb_vorbis_open_filename(@NativeType(value="char const *") ByteBuffer filename, @NativeType(value="int *") int[] error, @NativeType(value="stb_vorbis_alloc const *") @Nullable STBVorbisAlloc alloc_buffer) {
        if (Checks.CHECKS) {
            Checks.checkNT1(filename);
            Checks.check(error, 1);
            if (alloc_buffer != null) {
     ...
     */
    @NativeType(value="stb_vorbis *")
    public static long stb_vorbis_open_filename(@NativeType(value="char const *") CharSequence filename, @NativeType(value="int *") int[] error, @NativeType(value="stb_vorbis_alloc const *") @Nullable STBVorbisAlloc alloc_buffer) {
        if (Checks.CHECKS) {
            Checks.check(error, 1);
            if (alloc_buffer != null) {
                STBVorbisAlloc.validate(alloc_buffer.address());
    ...
    public static int stb_vorbis_get_frame_float(@NativeType(value="stb_vorbis *") long f, @NativeType(value="int *") int @Nullable [] channels, @NativeType(value="float ***") PointerBuffer output) {
        if (Checks.CHECKS) {
            Checks.check(f);
            Checks.checkSafe(channels, 1);
            Checks.check(output, 1);
