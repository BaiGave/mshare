...
implements IndexedStringMap {
    ...
    private static final TriConsumer<String, Object, StringMap> PUT_ALL = (key, value, contextData) -> contextData.putValue((String)key, value);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.size() != ((ReadOnlyStringMap)obj).size()) {
            return false;
        }
        Map<String, String> thisMap = this.toMap();
        Map<String, String> otherMap = ((ReadOnlyStringMap)obj).toMap();
