...
public interface LoggerContext {
    ...
    default public ExtendedLogger getLogger(Class<?> cls, @Nullable MessageFactory messageFactory) {
        String canonicalName = cls.getCanonicalName();
    ...
    public ExtendedLogger getLogger(String var1, @Nullable MessageFactory var2);
    ...
    public boolean hasLogger(String var1, @Nullable MessageFactory var2);
