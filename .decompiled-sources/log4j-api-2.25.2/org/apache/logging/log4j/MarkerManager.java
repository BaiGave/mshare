...
public final class MarkerManager {
    ...
    public static Marker getMarker(String name, String parent) {
        ...
        return MarkerManager.getMarker(name).addParents(parentMarker);
    }

    @Deprecated
    @InlineMe(replacement="MarkerManager.getMarker(name).addParents(parent)", imports={"org.apache.logging.log4j.MarkerManager"})
