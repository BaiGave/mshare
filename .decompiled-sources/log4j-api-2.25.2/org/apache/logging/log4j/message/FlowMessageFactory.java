...
public interface FlowMessageFactory {
    public EntryMessage newEntryMessage(String var1, Object ... var2);

    public EntryMessage newEntryMessage(Message var1);

    public ExitMessage newExitMessage(String var1, Object var2);

    public ExitMessage newExitMessage(Message var1);
