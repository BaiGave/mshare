...
final class MapMessageJsonFormatter
extends Enum<MapMessageJsonFormatter> {
    ...
    private static final /* synthetic */ MapMessageJsonFormatter[] $VALUES;
    ...
    public static MapMessageJsonFormatter valueOf(String name) {
        return Enum.valueOf(MapMessageJsonFormatter.class, name);
    }
    ...
    private static /* synthetic */ MapMessageJsonFormatter[] $values() {
        return new MapMessageJsonFormatter[0];
    }

    static {
        $VALUES = MapMessageJsonFormatter.$values();
        MAX_DEPTH = MapMessageJsonFormatter.readMaxDepth();
    }
}
