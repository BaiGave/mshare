...
implements Closeable {
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        if (!this.rewindEnabled) {
            ...
            this.pos = 0;
        } else if (buffer.length - this.limit < minimum) {
    ...
    public void rewind() {
        if (!this.rewindEnabled) {
            throw new IllegalStateException("rewind disabled");
        }
        this.pos = 0;
        this.lineNumber = 0;
        this.lineStart = 0;
    ...
    public void setRewindEnabled(boolean value) {
        if (value && (this.pos > 0 || this.lineNumber > 0)) {
            throw new IllegalStateException("already read some data");
        }
        this.rewindEnabled = value;
    }
}
