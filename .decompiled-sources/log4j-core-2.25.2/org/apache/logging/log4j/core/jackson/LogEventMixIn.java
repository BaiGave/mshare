...
@JsonPropertyOrder(value={"timeMillis", "instant", "thread", "level", "loggerName", "marker", "message", "thrown", "contextMap", "contextStack", "endOfBatch", "loggerFqcn", "source"})
abstract class LogEventMixIn
implements LogEvent {
