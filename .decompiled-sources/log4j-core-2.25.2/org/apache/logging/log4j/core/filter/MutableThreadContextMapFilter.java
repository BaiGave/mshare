        ...
        public void run() {
            ...
            switch (result.status) {
                case SUCCESS: {
                    ...
                    LOGGER.info("MutableThreadContextMapFilter configuration was updated: {}", (Object)MutableThreadContextMapFilter.this.filter.toString());
                    break;
                }
                case NOT_FOUND: {
                    if (MutableThreadContextMapFilter.this.filter instanceof NoOpFilter) break;
