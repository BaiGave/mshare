...
extends AbstractFilter {
    ...
    private String targetMessageTest(Message message) {
        return this.useRawMessage && (message instanceof ParameterizedMessage || message instanceof StringFormattedMessage || message instanceof MessageFormatMessage || message instanceof StructuredDataMessage) ? message.getFormat() : message.getFormattedMessage();
    }
    ...
    public static RegexFilter createFilter(@PluginAttribute(value="regex") String regex, @PluginElement(value="PatternFlags") String[] patternFlags, @PluginAttribute(value="useRawMsg") Boolean useRawMsg, @PluginAttribute(value="onMatch") Filter.Result match, @PluginAttribute(value="onMismatch") Filter.Result mismatch) throws IllegalArgumentException, IllegalAccessException {
        ...
        return new RegexFilter(Boolean.TRUE.equals(useRawMsg), Pattern.compile(regex, RegexFilter.toPatternFlags(patternFlags)), match, mismatch);
    }
