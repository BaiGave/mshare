...
implements AsyncLoggerConfigDelegate {
    ...
    private Log4jEventWrapperHandler createEventHandler() {
        if (DisruptorUtil.DISRUPTOR_MAJOR_VERSION == 3) {
            try {
                return (Log4jEventWrapperHandler)Class.forName("org.apache.logging.log4j.core.async.AsyncLoggerConfigDisruptor$Log4jEventWrapperHandler3").getConstructor(new Class[0]).newInstance(new Object[0]);
            }
    ...
    public synchronized void start() {
        ...
        EventHandler[] handlers = new Log4jEventWrapperHandler[]{this.createEventHandler()};
    ...
    private static final class Log4jEventWrapperHandler3
    extends Log4jEventWrapperHandler
