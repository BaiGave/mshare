...
public enum AnsiEscape {
    ...
    public static Map<String, String> createMap(String[] values, String[] dontEscapeKeys) {
        return AnsiEscape.createMap(values, dontEscapeKeys, "\\s");
    }

    static Map<String, String> createMap(String[] values, String[] dontEscapeKeys, String separatorRegex) {
        ...
        for (String string : values) {
            ...
            if (keyValue.length > 1) {
                ...
                map.put(key, escape ? AnsiEscape.createSequence(value.split(separatorRegex)) : value);
                continue;
            }
    ...
    public static String createSequence(String ... names) {
        ...
        for (String name : names) {
            try {
                if (name.startsWith("disableAnsi") || name.startsWith("noConsoleNoAnsi")) continue;
                if (!first) {
