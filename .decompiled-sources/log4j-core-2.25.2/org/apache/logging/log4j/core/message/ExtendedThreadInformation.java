...
implements ThreadInformation {
    ...
    private void formatState(StringBuilder sb, ThreadInfo info) {
        ...
        switch (state) {
            ...
            case WAITING: {
                String method;
                StackTraceElement element = ExtendedThreadInformation.getFirstStackTraceElement(info);
    ...
    private static @Nullable StackTraceElement getFirstStackTraceElement(ThreadInfo info) {
