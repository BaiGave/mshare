...
PropertyChangeListener {
    ...
    @Override
    @SuppressFBWarnings(value={"PATH_TRAVERSAL_IN"}, justification="The location of the configuration comes from a running configuration.")
    ...
    @Override
    @SuppressFBWarnings(value={"URLCONNECTION_SSRF_FD", "PATH_TRAVERSAL_IN"}, justification="This method should only be called by a secure JMX connection.")
    ...
    @Override
    @SuppressFBWarnings(value={"INFORMATION_EXPOSURE_THROUGH_AN_ERROR_MESSAGE"}, justification="JMX should be considered a trusted channel.")
