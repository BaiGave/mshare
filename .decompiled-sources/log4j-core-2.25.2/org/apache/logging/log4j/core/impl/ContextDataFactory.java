...
public class ContextDataFactory {
    ...
    private static final Constructor<? extends StringMap> DEFAULT_CONSTRUCTOR = ContextDataFactory.createDefaultConstructor(CACHED_CLASS);
    private static final Constructor<? extends StringMap> INITIAL_CAPACITY_CONSTRUCTOR = ContextDataFactory.createInitialCapacityConstructor(CACHED_CLASS);
    ...
    private static Constructor<? extends StringMap> createDefaultConstructor(Class<? extends StringMap> cachedClass) {
        if (cachedClass == null) {
            return null;
        }
        try {
    ...
    private static Constructor<? extends StringMap> createInitialCapacityConstructor(Class<? extends StringMap> cachedClass) {
        if (cachedClass == null) {
            return null;
        }
        try {
