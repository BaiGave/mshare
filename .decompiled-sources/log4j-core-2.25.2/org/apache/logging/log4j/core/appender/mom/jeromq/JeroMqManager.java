...
extends AbstractManager {
    ...
    private JeroMqManager(String name, JeroMqConfiguration config) {
        ...
        monitor.add(new ZMonitor.Event[]{ZMonitor.Event.LISTENING});
        monitor.start();
        ...
        ArrayList<String> endpoints = new ArrayList<String>(config.endpoints.size());
    ...
    static {
        ...
        SHUTDOWN_HOOK = enableShutdownHook && LogManager.getFactory() instanceof ShutdownCallbackRegistry ? ((ShutdownCallbackRegistry)((Object)LogManager.getFactory())).addShutdownCallback(() -> ((ZContext)CONTEXT).close()) : null;
    }
