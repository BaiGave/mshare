...
extends AbstractAppender {
    ...
    implements org.apache.logging.log4j.core.util.Builder<SmtpAppender> {
        ...
        public SmtpAppender build() {
            ...
            MailManagerFactory factory = ServiceLoaderUtil.safeStream(MailManagerFactory.class, ServiceLoader.load(MailManagerFactory.class, this.getClass().getClassLoader()), StatusLogger.getLogger()).findAny().orElseGet(() -> SmtpManager.FACTORY);
