...
extends OutputStreamManager {
    ...
    @SuppressFBWarnings(value={"OVERLY_PERMISSIVE_FILE_PERMISSION"}, justification="File permissions are specified in the configuration file.")
    ...
    @Override
    @SuppressFBWarnings(value={"PATH_TRAVERSAL_IN"}, justification="The destination file is specified in the configuration file.")
