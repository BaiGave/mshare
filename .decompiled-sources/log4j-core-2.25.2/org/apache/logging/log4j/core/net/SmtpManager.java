...
extends MailManager {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    @SuppressFBWarnings(value={"SMTP_HEADER_INJECTION"}, justification="False positive, since MimeMessage#setSubject does actually escape new lines.")
    ...
    implements MailManagerFactory {
        ...
        public SmtpManager createManager(String name, MailManager.FactoryData data) {
            ...
            if (smtpProtocol.equals("smtps") && (sslConfiguration = data.getSslConfiguration()) != null) {
                SSLSocketFactory sslSocketFactory = sslConfiguration.getSslContext().getSocketFactory();
