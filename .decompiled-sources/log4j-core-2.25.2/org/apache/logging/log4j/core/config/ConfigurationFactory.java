        ...
        private Configuration getConfiguration(LoggerContext loggerContext, boolean isTest, String name) {
            ...
            for (ConfigurationFactory factory : Factory.getFactories()) {
                ...
                for (String suffix : types) {
                    ...
                    if (!factory.isActive()) {
                        LOGGER.error("Found configuration file `{}` for the inactive `{}`. This `ConfigurationFactory` implementation might be inactive due to a missing dependency.", (Object)configName, (Object)factory.getClass().getName());
                    }
