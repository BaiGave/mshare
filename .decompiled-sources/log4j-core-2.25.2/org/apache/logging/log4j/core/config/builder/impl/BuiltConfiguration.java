...
extends AbstractConfiguration {
        ...
        for (Component component : rootComponent.getComponents()) {
            switch (component.getPluginType()) {
                ...
                case "MonitorResources": {
                    this.monitorResourcesComponent = component;
                    break;
                }
                case "AsyncWaitStrategyFactory": {
                    this.asyncWaitStrategyFactoryComponent = component;
                }
            }
        }
    ...
    public void setup() {
        ...
        if (this.monitorResourcesComponent != null && this.monitorResourcesComponent.getComponents().size() > 0) {
            children.add(this.convertToNode(this.rootNode, this.monitorResourcesComponent));
        }
        if (this.asyncWaitStrategyFactoryComponent != null) {
            children.add(this.convertToNode(this.rootNode, this.asyncWaitStrategyFactoryComponent));
        }
