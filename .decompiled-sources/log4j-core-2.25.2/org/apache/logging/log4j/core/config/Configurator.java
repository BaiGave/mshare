...
public final class Configurator {
    ...
    public static LoggerContext initialize(String name, ClassLoader loader, String configLocation, Object externalContext) {
        ...
        return configLocation.contains(",") ? Configurator.initialize(name, loader, NetUtils.toURIs(configLocation), externalContext) : Configurator.initialize(name, loader, NetUtils.toURI(configLocation), externalContext);
    }
    ...
    public static void setLevel(Class<?> clazz, Level level) {
        ...
        Configurator.setLevel(LoggerContext.getContext(StackLocatorUtil.getCallerClassLoader(2), false, null), canonicalName != null ? canonicalName : clazz.getName(), level);
    }
