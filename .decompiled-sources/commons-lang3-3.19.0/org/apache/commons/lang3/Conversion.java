...
public class Conversion {
    ...
    public static boolean[] hexDigitMsb0ToBinary(char hexChar) {
        switch (hexChar) {
            case '0': {
    ...
    public static int hexDigitMsb0ToInt(char hexChar) {
        switch (hexChar) {
            case '0': {
                return 0;
            }
    ...
    public static boolean[] hexDigitToBinary(char hexChar) {
        switch (hexChar) {
            case '0': {
                return (boolean[])FFFF.clone();
            }
    ...
    public static int hexDigitToInt(char hexChar) {
