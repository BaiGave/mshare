...
Serializable {
    ...
    private static final ConcurrentMap<TimeZoneDisplayKey, String> timeZoneDisplayCache = new ConcurrentHashMap<TimeZoneDisplayKey, String>(7);
    ...
    private static final class TwoDigitYearField
    ...
    private static final class WeekYear
    implements NumberRule {
    ...
    private static final class TwoDigitMonthField
    implements NumberRule {
    ...
    private static final class UnpaddedMonthField
    implements NumberRule {
    ...
    private static final class TwelveHourField
    implements NumberRule {
        private final NumberRule rule;
    ...
    private static final class DayInWeekField
    implements NumberRule {
        private final NumberRule rule;
    ...
    private static final class TwentyFourHourField
    implements NumberRule {
        private final NumberRule rule;
    ...
    private static final class Iso8601_Rule
    implements Rule {
    ...
    private static final class TimeZoneNameRule
    implements Rule {
        private final Locale locale;
        private final int style;
    ...
    private static final class TimeZoneNumberRule
    implements Rule {
    ...
    private static final class CharacterLiteral
    implements Rule {
    ...
    private static final class UnpaddedNumberField
    implements NumberRule {
        private final int field;
    ...
    private static final class TwoDigitNumberField
    implements NumberRule {
        private final int field;
