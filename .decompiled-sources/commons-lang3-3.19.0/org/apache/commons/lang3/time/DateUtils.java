...
public class DateUtils {
    ...
    public static LocalDateTime toLocalDateTime(Date date) {
        return DateUtils.toLocalDateTime(date, TimeZone.getDefault());
    }

    public static LocalDateTime toLocalDateTime(Date date, TimeZone timeZone) {
        return LocalDateTime.ofInstant(date.toInstant(), DateUtils.toZoneId(timeZone));
    }

    public static OffsetDateTime toOffsetDateTime(Date date) {
        return DateUtils.toOffsetDateTime(date, TimeZone.getDefault());
    }

    public static OffsetDateTime toOffsetDateTime(Date date, TimeZone timeZone) {
        return OffsetDateTime.ofInstant(date.toInstant(), DateUtils.toZoneId(timeZone));
    }

    public static ZonedDateTime toZonedDateTime(Date date) {
        return DateUtils.toZonedDateTime(date, TimeZone.getDefault());
    }

    public static ZonedDateTime toZonedDateTime(Date date, TimeZone timeZone) {
        return ZonedDateTime.ofInstant(date.toInstant(), DateUtils.toZoneId(timeZone));
    }
    ...
    static final class DateIterator
