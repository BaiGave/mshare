...
implements PathVisitor {
    ...
    SimplePathVisitor(AbstractBuilder<?, ?> builder) {
        this.visitFileFailedFunction = ((AbstractBuilder)builder).visitFileFailedFunction != null ? ((AbstractBuilder)builder).visitFileFailedFunction : (x$0, x$1) -> super.visitFileFailed(x$0, (IOException)x$1);
    }
    ...
    protected static abstract class AbstractBuilder<T, B extends AbstractSupplier<T, B>>
