...
implements Serializable {
    ...
    private FileAlterationObserver(Builder builder) {
        this(builder.rootEntry != null ? builder.rootEntry : new FileEntry(builder.checkOriginFile()), builder.fileFilter, FileAlterationObserver.toComparator(builder.ioCase));
    }
    ...
    public void removeListener(FileAlterationListener listener) {
        if (listener != null) {
            this.listeners.removeIf((Predicate<FileAlterationListener>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, equals(java.lang.Object ), (Lorg/apache/commons/io/monitor/FileAlterationListener;)Z)((FileAlterationListener)listener));
        }
    }
