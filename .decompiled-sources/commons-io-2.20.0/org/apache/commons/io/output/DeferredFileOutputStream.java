...
extends ThresholdingOutputStream {
    ...
    private DeferredFileOutputStream(Builder builder) {
        ...
        this.outputPath = DeferredFileOutputStream.toPath(builder.outputFile, null);
        this.prefix = builder.prefix;
        this.suffix = builder.suffix;
        this.directory = DeferredFileOutputStream.toPath(builder.directory, PathUtils::getTempDirectory);
        this.memoryOutputStream = new ByteArrayOutputStream(DeferredFileOutputStream.checkBufferSize(builder.getBufferSize()));
