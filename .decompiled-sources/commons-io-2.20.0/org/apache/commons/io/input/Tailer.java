...
AutoCloseable {
    ...
    public static Tailer create(File file, Charset charset, TailerListener tailerListener, long delayMillis, boolean end, boolean reOpen, int bufferSize) {
        return ((Builder)((Builder)((Builder)Tailer.builder().setFile(file)).setTailerListener(tailerListener).setCharset(charset)).setDelayDuration(Duration.ofMillis(delayMillis)).setTailFromEnd(end).setReOpen(reOpen).setBufferSize(bufferSize)).get();
    }

    @Deprecated
    public static Tailer create(File file, TailerListener tailerListener) {
        return ((Builder)Tailer.builder().setFile(file)).setTailerListener(tailerListener).get();
    }

    @Deprecated
    public static Tailer create(File file, TailerListener tailerListener, long delayMillis) {
        return ((Builder)Tailer.builder().setFile(file)).setTailerListener(tailerListener).setDelayDuration(Duration.ofMillis(delayMillis)).get();
    }

    @Deprecated
    public static Tailer create(File file, TailerListener tailerListener, long delayMillis, boolean end) {
        return ((Builder)Tailer.builder().setFile(file)).setTailerListener(tailerListener).setDelayDuration(Duration.ofMillis(delayMillis)).setTailFromEnd(end).get();
    }

    @Deprecated
    public static Tailer create(File file, TailerListener tailerListener, long delayMillis, boolean end, boolean reOpen) {
        return ((Builder)Tailer.builder().setFile(file)).setTailerListener(tailerListener).setDelayDuration(Duration.ofMillis(delayMillis)).setTailFromEnd(end).setReOpen(reOpen).get();
    }
    ...
    public static Tailer create(File file, TailerListener tailerListener, long delayMillis, boolean end, boolean reOpen, int bufferSize) {
        return ((Builder)((Builder)Tailer.builder().setFile(file)).setTailerListener(tailerListener).setDelayDuration(Duration.ofMillis(delayMillis)).setTailFromEnd(end).setReOpen(reOpen).setBufferSize(bufferSize)).get();
    }

    @Deprecated
    public static Tailer create(File file, TailerListener tailerListener, long delayMillis, boolean end, int bufferSize) {
        return ((Builder)((Builder)Tailer.builder().setFile(file)).setTailerListener(tailerListener).setDelayDuration(Duration.ofMillis(delayMillis)).setTailFromEnd(end).setBufferSize(bufferSize)).get();
    }
