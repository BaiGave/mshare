...
extends InputStream {
    ...
    private CharSequenceInputStream(Builder builder) {
    ...
    public CharSequenceInputStream(CharSequence cs, Charset charset, int bufferSize) {
        this((Builder)((Builder)CharSequenceInputStream.builder().setCharSequence(cs)).setCharset(charset).setBufferSize(bufferSize));
    }
