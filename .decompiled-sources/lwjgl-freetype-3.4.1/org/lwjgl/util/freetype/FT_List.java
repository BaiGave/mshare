...
extends Struct<FT_List> {
    ...
    public @Nullable FT_ListNode head() {
        return FT_List.nhead(this.address());
    }

    public @Nullable FT_ListNode tail() {
    ...
    public static @Nullable FT_ListNode nhead(long struct) {
        return FT_ListNode.createSafe(MemoryUtil.memGetAddress(struct + (long)HEAD));
    }

    public static @Nullable FT_ListNode ntail(long struct) {
