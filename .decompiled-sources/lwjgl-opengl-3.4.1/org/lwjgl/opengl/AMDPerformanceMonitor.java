...
public class AMDPerformanceMonitor {
    ...
    public static void glGetPerfMonitorGroupsAMD(@NativeType(value="GLint *") @Nullable IntBuffer numGroups, @NativeType(value="GLuint *") @Nullable IntBuffer groups) {
        if (Checks.CHECKS) {
    ...
    public static void glGetPerfMonitorGroupsAMD(@NativeType(value="GLint *") int @Nullable [] numGroups, @NativeType(value="GLuint *") int @Nullable [] groups) {
