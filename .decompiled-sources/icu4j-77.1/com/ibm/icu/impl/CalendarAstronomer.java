...
public class CalendarAstronomer {
    ...
    public Equatorial getMoonPosition() {
        if (this.moonPosition == null) {
            ...
            double variation = 0.011489502465878671 * Math.sin(2.0 * (moonLongitude - sunLong));
            double nodeLongitude = CalendarAstronomer.norm2PI(5.559050068029439 - 9.242199067718253E-4 * day);
            double y = Math.sin((moonLongitude += variation) - (nodeLongitude -= 0.0027925268031909274 * Math.sin(this.meanAnomalySun)));
    ...
    private double eclipticObliquity() {
        ...
        return eclipObliquity * (Math.PI / 180);
    }
