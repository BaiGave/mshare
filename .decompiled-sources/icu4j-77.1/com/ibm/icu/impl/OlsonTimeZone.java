...
extends BasicTimeZone {
    ...
    public void setRawOffset(int offsetMillis) {
        ...
        if ((double)current < this.finalStartMillis) {
            ...
            this.finalStartYear = Grego.timeToYear(current);
            this.finalStartMillis = Grego.fieldsToDay(this.finalStartYear, 0, 1);
            if (bDst) {
    ...
    public OlsonTimeZone(String id) {
        super(id);
        UResourceBundle top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata", ZONEINFORES, ICUResourceBundle.ICU_DATA_CLASS_LOADER);
