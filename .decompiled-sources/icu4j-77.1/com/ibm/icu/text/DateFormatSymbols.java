...
Cloneable {
    ...
    protected void initializeData(ULocale desiredLocale, ICUResourceBundle b, String calendarType) {
        ...
        this.abbreviatedDayPeriods = this.loadDayPeriodStrings(maps.get("dayPeriod/format/abbreviated"), null);
        this.wideDayPeriods = this.loadDayPeriodStrings(maps.get("dayPeriod/format/wide"), this.abbreviatedDayPeriods);
        this.narrowDayPeriods = this.loadDayPeriodStrings(maps.get("dayPeriod/format/narrow"), this.abbreviatedDayPeriods);
        this.standaloneAbbreviatedDayPeriods = this.loadDayPeriodStrings(maps.get("dayPeriod/stand-alone/abbreviated"), this.abbreviatedDayPeriods);
        this.standaloneWideDayPeriods = this.loadDayPeriodStrings(maps.get("dayPeriod/stand-alone/wide"), this.standaloneAbbreviatedDayPeriods);
        this.standaloneNarrowDayPeriods = this.loadDayPeriodStrings(maps.get("dayPeriod/stand-alone/narrow"), this.standaloneAbbreviatedDayPeriods);
        for (int i = 0; i < 7; ++i) {
    ...
    private String[] loadDayPeriodStrings(Map<String, String> resourceMap, String[] copyFrom) {
        ...
        if (resourceMap != null) {
            for (int i = 0; i < DAY_PERIOD_KEYS.length; ++i) {
                ...
                if (strings[i] != null || copyFrom == null) continue;
