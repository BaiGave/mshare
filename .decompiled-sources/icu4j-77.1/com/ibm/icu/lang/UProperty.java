...
public interface UProperty {
    ...
    public static final int IDENTIFIER_STATUS = 4121;
    public static final int INDIC_CONJUNCT_BREAK = 4122;
    @Deprecated
    public static final int INT_LIMIT = 4123;
    ...
    public static final int IDENTIFIER_TYPE = 28673;
    @Deprecated
    public static final int OTHER_PROPERTY_LIMIT = 28674;
