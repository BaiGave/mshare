...
final class CollectSpliterators {
    ...
    static <T> Spliterator<T> indexed(int size, int extraCharacteristics, IntFunction<T> function, @Nullable Comparator<? super T> comparator) {
        ...
        final class WithCharacteristics
    ...
    static <InElementT> Spliterator.OfInt flatMapToInt(Spliterator<InElementT> fromSpliterator, Function<? super InElementT, @Nullable Spliterator.OfInt> function, int topCharacteristics, long topSize) {
        Preconditions.checkArgument((topCharacteristics & 0x4000) == 0, "flatMap does not support SUBSIZED characteristic");
        Preconditions.checkArgument((topCharacteristics & 4) == 0, "flatMap does not support SORTED characteristic");
        Preconditions.checkNotNull(fromSpliterator);
        Preconditions.checkNotNull(function);
    ...
    static <InElementT> Spliterator.OfLong flatMapToLong(Spliterator<InElementT> fromSpliterator, Function<? super InElementT, @Nullable Spliterator.OfLong> function, int topCharacteristics, long topSize) {
        Preconditions.checkArgument((topCharacteristics & 0x4000) == 0, "flatMap does not support SUBSIZED characteristic");
        Preconditions.checkArgument((topCharacteristics & 4) == 0, "flatMap does not support SORTED characteristic");
        Preconditions.checkNotNull(fromSpliterator);
        Preconditions.checkNotNull(function);
    ...
    static <InElementT> Spliterator.OfDouble flatMapToDouble(Spliterator<InElementT> fromSpliterator, Function<? super InElementT, @Nullable Spliterator.OfDouble> function, int topCharacteristics, long topSize) {
        Preconditions.checkArgument((topCharacteristics & 0x4000) == 0, "flatMap does not support SUBSIZED characteristic");
        Preconditions.checkArgument((topCharacteristics & 4) == 0, "flatMap does not support SORTED characteristic");
        Preconditions.checkNotNull(fromSpliterator);
        Preconditions.checkNotNull(function);
    ...
    extends FlatMapSpliterator<InElementT, OutElementT, Spliterator<OutElementT>> {
        FlatMapSpliteratorOfObject(@Nullable Spliterator<OutElementT> prefix, Spliterator<InElementT> from, Function<? super InElementT, @Nullable Spliterator<OutElementT>> function, int characteristics, long estimatedSize) {
    ...
    implements Spliterator.OfInt {
        FlatMapSpliteratorOfInt(@Nullable Spliterator.OfInt prefix, Spliterator<InElementT> from, Function<? super InElementT, @Nullable Spliterator.OfInt> function, int characteristics, long estimatedSize) {
    ...
    implements Spliterator.OfLong {
        FlatMapSpliteratorOfLong(@Nullable Spliterator.OfLong prefix, Spliterator<InElementT> from, Function<? super InElementT, @Nullable Spliterator.OfLong> function, int characteristics, long estimatedSize) {
    ...
    implements Spliterator.OfDouble {
        FlatMapSpliteratorOfDouble(@Nullable Spliterator.OfDouble prefix, Spliterator<InElementT> from, Function<? super InElementT, @Nullable Spliterator.OfDouble> function, int characteristics, long estimatedSize) {
    ...
    implements Spliterator.OfPrimitive<OutElementT, OutConsumerT, OutSpliteratorT> {
        FlatMapSpliteratorOfPrimitive(@Nullable OutSpliteratorT prefix, Spliterator<InElementT> from, Function<? super InElementT, @Nullable OutSpliteratorT> function, FlatMapSpliterator.Factory<InElementT, OutSpliteratorT> factory, int characteristics, long estimatedSize) {
    ...
    implements Spliterator<OutElementT> {
        ...
        FlatMapSpliterator(@Nullable OutSpliteratorT prefix, Spliterator<InElementT> from, Function<? super InElementT, @Nullable OutSpliteratorT> function, Factory<InElementT, OutSpliteratorT> factory, int characteristics, long estimatedSize) {
            this.prefix = prefix;
            this.from = from;
        ...
        static interface Factory<InElementT, OutSpliteratorT extends Spliterator<?>> {
            public OutSpliteratorT newFlatMapSpliterator(@Nullable OutSpliteratorT var1, Spliterator<InElementT> var2, Function<? super InElementT, @Nullable OutSpliteratorT> var3, int var4, long var5);
        }
    }
}
