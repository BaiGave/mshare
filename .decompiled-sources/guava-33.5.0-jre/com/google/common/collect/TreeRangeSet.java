    ...
    extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this){
                ...
                @Override
                protected  @Nullable Map.Entry<Cut<C>, Range<C>> computeNext() {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this){
                ...
                protected  @Nullable Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    Range range = (Range)backingItr.next();
                    return ((RangesByUpperBound)this.this$0).upperBoundWindow.lowerBound.isLessThan(range.upperBound) ? Maps.immutableEntry(range.upperBound, range) : (Map.Entry)this.endOfData();
                }
            };
        }
