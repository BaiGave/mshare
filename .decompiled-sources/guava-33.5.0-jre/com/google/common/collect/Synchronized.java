...
final class Synchronized {
    ...
    @GwtIncompatible
    private static <K, V> @Nullable Map.Entry<K, V> nullableSynchronizedEntry(@Nullable Map.Entry<K, V> entry, @Nullable Object mutex) {
        if (entry == null) {
            return null;
        }
    ...
    static final class SynchronizedMultiset<E>
    extends SynchronizedCollection<E>
    ...
    static final class SynchronizedListMultimap<K, V>
    ...
    static final class SynchronizedSortedSetMultimap<K, V>
    ...
    static final class SynchronizedBiMap<K, V>
    extends SynchronizedMap<K, V>
    ...
    @GwtIncompatible
    @VisibleForTesting
    static final class SynchronizedNavigableSet<E>
    ...
    @GwtIncompatible
    @VisibleForTesting
    static final class SynchronizedNavigableMap<K, V>
    ...
    @GwtIncompatible
    static final class SynchronizedEntry<K, V>
    extends SynchronizedObject
    ...
    implements Table<R, C, V> {
        ...
        public Map<R, Map<C, V>> rowMap() {
            Object object = this.mutex;
            synchronized (object) {
                return Synchronized.map(Maps.transformValues(this.delegate().rowMap(), m -> Synchronized.map(m, this.mutex)), this.mutex);
            }
        }
        ...
        public Map<C, Map<R, V>> columnMap() {
            Object object = this.mutex;
            synchronized (object) {
                return Synchronized.map(Maps.transformValues(this.delegate().columnMap(), m -> Synchronized.map(m, this.mutex)), this.mutex);
            }
        }
    ...
    static final class SynchronizedAsMap<K, V>
