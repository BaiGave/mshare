...
implements Serializable {
    ...
    public @Nullable V put(@ParametricNullness K key, @ParametricNullness V value) {
        ...
        if (next == 0) {
            ...
            do {
                int entryIndex;
                if (CompactHashing.getHashPrefix(entry = entries[entryIndex = next - 1], mask) == hashPrefix && Objects.equals(key, keys[entryIndex])) {
    ...
    private int indexOf(@Nullable Object key) {
        ...
        do {
            int entryIndex;
            if (CompactHashing.getHashPrefix(entry = this.entry(entryIndex = next - 1), mask) != hashPrefix || !Objects.equals(key, this.key(entryIndex))) continue;
            return entryIndex;
    ...
    public boolean containsValue(@Nullable Object value) {
        ...
        for (int i = 0; i < this.size; ++i) {
            if (!Objects.equals(value, this.value(i))) continue;
            return true;
        }
        return false;
    }
    ...
    extends Maps.EntrySet<K, V> {
        ...
        public boolean contains(@Nullable Object o) {
            ...
            if (o instanceof Map.Entry) {
                ...
                return index != -1 && Objects.equals(CompactHashMap.this.value(index), entry.getValue());
            }
            return false;
        }
    ...
    extends AbstractMapEntry<K, V> {
        ...
        private void updateLastKnownIndex() {
            if (this.lastKnownIndex == -1 || this.lastKnownIndex >= CompactHashMap.this.size() || !Objects.equals(this.key, CompactHashMap.this.key(this.lastKnownIndex))) {
