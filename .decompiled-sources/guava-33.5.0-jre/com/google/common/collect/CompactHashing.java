...
final class CompactHashing {
    ...
    static int remove(@Nullable Object key, @Nullable Object value, int mask, Object table, int[] entries, @Nullable Object[] keys, @Nullable Object @Nullable [] values) {
        int entry;
        ...
        do {
            int entryIndex;
            if (CompactHashing.getHashPrefix(entry = entries[entryIndex = next - 1], mask) == hashPrefix && Objects.equals(key, keys[entryIndex]) && (values == null || Objects.equals(value, values[entryIndex]))) {
