...
public final class Multisets {
        ...
        return new ViewMultiset<E>(){
            ...
            Iterator<Multiset.Entry<E>> entryIterator() {
                ...
                return new AbstractIterator<Multiset.Entry<E>>(this){
                    ...
                    @Override
                    protected @Nullable Multiset.Entry<E> computeNext() {
    ...
    static <E> boolean addAllImpl(Multiset<E> self, Collection<? extends E> elements) {
        ...
        if (elements instanceof Multiset) {
            return Multisets.addAllImpl(self, (Multiset)elements);
        }
        if (elements.isEmpty()) {
            return false;
        }
    ...
    implements Multiset.Entry<E> {
        ...
        public boolean equals(@Nullable Object object) {
            if (object instanceof Multiset.Entry) {
                ...
                return this.getCount() == that.getCount() && Objects.equals(this.getElement(), that.getElement());
            }
            return false;
        }
