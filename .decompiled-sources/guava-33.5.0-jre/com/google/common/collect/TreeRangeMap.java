...
implements RangeMap<K, V> {
    ...
    private static final RangeMap<Comparable<?>, Object> EMPTY_SUB_RANGE_MAP = new RangeMap<Comparable<?>, Object>(){
        ...
        @Override
        public @Nullable Map.Entry<Range<Comparable<?>>, Object> getEntry(Comparable<?> key) {
            return null;
        }
        ...
        @Override
        public void merge(Range<Comparable<?>> range, @Nullable Object value, BiFunction<? super Object, ? super @Nullable Object, ? extends @Nullable Object> remappingFunction) {
            Preconditions.checkNotNull(range);
    ...
    public static <K extends Comparable<?>, V> TreeRangeMap<K, V> copyOf(RangeMap<K, ? extends V> rangeMap) {
        if (rangeMap instanceof TreeRangeMap) {
            TreeMap<Cut<Cut<K>>, RangeMapEntry<Cut<K>, RangeMapEntry<K, V>>> entriesByLowerBound = Maps.newTreeMap();
            entriesByLowerBound.putAll(((TreeRangeMap)rangeMap).entriesByLowerBound);
            return new TreeRangeMap<K, V>(entriesByLowerBound);
        }
        TreeMap<Cut<Cut<K>>, RangeMapEntry<Cut<K>, RangeMapEntry<K, V>>> entriesByLowerBound = Maps.newTreeMap();
        for (Map.Entry<Range<K>, V> entry : rangeMap.asMapOfRanges().entrySet()) {
            entriesByLowerBound.put(entry.getKey().lowerBound(), new RangeMapEntry<K, V>(entry.getKey(), entry.getValue()));
        }
        return new TreeRangeMap<K, V>(entriesByLowerBound);
    }
    ...
    private static <K extends Comparable, V> Range<K> coalesce(Range<K> range, V value, @Nullable Map.Entry<Cut<K>, RangeMapEntry<K, V>> entry) {
        if (entry != null && ((Range)entry.getValue().getKey()).isConnected(range) && entry.getValue().getValue().equals(value)) {
            return range.span((Range)entry.getValue().getKey());
        }
        return range;
    }
    ...
    extends AbstractMap.SimpleImmutableEntry<Range<K>, V> {
        ...
        boolean contains(K value) {
            return ((Range)this.getKey()).contains(value);
        }
    ...
    private final class SubRangeMap
    implements RangeMap<K, V> {
            ...
            return new SubRangeMapAsMap(){
                ...
                Iterator<Map.Entry<Range<K>, V>> entryIterator() {
                    ...
                    return new AbstractIterator<Map.Entry<Range<K>, V>>(this){
                        ...
                        @Override
                        protected @Nullable Map.Entry<Range<K>, V> computeNext() {
                            if (backingItr.hasNext()) {
                                ...
                                return Maps.immutableEntry(((Range)entry.getKey()).intersection(this.this$2.SubRangeMap.this.subRange), entry.getValue());
                            }
                            return (Map.Entry)this.endOfData();
                        }
                    };
            ...
            Iterator<Map.Entry<Range<K>, V>> entryIterator() {
                ...
                return new AbstractIterator<Map.Entry<Range<K>, V>>(this){
                    ...
                    protected @Nullable Map.Entry<Range<K>, V> computeNext() {
                        while (backingItr.hasNext()) {
                            RangeMapEntry entry = (RangeMapEntry)backingItr.next();
                            if (entry.getLowerBound().compareTo(((SubRangeMap)this.this$2.SubRangeMap.this).subRange.upperBound) >= 0) {
                                return (Map.Entry)this.endOfData();
                            }
                            if (entry.getUpperBound().compareTo(((SubRangeMap)this.this$2.SubRangeMap.this).subRange.lowerBound) <= 0) continue;
                            return Maps.immutableEntry(((Range)entry.getKey()).intersection(this.this$2.SubRangeMap.this.subRange), entry.getValue());
                        }
                        return (Map.Entry)this.endOfData();
                    }
