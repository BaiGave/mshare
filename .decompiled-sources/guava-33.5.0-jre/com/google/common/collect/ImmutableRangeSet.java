...
implements Serializable {
    ...
    @LazyInit
    @RetainedWith
    private transient @Nullable ImmutableRangeSet<C> lazyComplement;
    ...
    private ImmutableRangeSet(ImmutableList<Range<C>> ranges, @Nullable ImmutableRangeSet<C> complement) {
        this.ranges = ranges;
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        return this.lazyComplement();
    }

    private ImmutableRangeSet<C> lazyComplement() {
        ImmutableRangeSet<C> result = this.lazyComplement;
        return result == null ? (this.lazyComplement = new ImmutableRangeSet<C>(new ComplementRanges<C>(this.ranges), this)) : result;
    }
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        final int fromIndex = range.hasLowerBound() ? SortedLists.binarySearch(this.ranges, Range::upperBound, range.lowerBound, SortedLists.KeyPresentBehavior.FIRST_AFTER, SortedLists.KeyAbsentBehavior.NEXT_HIGHER) : 0;
        int toIndex = range.hasUpperBound() ? SortedLists.binarySearch(this.ranges, Range::lowerBound, range.upperBound, SortedLists.KeyPresentBehavior.FIRST_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER) : this.ranges.size();
        ...
        return new ImmutableList<Range<C>>(this){
            ...
            public Range<C> get(int index) {
                ...
                if (index == 0 || index == length - 1) {
                    return ((Range)this.this$0.ranges.get(index + fromIndex)).intersection(range);
                }
                return (Range)this.this$0.ranges.get(index + fromIndex);
            }
    ...
    extends ImmutableList<Range<C>> {
        ...
        ComplementRanges(ImmutableList<Range<C>> ranges) {
            this.ranges = ranges;
            this.positiveBoundedBelow = ((Range)ranges.get(0)).hasLowerBound();
        ...
        public Range<C> get(int index) {
            ...
            Cut lowerBound = this.positiveBoundedBelow ? (index == 0 ? Cut.belowAll() : ((Range)this.ranges.get((int)(index - 1))).upperBound) : ((Range)this.ranges.get((int)index)).upperBound;
            Cut upperBound = this.positiveBoundedAbove && index == this.size - 1 ? Cut.aboveAll() : ((Range)this.ranges.get((int)(index + (this.positiveBoundedBelow ? 0 : 1)))).lowerBound;
    ...
    private static final class AsSetSerializedForm<C extends Comparable>
    implements Serializable {
        private final ImmutableList<Range<C>> ranges;
        private final DiscreteDomain<C> domain;
