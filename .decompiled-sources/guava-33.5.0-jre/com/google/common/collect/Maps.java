...
public final class Maps {
    ...
    public static <K, V> MapDifference<K, V> difference(Map<? extends K, ? extends V> left, Map<? extends K, ? extends V> right, Equivalence<? super @NonNull V> valueEquivalence) {
        ...
        LinkedHashMap onlyOnLeft = new LinkedHashMap();
        LinkedHashMap<? extends K, ? extends V> onlyOnRight = new LinkedHashMap<K, V>(right);
        LinkedHashMap onBoth = new LinkedHashMap();
        LinkedHashMap differences = new LinkedHashMap();
    ...
    public static <K, V1, V2> Map<K, V2> transformValues(Map<K, V1> fromMap, Function<? super V1, V2> function) {
        ...
        return Maps.transformEntries(fromMap, (? super K key, ? super V1 value) -> function.apply((Object)value));
    }
    ...
    static <K, V1, V2> Function<Map.Entry<K, V1>, Map.Entry<K, V2>> asEntryToEntryFunction(EntryTransformer<? super K, ? super V1, V2> transformer) {
        Preconditions.checkNotNull(transformer);
        return entry -> Maps.transformEntry(transformer, entry);
    }
    ...
    static <K, V> boolean containsEntryImpl(Collection<Map.Entry<K, V>> c, @Nullable Object o) {
    ...
    static <K, V> boolean removeEntryImpl(Collection<Map.Entry<K, V>> c, @Nullable Object o) {
        if (!(o instanceof Map.Entry)) {
            return false;
        }
    ...
    implements MapDifference<K, V> {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(this.entriesOnlyOnLeft(), this.entriesOnlyOnRight(), this.entriesInCommon(), this.entriesDiffering());
        }
    ...
    private static final class SortedMapDifferenceImpl<K, V>
    ...
    static final class ValueDifferenceImpl<V>
    implements MapDifference.ValueDifference<V> {
        ...
        public boolean equals(@Nullable Object object) {
            if (object instanceof MapDifference.ValueDifference) {
                ...
                return Objects.equals(this.left, that.leftValue()) && Objects.equals(this.right, that.rightValue());
            }
            return false;
        }
    ...
    private static final class SortedAsMapView<K, V>
    ...
    private static final class UnmodifiableBiMap<K, V>
    ...
    private static class TransformedEntriesSortedMap<K, V1, V2>
    ...
    @GwtIncompatible
    private static final class TransformedEntriesNavigableMap<K, V1, V2>
    ...
    implements NavigableMap<K, V2> {
        ...
        @Override
        public @Nullable Map.Entry<K, V2> ceilingEntry(@ParametricNullness K key) {
        ...
        @Override
        public @Nullable Map.Entry<K, V2> firstEntry() {
            return this.transformEntry(this.fromMap().firstEntry());
        }

        @Override
        public @Nullable Map.Entry<K, V2> floorEntry(@ParametricNullness K key) {
        ...
        @Override
        public @Nullable Map.Entry<K, V2> higherEntry(@ParametricNullness K key) {
        ...
        @Override
        public @Nullable Map.Entry<K, V2> lastEntry() {
            return this.transformEntry(this.fromMap().lastEntry());
        }

        @Override
        public @Nullable Map.Entry<K, V2> lowerEntry(@ParametricNullness K key) {
        ...
        @Override
        public @Nullable Map.Entry<K, V2> pollFirstEntry() {
            return this.transformEntry(this.fromMap().pollFirstEntry());
        }

        @Override
        public @Nullable Map.Entry<K, V2> pollLastEntry() {
    ...
    private static final class FilteredKeyMap<K, V>
                    ...
                    Map.Entry<K, V> transform(final Map.Entry<K, V> entry) {
                        return new ForwardingMapEntry<K, V>(this){
                            ...
                            public V setValue(@ParametricNullness V newValue) {
                                Preconditions.checkArgument(this.this$2.FilteredEntryMap.this.apply(this.getKey(), newValue));
    ...
    private static final class FilteredEntrySortedMap<K, V>
    ...
    @GwtIncompatible
    private static final class FilteredEntryNavigableMap<K, V>
    extends AbstractNavigableMap<K, V> {
    ...
    @GwtIncompatible
    private static final class UnmodifiableNavigableMap<K, V>
    ...
    Serializable {
        ...
        @Override
        public @Nullable Map.Entry<K, V> lowerEntry(@ParametricNullness K key) {
        ...
        @Override
        public @Nullable Map.Entry<K, V> floorEntry(@ParametricNullness K key) {
        ...
        @Override
        public @Nullable Map.Entry<K, V> ceilingEntry(@ParametricNullness K key) {
        ...
        @Override
        public @Nullable Map.Entry<K, V> higherEntry(@ParametricNullness K key) {
        ...
        @Override
        public final @Nullable Map.Entry<K, V> pollFirstEntry() {
            throw new UnsupportedOperationException();
        }

        @Override
        public final @Nullable Map.Entry<K, V> pollLastEntry() {
            throw new UnsupportedOperationException();
        }
    ...
    extends Values<K, V> {
        ...
        public boolean remove(@Nullable Object o) {
            ...
            while (entryItr.hasNext()) {
                Map.Entry<K, V> entry = entryItr.next();
                if (!this.predicate.apply(entry) || !Objects.equals(entry.getValue(), o)) continue;
                entryItr.remove();
                return true;
            }
            return false;
