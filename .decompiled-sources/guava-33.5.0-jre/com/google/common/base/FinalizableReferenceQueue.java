...
implements Closeable {
    ...
    implements FinalizerLoader {
        ...
        public @Nullable Class<?> loadFinalizer() {
            ...
            block8: {
                ...
                try {
                    clazz = finalizerLoader.loadClass(FinalizableReferenceQueue.FINALIZER_CLASS_NAME);
                    if (finalizerLoader == null) break block8;
                }
    ...
    private static final class DirectLoader
    implements FinalizerLoader {
