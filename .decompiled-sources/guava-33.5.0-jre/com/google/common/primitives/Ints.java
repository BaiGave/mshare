...
extends IntsMethodsForWeb {
    ...
    @InlineMeValidationDisabled(value="The hash code of a int is the int itself, so it's simplest to return that.")
    ...
    public static int[] concat(int[] ... arrays) {
        ...
        int[] result = new int[Ints.checkNoOverflow(length)];
        int pos = 0;
        for (int[] array : arrays) {
    ...
    private static final class IntArrayAsList
