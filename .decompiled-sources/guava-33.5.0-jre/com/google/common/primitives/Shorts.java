...
extends ShortsMethodsForWeb {
    ...
    @InlineMeValidationDisabled(value="The hash code of a short is the int version of the short itself, so it's simplest to return that.")
    ...
    public static short[] concat(short[] ... arrays) {
        ...
        short[] result = new short[Shorts.checkNoOverflow(length)];
        int pos = 0;
        for (short[] array : arrays) {
    ...
    private static final class ShortArrayAsList
