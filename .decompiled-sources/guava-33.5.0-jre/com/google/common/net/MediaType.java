...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.of("charset", Ascii.toLowerCase(StandardCharsets.UTF_8.name()));
    ...
    private static final Map<MediaType, MediaType> knownTypes = new HashMap<MediaType, MediaType>();
    ...
    public static final MediaType MD_UTF_8 = MediaType.createConstantUtf8("text", "markdown");
    ...
    public static final MediaType AVIF = MediaType.createConstant("image", "avif");
    ...
    public static final MediaType CBOR = MediaType.createConstant("application", "cbor");
    ...
    public MediaType withParameters(String attribute, Iterable<String> values) {
        ...
        MediaType result = MoreObjects.firstNonNull(knownTypes.get(mediaType), mediaType);
        return result;
    }
    ...
    private static MediaType create(String type, String subtype, Multimap<String, String> parameters) {
        ...
        Preconditions.checkArgument(!normalizedType.equals(WILDCARD) || normalizedSubtype.equals(WILDCARD), "A wildcard type cannot be used with a non-wildcard subtype");
        ImmutableListMultimap.Builder builder = ImmutableListMultimap.builder();
    ...
    public int hashCode() {
        int h = this.hashCode;
        if (h == 0) {
            this.hashCode = h = Objects.hash(this.type, this.subtype, this.parametersAsMap());
        }
        return h;
    }
