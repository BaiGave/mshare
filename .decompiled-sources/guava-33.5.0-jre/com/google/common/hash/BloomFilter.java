...
Serializable {
    ...
    public int hashCode() {
        return Objects.hash(this.numHashFunctions, this.funnel, this.strategy, this.bits);
    }
    ...
    public static <T> BloomFilter<T> readFrom(InputStream in, Funnel<? super T> funnel) throws IOException {
        ...
        try {
            ...
            numHashFunctions = Byte.toUnsignedInt(din.readByte());
            dataLength = din.readInt();
            BloomFilterStrategies strategy = BloomFilterStrategies.values()[strategyOrdinal];
            BloomFilterStrategies.LockFreeBitArray dataArray = new BloomFilterStrategies.LockFreeBitArray(Math.multiplyExact((long)dataLength, 64L));
    ...
    private static final class SerialForm<T>
