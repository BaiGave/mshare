...
implements IMixinContext {
    ...
    private void validateMethod(MethodNode method) {
        ...
        if (this.getEnvironment().getOption(MixinEnvironment.Option.DEBUG_VERIFY) && Bytecode.isVirtual(method) && (superMethod = this.targetClassInfo.findMethodInHierarchy(method, ClassInfo.SearchType.SUPER_CLASSES_ONLY, ClassInfo.Traversal.ALL, 0)) != null && superMethod.isFinal()) {
