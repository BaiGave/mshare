...
extends BaseNCodec {
    ...
    public static BigInteger decodeInteger(byte[] array) {
        return new BigInteger(1, Base64.decodeBase64(array));
    }
    ...
    private Base64(int lineLength, byte[] lineSeparator, byte padding, byte[] encodeTable, CodecPolicy decodingPolicy) {
        ...
        boolean bl = this.isUrlSafe = encodeTable == URL_SAFE_ENCODE_TABLE || Arrays.equals(encodeTable, URL_SAFE_ENCODE_TABLE);
