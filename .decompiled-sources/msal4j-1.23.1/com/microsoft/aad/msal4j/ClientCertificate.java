...
implements IClientCertificate {
    ...
    public String publicCertificateHash256() throws CertificateEncodingException, NoSuchAlgorithmException {
        return Base64.getEncoder().encodeToString(ClientCertificate.getHashSha256(this.publicKeyCertificateChain.get(0).getEncoded()));
    }

    @Override
    public String publicCertificateHash() throws CertificateEncodingException, NoSuchAlgorithmException {
        return Base64.getEncoder().encodeToString(ClientCertificate.getHashSha1(this.publicKeyCertificateChain.get(0).getEncoded()));
    }
