...
public final class ALCCapabilities {
    ...
    private static boolean check_EXT_direct_context(FunctionProviderLocal provider, long device, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, device, caps, new int[]{20}, "alcGetProcAddress2") || Checks.reportMissing("ALC", "ALC_EXT_direct_context");
    }
    ...
    private static boolean check_EXT_thread_local_context(FunctionProviderLocal provider, long device, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, device, caps, new int[]{21, 22}, "alcSetThreadContext", "alcGetThreadContext") || Checks.reportMissing("ALC", "ALC_EXT_thread_local_context");
    }
    ...
    private static boolean check_SOFT_device_clock(FunctionProviderLocal provider, long device, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, device, caps, new int[]{23}, "alcGetInteger64vSOFT") || Checks.reportMissing("ALC", "ALC_SOFT_device_clock");
    }
    ...
    private static boolean check_SOFT_HRTF(FunctionProviderLocal provider, long device, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, device, caps, new int[]{24, 25}, "alcGetStringiSOFT", "alcResetDeviceSOFT") || Checks.reportMissing("ALC", "ALC_SOFT_HRTF");
    }
    ...
    private static boolean check_SOFT_loopback(FunctionProviderLocal provider, long device, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, device, caps, new int[]{26, 27, 28}, "alcLoopbackOpenDeviceSOFT", "alcIsRenderFormatSupportedSOFT", "alcRenderSamplesSOFT") || Checks.reportMissing("ALC", "ALC_SOFT_loopback");
    }
    ...
    private static boolean check_SOFT_pause_device(FunctionProviderLocal provider, long device, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, device, caps, new int[]{29, 30}, "alcDevicePauseSOFT", "alcDeviceResumeSOFT") || Checks.reportMissing("ALC", "ALC_SOFT_pause_device");
    }
    ...
    private static boolean check_SOFT_reopen_device(FunctionProviderLocal provider, long device, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, device, caps, new int[]{31}, "alcReopenDeviceSOFT") || Checks.reportMissing("ALC", "ALC_SOFT_reopen_device");
    }
    ...
    private static boolean check_SOFT_system_events(FunctionProviderLocal provider, long device, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, device, caps, new int[]{32, 33, 34}, "alcEventIsSupportedSOFT", "alcEventControlSOFT", "alcEventCallbackSOFT") || Checks.reportMissing("ALC", "ALC_SOFT_system_events");
    }
}
