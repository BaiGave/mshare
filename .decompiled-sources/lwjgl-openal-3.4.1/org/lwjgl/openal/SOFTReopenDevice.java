...
public class SOFTReopenDevice {
    ...
    public static boolean alcReopenDeviceSOFT(@NativeType(value="ALCdevice *") long device, @NativeType(value="ALCchar const *") @Nullable ByteBuffer deviceName, @NativeType(value="ALCint const *") @Nullable IntBuffer attribs) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="ALCboolean")
    public static boolean alcReopenDeviceSOFT(@NativeType(value="ALCdevice *") long device, @NativeType(value="ALCchar const *") @Nullable CharSequence deviceName, @NativeType(value="ALCint const *") @Nullable IntBuffer attribs) {
        if (Checks.CHECKS) {
            Checks.checkNTSafe(attribs);
        }
    ...
    @NativeType(value="ALCboolean")
    public static boolean alcReopenDeviceSOFT(@NativeType(value="ALCdevice *") long device, @NativeType(value="ALCchar const *") @Nullable ByteBuffer deviceName, @NativeType(value="ALCint const *") int @Nullable [] attribs) {
        long __functionAddress = ALC.getICD().alcReopenDeviceSOFT;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(device);
     ...
     */
    @NativeType(value="ALCboolean")
    public static boolean alcReopenDeviceSOFT(@NativeType(value="ALCdevice *") long device, @NativeType(value="ALCchar const *") @Nullable CharSequence deviceName, @NativeType(value="ALCint const *") int @Nullable [] attribs) {
        long __functionAddress = ALC.getICD().alcReopenDeviceSOFT;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(device);
