...
extends ALC10 {
    ...
    public static long alcCaptureOpenDevice(@NativeType(value="ALCchar const *") @Nullable ByteBuffer deviceName, @NativeType(value="ALCuint") int frequency, @NativeType(value="ALCenum") int format, @NativeType(value="ALCsizei") int samples) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="ALCdevice *")
    public static long alcCaptureOpenDevice(@NativeType(value="ALCchar const *") @Nullable CharSequence deviceName, @NativeType(value="ALCuint") int frequency, @NativeType(value="ALCenum") int format, @NativeType(value="ALCsizei") int samples) {
