...
public class ALC10 {
    ...
    public static long alcOpenDevice(@NativeType(value="ALCchar const *") @Nullable ByteBuffer deviceSpecifier) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="ALCdevice *")
    public static long alcOpenDevice(@NativeType(value="ALCchar const *") @Nullable CharSequence deviceSpecifier) {
    ...
    public static long alcCreateContext(@NativeType(value="ALCdevice const *") long deviceHandle, @NativeType(value="ALCint const *") @Nullable IntBuffer attrList) {
        if (Checks.CHECKS) {
    ...
    public static @Nullable String alcGetString(@NativeType(value="ALCdevice *") long deviceHandle, @NativeType(value="ALCenum") int token) {
    ...
    @NativeType(value="ALCcontext *")
    public static long alcCreateContext(@NativeType(value="ALCdevice const *") long deviceHandle, @NativeType(value="ALCint const *") int @Nullable [] attrList) {
        long __functionAddress = ALC.getICD().alcCreateContext;
        if (Checks.CHECKS) {
            Checks.check(deviceHandle);
            Checks.checkNTSafe(attrList);
