...
public class EXTEfx {
    ...
    public static void nalGenEffectsDirect(long context, int n, long effects) {
        ...
        JNI.invokePPV(context, n, effects, __functionAddress);
    }

    @NativeType(value="ALvoid")
    public static void alGenEffectsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") IntBuffer effects) {
        EXTEfx.nalGenEffectsDirect(context, effects.remaining(), MemoryUtil.memAddress(effects));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static int alGenEffectsDirect(@NativeType(value="ALCcontext *") long context) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer effects = stack.callocInt(1);
            EXTEfx.nalGenEffectsDirect(context, 1, MemoryUtil.memAddress(effects));
            int n = effects.get(0);
            return n;
        }
        finally {
    ...
    @NativeType(value="ALvoid")
    public static void alDeleteEffectsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") IntBuffer effects) {
        EXTEfx.nalDeleteEffectsDirect(context, effects.remaining(), MemoryUtil.memAddress(effects));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static void alDeleteEffectsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") int effect) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer effects = stack.ints(effect);
            EXTEfx.nalDeleteEffectsDirect(context, 1, MemoryUtil.memAddress(effects));
        }
        finally {
            stack.setPointer(stackPointer);
        }
    ...
    @NativeType(value="ALboolean")
    public static boolean alIsEffectDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect) {
        long __functionAddress = AL.getICD().alIsEffectDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
        }
        return JNI.invokePZ(context, effect, __functionAddress);
    }
    ...
    @NativeType(value="ALvoid")
    public static void alEffectiDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALint") int value) {
        long __functionAddress = AL.getICD().alEffectiDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
        }
        JNI.invokePV(context, effect, param, value, __functionAddress);
    }
    ...
    public static void nalEffectivDirect(long context, int effect, int param, long values) {
        ...
        JNI.invokePPV(context, effect, param, values, __functionAddress);
    }

    @NativeType(value="ALvoid")
    public static void alEffectivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALint const *") IntBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalEffectivDirect(context, effect, param, MemoryUtil.memAddress(values));
    }
    ...
    @NativeType(value="ALvoid")
    public static void alEffectfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat") float value) {
    ...
    @NativeType(value="ALvoid")
    public static void alEffectfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat const *") FloatBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalEffectfvDirect(context, effect, param, MemoryUtil.memAddress(values));
    }
    ...
    public static void nalGetEffectiDirect(long context, int effect, int param, long value) {
        ...
        JNI.invokePPV(context, effect, param, value, __functionAddress);
    }

    @NativeType(value="ALvoid")
    public static void alGetEffectiDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") IntBuffer value) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)value, 1);
        }
        EXTEfx.nalGetEffectiDirect(context, effect, param, MemoryUtil.memAddress(value));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static int alGetEffectiDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer value = stack.callocInt(1);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") IntBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalGetEffectivDirect(context, effect, param, MemoryUtil.memAddress(values));
    }
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") FloatBuffer value) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)value, 1);
        }
        EXTEfx.nalGetEffectfDirect(context, effect, param, MemoryUtil.memAddress(value));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static float alGetEffectfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            FloatBuffer value = stack.callocFloat(1);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") FloatBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalGetEffectfvDirect(context, effect, param, MemoryUtil.memAddress(values));
    }
    ...
    public static void nalGenFiltersDirect(long context, int n, long filters) {
        ...
        JNI.invokePPV(context, n, filters, __functionAddress);
    }

    @NativeType(value="ALvoid")
    public static void alGenFiltersDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") IntBuffer filters) {
        EXTEfx.nalGenFiltersDirect(context, filters.remaining(), MemoryUtil.memAddress(filters));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static int alGenFiltersDirect(@NativeType(value="ALCcontext *") long context) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer filters = stack.callocInt(1);
            EXTEfx.nalGenFiltersDirect(context, 1, MemoryUtil.memAddress(filters));
            int n = filters.get(0);
            return n;
        }
        finally {
    ...
    @NativeType(value="ALvoid")
    public static void alDeleteFiltersDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") IntBuffer filters) {
        EXTEfx.nalDeleteFiltersDirect(context, filters.remaining(), MemoryUtil.memAddress(filters));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static void alDeleteFiltersDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") int filter) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer filters = stack.ints(filter);
            EXTEfx.nalDeleteFiltersDirect(context, 1, MemoryUtil.memAddress(filters));
        }
        finally {
            stack.setPointer(stackPointer);
        }
    ...
    @NativeType(value="ALboolean")
    public static boolean alIsFilterDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter) {
        long __functionAddress = AL.getICD().alIsFilterDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
        }
        return JNI.invokePZ(context, filter, __functionAddress);
    }
    ...
    @NativeType(value="ALvoid")
    public static void alFilteriDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALint") int value) {
        long __functionAddress = AL.getICD().alFilteriDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
        }
        JNI.invokePV(context, filter, param, value, __functionAddress);
    }
    ...
    public static void nalFilterivDirect(long context, int filter, int param, long values) {
        ...
        JNI.invokePPV(context, filter, param, values, __functionAddress);
    }

    @NativeType(value="ALvoid")
    public static void alFilterivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALint const *") IntBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalFilterivDirect(context, filter, param, MemoryUtil.memAddress(values));
    }
    ...
    @NativeType(value="ALvoid")
    public static void alFilterfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat") float value) {
    ...
    @NativeType(value="ALvoid")
    public static void alFilterfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat const *") FloatBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalFilterfvDirect(context, filter, param, MemoryUtil.memAddress(values));
    }
    ...
    public static void nalGetFilteriDirect(long context, int filter, int param, long value) {
        ...
        JNI.invokePPV(context, filter, param, value, __functionAddress);
    }

    @NativeType(value="ALvoid")
    public static void alGetFilteriDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") IntBuffer value) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)value, 1);
        }
        EXTEfx.nalGetFilteriDirect(context, filter, param, MemoryUtil.memAddress(value));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static int alGetFilteriDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer value = stack.callocInt(1);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") IntBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalGetFilterivDirect(context, filter, param, MemoryUtil.memAddress(values));
    }
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") FloatBuffer value) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)value, 1);
        }
        EXTEfx.nalGetFilterfDirect(context, filter, param, MemoryUtil.memAddress(value));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static float alGetFilterfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            FloatBuffer value = stack.callocFloat(1);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") FloatBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalGetFilterfvDirect(context, filter, param, MemoryUtil.memAddress(values));
    }
    ...
    public static void nalGenAuxiliaryEffectSlotsDirect(long context, int n, long effectSlots) {
        ...
        JNI.invokePPV(context, n, effectSlots, __functionAddress);
    }

    @NativeType(value="ALvoid")
    public static void alGenAuxiliaryEffectSlotsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") IntBuffer effectSlots) {
        EXTEfx.nalGenAuxiliaryEffectSlotsDirect(context, effectSlots.remaining(), MemoryUtil.memAddress(effectSlots));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static int alGenAuxiliaryEffectSlotsDirect(@NativeType(value="ALCcontext *") long context) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer effectSlots = stack.callocInt(1);
            EXTEfx.nalGenAuxiliaryEffectSlotsDirect(context, 1, MemoryUtil.memAddress(effectSlots));
            int n = effectSlots.get(0);
            return n;
        }
        finally {
    ...
    @NativeType(value="ALvoid")
    public static void alDeleteAuxiliaryEffectSlotsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") IntBuffer effectSlots) {
        EXTEfx.nalDeleteAuxiliaryEffectSlotsDirect(context, effectSlots.remaining(), MemoryUtil.memAddress(effectSlots));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static void alDeleteAuxiliaryEffectSlotsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") int effectSlot) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer effectSlots = stack.ints(effectSlot);
            EXTEfx.nalDeleteAuxiliaryEffectSlotsDirect(context, 1, MemoryUtil.memAddress(effectSlots));
        }
        finally {
            stack.setPointer(stackPointer);
        }
    ...
    @NativeType(value="ALboolean")
    public static boolean alIsAuxiliaryEffectSlotDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot) {
        long __functionAddress = AL.getICD().alIsAuxiliaryEffectSlotDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
        }
        return JNI.invokePZ(context, effectSlot, __functionAddress);
    }
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotiDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALint") int value) {
        long __functionAddress = AL.getICD().alAuxiliaryEffectSlotiDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
        }
        JNI.invokePV(context, effectSlot, param, value, __functionAddress);
    }
    ...
    public static void nalAuxiliaryEffectSlotivDirect(long context, int effectSlot, int param, long values) {
        ...
        JNI.invokePPV(context, effectSlot, param, values, __functionAddress);
    }

    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALint const *") IntBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalAuxiliaryEffectSlotivDirect(context, effectSlot, param, MemoryUtil.memAddress(values));
    }
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat") float value) {
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat const *") FloatBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalAuxiliaryEffectSlotfvDirect(context, effectSlot, param, MemoryUtil.memAddress(values));
    }
    ...
    public static void nalGetAuxiliaryEffectSlotiDirect(long context, int effectSlot, int param, long value) {
        ...
        JNI.invokePPV(context, effectSlot, param, value, __functionAddress);
    }

    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotiDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") IntBuffer value) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)value, 1);
        }
        EXTEfx.nalGetAuxiliaryEffectSlotiDirect(context, effectSlot, param, MemoryUtil.memAddress(value));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static int alGetAuxiliaryEffectSlotiDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer value = stack.callocInt(1);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") IntBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalGetAuxiliaryEffectSlotivDirect(context, effectSlot, param, MemoryUtil.memAddress(values));
    }
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") FloatBuffer value) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)value, 1);
        }
        EXTEfx.nalGetAuxiliaryEffectSlotfDirect(context, effectSlot, param, MemoryUtil.memAddress(value));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static float alGetAuxiliaryEffectSlotfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            FloatBuffer value = stack.callocFloat(1);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") FloatBuffer values) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values, 1);
        }
        EXTEfx.nalGetAuxiliaryEffectSlotfvDirect(context, effectSlot, param, MemoryUtil.memAddress(values));
    }
    ...
    @NativeType(value="ALvoid")
    public static void alGenEffectsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") int[] effects) {
        long __functionAddress = AL.getICD().alGenEffectsDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
        }
        JNI.invokePPV(context, effects.length, effects, __functionAddress);
    }
    ...
    @NativeType(value="ALvoid")
    public static void alDeleteEffectsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") int[] effects) {
        long __functionAddress = AL.getICD().alDeleteEffectsDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alEffectivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALint const *") int[] values) {
        long __functionAddress = AL.getICD().alEffectivDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alEffectfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat const *") float[] values) {
        long __functionAddress = AL.getICD().alEffectfvDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectiDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") int[] value) {
        long __functionAddress = AL.getICD().alGetEffectiDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") int[] values) {
        long __functionAddress = AL.getICD().alGetEffectivDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") float[] value) {
        long __functionAddress = AL.getICD().alGetEffectfDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effect, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") float[] values) {
        long __functionAddress = AL.getICD().alGetEffectfvDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGenFiltersDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") int[] filters) {
        long __functionAddress = AL.getICD().alGenFiltersDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
        }
        JNI.invokePPV(context, filters.length, filters, __functionAddress);
    }
    ...
    @NativeType(value="ALvoid")
    public static void alDeleteFiltersDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") int[] filters) {
        long __functionAddress = AL.getICD().alDeleteFiltersDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alFilterivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALint const *") int[] values) {
        long __functionAddress = AL.getICD().alFilterivDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alFilterfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat const *") float[] values) {
        long __functionAddress = AL.getICD().alFilterfvDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilteriDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") int[] value) {
        long __functionAddress = AL.getICD().alGetFilteriDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") int[] values) {
        long __functionAddress = AL.getICD().alGetFilterivDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") float[] value) {
        long __functionAddress = AL.getICD().alGetFilterfDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int filter, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") float[] values) {
        long __functionAddress = AL.getICD().alGetFilterfvDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGenAuxiliaryEffectSlotsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") int[] effectSlots) {
        long __functionAddress = AL.getICD().alGenAuxiliaryEffectSlotsDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
        }
        JNI.invokePPV(context, effectSlots.length, effectSlots, __functionAddress);
    }
    ...
    @NativeType(value="ALvoid")
    public static void alDeleteAuxiliaryEffectSlotsDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint *") int[] effectSlots) {
        long __functionAddress = AL.getICD().alDeleteAuxiliaryEffectSlotsDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALint const *") int[] values) {
        long __functionAddress = AL.getICD().alAuxiliaryEffectSlotivDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat const *") float[] values) {
        long __functionAddress = AL.getICD().alAuxiliaryEffectSlotfvDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotiDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") int[] value) {
        long __functionAddress = AL.getICD().alGetAuxiliaryEffectSlotiDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotivDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALint *") int[] values) {
        long __functionAddress = AL.getICD().alGetAuxiliaryEffectSlotivDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotfDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") float[] value) {
        long __functionAddress = AL.getICD().alGetAuxiliaryEffectSlotfDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotfvDirect(@NativeType(value="ALCcontext *") long context, @NativeType(value="ALuint") int effectSlot, @NativeType(value="ALenum") int param, @NativeType(value="ALfloat *") float[] values) {
        long __functionAddress = AL.getICD().alGetAuxiliaryEffectSlotfvDirect;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(context);
