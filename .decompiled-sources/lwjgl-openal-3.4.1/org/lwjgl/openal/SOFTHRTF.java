...
public class SOFTHRTF {
    ...
    public static @Nullable String alcGetStringiSOFT(@NativeType(value="ALCdevice *") long device, @NativeType(value="ALCenum") int paramName, @NativeType(value="ALCsizei") int index) {
    ...
    public static boolean alcResetDeviceSOFT(@NativeType(value="ALCdevice *") long device, @NativeType(value="ALCint const *") @Nullable IntBuffer attrList) {
        if (Checks.CHECKS) {
    ...
    @NativeType(value="ALCboolean")
    public static boolean alcResetDeviceSOFT(@NativeType(value="ALCdevice *") long device, @NativeType(value="ALCint const *") int @Nullable [] attrList) {
        long __functionAddress = ALC.getICD().alcResetDeviceSOFT;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(device);
